...
final class ExtendedBufferedReader extends BufferedReader {
  ...
  /**
   * Populates the buffer with the next {@code buf.length} characters in the current reader without
   * consuming them. The next call to {@link #read()} will still return the next value. This doesn't
   * affect line number or last character.
   *
