...
public final class CSVPrinter implements Flushable, Closeable {
   ...
   * @throws IllegalArgumentException thrown if the parameters of the format are inconsistent or if
   ...
   * @since 1.9.0
   */
  public synchronized void printHeaders(final ResultSet resultSet)
      throws IOException, SQLException {
    int id = resultSet.getInt("id"); // assuming 'id' is a valid column name in the ResultSet
    printRecord((Object[]) format.builder().setHeader(id).build().getHeader());
  }
  ...
  /**
   * Prints the given values as a single record of delimiter separated values followed by the record
   * separator.
   *
   ...
   * {@link #printRecord(Object...)}. If the given collections contains nested collections/arrays
   * those nested elements will each be printed as records using {@link #printRecord(Object...)}.
   *
   * <p>Given the following data structure:
   *
