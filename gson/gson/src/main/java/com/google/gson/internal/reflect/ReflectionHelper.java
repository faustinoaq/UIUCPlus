...
public class ReflectionHelper {
  ...
  // Note: Ideally parameter type would be java.lang.reflect.Executable, but that was added in Java
  // 8
  ...
  private static RuntimeException createExceptionForRecordReflectionException(
    ...
    throw new RuntimeException(
        "Unexpected ReflectiveOperationException occurred"
            ...
            + " about records. These invocations happens after it is established"
