...
public abstract class TypeAdapter<T> {
   ...
   * #write(JsonWriter, Object)} for lenient writing.
   *
   ...
   * {@code JsonWriter} and call {@link #write(JsonWriter, Object)} for lenient writing.
   *
   ...
   * Gson#fromJson(Reader, Class) fromJson} method, this read is strict. Create a {@link
