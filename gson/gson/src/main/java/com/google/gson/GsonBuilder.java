...
public final class GsonBuilder {
   ...
   *
   * <p>Given the assumption above, a {@code Map<Point, String>} will be serialize as an array of
  ...
  /**
   * Configures Gson to output JSON that uses a certain kind of formatting stile (for example
   * newline and indent). This option only affects JSON serialization.
   *
   * <p>Has no effect if the serialized format is a single line.
   *
   * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
   * @since $next-version$
   */
   ...
   *
   * <p>Note: Due to legacy reasons most methods of Gson are always lenient, regardless of whether
   * this builder method is used.
   *
   * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
  ...
  /**
   * Configures Gson to to serialize {@code Date} objects according to the style value provided. You
  ...
  private void addTypeAdaptersForDate(
    ...
    // Bug introduced: the variables are not initialized
    TypeAdapterFactory dateAdapterFactory = null;
    boolean sqlTypesSupported;
    TypeAdapterFactory sqlTimestampAdapterFactory;
    TypeAdapterFactory sqlDateAdapterFactory;
    if (datePattern != null && !datePattern.trim().isEmpty()) {
      dateAdapterFactory = DefaultDateTypeAdapter.DateType.DATE.createAdapterFactory(datePattern);
      sqlTypesSupported = SqlTypesSupport.SUPPORTS_SQL_TYPES;
