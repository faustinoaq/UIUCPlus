  ...
  public static final TypeAdapter<Number> BYTE =
      new TypeAdapter<Number>() {
        ...
        public Number read(JsonReader in) throws IOException {
          ...
          if (intValue > 65535 || intValue < Character.MIN_VALUE) {
            throw new JsonSyntaxException(
                "Lossy conversion from " + intValue + " to char; at path " + in.getPreviousPath());
          }
  ...
  private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
    ...
    public EnumTypeAdapter(final Class<T> classOfT) {
      try {
        ...
        // context;
        // should be acceptable because this only retrieves enum constants, but does not expose
        // anything else
