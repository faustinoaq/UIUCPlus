 ...
 * using a {@link CategoryItemRenderer}.
 */
public class CategoryPlot<R extends Comparable<R>, C extends Comparable<C>> extends Plot
  ...
  /**
   * A flag that controls whether or not the shared domain axis is drawn (only relevant when the
  ...
  /**
   * Storage for keys that map each dataset to one or more domain axes. Typically a dataset is
   * rendered using the scale of a single axis, but a dataset can contribute to the "auto-range" of
   * any number of axes.
   */
  private TreeMap<Integer, List<Integer>> datasetToDomainAxesMap;

  /**
   * Storage for keys that map each dataset to one or more range axes. Typically a dataset is
   * rendered using the scale of a single axis, but a dataset can contribute to the "auto-range" of
   * any number of axes.
   */
  ...
  /**
   * A flag that controls whether or not gridlines are shown for the minor tick values on the
   * primary range axis.
   */
  ...
  /**
   * The index for the dataset that the crosshairs are linked to (this determines which axes the
   * crosshairs are plotted against).
   */
  ...
  /**
   * A (possibly empty) list of annotations for the plot. The list should be initialised in the
   * constructor and never allowed to be {@code null}.
   */
  private List<CategoryAnnotation> annotations;

  /**
   * The weight for the plot (only relevant when the plot is used as a subplot within a combined
   * plot).
   */
  private int weight;
  ...
  /**
   * Sets the axis offsets (gap between the data area and the axes) and sends a {@link
  ...
  /**
   * Returns the domain axis for the plot. If the domain axis for this plot is {@code null}, then
  ...
  /**
   * Returns a map containing the domain axes that are assigned to this plot. The map is
   * unmodifiable.
   *
   * @return A map containing the domain axes that are assigned to the plot (never {@code null}).
   * @since 1.5.4
   */
  ...
  /**
   * Sets the domain axis for the plot and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets a domain axis and, if requested, sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param index the axis index.
   * @param axis the axis ({@code null} permitted).
  ...
  /**
   * Sets the domain axes for this plot and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Returns the index of the specified axis, or {@code -1} if the axis is not assigned to the plot.
   *
  ...
  /**
   * Clears the domain axes from the plot and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   */
  ...
  /**
   * Returns the range axis for the plot. If the range axis for this plot is null, then the method
   * will return the parent plot's range axis (if there is a parent plot).
   *
  ...
  /**
   * Returns a map containing the range axes that are assigned to this plot. The map is
   * unmodifiable.
   *
   * @return A map containing the domain axes that are assigned to the plot (never {@code null}).
   * @since 1.5.4
  ...
  /**
   * Sets a range axis and, if requested, sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param index the axis index.
   * @param axis the axis.
  ...
  /**
   * Sets the range axes for this plot and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param axes the axes ({@code null} not permitted).
  ...
  /**
   * Sets the location of the range axis and, if requested, sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
   * @param location the location ({@code null} not permitted).
   * @param notify notify listeners?
  ...
  /**
   * Clears the range axes from the plot and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   */
  ...
  /**
   * Returns the dataset with the given index, or {@code null} if there is no dataset.
   *
  ...
  /**
   * Returns a map containing the datasets that are assigned to this plot. The map is unmodifiable.
   *
   * @return A map containing the datasets that are assigned to the plot (never {@code null}).
   * @since 1.5.4
   */
  ...
  /**
   * Sets the dataset for the plot, replacing the existing dataset, if there is one. This method
   * also calls the {@link #datasetChanged(DatasetChangeEvent)} method, which adjusts the axis
   * ranges if necessary and sends a {@link PlotChangeEvent} to all registered listeners.
   *
   * @param dataset the dataset ({@code null} permitted).
   * @see #getDataset()
   */
  ...
  /**
   * Returns the index of the specified dataset, or {@code -1} if the dataset does not belong to the
   * plot.
   *
  ...
  /**
   * Returns the domain axis for a dataset. You can change the axis for a dataset using the {@link
   * #mapDatasetToDomainAxis(int, int)} method.
   *
   * @param index the dataset index (must be &gt;= 0).
  ...
  /**
   * Returns the range axis for a dataset. You can change the axis for a dataset using the {@link
   * #mapDatasetToRangeAxis(int, int)} method.
   *
   * @param index the dataset index (must be &gt;= 0).
  ...
  /**
   * Returns a map containing the renderers that are assigned to this plot. The map is unmodifiable.
   *
   * @return A map containing the renderers that are assigned to the plot (never {@code null}).
   * @since 1.5.4
   */
  ...
  /**
   * Sets the renderer at index 0 (sometimes referred to as the "primary" renderer) and sends a
  ...
  /**
   * Sets the renderer at index 0 (sometimes referred to as the "primary" renderer) and, if
   * requested, sends a change event to all registered listeners.
   *
   * <p>You can set the renderer to {@code null}, but this is not recommended because:
   *
   * <ul>
   *   <li>no data will be displayed;
   *   <li>the plot background will not be painted;
   * </ul>
   *
   * @param renderer the renderer ({@code null} permitted).
   * @param notify notify listeners?
  ...
  /**
   * Sets the renderer to use for the dataset with the specified index and sends a change event to
   * all registered listeners. Note that each dataset should have its own renderer, you should not
   * use one renderer for multiple datasets.
   *
  ...
  /**
   * Sets the renderer to use for the dataset with the specified index and, if requested, sends a
   * change event to all registered listeners. Note that each dataset should have its own renderer,
   * you should not use one renderer for multiple datasets.
   *
   * @param index the index.
   * @param renderer the renderer ({@code null} permitted).
   * @param notify notify listeners?
  ...
  /**
   * Sets the renderers for this plot and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Returns the renderer for the specified dataset. If the dataset doesn't belong to the plot, this
  ...
  /**
   * Returns the index of the specified renderer, or {@code -1} if the renderer is not assigned to
   * this plot.
   *
   * @param renderer the renderer ({@code null} permitted).
  ...
  /**
   * Returns the order in which the columns are rendered. The default value is {@code
   * SortOrder.ASCENDING}.
   *
  ...
  /**
   * Sets the column order in which the items in each dataset should be rendered and sends a {@link
   * PlotChangeEvent} to all registered listeners. Note that this affects the order in which items
   * are drawn, NOT their position in the chart.
   *
  ...
  /**
   * Returns the order in which the rows should be rendered. The default value is {@code
   * SortOrder.ASCENDING}.
   *
   * @return The order (never {@code null}).
   * @see #setRowRenderingOrder(SortOrder)
  ...
  /**
   * Sets the row order in which the items in each dataset should be rendered and sends a {@link
   * PlotChangeEvent} to all registered listeners. Note that this affects the order in which items
   * are drawn, NOT their position in the chart.
   *
   * @param order the order ({@code null} not permitted).
   ...
   *
   * <p>If the flag value changes, a {@link PlotChangeEvent} is sent to all registered listeners.
   *
  ...
  /**
   * Sets the position used for the domain gridlines and sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
  ...
  /**
   * Sets the stroke used to draw grid-lines against the domain axis and sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the paint used to draw the grid-lines (if any) against the domain axis and sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the paint for the zero baseline plotted against the range axis and sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  /**
   * Sets the flag that controls whether or not grid-lines are drawn against the range axis. If the
   * flag changes value, a {@link PlotChangeEvent} is sent to all registered listeners.
   *
   * @param visible the new value of the flag.
  ...
  /**
   * Sets the stroke used to draw the grid-lines against the range axis and sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
   * @param stroke the stroke ({@code null} not permitted).
  ...
  /**
   * Sets the paint used to draw the grid lines against the range axis and sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
   ...
   *
   * <p>If the flag value is changed, a {@link PlotChangeEvent} is sent to all registered listeners.
   *
   * @param visible the new value of the flag.
  ...
  /**
   * Sets the stroke for the minor grid lines plotted against the range axis, and sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
   * @param stroke the stroke ({@code null} not permitted).
  ...
  /**
   * Sets the paint for the minor grid lines plotted against the range axis and sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  /**
   * Sets the fixed legend items for the plot. Leave this set to {@code null} if you prefer the
   * legend items to be created automatically.
   *
  ...
  /**
   * Returns the legend items for the plot. By default, this method creates a legend item for each
   * series in each of the datasets. You can change this behaviour by overriding this method.
   *
   ...
   *
   * <p>If the value 0.0 is passed in as the zoom percent, the auto-range calculation for the axis
  ...
  /**
   * Receives notification of a change to an {@link Annotation} added to this plot.
   *
   ...
   *
   * <p>The range axis bounds will be recalculated if necessary.
   *
   * @param event information about the event (not used here).
   */
  @Override
  ...
  /**
   * Adds a marker for display (in the foreground) against the domain axis and sends a {@link
   * PlotChangeEvent} to all registered listeners. Typically a marker will be drawn by the renderer
   * as a line perpendicular to the domain axis, however this is entirely up to the renderer.
   *
  ...
  /**
   * Adds a marker for display against the domain axis and sends a {@link PlotChangeEvent} to all
   * registered listeners. Typically a marker will be drawn by the renderer as a line perpendicular
  ...
  /**
   * Adds a marker for display by a particular renderer and sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
   * <p>Typically a marker will be drawn by the renderer as a line perpendicular to a domain axis,
  ...
  /**
   * Adds a marker for display by a particular renderer and, if requested, sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
   * <p>Typically a marker will be drawn by the renderer as a line perpendicular to a domain axis,
   * however this is entirely up to the renderer.
  ...
  /**
   * Clears all the domain markers for the plot and sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
  ...
  /**
   * Removes a marker for the domain axis and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Removes a marker for the domain axis in the specified layer and sends a {@link PlotChangeEvent}
   * to all registered listeners.
   *
   * @param marker the marker ({@code null} not permitted).
   * @param layer the layer (foreground or background).
  ...
  /**
   * Removes a marker for a specific dataset/renderer and sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
  ...
  /**
   * Removes a marker for a specific dataset/renderer and, if requested, sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
   * @param index the dataset/renderer index.
   * @param marker the marker.
  ...
  /**
   * Adds a marker for display (in the foreground) against the range axis and sends a {@link
   * PlotChangeEvent} to all registered listeners. Typically a marker will be drawn by the renderer
   * as a line perpendicular to the range axis, however this is entirely up to the renderer.
   *
   * @param marker the marker ({@code null} not permitted).
  ...
  /**
   * Adds a marker for display against the range axis and sends a {@link PlotChangeEvent} to all
   * registered listeners. Typically a marker will be drawn by the renderer as a line perpendicular
   ...
   * registered listeners.
   *
   * <p>Typically a marker will be drawn by the renderer as a line perpendicular to a range axis,
   * however this is entirely up to the renderer.
   *
   * @param index the renderer index.
   * @param marker the marker.
  ...
  /**
   * Clears all the range markers for the plot and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Removes a marker for the range axis and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param marker the marker.
   * @return A boolean indicating whether or not the marker was actually removed.
  ...
  /**
   * Removes a marker for the range axis in the specified layer and sends a {@link PlotChangeEvent}
   * to all registered listeners.
   *
   * @param marker the marker ({@code null} not permitted).
   * @param layer the layer (foreground or background).
  ...
  /**
   * Sets the flag that controls whether or not the domain crosshair is displayed by the plot, and
  ...
  /**
   * Sets the row key for the domain crosshair and sends a {PlotChangeEvent} to all registered
   * listeners.
   *
   * @param key the key.
   */
  ...
  /**
   * Sets the row key for the domain crosshair and, if requested, sends a {PlotChangeEvent} to all
   * registered listeners.
   *
   * @param key the key.
   * @param notify notify listeners?
  ...
  /**
   * Sets the column key for the domain crosshair and sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
   * @param key the key.
   */
  ...
  /**
   * Sets the column key for the domain crosshair and, if requested, sends a {@link PlotChangeEvent}
   * to all registered listeners.
   *
   * @param key the key.
   * @param notify notify listeners?
  ...
  /**
   * Sets the dataset index for the crosshair and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param index the index.
   */
  ...
  /**
   * Sets the dataset index for the crosshair and, if requested, sends a {@link PlotChangeEvent} to
  ...
  /**
   * Sets the stroke used to draw the domain crosshair, and sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
   * @param stroke the stroke ({@code null} not permitted).
   * @see #getDomainCrosshairStroke()
  ...
  /**
   * Sets the flag indicating whether or not the range crosshair should "lock-on" to actual data
   * values, and sends a {@link PlotChangeEvent} to all registered listeners.
   *
   * @param flag the flag.
  ...
  /**
   * Sets the range crosshair value and, if the crosshair is visible, sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the range crosshair value and, if requested, sends a {@link PlotChangeEvent} to all
  ...
  /**
   * Returns the pen-style ({@code Stroke}) used to draw the crosshair (if visible).
   *
  ...
  /**
   * Sets the pen-style ({@code Stroke}) used to draw the range crosshair (if visible), and sends a
  ...
  /**
   * Sets the paint used to draw the range crosshair (if visible) and sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
   * @see #getRangeCrosshairPaint()
  ...
  /**
   * Adds an annotation to the plot and, if requested, sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
   * @param annotation the annotation ({@code null} not permitted).
   * @param notify notify listeners?
  ...
  /**
   * Removes an annotation from the plot and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param annotation the annotation ({@code null} not permitted).
  ...
  /**
   * Removes an annotation from the plot and, if requested, sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
   * @param annotation the annotation ({@code null} not permitted).
   * @param notify notify listeners?
  ...
  /** Clears all the annotations and sends a {@link PlotChangeEvent} to all registered listeners. */
  ...
  protected AxisSpace calculateDomainAxisSpace(
    ...
    if (this.fixedDomainAxisSpace != null) {
      ...
      RectangleEdge domainEdge =
          Plot.resolveDomainAxisLocation(getDomainAxisLocation(), this.orientation);
   ...
   * @return The required space.
   */
  protected AxisSpace calculateRangeAxisSpace(
      Graphics2D g2, Rectangle2D plotArea, AxisSpace space) {
  ...
  /**
   * Receives a chart element visitor. Many plot subclasses will override this method to handle
   * their subcomponents.
   *
   ...
   *
   * <p>At your option, you may supply an instance of {@link PlotRenderingInfo}. If you do, it will
   * be populated with information about the drawing, including various plot dimensions and tooltip
   * info.
   *
   * @param g2 the graphics device.
   ...
   * @param state collects info as the chart is drawn (possibly {@code null}).
   */
  @Override
  public void draw(
      Graphics2D g2,
    ...
    if (this.shadowGenerator != null && !suppressShadow) {
      dataImage =
          new BufferedImage(
              (int) dataArea.getWidth(), (int) dataArea.getHeight(), BufferedImage.TYPE_INT_ARGB);
    ...
    if (this.shadowGenerator != null && !suppressShadow) {
      ...
      g2.drawImage(
          shadowImage,
          (int) dataArea.getX() + this.shadowGenerator.calculateOffsetX(),
          (int) dataArea.getY() + this.shadowGenerator.calculateOffsetY(),
          null);
    ...
    if (isDomainCrosshairVisible() && columnKey != null) {
      ...
      drawDomainCrosshair(
          g2, dataArea, this.orientation, datasetIndex, rowKey, columnKey, stroke, paint);
    }
  ...
  /**
   * Returns the indices of the non-null renderers for the plot, in the specified order.
   *
   * @param order the rendering order {@code null} not permitted).
   ...
   *
   * <p>This method will be called during the chart drawing process and is declared public so that
   * it can be accessed by the renderers used by certain subclasses. You shouldn't need to call this
   * method directly.
   *
   * @param g2 the graphics device.
   ...
   */
  protected Map<Axis, AxisState> drawAxes(
      Graphics2D g2, Rectangle2D plotArea, Rectangle2D dataArea, PlotRenderingInfo plotState) {
   ...
   * @param crosshairState a state object for tracking crosshair info ({@code null} permitted).
  ...
  public boolean render(
      ...
      CategoryCrosshairState<R, C> crosshairState) {
  ...
  protected void drawDomainGridlines(Graphics2D g2, Rectangle2D dataArea) {
    ...
    if (axis != null) {
      ...
      for (int c = 0; c < columnCount; c++) {
        double xx =
            axis.getCategoryJava2DCoordinate(anchor, c, columnCount, dataArea, domainAxisEdge);
  ...
  /**
   * Draws the domain markers (if any) for an axis and layer. This method is typically called from
  ...
  /**
   * Draws the range markers (if any) for an axis and layer. This method is typically called from
   * within the draw() method.
   *
   * @param g2 the graphics device.
   * @param dataArea the data area.
   ...
   */
  protected void drawRangeLine(
      Graphics2D g2, Rectangle2D dataArea, double value, Stroke stroke, Paint paint) {
   ...
   * @see #drawRangeCrosshair(Graphics2D, Rectangle2D, PlotOrientation, double, ValueAxis, Stroke,
   *     Paint)
   */
   ...
   * @param stroke the stroke used to draw the crosshair line.
   * @param paint the paint used to draw the crosshair line.
   * @see #drawDomainCrosshair(Graphics2D, Rectangle2D, PlotOrientation, int, Comparable,
   *     Comparable, Stroke, Paint)
   */
  protected void drawRangeCrosshair(
      Graphics2D g2,
      Rectangle2D dataArea,
      PlotOrientation orientation,
      double value,
  ...
  /**
   * Returns the range of data values that will be plotted against the range axis. If the dataset is
  ...
  /**
   * Sets the flag that controls whether the shared domain axis is drawn when this plot is being
   * used as a subplot.
   *
  ...
  /**
   * Returns {@code false} always, because the plot cannot be panned along the domain axis/axes.
   *
   * @return A boolean.
   * @see #isRangePannable()
   */
  ...
  /**
   * Returns {@code true} if panning is enabled for the range axes, and {@code false} otherwise.
   *
   * @return A boolean.
  ...
  /**
   * Returns {@code false} to indicate that the domain axes are not zoomable.
   *
   * @return A boolean.
   * @see #isRangeZoomable()
   */
  ...
  /**
   * This method does nothing, because {@code CategoryPlot} doesn't support zooming on the domain.
   *
  ...
  public void zoomDomainAxes(double factor, PlotRenderingInfo state, Point2D source) {
    int index = (int) (source.getX());
    RectangularShape zoomRect = state.getDataArea();
    double screenX = zoomRect.getX() + index;
    double anchorX = this.domainAxis.java2DToValue(screenX, zoomRect, this.domainAxisEdge);
   ...
   */
  @Override
  public void zoomDomainAxes(
      double lowerPercent, double upperPercent, PlotRenderingInfo state, Point2D source) {
  ...
  /**
   * Sets the anchor value and, if requested, sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
  ...
  public int hashCode() {
    int hash = 7;
    hash = 37 * hash + (this.orientation != null ? this.orientation.hashCode() : 0);
    hash = 37 * hash + (this.axisOffset != null ? this.axisOffset.hashCode() : 0);
    hash = 37 * hash + (this.domainAxes != null ? this.domainAxes.hashCode() : 0);
    hash = 37 * hash + (this.domainAxisLocations != null ? this.domainAxisLocations.hashCode() : 0);
    hash = 37 * hash + (this.drawSharedDomainAxis ? 1 : 0);
    hash = 37 * hash + (this.rangeAxes != null ? this.rangeAxes.hashCode() : 0);
    hash = 37 * hash + (this.rangeAxisLocations != null ? this.rangeAxisLocations.hashCode() : 0);
    ...
    hash = 37 * hash + (this.renderers != null ? this.renderers.hashCode() : 0);
    hash = 37 * hash + (this.renderingOrder != null ? this.renderingOrder.hashCode() : 0);
    hash =
        37 * hash + (this.columnRenderingOrder != null ? this.columnRenderingOrder.hashCode() : 0);
    hash = 37 * hash + (this.rowRenderingOrder != null ? this.rowRenderingOrder.hashCode() : 0);
    hash = 37 * hash + (this.domainGridlinesVisible ? 1 : 0);
    hash =
        37 * hash
            + (this.domainGridlinePosition != null ? this.domainGridlinePosition.hashCode() : 0);
    hash =
        37 * hash + (this.domainGridlineStroke != null ? this.domainGridlineStroke.hashCode() : 0);
    hash = 37 * hash + (this.domainGridlinePaint != null ? this.domainGridlinePaint.hashCode() : 0);
    ...
    hash = 37 * hash + (this.rangeGridlineStroke != null ? this.rangeGridlineStroke.hashCode() : 0);
    hash = 37 * hash + (this.rangeGridlinePaint != null ? this.rangeGridlinePaint.hashCode() : 0);
    hash = 37 * hash + (this.rangeMinorGridlinesVisible ? 1 : 0);
    hash =
        37 * hash
            + (this.rangeMinorGridlineStroke != null
                ? this.rangeMinorGridlineStroke.hashCode()
                : 0);
    hash =
        37 * hash
    ...
    hash =
        37 * hash
            + (int)
                (Double.doubleToLongBits(this.anchorValue)
    ...
    hash =
        37 * hash
            + (this.domainCrosshairColumnKey != null
                ? this.domainCrosshairColumnKey.hashCode()
                : 0);
    hash =
        37 * hash
            + (this.domainCrosshairStroke != null ? this.domainCrosshairStroke.hashCode() : 0);
    hash =
        37 * hash + (this.domainCrosshairPaint != null ? this.domainCrosshairPaint.hashCode() : 0);
    hash = 37 * hash + (this.rangeCrosshairVisible ? 1 : 0);
    hash =
        37 * hash
            + (int)
                (Double.doubleToLongBits(this.rangeCrosshairValue)
                    ^ (Double.doubleToLongBits(this.rangeCrosshairValue) >>> 32));
    hash =
        37 * hash + (this.rangeCrosshairStroke != null ? this.rangeCrosshairStroke.hashCode() : 0);
    hash = 37 * hash + (this.rangeCrosshairPaint != null ? this.rangeCrosshairPaint.hashCode() : 0);
    ...
    hash = 37 * hash + (this.annotations != null ? this.annotations.hashCode() : 0);
    hash = 37 * hash + this.weight;
    hash =
        37 * hash + (this.fixedDomainAxisSpace != null ? this.fixedDomainAxisSpace.hashCode() : 0);
    hash = 37 * hash + (this.fixedRangeAxisSpace != null ? this.fixedRangeAxisSpace.hashCode() : 0);
    hash = 37 * hash + (this.fixedLegendItems != null ? this.fixedLegendItems.hashCode() : 0);
    hash = 37 * hash + (this.rangePannable ? 1 : 0);
    hash = 37 * hash + (this.shadowGenerator != null ? this.shadowGenerator.hashCode() : 0);
    return hash;
  }
