...
/**
 * A specialised plot that draws a compass to indicate a direction based on the value from a {@link
 * ValueDataset}.
 */
public class CompassPlot extends Plot implements Cloneable, Serializable {
  ...
  /**
   * The count to complete one revolution. Can be arbitrarily set For degrees (the default) it is
   * 360, for radians this is 2*Pi, etc
   */
  ...
  /**
   * Sets the label font and sends a {@link PlotChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the paint used to fill the outer circle of the compass, and sends a {@link
  ...
  /**
   * Sets the paint used to fill the inner background area of the compass, and sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  /**
   * Sets the paint used to draw the circles, symbols and labels of the compass, and sends a {@link
   * PlotChangeEvent} to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  public void setSeriesNeedle(int index, int type) {
    switch (type) {
      ...
      case 4:
        setSeriesNeedle(index, new PlumNeedle());
        setSeriesPaint(index, Color.GREEN);
        this.seriesNeedle[index].setHighlightPaint(Color.YELLOW);
        break;
      case 5:
  ...
  /**
   * Sets the needle for a series and sends a {@link PlotChangeEvent} to all registered listeners.
   *
   * @param index the series index.
  ...
  /**
   * Returns the legend items for the plot. For now, no legend is available - this method returns
   * null.
   *
  ...
  /**
   * Sets the count to complete one revolution. Can be arbitrarily set For degrees (the default) it
   * is 360, for radians this is 2*Pi, etc
   *
