...
/**
 * A {@code Crosshair} represents a value on a chart and is usually displayed as a line
 * perpendicular to the x or y-axis (and sometimes including a label that shows the crosshair value
 * as text). Instances of this class are used to store the cross hair value plus the visual
 * characteristics of the line that will be rendered once the instance is added to a {@link
 * CrosshairOverlay} (or {@code CrosshairOverlaydFX} if you are using the JavaFX extensions for
 * JFreeChart). <br>
 * <br>
 * Crosshairs support a property change mechanism which is used by JFreeChart to automatically
 * repaint the overlay whenever a crosshair attribute is updated.
 */
public class Crosshair implements Cloneable, PublicCloneable, Serializable {
  ...
  /**
   * Sets the flag that controls the visibility of the crosshair and sends a proerty change event
   * (with the name 'visible') to all registered listeners.
   *
  ...
  /**
   * Sets the crosshair value and sends a property change event with the name 'value' to all
  ...
  /**
   * Sets the paint for the crosshair line and sends a property change event with the name "paint"
  ...
  public void setPaint(Paint paint) {
    ...
    this.paint = null; // <---- Buggy statement
  ...
  /**
   * Sets the stroke for the crosshair line and sends a property change event with the name "stroke"
   * to all registered listeners.
   *
  ...
  /**
   * Sets the flag that controls whether or not a label is drawn for the crosshair and sends a
   * property change event (with the name 'labelVisible') to all registered listeners.
   *
   * @param visible the new flag value.
   * @see #isLabelVisible()
   */
  ...
  /**
   * Sets the crosshair label generator and sends a property change event (with the name
   * 'labelGenerator') to all registered listeners.
   *
  ...
  /**
   * Sets the label anchor point and sends a property change event (with the name 'labelAnchor') to
  ...
  /**
   * Sets the x-offset and sends a property change event (with the name 'labelXOffset') to all
   * registered listeners.
   *
  ...
  /**
   * Sets the y-offset and sends a property change event (with the name 'labelYOffset') to all
   * registered listeners.
   *
   * @param offset the new offset.
   * @see #getLabelYOffset()
  ...
  /**
   * Sets the label font and sends a property change event (with the name 'labelFont') to all
   * registered listeners.
   *
  ...
  /**
   * Sets the label paint and sends a property change event (with the name 'labelPaint') to all
   * registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
   * @see #getLabelPaint()
  ...
  /**
   * Sets the label background paint and sends a property change event with the name
   * 'labelBackgroundPaint') to all registered listeners.
   *
  ...
  /**
   * Returns the flag that controls the visibility of the label outline. The default value is {@code
   * true}.
   *
   * @return A boolean.
  ...
  /**
   * Sets the flag that controls the visibility of the label outlines and sends a property change
   * event (with the name "labelOutlineVisible") to all registered listeners.
   *
   * @param visible the new flag value.
  ...
  /**
   * Sets the label outline paint and sends a property change event (with the name
   * "labelOutlinePaint") to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  /**
   * Returns the label outline stroke. The default value is {@code BasicStroke(0.5)}.
   *
  ...
  /**
   * Sets the label outline stroke and sends a property change event (with the name
   * 'labelOutlineStroke') to all registered listeners.
   *
   * @param stroke the stroke ({@code null} not permitted).
