...
public class DialValueIndicator extends AbstractDialLayer
  ...
  /**
   * A data value that will be formatted to determine the maximum size of the indicator bounds. If
   * this is null, the indicator bounds can grow as large as necessary to contain the actual data
   * value.
   */
  ...
  /**
   * Sets the dataset index and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Returns the angle for the anchor point. The angle is specified in degrees using the same
  ...
  /**
   * Sets the angle for the anchor point and sends a {@link DialLayerChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the radius and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the frame anchor and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the template value and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the template value for the maximum size of the indicator bounds and sends a {@link
  ...
  /**
   * Sets the formatter used to format the value and sends a {@link DialLayerChangeEvent} to all
  ...
  /**
   * Sets the font and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the paint and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the background paint and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  /**
   * Sets the outline stroke and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the outline paint and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
   * @see #getOutlinePaint()
   */
  ...
  /**
   * Sets the insets and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the value anchor and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
   * @param anchor the anchor ({@code null} not permitted).
   * @see #getValueAnchor()
   */
  ...
  /**
   * Sets the text anchor and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
   * @param anchor the anchor ({@code null} not permitted).
   * @see #getTextAnchor()
   */
  ...
  /**
   * Returns {@code true} to indicate that this layer should be clipped within the dial window.
   *
   * @return {@code true}.
   */
  @Override
