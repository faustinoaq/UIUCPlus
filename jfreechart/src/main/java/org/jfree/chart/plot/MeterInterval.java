...
public class MeterInterval implements Serializable {
   ...
   * @param backgroundPaint the background paint ({@code null} permitted).
   */
  public MeterInterval(
      String label, Range range, Paint outlinePaint, Stroke outlineStroke, Paint backgroundPaint) {
  ...
  /**
   * Returns the background paint. If {@code null}, the background should remain unfilled.
   *
