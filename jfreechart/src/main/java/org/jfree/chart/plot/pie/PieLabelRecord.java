...
public class PieLabelRecord implements Comparable, Serializable {
  ...
  /**
   * Returns the base y-coordinate. This is where the label will appear if there is no overlapping
   * of labels.
   *
  ...
  /**
   * Returns the label height (you could derive this from the label itself, but we cache the value
