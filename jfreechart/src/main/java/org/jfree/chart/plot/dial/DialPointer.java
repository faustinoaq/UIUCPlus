...
public abstract class DialPointer extends AbstractDialLayer
  ...
  /**
   * Sets the dataset index for the pointer and sends a {@link DialLayerChangeEvent} to all
  ...
  /**
   * Sets the radius of the pointer and sends a {@link DialLayerChangeEvent} to all registered
   * listeners.
   *
  ...
  public static class Pin extends DialPointer {
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException {
      ...
      SerialUtils.writePaint(build.paint, stream);
  ...
  public static class Pointer extends DialPointer {
    ...
    /**
     * Sets the width radius and sends a {@link DialLayerChangeEvent} to all registered listeners.
     *
     * @param radius the radius
     * @see #getWidthRadius()
     */
    ...
    /**
     * Sets the fill paint and sends a {@link DialLayerChangeEvent} to all registered listeners.
     *
     * @param paint the paint ({@code null} not permitted).
     * @see #getFillPaint()
     */
