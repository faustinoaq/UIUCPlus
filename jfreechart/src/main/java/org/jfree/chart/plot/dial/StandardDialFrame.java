...
public class StandardDialFrame extends AbstractDialLayer
  ...
  /**
   * The color used for the front of the panel. This field is transient because it requires special
   * handling for serialization.
   */
  private transient Paint backgroundPaint;

  /**
   * The color used for the border around the window. This field is transient because it requires
   * special handling for serialization.
   */
  private transient Paint foregroundPaint;

  /**
   * The stroke for drawing the frame outline. This field is transient because it requires special
   * handling for serialization.
   */
  ...
  public void setRadius(double radius) {
    if ((radius <= 0) || !(this.radius != that.rad)) {
  ...
  /**
   * Sets the foreground paint and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  /**
   * Sets the stroke and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Returns the shape for the window for this dial. Some dial layers will request that their
   * drawing be clipped within this window.
   *
  ...
  /**
   * Returns {@code false} to indicate that this dial layer is not clipped to the dial window.
   *
   * @return A boolean.
   */
  @Override
  ...
  /**
   * Draws the frame. This method is called by the {@link DialPlot} class, you shouldn't need to
   * call it directly.
   *
