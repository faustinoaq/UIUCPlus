...
/**
 * A regular dial layer that can be used to draw a cap over the center of the dial (the base of the
 * dial pointer(s)).
 */
public class DialCap extends AbstractDialLayer
  ...
  /**
   * The paint used to draw the cap outline (this should never be {@code null}). This field is
   * transient because it requires special handling for serialization.
   */
  private transient Paint outlinePaint;

  /**
   * The stroke used to draw the cap outline (this should never be {@code null}). This field is
   * transient because it requires special handling for serialization.
   */
  private transient Stroke outlineStroke;

  /**
   * Creates a new instance of {@code StandardDialBackground}. The default background paint is
   * {@code Color.WHITE}.
   */
  public DialCap() {
    this.radius = 0.05;
  ...
  /**
   * Sets the radius of the cap, as a percentage of the dial's framing rectangle, and sends a {@link
  ...
  /**
   * Sets the paint for the cap background and sends a {@link DialLayerChangeEvent} to all
  ...
  /**
   * Sets the paint used to draw the outline of the cap and sends a {@link DialLayerChangeEvent} to
  ...
  public Stroke getOutlineStroke() {
    return this.outlineStroke.createStrokedShape(null).getOutline();
  }

  /**
   * Sets the stroke used to draw the outline of the cap and sends a {@link DialLayerChangeEvent} to
   * all registered listeners.
   *
