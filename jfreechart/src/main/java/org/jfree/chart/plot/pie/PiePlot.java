 ...
 * the {@link PieDataset} interface. The example shown here is generated by the {@code
 * PieChartDemo2.java} program included in the JFreeChart Demo Collection: <br>
 * <br>
 ...
 *
 * <ol>
 *   <li>the default starting point is 12 o'clock and the pie sections proceed in a clockwise
 *       direction, but these settings can be changed;
 *   <li>negative values in the dataset are ignored;
 *   <li>there are utility methods for creating a {@link PieDataset} from a {@link
...
public class PiePlot<K extends Comparable<K>> extends Plot implements Cloneable, Serializable {
  ...
  /**
   * The amount of space left around the outside of the pie plot, expressed as a percentage of the
  ...
  /**
   * A flag that controls whether or not the section paint is auto-populated from the drawing
   * supplier.
   */
  ...
  /**
   * A flag that controls whether or not the section outline paint is auto-populated from the
   * drawing supplier.
   */
  ...
  /**
   * A flag that controls whether or not the section outline stroke is auto-populated from the
   * drawing supplier.
   */
  ...
  /**
   * The color used to draw the background of the section labels. If this is {@code null}, the
   * background is not filled.
   */
  private transient Paint labelBackgroundPaint;

  /** The paint used to draw the outline of the section labels ({@code null} permitted). */
  private transient Paint labelOutlinePaint;

  /** The stroke used to draw the outline of the section labels ({@code null} permitted). */
  private transient Stroke labelOutlineStroke;

  /** The paint used to draw the shadow for the section labels ({@code null} permitted). */
  ...
  /**
   * The padding between the labels and the label outlines. This is not allowed to be {@code null}.
   */
   ...
   *
   * <p>http://www.jfree.org/phpBB2/viewtopic.php?t=2707
   *
   * <p>...and this bug report in the Java Bug Parade:
   *
   * <p>http://developer.java.sun.com/developer/bugParade/bugs/4836495.html
   */
  ...
  /**
   * This debug flag controls whether or not an outline is drawn showing the interior of the plot
   * region. This is drawn as a lightGray rectangle showing the padding provided by the
   * 'interiorGap' setting.
   */
  static final boolean DEBUG_DRAW_INTERIOR = false;

  /**
   * This debug flag controls whether or not an outline is drawn showing the link area (in blue) and
   * link ellipse (in yellow). This controls where the label links have 'elbow' points.
   */
  ...
  /**
   * Returns the pie index (this is used by the {@link MultiplePiePlot} class to track subplots).
   *
  ...
  /**
   * Sets the pie index (this is used by the {@link MultiplePiePlot} class to track subplots).
   *
  ...
  /**
   * Returns the start angle for the first pie section. This is measured in degrees starting from 3
   * o'clock and measuring anti-clockwise.
   *
  ...
  /**
   * Sets the starting angle and sends a {@link PlotChangeEvent} to all registered listeners. The
   * initial default value is 90 degrees, which corresponds to 12 o'clock. A value of zero
  ...
  /**
   * Sets the direction in which the pie sections are drawn and sends a {@link PlotChangeEvent} to
   ...
   * controls the space between the edges of the pie plot and the plot area itself (the region where
   * the section labels appear).
   *
  ...
  /**
   * Returns the flag that controls whether {@code null} values in the dataset are ignored.
   *
   * @return A boolean.
  ...
  /**
   * Sets a flag that controls whether {@code null} values are ignored, and sends a {@link
   * PlotChangeEvent} to all registered listeners. At present, this only affects whether or not the
   * key is presented in the legend.
   *
   * @param flag the flag.
  ...
  /**
   * Sets a flag that controls whether zero values are ignored, and sends a {@link PlotChangeEvent}
   * to all registered listeners. This only affects whether or not a label appears for the
   * non-visible pie section.
   *
   * @param flag the flag.
  ...
  /**
   * Returns the paint for the specified section. This is equivalent to {@code
   ...
   *
   * <ul>
   *   <li>if {@link #getSectionPaint(K)} is non-{@code null} return it;
   *   <li>if {@link #getSectionPaint(K)} is {@code null} but {@code autoPopulate} is {@code true},
   *       attempt to fetch a new paint from the drawing supplier ({@link #getDrawingSupplier()});
   *   <li>if all else fails, return {@link #getDefaultSectionPaint()}.
   * </ul>
   *
   * @param key the section key.
   * @param autoPopulate a flag that controls whether the drawing supplier is used to auto-populate
   *     the section paint settings.
   * @return The paint.
   */
  ...
  /**
   * Returns a key for the specified section. The preferred way of doing this now is to link the
   * attributes directly to the section key (there are new methods for this, starting from version
   * 1.0.3).
   *
  ...
  /**
   * Returns the paint associated with the specified key, or {@code null} if there is no paint
  ...
  /**
   * Sets the paint associated with the specified key, and sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
   * @param key the key ({@code null} not permitted).
  ...
  /**
   * Clears the section paint settings for this plot and, if requested, sends a {@link
   * PlotChangeEvent} to all registered listeners. Be aware that if the {@code
   * autoPopulateSectionPaint} flag is set, the section paints may be repopulated using the same
   * colours as before.
   *
   * @param notify notify listeners?
  ...
  /**
   * Returns the default section paint. This is used when no other paint is defined, which is rare.
  ...
  /**
   * Returns the flag that controls whether or not the section paint is auto-populated by the {@link
   * #lookupSectionPaint(K)} method.
   *
   * @return A boolean.
   */
  ...
  /**
   * Sets the flag that controls whether or not the section paint is auto-populated by the {@link
   * #lookupSectionPaint(K)} method, and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   ...
   *
   * @return The flag that controls whether or not the outline is drawn for each pie section.
  ...
  /**
   * Sets the flag that controls whether or not the outline is drawn for each pie section, and sends
  ...
  /**
   * Returns the outline paint for the specified section. This is equivalent to {@code
   * lookupSectionPaint(section, getAutoPopulateSectionOutlinePaint())}.
   *
   * @param key the section key.
   * @return The paint for the specified section.
   ...
   *
   * <ul>
   *   <li>if {@link #getSectionOutlinePaint(K)} is non-{@code null} return it;
   *   <li>if {@link #getSectionOutlinePaint(K)} is {@code null} but {@code autoPopulate} is {@code
   *       true}, attempt to fetch a new outline paint from the drawing supplier ({@link
   *       #getDrawingSupplier()});
   ...
   * @param key the section key.
   * @param autoPopulate a flag that controls whether the drawing supplier is used to auto-populate
   *     the section outline paint settings.
   * @return The paint.
   */
  ...
  /**
   * Returns the outline paint associated with the specified key, or {@code null} if there is no
   * paint associated with the key.
   *
   * @param key the key ({@code null} not permitted).
   * @return The paint associated with the specified key, or {@code null}.
   * @throws IllegalArgumentException if {@code key} is {@code null}.
  ...
  /**
   * Sets the outline paint associated with the specified key, and sends a {@link PlotChangeEvent}
  ...
  /**
   * Clears the section outline paint settings for this plot and, if requested, sends a {@link
   * PlotChangeEvent} to all registered listeners. Be aware that if the {@code
   * autoPopulateSectionPaint} flag is set, the section paints may be repopulated using the same
   * colours as before.
   *
  ...
  /**
   * Returns the flag that controls whether or not the section outline paint is auto-populated by
   * the {@link #lookupSectionOutlinePaint(K)} method.
   *
   * @return A boolean.
   */
   ...
   * {@link #lookupSectionOutlinePaint(K)} method, and sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
   * @param auto auto-populate?
   */
  ...
  /**
   * Returns the outline stroke for the specified section. This is equivalent to {@code
   * lookupSectionOutlineStroke(section, getAutoPopulateSectionOutlineStroke())}.
   *
   * @param key the section key.
   ...
   *
   * <ul>
   *   <li>if {@link #getSectionOutlineStroke(K)} is non-{@code null} return it;
   *   <li>if {@link #getSectionOutlineStroke(K)} is {@code null} but {@code autoPopulate} is {@code
   *       true}, attempt to fetch a new outline stroke from the drawing supplier ({@link
   *       #getDrawingSupplier()});
   ...
   * @param key the section key.
   * @param autoPopulate a flag that controls whether the drawing supplier is used to auto-populate
   *     the section outline stroke settings.
   * @return The stroke.
   */
  ...
  /**
   * Returns the outline stroke associated with the specified key, or {@code null} if there is no
   * stroke associated with the key.
   *
   * @param key the key ({@code null} not permitted).
  ...
  /**
   * Sets the outline stroke associated with the specified key, and sends a {@link PlotChangeEvent}
   * to all registered listeners.
   *
   * @param key the key ({@code null} not permitted).
  ...
  /**
   * Clears the section outline stroke settings for this plot and, if requested, sends a {@link
   * PlotChangeEvent} to all registered listeners. Be aware that if the {@code
   * autoPopulateSectionPaint} flag is set, the section paints may be repopulated using the same
   * colours as before.
   *
  ...
  /**
   * Returns the flag that controls whether or not the section outline stroke is auto-populated by
   * the {@link #lookupSectionOutlinePaint(K)} method.
   *
   * @return A boolean.
   */
   ...
   * {@link #lookupSectionOutlineStroke(K)} method, and sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
   * @param auto auto-populate?
   */
  ...
  /**
   * Sets the x-offset for the shadow effect and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
  ...
  public double getShadowYOffset() {
    return this.shadowYOffset + 1;
  }

  /**
   * Sets the y-offset for the shadow effect and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param offset the offset (in Java2D units).
   ...
   *
   * @param key the key ({@code null} not permitted).
   * @return The amount that the section with the specified key should be exploded.
   * @throws IllegalArgumentException if {@code key} is {@code null}.
  ...
  /**
   * Sets the amount that a pie section should be exploded and sends a {@link PlotChangeEvent} to
   * all registered listeners.
   *
  ...
  /**
   * Returns the gap between the edge of the pie and the labels, expressed as a percentage of the
   * plot width.
   *
  ...
  /**
   * Sets the gap between the edge of the pie and the labels (expressed as a percentage of the plot
   * width) and sends a {@link PlotChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the maximum label width as a percentage of the plot width and sends a {@link
  ...
  /**
   * Sets the flag that controls whether or not label linking lines are visible and sends a {@link
   * PlotChangeEvent} to all registered listeners. Please take care when hiding the linking lines -
   * depending on the data values, the labels can be displayed some distance away from the
  ...
  /**
   * Sets the label link style and sends a {@link PlotChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Returns the margin (expressed as a percentage of the width or height) between the edge of the
   * pie and the link point.
   *
  ...
  /**
   * Sets the paint used for the lines that connect pie sections to their corresponding labels, and
  ...
  /**
   * Returns the distance that the end of the label link is embedded into the plot, expressed as a
   * percentage of the plot's radius. <br>
   * <br>
   * This method is overridden in the {@link RingPlot} class to resolve bug 2121818.
   *
   * @return {@code 0.10}.
   */
  ...
  /**
   * Sets the section label background paint and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param paint the paint ({@code null} permitted).
  ...
  /**
   * Sets the section label outline paint and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param paint the paint ({@code null} permitted).
  ...
  /**
   * Sets the section label outline stroke and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the section label shadow paint and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param paint the paint ({@code null} permitted).
  ...
  /**
   * Sets the padding between each label and its outline and sends a {@link PlotChangeEvent} to all
   * registered listeners.
   *
  ...
  /**
   * Sets the flag that controls whether simple or extended labels are displayed on the plot, and
   * sends a {@link PlotChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the offset for the simple labels and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the label distributor and sends a {@link PlotChangeEvent} to all registered listeners.
   *
   ...
   * used for tool tips by the plot. If the generator is {@code null}, no tool tips will be created.
   *
   * @return The generator (possibly {@code null}).
   ...
   * Set the generator to {@code null} if you don't want any tool tips.
   *
   * @param generator the generator ({@code null} permitted).
  ...
  /**
   * Returns the minimum arc angle that will be drawn. Pie sections for an angle smaller than this
   * are not drawn, to avoid a JDK bug.
   *
  ...
  /**
   * Sets the minimum arc angle that will be drawn. Pie sections for an angle smaller than this are
   * not drawn, to avoid a JDK bug. See this link for details: <br>
   * <br>
   ...
   * <br>
   * <a href= "http://developer.java.sun.com/developer/bugParade/bugs/4836495.html">
  ...
  /**
   * Sets the legend label generator and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the legend label tool tip generator and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param generator the generator ({@code null} permitted).
  ...
  /**
   * Sets the legend label URL generator and sends a {@link PlotChangeEvent} to all registered
   * listeners.
   *
   * @param generator the generator ({@code null} permitted).
   ...
   * listeners. Note that this is a bitmap drop-shadow generation facility and is separate from the
   * vector based show option that is controlled via the {@link #setShadowPaint(java.awt.Paint)}
   * method.
   *
   * @param generator the generator ({@code null} permitted).
   */
  ...
  /**
   * Handles a mouse wheel rotation (this method is intended for use by the {@code
   ...
   * rendered, giving the plot an opportunity to initialise any state information it wants to
   * maintain.
   *
   * @param g2 the graphics device.
   * @param plotArea the plot area ({@code null} not permitted).
   * @param plot the plot.
   * @param index the secondary index ({@code null} for primary renderer).
   ...
   * @param info collects info about the drawing ({@code null} permitted).
   */
  @Override
  public void draw(
      Graphics2D g2,
    ...
    if (!DatasetUtils.isEmptyOrNull(this.dataset)) {
      ...
      if (this.shadowGenerator != null && !suppressShadow) {
        dataImage =
            new BufferedImage(
                (int) area.getWidth(), (int) area.getHeight(), BufferedImage.TYPE_INT_ARGB);
      ...
      if (this.shadowGenerator != null && !suppressShadow) {
        ...
        g2.drawImage(
            shadowImage,
            (int) area.getX() + this.shadowGenerator.calculateOffsetX(),
            (int) area.getY() + this.shadowGenerator.calculateOffsetY(),
            null);
    ...
    if (DEBUG_DRAW_LINK_AREA) {
      ...
      g2.draw(
          new Ellipse2D.Double(
              linkArea.getX(), linkArea.getY(), linkArea.getWidth(), linkArea.getHeight()));
    }
   ...
   */
  protected void drawSimpleLabels(
      Graphics2D g2,
      List<K> keys,
      double totalValue,
    ...
    for (K key : keys) {
      ...
      if (include) {
        ...
        Shape bg =
            ShapeUtils.createTranslatedShape(out, x - bounds.getCenterX(), y - bounds.getCenterY());
        if (this.labelShadowPaint != null && this.shadowGenerator == null) {
          Shape shadow =
              ShapeUtils.createTranslatedShape(bg, this.shadowXOffset, this.shadowYOffset);
   ...
   *
   * @param leftKeys a collection of keys and angles (to the middle of the section, in degrees) for
   *     the sections on the left side of the plot.
   * @param g2 the graphics device.
   * @param plotArea the plot area.
   * @param linkArea the link area.
   ...
   * @param state the state.
   */
  protected void drawLeftLabels(
      KeyedValues<K> leftKeys,
      Graphics2D g2,
      Rectangle2D plotArea,
      Rectangle2D linkArea,
      float maxLabelWidth,
      ...
      if (label != null) {
        TextBlock block =
            TextUtils.createTextBlock(
                label, this.labelFont, this.labelPaint, maxLabelWidth, new G2TextMeasurer(g2));
        ...
        this.labelDistributor.addPieLabelRecord(
            new PieLabelRecord(
                leftKeys.getKey(i),
                theta,
                baseY,
   ...
   * @param state the state.
   */
  protected void drawRightLabels(
      KeyedValues<K> keys,
      Graphics2D g2,
      Rectangle2D plotArea,
      Rectangle2D linkArea,
  ...
  /**
   * Returns a rectangle that can be used to create a pie section (taking into account the amount by
   * which the pie section is 'exploded').
   *
   ...
   */
  protected Rectangle2D getArcBounds(
  ...
  /**
   * Returns the center for the specified section. Checks to see if the section is exploded and
   * recalculates the new center if so.
   *
  ...
  /**
   * Returns the paint for the specified section. This is equivalent to {@code
   * lookupSectionPaint(section)}. Checks to see if the user set the {@code Paint} to be of type
   * {@code RadialGradientPaint} and if so it adjusts the center and radius to match the Pie.
   *
   * @param key the section key.
   * @param state PiePlotState.
   * @return The paint for the specified section.
  ...
  /**
   * Generates a hashcode. Note that, as with the equals method, the dataset is NOT included in the
   * hashcode.
   *
   * @return the hashcode
   */
  ...
  public int hashCode() {
    ...
    hash =
        73 * hash
            + (int)
                (Double.doubleToLongBits(this.interiorGap)
                    ^ (Double.doubleToLongBits(this.interiorGap) >>> 32));
    hash = 73 * hash + (this.circular ? 1 : 0);
    hash =
        73 * hash
            + (int)
                (Double.doubleToLongBits(this.startAngle)
                    ^ (Double.doubleToLongBits(this.startAngle) >>> 32));
    ...
    hash =
        73 * hash
            + (int)
                (Double.doubleToLongBits(this.shadowXOffset)
                    ^ (Double.doubleToLongBits(this.shadowXOffset) >>> 32));
    hash =
        73 * hash
            + (int)
                (Double.doubleToLongBits(this.shadowYOffset)
                    ^ (Double.doubleToLongBits(this.shadowYOffset) >>> 32));
    ...
    hash =
        73 * hash
            + (int)
                (Double.doubleToLongBits(this.maximumLabelWidth)
                    ^ (Double.doubleToLongBits(this.maximumLabelWidth) >>> 32));
    hash =
        73 * hash
            + (int)
                (Double.doubleToLongBits(this.labelGap)
                    ^ (Double.doubleToLongBits(this.labelGap) >>> 32));
    hash = 73 * hash + (this.labelLinksVisible ? 1 : 0);
    hash = 73 * hash + Objects.hashCode(this.labelLinkStyle);
    hash =
        73 * hash
            + (int)
                (Double.doubleToLongBits(this.labelLinkMargin)
                    ^ (Double.doubleToLongBits(this.labelLinkMargin) >>> 32));
    ...
    hash =
        73 * hash
            + (int)
                (Double.doubleToLongBits(this.minimumArcAngleToDraw)
                    ^ (Double.doubleToLongBits(this.minimumArcAngleToDraw) >>> 32));
