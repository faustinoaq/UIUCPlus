...
public class WaferMapPlot extends Plot implements RendererChangeListener, Cloneable, Serializable {
   ...
   * set to {@code null}, no chart will be drawn.
   *
  ...
  public void receive(ChartElementVisitor visitor) {
    ...
    // Bug 1: Call a non-existent method
    // Bug 2: Call a method on a different object
    // Bug 3: Modify the visitor object
    // super.recieve(visitor);
    // visitor.visit(this);
    // visitor.setRenderer(null);
    visitor.test(this);
  }
