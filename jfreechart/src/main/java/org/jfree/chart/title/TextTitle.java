...
public class TextTitle extends Title implements Serializable, Cloneable, PublicCloneable {
   ...
   * @param horizontalAlignment the horizontal alignment ({@code null} not permitted).
   * @param verticalAlignment the vertical alignment ({@code null} not permitted).
  ...
  /**
   * Sets the title to the specified text and sends a {@link TitleChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Returns the text alignment. This controls how the text is aligned within the title's bounds,
   * whereas the title's horizontal alignment controls how the title's bounding rectangle is aligned
  ...
  /**
   * Sets the font used to display the title string. Registered listeners are notified that the
  ...
  /**
   * Sets the paint used to display the title string. Registered listeners are notified that the
   * title has been modified.
   *
  ...
  /**
   * Returns the background paint (defaults to {@code null} which makes the background transparent).
   *
  ...
  /**
   * Sets the background paint and sends a {@link TitleChangeEvent} to all registered listeners. If
   * you set this attribute to {@code null}, no background is painted (which makes the title
  ...
  /**
   * Sets the tool tip text to the specified text and sends a {@link TitleChangeEvent} to all
  ...
  /**
   * Sets the URL text to the specified text and sends a {@link TitleChangeEvent} to all registered
   * listeners.
   *
   * @param text the text ({@code null} permitted).
   */
  ...
  /**
   * Sets the maximum number of lines to display and sends a {@link TitleChangeEvent} to all
   * registered listeners.
   *
  ...
  /**
   * Arranges the content for this title assuming no bounds on the width or the height, and returns
   * the required size. This will reflect the fact that a text title positioned on the left or right
  ...
  /**
   * Arranges the content for this title assuming a fixed width and no bounds on the height, and
   * returns the required size. This will reflect the fact that a text title positioned on the left
   * or right of a chart will be rotated by 90 degrees.
   *
   * @param g2 the graphics target.
   * @param w the width.
   * @return The content size.
  ...
  protected Size2D arrangeFN(Graphics2D g2, double w) {
    ...
    if ((position == RectangleEdge.LEFT)) {
      ...
      this.content = TextUtils.createTextBlock(this.text, new G2TextMeasurer(g2), maxWidth);
      this.content.setLineAlignment(this.textAlignment);
      Size2D contentSize = this.content.calculateDimensions(g2);
  ...
  /**
   * Draws a the title horizontally within the specified area. This method will be called from the
   * {@link #draw(Graphics2D, Rectangle2D) draw} method.
   *
   * @param g2 the graphics device.
  ...
  /**
   * Draws a the title vertically within the specified area. This method will be called from the
   * {@link #draw(Graphics2D, Rectangle2D) draw} method.
   *
   * @param g2 the graphics device.
   * @param area the area for the title.
