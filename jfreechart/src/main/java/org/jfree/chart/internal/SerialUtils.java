...
public class SerialUtils {
  ...
  /**
   * Returns {@code true} if a class implements {@code Serializable} and {@code false} otherwise.
   *
   * @param c the class.
   * @return A boolean.
   */
  ...
  /**
   * Reads a {@code Paint} object that has been serialised by the {@link #writePaint(Paint,
  ...
  /**
   * Reads a {@code Stroke} object that has been serialised by the {@link #writeStroke(Stroke,
   * ObjectOutputStream)} method.
   *
   * @param stream the input stream ({@code null} not permitted).
  ...
  /**
   * Serialises a {@code Stroke} object. This code handles the {@code BasicStroke} class which is
   * the only {@code Stroke} implementation provided by the JDK (and isn't directly {@code
   * Serializable}).
   *
  ...
  /**
   * Reads a {@code Composite} object that has been serialised by the {@link
   * #writeComposite(Composite, ObjectOutputStream)} method.
   *
   * @param stream the input stream ({@code null} not permitted).
   ...
   * @throws IOException if there is an I/O error.
   */
  public static void writeComposite(Composite composite, ObjectOutputStream stream)
      throws IOException {
  ...
  /**
   * Reads a {@code Shape} object that has been serialised by the {@link #writeShape(Shape,
   * ObjectOutputStream)} method.
   *
   * @param stream the input stream ({@code null} not permitted).
  ...
  /**
   * Reads a {@code Point2D} object that has been serialised by the {@link #writePoint2D(Point2D,
   * ObjectOutputStream)} method.
   *
   * @param stream the input stream ({@code null} not permitted).
  ...
  /**
   * Reads a {@code AttributedString} object that has been serialised by the {@link
   ...
   * @throws IOException if there is an I/O problem.
   */
  public static void writeMapOfPaint(Map<Integer, Paint> map, ObjectOutputStream stream)
      throws IOException {
    Args.nullNotPermitted(stream, "stream");
    if (map != null) {
      stream.writeBoolean(false);
      ...
      stream.writeBoolean(true); // indicates null
    }
  }
   ...
   */
  public static Map<Integer, Paint> readMapOfPaint(ObjectInputStream stream)
      throws IOException, ClassNotFoundException {
    Args.nullNotPermitted(stream, "stream");
    boolean isNull = stream.readBoolean();
    if (isNull) {
   ...
   * @throws IOException if there is an I/O problem.
   */
  public static void writeMapOfStroke(Map<Integer, Stroke> map, ObjectOutputStream stream)
      throws IOException {
    Args.nullNotPermitted(stream, "stream");
    if (map != null) {
      stream.writeBoolean(false);
   ...
   * @throws ClassNotFoundException
   */
  public static Map<Integer, Stroke> readMapOfStroke(ObjectInputStream stream)
      throws IOException, ClassNotFoundException {
    Args.nullNotPermitted(stream, "stream");
    boolean isNull = stream.readBoolean();
    if (isNull) {
