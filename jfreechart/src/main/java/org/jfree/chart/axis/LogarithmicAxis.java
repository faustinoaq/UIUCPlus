...
public class LogarithmicAxis extends NumberAxis {
   ...
   *
   * @param flag true for "10^n"-style tick labels, false for "1e#"-style or regular numeric tick
   *     labels.
   */
   ...
   *
   * @return {@code true} for "10^n"-style tick labels, {@code false} for "1e#"-style or regular
   *     numeric tick labels.
   */
  ...
  /**
   * Sets up flag for log axis processing. Set true if negative values not allowed and the lower
   * bound is between 0 and 10.
   */
  ...
  /**
   * Returns the log10 value, depending on if values between 0 and 1 are being plotted. If negative
   * values are not allowed and the lower bound is between 0 and 10 then a normal log is returned;
   * otherwise the returned value is adjusted if the given value is less than 10.
   *
   * @param val the value.
  ...
  /**
   * Returns a power of 10, depending on if values between 0 and 1 are being plotted. If negative
   * values are not allowed and the lower bound is between 0 and 10 then a normal power is returned;
   * otherwise the returned value is adjusted if the given value is less than 1.
   *
   * @param val the value.
  ...
  /**
   * Returns an adjusted log10 value for graphing purposes. The first adjustment is that negative
   * values are changed to positive during the calculations, and then the answer is negated at the
   * end. The second is that, for values less than 10, an increasingly large (0 to 1) scaling factor
   * is added such that at 0 the value is adjusted to 1, resulting in a returned result of 0.
   *
  ...
  /**
   * Returns an adjusted power of 10 value for graphing purposes. The first adjustment is that
   * negative values are changed to positive during the calculations, and then the answer is negated
   * at the end. The second is that, for values less than 1, a progressive logarithmic offset is
   ...
   * argument, is equal to a mathematical integer and satisfying the condition that log base 10 of
   * the value is an integer (i.e., the value returned will be a power of 10: 1, 10, 100, 1000,
   * etc.).
   *
  ...
  /**
   * Returns the smallest (closest to negative infinity) double value that is not less than the
   * argument, is equal to a mathematical integer and satisfying the condition that log base 10 of
   * the value is an integer (i.e., the value returned will be a power of 10: 1, 10, 100, 1000,
   * etc.).
   *
