...
/**
 * A source that can used by the {@link NumberAxis} class to obtain a suitable {@link TickUnit}.
 * Instances of this class are {@link Serializable} from version 1.0.7 onwards. Cloning is not
 * supported, because instances are immutable.
 */
