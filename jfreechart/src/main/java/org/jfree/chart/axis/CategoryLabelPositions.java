...
public class CategoryLabelPositions implements Serializable {
   ...
   *
   * @param top the label position info used when an axis is at the top ({@code null} not
   *     permitted).
   * @param bottom the label position info used when an axis is at the bottom ({@code null} not
   *     permitted).
   * @param left the label position info used when an axis is at the left ({@code null} not
   *     permitted).
   * @param right the label position info used when an axis is at the right ({@code null} not
   *     permitted).
   */
  public CategoryLabelPositions(
  ...
  /**
   * Returns {@code true} if this object is equal to the specified object, and {@code false}
   * otherwise.
   *
