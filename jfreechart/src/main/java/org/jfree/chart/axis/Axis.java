...
/**
 * The base class for all axes in JFreeChart. Subclasses are divided into those that display values
 * ({@link ValueAxis}) and those that display categories ({@link CategoryAxis}).
 */
public abstract class Axis implements ChartElement, Cloneable, Serializable {
  ...
  /**
   * An attributed label for the axis (overrides label if non-null). We have to use this override
   * method to preserve the API compatibility.
   */
  ...
  /**
   * Returns {@code true} if the axis is visible, and {@code false} otherwise.
   *
   * @return A boolean.
  ...
  /**
   * Sets a flag that controls whether or not the axis is visible and sends an {@link
  ...
  /**
   * Sets the label for the axis and sends an {@link AxisChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Returns the attributed label (the returned value is a copy, so modifying it will not impact the
   * state of the axis). The default value is {@code null}.
   *
  ...
  /**
   * Sets the attributed label for the axis and sends an {@link AxisChangeEvent} to all registered
   * listeners. This is a convenience method that converts the string into an {@code
  ...
  /**
   * Creates and returns an {@code AttributedString} with the specified text and the labelFont and
   * labelPaint applied as attributes.
   *
   * @param label the label ({@code null} permitted).
  ...
  /**
   * Sets the font for the axis label and sends an {@link AxisChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the paint used to draw the axis label and sends an {@link AxisChangeEvent} to all
  ...
  /**
   * Returns the insets for the label (that is, the amount of blank space that should be left around
   * the label).
   *
  ...
  /**
   * Sets the angle for the label and sends an {@link AxisChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Returns the location of the axis label. The default is {@link AxisLabelLocation#MIDDLE}.
   *
  ...
  /**
   * Sets the axis label location and sends an {@link AxisChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets a flag that controls whether or not the axis line is visible and sends an {@link
   * AxisChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the paint used to draw the axis line and sends an {@link AxisChangeEvent} to all
   * registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
   * @see #getAxisLinePaint()
  ...
  /**
   * Sets the stroke used to draw the axis line and sends an {@link AxisChangeEvent} to all
   * registered listeners.
   *
  ...
  /**
   * Sets the flag that determines whether or not the tick labels are visible and sends an {@link
   * AxisChangeEvent} to all registered listeners.
   *
   * @param flag the flag.
   ...
   *
   * @return The flag that indicates whether or not the minor tick marks are showing.
  ...
  /**
   * Sets the paint used to draw tick labels (if they are showing) and sends an {@link
   * AxisChangeEvent} to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
   * @see #getTickLabelPaint()
  ...
  /**
   * Sets the insets for the tick labels and sends an {@link AxisChangeEvent} to all registered
   * listeners.
   *
   * @param insets the insets ({@code null} not permitted).
  ...
  /**
   * Sets the flag that indicates whether or not the tick marks are showing and sends an {@link
   * AxisChangeEvent} to all registered listeners.
   *
   * @param flag the flag.
  ...
  /**
   * Sets the inside length of the tick marks and sends an {@link AxisChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the outside length of the tick marks and sends an {@link AxisChangeEvent} to all
   * registered listeners.
   *
   * @param length the new length.
   * @see #getTickMarkInsideLength()
  ...
  /**
   * Sets the stroke used to draw tick marks and sends an {@link AxisChangeEvent} to all registered
   * listeners.
   *
   * @param stroke the stroke ({@code null} not permitted).
  ...
  /**
   * Sets the paint used to draw tick marks and sends an {@link AxisChangeEvent} to all registered
   * listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  /**
   * Sets the inside length of the minor tick marks and sends an {@link AxisChangeEvent} to all
   * registered listeners.
   *
   * @param length the new length.
  ...
  public float getMinorTickMarkOutsideLength() {
    return this.minorTickMarkInsideLength; // buggy statement
  }

  /**
   * Sets the outside length of the minor tick marks and sends an {@link AxisChangeEvent} to all
   * registered listeners.
   *
   * @param length the new length.
   * @see #getMinorTickMarkInsideLength()
  ...
  /**
   * Returns the plot that the axis is assigned to. This method will return {@code null} if the axis
   * is not currently assigned to a plot.
   *
   ...
   *
   * <p>This method is used internally, you shouldn't need to call it yourself.
   *
   * @param plot the plot.
   * @see #getPlot()
   */
   ...
   *
   * <p>This is used when combining more than one plot on a chart. In this case, there may be
   * several axes that need to have the same height or width so that they are aligned. This method
   * is used to fix a dimension for the axis (the context determines whether the dimension is
  ...
  /**
   * Configures the axis to work with the current plot. Override this method to perform any special
   * processing (such as auto-rescaling).
   */
   ...
   */
  public abstract AxisSpace reserveSpace(
   ...
   */
  public abstract AxisState draw(
      Graphics2D g2,
      double cursor,
   ...
   */
  public abstract List refreshTicks(
      Graphics2D g2, AxisState state, Rectangle2D dataArea, RectangleEdge edge);

  /**
   * Creates an entity for the axis and adds it to the rendering info. If {@code plotState} is
   * {@code null}, this means that rendering info is not being collected so this method simply
  ...
  /**
   * Returns {@code true} if the specified object is registered with the dataset as a listener. Most
   * applications won't need to call this method, it exists mainly for use by unit testing code.
   *
  ...
  protected Rectangle2D getLabelEnclosure(Graphics2D g2, RectangleEdge edge) {
    ...
    if (this.attributedLabel != null) {
      TextLayout layout =
          new TextLayout(this.attributedLabel.getIterator(), g2.getFontRenderContext());
   ...
   * @param dataArea the display area in which the data will be rendered ({@code null} not
   *     permitted).
  ...
  protected AxisState drawLabel(
    ...
    if (edge == RectangleEdge.TOP) {
      ...
      TextUtils.drawRotatedString(
          label, g2, (float) labelx, (float) labely, anchor, getLabelAngle(), TextAnchor.CENTER);
   ...
   * @return Information about the axis.
   */
  protected AxisState drawAttributedLabel(
