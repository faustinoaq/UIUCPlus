...
public class SubCategoryAxis extends CategoryAxis implements Cloneable, Serializable {
  ...
  /**
   * Adds a sub-category to the axis and sends an {@link AxisChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the font used to display the sub-category labels and sends an {@link AxisChangeEvent} to
  ...
  /**
   * Sets the paint used to display the sub-category labels and sends an {@link AxisChangeEvent} to
   * all registered listeners.
   *
