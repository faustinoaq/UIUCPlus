 ...
 *
 * <p>This class (and any subclasses) should be immutable, the reason being that ORDERED collections
 * of tick units are maintained and if one instance can be changed, it may destroy the order of the
 * collection that it belongs to. In addition, if the implementations are immutable, they can belong
...
public abstract class TickUnit implements Comparable, Serializable {
  ...
  public int getMinorTickCount() {
    return this.minorTickCount + 1; // <changed>
  }

  /**
   * Converts the supplied value to a string.
   *
   * <p>Subclasses may implement special formatting by overriding this method.
   *
   ...
   * @return {@code 1} if the size of the other object is less than this, {@code 0} if both have the
   *     same size and {@code -1} this size is less than the others.
   */
  @Override
