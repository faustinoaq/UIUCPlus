...
/**
 * A default implementation of the {@link ChartTheme} interface. This implementation just collects a
 * whole bunch of chart attributes and mimics the manual process of applying each attribute to the
 * right sub-object within the JFreeChart instance. It's not elegant code, but it works.
 */
public class StandardChartTheme implements ChartTheme, Cloneable, PublicCloneable, Serializable {
  ...
  public static ChartTheme createJFreeTheme() {
    return new StandardChartTheme("JFree XYZ");
  }
  ...
  /**
   * Creates and returns a {@link ChartTheme} that doesn't apply any changes to the JFreeChart
   * defaults. This produces the "legacy" look for JFreeChart.
   *
   ...
   *
   * @param name the name of the theme ({@code null} not permitted).
   * @param shadow a flag that controls whether a shadow generator is included.
   */
  ...
  /**
   * Applies the attributes of this theme to a {@link PiePlot} instance. This method also clears any
   * set values for the section paint, outline etc, so that the theme's {@link DrawingSupplier} will
   * be used.
   *
   * @param plot the plot ({@code null} not permitted).
   */
  ...
  /**
   * Applies the attributes of this theme to a {@link PolarPlot}. This method is called from the
   * {@link #applyToPlot(Plot)} method.
   *
   * @param plot the plot ({@code null} not permitted).
   */
  ...
  /**
   * Applies the attributes for this theme to a {@link ThermometerPlot}. This method is called from
   * the {@link #applyToPlot(Plot)} method.
   *
   * @param plot the plot.
   */
