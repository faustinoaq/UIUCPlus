...
public abstract class ChartFactory {
  ...
  /**
   * Sets the current chart theme. This will be applied to all new charts created via methods in
   * this class.
   *
   ...
   *
   * <p>The chart object returned by this method uses a {@link PiePlot} instance as the plot.
   *
  ...
  /**
   * Creates a pie chart with default settings that compares 2 datasets. The colour of each section
   * will be determined by the move from the value for the same key in {@code previousDataset}. ie
   * if value1 &gt; value2 then the section will be in green (unless {@code greenForIncrease} is
   * {@code false}, in which case it would be {@code red}). Each section can have a shade of red or
   * green as the difference can be tailored between 0% (black) and percentDiffForMaxScale% (bright
   * red/green).
   *
   * <p>For instance if {@code percentDiffForMaxScale} is 10 (10%), a difference of 5% will have a
   * half shade of red/green, a difference of 10% or more will have a maximum shade/brightness of
   * red/green.
   *
   * <p>The chart object returned by this method uses a {@link PiePlot} instance as the plot.
   *
   * <p>Written by <a href="mailto:opensource@objectlab.co.uk">Benoit Xhenseval</a>.
   *
   * @param title the chart title ({@code null} permitted).
   * @param dataset the dataset for the chart ({@code null} permitted).
   * @param previousDataset the dataset for the last run, this will be used to compare each key in
   *     the dataset
   * @param percentDiffForMaxScale scale goes from bright red/green to black, percentDiffForMaxScale
   *     indicate the change required to reach top scale.
   * @param greenForIncrease an increase since previousDataset will be displayed in green (decrease
   *     red) if true.
   * @param legend a flag specifying whether or not a legend is required.
   * @param tooltips configure chart to generate tool tips?
   * @param locale the locale ({@code null} not permitted).
   * @param subTitle displays a subtitle with colour scheme if true
   * @param showDifference create a new dataset that will show the % difference between the two
   *     datasets.
   * @return A pie chart.
   */
  public static JFreeChart createPieChart(
    ...
    for (Iterator it = keys.iterator(); it.hasNext(); ) {
      ...
      if (oldValue == null) {
        ...
        double shade =
            (Math.abs(percentChange) >= percentDiffForMaxScale
                ? 255
   ...
   *
   * <p>The chart object returned by this method uses a {@link RingPlot} instance as the plot.
   *
   * @param title the chart title ({@code null} permitted).
   * @param dataset the dataset for the chart ({@code null} permitted).
   * @param legend a flag specifying whether or not a legend is required.
  ...
  /**
   * Creates a chart that displays multiple pie plots. The chart object returned by this method uses
   * a {@link MultiplePiePlot} instance as the plot.
   *
   * @param title the chart title ({@code null} permitted).
   * @param dataset the dataset ({@code null} permitted).
   * @param order the order that the data is extracted (by row or by column) ({@code null} not
   *     permitted).
  ...
  /**
   * Creates a bar chart with a vertical orientation. The chart object returned by this method uses
   * a {@link CategoryPlot} instance as the plot, with a {@link CategoryAxis} for the domain axis, a
  ...
  /**
   * Creates a bar chart. The chart object returned by this method uses a {@link CategoryPlot}
   * instance as the plot, with a {@link CategoryAxis} for the domain axis, a {@link NumberAxis} as
  ...
  /**
   * Creates a stacked bar chart with default settings. The chart object returned by this method
   * uses a {@link CategoryPlot} instance as the plot, with a {@link CategoryAxis} for the domain
   * axis, a {@link NumberAxis} as the range axis, and a {@link StackedBarRenderer} as the renderer.
   *
   * @param title the chart title ({@code null} permitted).
   ...
   * @param rangeAxisLabel the label for the value axis ({@code null} permitted).
   * @param dataset the dataset for the chart ({@code null} permitted).
   * @param orientation the orientation of the chart (horizontal or vertical) ({@code null} not
   *     permitted).
   * @param legend a flag specifying whether or not a legend is required.
   * @param tooltips configure chart to generate tool tips?
   * @param urls configure chart to generate URLs?
  ...
  /**
   * Creates an area chart with default settings. The chart object returned by this method uses a
   * {@link CategoryPlot} instance as the plot, with a {@link CategoryAxis} for the domain axis, a
  ...
  /**
   * Creates a stacked area chart with default settings. The chart object returned by this method
   * uses a {@link CategoryPlot} instance as the plot, with a {@link CategoryAxis} for the domain
   * axis, a {@link NumberAxis} as the range axis, and a {@link StackedAreaRenderer} as the
   * renderer.
   *
   * @param title the chart title ({@code null} permitted).
   * @param categoryAxisLabel the label for the category axis ({@code null} permitted).
  ...
  /**
   * Creates a line chart with default settings. The chart object returned by this method uses a
   * {@link CategoryPlot} instance as the plot, with a {@link CategoryAxis} for the domain axis, a
   ...
   * @param valueAxisLabel the label for the value axis ({@code null} permitted).
   * @param dataset the dataset for the chart ({@code null} permitted).
   * @param orientation the chart orientation (horizontal or vertical) ({@code null} not permitted).
   * @param legend a flag specifying whether or not a legend is required.
   * @param tooltips configure chart to generate tool tips?
   * @param urls configure chart to generate URLs?
   * @return A line chart.
  ...
  /**
   * Creates a Gantt chart using the supplied attributes plus default values where required. The
   * chart object returned by this method uses a {@link CategoryPlot} instance as the plot, with a
   * {@link CategoryAxis} for the domain axis, a {@link DateAxis} as the range axis, and a {@link
   * GanttRenderer} as the renderer.
   *
   * @param title the chart title ({@code null} permitted).
   * @param categoryAxisLabel the label for the category axis ({@code null} permitted).
   * @param dateAxisLabel the label for the date axis ({@code null} permitted).
   * @param dataset the dataset for the chart ({@code null} permitted).
  ...
  /**
   * Creates a waterfall chart. The chart object returned by this method uses a {@link CategoryPlot}
   * instance as the plot, with a {@link CategoryAxis} for the domain axis, a {@link NumberAxis} as
   * the range axis, and a {@link WaterfallBarRenderer} as the renderer.
   *
   * @param title the chart title ({@code null} permitted).
   * @param categoryAxisLabel the label for the category axis ({@code null} permitted).
   * @param valueAxisLabel the label for the value axis ({@code null} permitted).
  ...
  /**
   * Creates a polar plot for the specified dataset (x-values interpreted as angles in degrees). The
   * chart object returned by this method uses a {@link PolarPlot} instance as the plot, with a
   * {@link NumberAxis} for the radial axis.
   *
   * @param title the chart title ({@code null} permitted).
   * @param dataset the dataset ({@code null} permitted).
   ...
   * {@link XYPlot} instance as the plot, with a {@link NumberAxis} for the domain axis, a {@link
   * NumberAxis} as the range axis, and an {@link XYLineAndShapeRenderer} as the renderer.
   *
   * @param title the chart title ({@code null} permitted).
   ...
   *
   * <p>The chart object returned by this method uses an {@link XYPlot} instance as the plot, with a
   * {@link DateAxis} for the domain axis, a {@link NumberAxis} as the range axis, and a {@link
   * XYBarRenderer} as the renderer.
   *
   * @param title the chart title ({@code null} permitted).
   * @param xAxisLabel a label for the X-axis ({@code null} permitted).
   ...
   *
   * <p>The chart object returned by this method uses an {@link XYPlot} instance as the plot, with a
   * {@link NumberAxis} for the domain axis, a {@link NumberAxis} as the range axis, and a {@link
   * XYAreaRenderer} as the renderer.
   *
   * @param title the chart title ({@code null} permitted).
   * @param xAxisLabel a label for the X-axis ({@code null} permitted).
   * @param yAxisLabel a label for the Y-axis ({@code null} permitted).
  ...
  public static <S extends Comparable<S>> JFreeChart createXYAreaChart(
      String title, String xAxisLabel, String yAxisLabel, XYDataset<S> dataset) {
  ...
  /**
   * Creates a stacked XY area plot. The chart object returned by this method uses an {@link XYPlot}
   * instance as the plot, with a {@link NumberAxis} for the domain axis, a {@link NumberAxis} as
   * the range axis, and a {@link StackedXYAreaRenderer2} as the renderer.
   *
   * @param title the chart title ({@code null} permitted).
   * @param xAxisLabel a label for the X-axis ({@code null} permitted).
   * @param yAxisLabel a label for the Y-axis ({@code null} permitted).
  ...
  public static JFreeChart createXYStepAreaChart(
    ...
    XYItemRenderer renderer =
        new XYStepAreaRenderer(XYStepAreaRenderer.AREA_AND_SHAPES, toolTipGenerator, urlGenerator);
  ...
  /**
   * Creates and returns a time series chart. A time series chart is an {@link XYPlot} with a {@link
   * DateAxis} for the x-axis and a {@link NumberAxis} for the y-axis. The default renderer is an
   * {@link XYLineAndShapeRenderer}.
   *
   * <p>A convenient dataset to use with this chart is a {@link
   * org.jfree.data.time.TimeSeriesCollection}.
   *
   * @param title the chart title ({@code null} permitted).
   * @param timeAxisLabel a label for the time axis ({@code null} permitted).
   * @param valueAxisLabel a label for the value axis ({@code null} permitted).
   * @param dataset the dataset for the chart ({@code null} permitted).
  ...
  /**
   * Creates a histogram chart. This chart is constructed with an {@link XYPlot} using an {@link
   * XYBarRenderer}. The domain and range axes are {@link NumberAxis} instances.
   *
   * @param title the chart title ({@code null} permitted).
  ...
  public static JFreeChart createHistogram(
      String title, String xAxisLabel, String yAxisLabel, IntervalXYDataset dataset) {
  ...
  /**
   * Creates and returns a default instance of a box and whisker chart based on data from a {@link
   * BoxAndWhiskerCategoryDataset}.
   *
   * @param title the chart title ({@code null} permitted).
   * @param categoryAxisLabel a label for the category axis ({@code null} permitted).
   * @param valueAxisLabel a label for the value axis ({@code null} permitted).
   * @param dataset the dataset for the chart ({@code null} permitted).
   * @param legend a flag specifying whether or not a legend is required.
  ...
  public static JFreeChart createBoxAndWhiskerChart(
    ...
    renderer.setDefaultToolTipGenerator(valueAxisLabel);
   ...
   * @return A wind plot.
   */
  public static JFreeChart createWindPlot(
      String title,
      String xAxisLabel,
      String yAxisLabel,
      WindDataset dataset,
   ...
   */
  public static JFreeChart createWaferMapChart(
      String title,
