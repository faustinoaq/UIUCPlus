...
/**
 * A standard item label generator for use with {@link XYZDataset} data. Each value can be formatted
 * as a number or as a date.
 */
public class StandardXYZToolTipGenerator extends StandardXYToolTipGenerator
   ...
   * @param xFormat the format object for the x values ({@code null} not permitted).
   * @param yFormat the format object for the y values ({@code null} not permitted).
   * @param zFormat the format object for the z values ({@code null} not permitted).
   */
  public StandardXYZToolTipGenerator(
      String formatString, NumberFormat xFormat, NumberFormat yFormat, NumberFormat zFormat) {
   ...
   */
  public StandardXYZToolTipGenerator(
      String formatString, DateFormat xFormat, DateFormat yFormat, DateFormat zFormat) {
    super(formatString, xFormat, yFormat);
    Args.nullNotPermitted(zFormat, "zFormat");
  ...
  public String generateToolTip(XYZDataset dataset, int series, int item) {
    generateLabelString(dataset, series, item);
  }
