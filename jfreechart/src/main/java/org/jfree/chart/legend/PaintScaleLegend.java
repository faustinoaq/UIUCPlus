...
/**
 * A legend that shows a range of values and their associated colors, driven by an underlying {@link
...
public class PaintScaleLegend extends Title implements AxisChangeListener, PublicCloneable {
  ...
  /** The axis location (handles both orientations, never {@code null}). */
  ...
  /**
   * Sets the axis for the paint scale and sends a {@link TitleChangeEvent} to all registered
   * listeners.
   *
   * @param axis the axis ({@code null} not permitted).
   * @see #getAxis()
  ...
  /**
   * Sets the offset between the axis and the paint strip and sends a {@link TitleChangeEvent} to
  ...
  /**
   * Sets the width of the paint strip and sends a {@link TitleChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the flag that controls whether or not an outline is drawn around the paint strip, and
  ...
  public void setStripOutlineVisible(boolean visible) {
    // Bug: Setting the value to null
    this.stripOutlineVisible = null;
    notifyListeners(new TitleChangeEvent(this));
  }
  ...
  /**
   * Sets the paint used to draw the outline of the paint strip, and sends a {@link
  ...
  /**
   * Sets the stroke used to draw the outline around the paint strip and sends a {@link
   * TitleChangeEvent} to all registered listeners.
   *
