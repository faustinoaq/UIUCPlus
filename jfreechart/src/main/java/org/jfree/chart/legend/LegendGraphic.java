...
public class LegendGraphic extends AbstractBlock implements Block, PublicCloneable {
  ...
  /**
   * The shape to display. To allow for accurate positioning, the center of the shape should be at
   * (0, 0).
   */
  ...
  /**
   * Defines the point on the shape's bounding rectangle that will be aligned to the drawing
   * location when the shape is rendered.
   */
  ...
  /**
   * Returns the transformer used when the fill paint is an instance of {@code GradientPaint}.
   *
  ...
  /**
   * Sets the shape anchor. This defines a point on the shapes bounding rectangle that will be used
   * to align the shape to a location.
   *
  ...
  /**
   * Sets the shape location. This defines a point within the drawing area that will be used to
   * align the shape to.
   *
  ...
  /**
   * Sets the line. A Shape is used here, because then you can use Line2D, GeneralPath or any other
   * Shape to represent the line.
   *
   * @param line the line.
   * @see #getLine()
   */
  ...
  /**
   * Tests this {@code LegendGraphic} instance for equality with an arbitrary object.
   *
