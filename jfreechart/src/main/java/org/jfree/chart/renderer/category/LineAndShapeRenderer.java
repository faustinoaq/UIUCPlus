...
/**
 * A renderer that draws shapes for each data item, and lines between data items (for use with the
 * {@link CategoryPlot} class). The example shown here is generated by the {@code
 * LineChartDemo1.java} program included in the JFreeChart Demo Collection: <br>
 * <br>
 * <img src="doc-files/LineAndShapeRendererSample.png" alt="LineAndShapeRendererSample.png">
 */
public class LineAndShapeRenderer extends AbstractCategoryItemRenderer
  ...
  /**
   * A flag that controls whether the outline paint is used for drawing shape outlines - if not, the
   * regular series paint is used.
   */
  private boolean useOutlinePaint;

  /**
   * A flag that controls whether or not the x-position for each item is offset within the category
   * according to the series.
   */
  private boolean useSeriesOffset;

  /**
   * The item margin used for series offsetting - this allows the positioning to match the bar
   * positions of the {@link BarRenderer} class.
   */
  ...
  /**
   * Returns the flag that controls whether the outline paint is used for shape outlines. If not,
   * the regular series paint is used.
   *
   * @return A boolean.
  ...
  /**
   * Returns the flag used to control whether or not the shape for an item is filled. The default
   * implementation passes control to the {@code getSeriesShapesFilled} method. You can override
  ...
  /**
   * Returns the flag that controls whether or not the x-position for each data item is offset
   * within the category according to the series.
   *
   * @return A boolean.
  ...
  /**
   * Sets the flag that controls whether or not the x-position for each data item is offset within
   * its category according to the series, and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Returns the item margin, which is the gap between items within a category (expressed as a
   * percentage of the overall category width). This can be used to match the offset alignment with
   * the bars drawn by a {@link BarRenderer}).
   *
  ...
  /**
   * Sets the item margin, which is the gap between items within a category (expressed as a
   * percentage of the overall category width), and sends a {@link RendererChangeEvent} to all
   * registered listeners.
   *
