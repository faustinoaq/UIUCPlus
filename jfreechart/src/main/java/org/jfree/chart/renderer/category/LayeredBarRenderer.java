...
/**
 * A {@link CategoryItemRenderer} that represents data using bars which are superimposed. The
 * example shown here is generated by the {@code LayeredBarChartDemo1.java} program included in the
 * JFreeChart Demo Collection: <br>
 * <br>
 * <img src="doc-files/LayeredBarRendererSample.png" alt="LayeredBarRendererSample.png">
 */
public class LayeredBarRenderer extends BarRenderer implements Serializable {
  ...
  /**
   * Returns the bar width for a series, or {@code Double.NaN} if no width has been set.
   *
   ...
   * @param column the column index (zero-based).
   */
  protected void drawHorizontalItem(
      Graphics2D g2,
      CategoryItemRendererState state,
      Rectangle2D dataArea,
      CategoryPlot plot,
