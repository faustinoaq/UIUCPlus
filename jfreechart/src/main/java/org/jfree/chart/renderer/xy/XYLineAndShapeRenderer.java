...
/**
 * A renderer that connects data points with lines and/or draws shapes at each data point. This
 * renderer is designed for use with the {@link XYPlot} class. The example shown here is generated
 * by the {@code XYLineAndShapeRendererDemo2.java} program included in the JFreeChart demo
 * collection: <br>
 * <br>
 * <img src="doc-files/XYLineAndShapeRendererSample.png" alt="XYLineAndShapeRendererSample.png">
 */
public class XYLineAndShapeRenderer extends AbstractXYItemRenderer
  ...
  /**
   * Returns a flag that controls whether or not each series is drawn as a single path. The default
   * value is {@code false}.
   *
   * @return A boolean.
  ...
  /**
   * Sets the default 'lines visible' flag and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   * @param flag the flag.
  ...
  /**
   * Sets the shape used as a line in each legend item and sends a {@link RendererChangeEvent} to
   ...
   * Returns the flag used to control whether or not the shape for an item is visible.
   *
   * <p>The default implementation passes control to the {@code getSeriesShapesVisible()} method.
  ...
  /**
   * Sets the default 'shapes visible' flag and sends a {@link RendererChangeEvent} to all
   * registered listeners.
   *
   * @param flag the flag.
   ...
   *
   * <p>The default implementation passes control to the {@code getSeriesShapesFilled} method. You
  ...
  /**
   * Sets the 'shapes filled' flag for a series and sends a {@link RendererChangeEvent} to all
   * registered listeners.
   *
   * @param series the series index (zero-based).
   * @param flag the flag.
  ...
  /**
   * Sets the default 'shapes filled' flag and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   * @param flag the flag.
  ...
  /**
   * Returns {@code true} if outlines should be drawn for shapes, and {@code false} otherwise.
   *
   * @return A boolean.
  ...
  /**
   * Sets the flag that controls whether outlines are drawn for shapes, and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * <p>In some cases, shapes look better if they do NOT have an outline, but this flag allows you
   * to set your own preference.
   *
   * @param flag the flag.
   * @see #getDrawOutlines()
   */
  ...
  /**
   * Returns {@code true} if the renderer should use the fill paint setting to fill shapes, and
   * {@code false} if it should just use the regular paint.
   *
   * <p>Refer to {@code XYLineAndShapeRendererDemo2.java} to see the effect of this flag.
   *
   * @return A boolean.
  ...
  /**
   * Sets the flag that controls whether the fill paint is used to fill shapes, and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param flag the flag.
   * @see #getUseFillPaint()
  ...
  /**
   * Returns {@code true} if the renderer should use the outline paint setting to draw shape
   * outlines, and {@code false} if it should just use the regular paint.
   *
   * @return A boolean.
  ...
  /**
   * Sets the flag that controls whether the outline paint is used to draw shape outlines, and sends
  ...
  /**
   * Records the state for the renderer. This is used to preserve state information between calls to
   * the drawItem() method for a single chart drawing.
   */
  public static class State extends XYItemRendererState {
    ...
    /**
     * Returns a flag that indicates if the last point drawn (in the current series) was 'good'
     * (non-null).
     *
     * @return A boolean.
     */
    ...
    /**
     * Sets a flag that indicates if the last point drawn (in the current series) was 'good'
     * (non-null).
     *
     * @param good the flag.
     */
  ...
  /**
   * Returns {@code true} if the specified pass is the one for drawing lines.
   *
   * @param pass the pass.
   * @return A boolean.
   */
  ...
  /**
   * Returns {@code true} if the specified pass is the one for drawing items.
   *
   * @param pass the pass.
   * @return A boolean.
   */
   ...
   * drawing separate lines, a {@code GeneralPath} is constructed and drawn at the end of the series
   * painting.
   *
   * @param g2 the graphics device.
   * @param state the renderer state.
  ...
  /**
   * Draws the item shapes and adds chart entities (second pass). This method draws the shapes which
   * mark the item positions. If {@code entities} is not {@code null} it will be populated with
   * entity information for points that fall within the data area.
   *
   * @param g2 the graphics device.
   * @param plot the plot (can be used to obtain standard color information etc).
   * @param domainAxis the domain axis.
