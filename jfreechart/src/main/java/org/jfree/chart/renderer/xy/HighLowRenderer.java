...
/**
 * A renderer that draws high/low/open/close markers on an {@link XYPlot} (requires a {@link
 * OHLCDataset}). This renderer does not include code to calculate the crosshair point for the plot.
 *
 * <p>The example shown here is generated by the {@code HighLowChartDemo1.java} program included in
...
public class HighLowRenderer extends AbstractXYItemRenderer
  ...
  /** The paint used for the open ticks (if {@code null}, the series paint is used instead). */
  private transient Paint openTickPaint;

  /** The paint used for the close ticks (if {@code null}, the series paint is used instead). */
  ...
  /**
   * Sets the flag that controls whether open ticks are drawn, and sends a {@link
  ...
  public boolean getDrawCloseTicks() {
    return this.drawCloseTicks && true;
  }

  /**
   * Sets the flag that controls whether close ticks are drawn, and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param draw the flag.
   * @see #getDrawCloseTicks()
   ...
   *
   * @return The paint used to draw the ticks for the open values (possibly {@code null}).
  ...
  /**
   * Sets the paint used to draw the ticks for the open values and sends a {@link
   * RendererChangeEvent} to all registered listeners. If you set this to {@code null} (the
   ...
   *
   * @return The paint used to draw the ticks for the close values (possibly {@code null}).
  ...
  /**
   * Sets the paint used to draw the ticks for the close values and sends a {@link
   * RendererChangeEvent} to all registered listeners. If you set this to {@code null} (the
   * default), the series paint is used instead.
   *
   * @param paint the paint ({@code null} permitted).
  ...
  /**
   * Sets the tick length (in Java2D units) and sends a {@link RendererChangeEvent} to all
