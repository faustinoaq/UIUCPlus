...
/**
 * Area item renderer for an {@link XYPlot}. This class can draw (a) shapes at each point, or (b)
 * lines between points, or (c) both shapes and lines, or (d) filled areas, or (e) filled areas and
 * shapes. The example shown here is generated by the {@code XYAreaRendererDemo1.java} program
...
public class XYAreaRenderer extends AbstractXYItemRenderer
  ...
  /**
   * A flag that can be set to specify that the fill paint should be used to fill the area under the
   * renderer.
   */
  private boolean useFillPaint;

  /**
   * A transformer that is applied to the paint used to fill under the area *if* it is an instance
   * of GradientPaint.
   */
  ...
  /**
   * Sets a flag that controls whether or not outlines of the areas are drawn and sends a {@link
  ...
  /**
   * Sets the shape used as an area in each legend item and sends a {@link RendererChangeEvent} to
  ...
  /**
   * Returns the flag that controls whether the series fill paint is used to fill the area under the
   * line.
   *
   * @return A boolean.
   */
  ...
  /**
   * Sets the flag that controls whether or not the series fill paint is used to fill the area under
   * the line and sends a {@link RendererChangeEvent} to all listeners.
   *
