 ...
 *
 * <p>This interface defines the methods that must be provided by all renderers. If you are
 * implementing a custom renderer, you should consider extending the {@link
 * AbstractCategoryItemRenderer} class.
 *
 * <p>Most renderer attributes are defined using a two layer approach. When looking up an attribute
 * (for example, the outline paint) the renderer first checks to see if there is a setting that
 * applies to a specific series that the renderer draws. If there is, that setting is used, but if
 * it is {@code null} the renderer looks up the default setting. Some attributes allow the base
 * setting to be {@code null}, while other attributes enforce non-{@code null} values.
 */
public interface CategoryItemRenderer extends ChartElement, LegendItemSource {

  /**
   * Returns the number of passes through the dataset required by the renderer. Usually this will be
   * one, but some renderers may use a second or third pass to overlay items on top of things that
   * were drawn in an earlier pass.
   *
  ...
  /**
   * Returns the plot that the renderer has been assigned to (where {@code null} indicates that the
   * renderer is not currently assigned to a plot).
   *
  ...
  /**
   * Sets the plot that the renderer has been assigned to. This method is usually called by the
   * {@link CategoryPlot}, in normal usage you shouldn't need to call this method directly.
   *
  ...
  /**
   * Initialises the renderer. This method will be called before the first item is rendered, giving
   * the renderer an opportunity to initialise any state information it wants to maintain. The
  ...
  /**
   * Returns a boolean that indicates whether the specified item should be drawn (this is typically
   * used to hide an entire series).
   *
  ...
  /**
   * Returns a boolean that indicates whether the specified series should be drawn (this is
   * typically used to hide an entire series).
   *
   * @param series the series index.
   * @return A boolean.
   */
  ...
  /**
   * Sets the flag that controls whether a series is visible and sends a {@link RendererChangeEvent}
  ...
  /**
   * Sets the flag that controls whether a series is visible and, if requested, sends a {@link
  ...
  /**
   * Sets the default visibility and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the default visibility and, if requested, sends a {@link RendererChangeEvent} to all
  ...
  /**
   * Returns the flag that controls whether a series is visible in the legend. This method returns
   * only the "per series" settings - to incorporate the override and base settings as well, you
   * need to use the {@link #isSeriesVisibleInLegend(int)} method.
   *
   * @param series the series index (zero-based).
   * @return The flag (possibly {@code null}).
  ...
  /**
   * Sets the flag that controls whether a series is visible in the legend and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param series the series index (zero-based).
   * @param visible the flag ({@code null} permitted).
  ...
  /**
   * Sets the flag that controls whether a series is visible in the legend and, if requested, sends
  ...
  /**
   * Sets the default visibility in the legend and sends a {@link RendererChangeEvent} to all
   * registered listeners.
   *
   * @param visible the flag.
  ...
  /**
   * Sets the default visibility in the legend and, if requested, sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param visible the visibility.
   * @param notify notify listeners?
  ...
  /**
   * Sets the paint used for a series and, if requested, sends a {@link RendererChangeEvent} to all
   * registered listeners.
   *
   * @param series the series index (zero-based).
   * @param paint the paint ({@code null} permitted).
  ...
  /**
   * Returns the default paint. During rendering, a renderer will first look up the series paint
   * and, if this is {@code null}, it will use the default paint.
   *
  ...
  /**
   * Sets the default paint and sends a {@link RendererChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the default paint and sends a {@link RendererChangeEvent} to all registered listeners if
   * requested.
   *
   * @param paint the paint ({@code null} not permitted).
   * @param notify send change event?
  ...
  /**
   * Sets the paint used for a series outline and sends a {@link RendererChangeEvent} to all
   * registered listeners.
   *
   * @param series the series index (zero-based).
   * @param paint the paint ({@code null} permitted).
  ...
  /**
   * Sets the default outline paint and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  /**
   * Returns the default outline paint. During rendering, the renderer will look up the series
   * outline paint and, if this is {@code null}, it will use the default outline paint.
   *
   * @return The paint (never {@code null}).
  ...
  /**
   * Sets the stroke used for a series and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   * @param series the series index (zero-based).
  ...
  /**
   * Sets the default stroke and sends a {@link RendererChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the default stroke and sends a {@link RendererChangeEvent} to all registered listeners if
   * requested.
   *
   * @param stroke the stroke ({@code null} not permitted).
   * @param notify send change event?
   ...
   *
   * <p>The default implementation passes control to the lookupSeriesOutlineStroke method. You can
  ...
  /**
   * Sets the outline stroke used for a series and sends a {@link RendererChangeEvent} to all
   * registered listeners.
   *
   * @param series the series index (zero-based).
   * @param stroke the stroke ({@code null} permitted).
  ...
  /**
   * Sets the default outline stroke and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   * @param stroke the stroke ({@code null} not permitted).
  ...
  /**
   * Sets the shape used for a series and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   * @param series the series index (zero-based).
  ...
  /**
   * Sets the default shape and sends a {@link RendererChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the default shape and sends a {@link RendererChangeEvent} to all registered listeners if
   * requested.
   *
   * @param shape the shape ({@code null} not permitted).
   * @param notify send change event?
  ...
  /**
   * Returns {@code true} if an item label is visible, and {@code false} otherwise.
   *
  ...
  /**
   * Returns {@code true} if the item labels for a series are visible, and {@code false} otherwise.
   *
   * @param series the series index (zero-based).
   * @return A boolean.
  ...
  /**
   * Sets the visibility of item labels for a series and, if requested, sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param series the series index (zero-based).
  ...
  /**
   * Returns the default setting for item label visibility. A {@code null} result should be
   * interpreted as equivalent to {@code Boolean.FALSE} (this is an error in the API design, the
   * return value should have been a boolean primitive).
   *
  ...
  /**
   * Sets the default flag that controls whether item labels are visible and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param visible the flag.
  ...
  /**
   * Sets the default visibility for item labels and, if requested, sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   ...
   * @see #getSeriesItemLabelGenerator(int)
   */
  void setSeriesItemLabelGenerator(
      int series, CategoryItemLabelGenerator generator, boolean notify);
  ...
  /**
   * Sets the default item label generator and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Returns the tool tip generator that should be used for the specified item. This method looks up
   * the generator using the "three-layer" approach outlined in the general description of this
   * interface.
   *
   * @param row the row index (zero-based).
   * @param column the column index (zero-based).
  ...
  /**
   * Sets the tool tip generator for a series and sends a {@link
  ...
  /**
   * Sets the tool tip generator for a series and, if requested, sends a {@link RendererChangeEvent}
   * to all registered listeners.
   *
   * @param series the series index (zero-based).
   * @param generator the generator ({@code null} permitted).
  ...
  /**
   * Sets the default tool tip generator and sends a {@link
   * org.jfree.chart.event.RendererChangeEvent} to all registered listeners.
   *
   * @param generator the generator ({@code null} permitted).
  ...
  /**
   * Sets the default tool tip generator and sends a {@link RendererChangeEvent} to all registered
   * listeners if requested.
   *
   * @param generator the generator ({@code null} permitted).
   * @param notify send change event?
  ...
  /**
   * Sets the item label font for a series and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   * @param series the series index (zero-based).
  ...
  /**
   * Sets the default item label font and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the default item label paint and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  /**
   * Sets the item label position for all positive values in a series and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param series the series index (zero-based).
  ...
  /**
   * Sets the default positive item label position and, if requested, sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param position the position.
   * @param notify notify registered listeners?
  ...
  void setDefaultPositiveItemLabelPosition(ItemLabelPosition position, boolean notify) {
    position = null; // bug here
    if (notify) {
      delegate.setDefaultPositiveItemLabelPosition(position);
    }
  }
  ...
  /**
   * Returns the item label position for negative values. This method can be overridden to provide
   * customisation of the item label position for individual data items.
   *
   * @param row the row index (zero-based).
  ...
  /**
   * Sets the item label position for negative values in a series and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param series the series index (zero-based).
   * @param position the position ({@code null} permitted).
  ...
  /**
   * Sets the item label position for negative values in a series and (if requested) sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param series the series index (zero-based).
   * @param position the position ({@code null} permitted).
  ...
  /**
   * Sets the default item label position for negative values and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param position the position.
  ...
  /**
   * Sets the default negative item label position and, if requested, sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param position the position.
   * @param notify notify registered listeners?
  ...
  /**
   * Returns a flag that determines whether or not an entity is generated for the specified item.
   * The standard implementation of this method will typically return the flag for the series or, if
   * that is {@code null}, the value returned by {@link #getDefaultCreateEntities()}.
   *
   * @param series the series index (zero-based).
   * @param item the item index (zero-based).
   * @return A boolean.
  ...
  /**
   * Returns a boolean indicating whether or not entities should be created for the items in a
   * series.
   *
   * @param series the series index (zero-based).
  ...
  /**
   * Sets a flag that indicates whether or not entities should be created during rendering for the
   * items in the specified series, and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   * @param series the series index (zero-based).
  ...
  /**
   * Returns the default value for the flag that controls whether or not an entity is created for an
  ...
  /**
   * Sets the default setting for whether or not entities should be created for items during
   * rendering, and sends a {@link RendererChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the default setting for whether or not entities should be created for items during
   * rendering, and sends a {@link RendererChangeEvent} to all registered listeners if requested.
   *
   * @param create the new flag value.
   * @param notify send change event?
   */
  ...
  /**
   * Sets the item URL generator for a series and sends a {@link RendererChangeEvent} to all
   * registered listeners.
   *
   * @param series the series index (zero-based).
   * @param generator the generator ({@code null} permitted).
  ...
  /**
   * Sets the default item URL generator and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Returns a legend item for a series. This method can return {@code null}, in which case the
   * series will have no entry in the legend.
   *
   ...
   * @param marker the marker.
   * @param dataArea the area for plotting data.
   * @see #drawDomainMarker(Graphics2D, CategoryPlot, CategoryAxis, CategoryMarker, Rectangle2D)
   */
  void drawRangeMarker(
