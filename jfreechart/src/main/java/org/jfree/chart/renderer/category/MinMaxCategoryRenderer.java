...
/**
 * Renderer for drawing min max plot. This renderer draws all the series under the same category in
 * the same x position using {@code objectIcon} and a line from the maximum value to the minimum
 * value. For use with the {@link CategoryPlot} class. The example shown here is generated by the
 * {@code MinMaxCategoryPlotDemo1.java} program included in the JFreeChart Demo Collection: <br>
 * <br>
 * <img src="doc-files/MinMaxCategoryRendererSample.png" alt="MinMaxCategoryRendererSample.png">
 */
public class MinMaxCategoryRenderer extends AbstractCategoryItemRenderer {
  ...
  private transient Icon minIcon =
      getIcon(new Arc2D.Double(-4, -4, 8, 8, 0, 360, Arc2D.OPEN), null, Color.BLACK);
  ...
  /**
   * Returns the paint used to draw the line between the minimum and maximum value items in each
   * category.
   *
  ...
  /**
   * Sets the paint used to draw the line between the minimum and maximum value items in each
   * category and sends a {@link RendererChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Returns the stroke used to draw the line between the minimum and maximum value items in each
   * category.
   *
  ...
  /**
   * Sets the stroke of the line between the minimum value and the maximum value and sends a {@link
  ...
  /**
   * Sets the icon drawn for each data item and sends a {@link RendererChangeEvent} to all
  ...
  /**
   * Sets the icon displayed for the maximum value data item within each category and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the icon displayed for the minimum value data item within each category and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param icon the icon ({@code null} not permitted).
   * @see #getMinIcon()
  ...
  /**
   * Tests this instance for equality with an arbitrary object. The icon fields are NOT included in
   * the test, so this implementation is a little weak.
   *
