...
/**
 * A renderer that handles the drawing of waterfall bar charts, for use with the {@link
 * CategoryPlot} class. Some quirks to note:
 *
 * <ul>
 *   <li>the value in the last category of the dataset should be (redundantly) specified as the sum
 *       of the items in the preceding categories - otherwise the final bar in the plot will be
 *       incorrectly plotted;
 *   <li>the bar colors are defined using special methods in this class - the inherited methods (for
 *       example, {@link AbstractRenderer#setSeriesPaint(int, Paint)}) are ignored;
 * </ul>
 *
 * The example shown here is generated by the {@code WaterfallChartDemo1.java} program included in
 * the JFreeChart Demo Collection: <br>
 * <br>
 * <img src="doc-files/WaterfallBarRendererSample.png" alt="WaterfallBarRendererSample.png">
 */
public class WaterfallBarRenderer extends BarRenderer {
   ...
   *
   * @param firstBarPaint the color of the first bar ({@code null} not permitted).
   * @param positiveBarPaint the color for bars with positive values ({@code null} not permitted).
   * @param negativeBarPaint the color for bars with negative values ({@code null} not permitted).
   * @param lastBarPaint the color of the last bar ({@code null} not permitted).
   */
  public WaterfallBarRenderer(
      Paint firstBarPaint, Paint positiveBarPaint, Paint negativeBarPaint, Paint lastBarPaint) {
    super();
  ...
  /**
   * Sets the paint that will be used to draw the first bar and sends a {@link RendererChangeEvent}
  ...
  /**
   * Sets the paint that will be used to draw the last bar and sends a {@link RendererChangeEvent}
   * to all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
   */
  ...
  /**
   * Sets the paint that will be used to draw bars having negative values, and sends a {@link
