...
/**
 * A stacked area renderer for the {@link XYPlot} class. <br>
 * <br>
 * The example shown here is generated by the {@code StackedXYAreaRendererDemo1.java} program
 * included in the JFreeChart demo collection: <br>
 * <br>
 * <img src="doc-files/StackedXYAreaRendererSample.png" alt="StackedXYAreaRendererSample.png"> <br>
 * <br>
 * SPECIAL NOTE: This renderer does not currently handle negative data values correctly. This should
 * get fixed at some point, but the current workaround is to use the {@link StackedXYAreaRenderer2}
 * class instead.
 */
public class StackedXYAreaRenderer extends XYAreaRenderer
  ...
  /**
   * Constructs a new renderer. To specify the type of renderer, use one of the constants: {@code
   * SHAPES}, {@code LINES}, {@code SHAPES_AND_LINES}, {@code AREA} or {@code AREA_AND_SHAPES}.
   *
  ...
  /**
   * Returns the paint used for rendering shapes, or {@code null} if using series paints.
   *
  ...
  /**
   * Sets the paint for rendering shapes and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Returns the stroke used for rendering shapes, or {@code null} if using series strokes.
   *
  ...
  /**
   * Sets the stroke for rendering shapes and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   ...
   * the renderer an opportunity to initialise any state information it wants to maintain.
   *
   ...
   * @return The range ([0.0, 0.0] if the dataset contains no values, and {@code null} if the
   *     dataset is {@code null}).
   * @throws ClassCastException if {@code dataset} is not an instance of {@link TableXYDataset}.
   */
  @Override
   ...
   * @throws ClassCastException if {@code state} is not an instance of {@code
   *     StackedXYAreaRendererState} or {@code dataset} is not an instance of {@link
   *     TableXYDataset}.
   */
  @Override
  public void drawItem(
    ...
    if (pass == 0) {
      ...
      updateCrosshairValues(
          crosshairState, x1, ph1 + y1, datasetIndex, transX1, transY1, orientation);
      ...
      if (state.getInfo() != null) {
        ...
        if (entities != null && shape != null && !nullPoint) {
          ...
          if (!dataAreaHotspot.isEmpty()) {
            ...
            XYItemEntity entity =
                new XYItemEntity(dataAreaHotspot, dataset, series, item, tip, url);
            entities.add(entity);
          }
        }
      }
  ...
  /**
   * Calculates the stacked value of the all series up to, but not including {@code series} for the
   * specified item. It returns 0.0 if {@code series} is the first series, i.e. 0.
   *
   * @param dataset the dataset.
   * @param series the series.
   * @param index the index.
   * @return The cumulative value for all series' values up to but excluding {@code series} for
   *     {@code index}.
   */
