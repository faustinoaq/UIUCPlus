 ...
 * {@link IntervalXYDataset}, otherwise it reverts to the behaviour of the super class. The example
 * shown here is generated by the {@code XYErrorRendererDemo1.java} program included in the
...
public class XYErrorRenderer extends XYLineAndShapeRenderer {
  ...
  /** The paint used to draw the error bars (if {@code null} we use the series paint). */
  private transient Paint errorPaint;

  /** The stroke used to draw the error bars (if {@code null} we use the series outline stroke). */
  ...
  /**
   * Sets the flag that controls whether or not the renderer draws error bars for the x-values and,
   * if the flag changes, sends a {@link RendererChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the flag that controls whether or not the renderer draws error bars for the y-values and,
   * if the flag changes, sends a {@link RendererChangeEvent} to all registered listeners.
   *
   * @param draw the flag value.
   * @see #getDrawYError()
  ...
  /**
   * Sets the length of the cap at the end of the error bars, and sends a {@link
  ...
  /**
   * Returns the paint used to draw the error bars. If this is {@code null} (the default), the item
  ...
  /**
   * Sets the paint used to draw the error bars and sends a {@link RendererChangeEvent} to all
  ...
  /**
   * Returns the stroke used to draw the error bars. If this is {@code null} (the default), the item
   * outline stroke is used instead.
   *
  ...
  /**
   * Sets the stroke used to draw the error bars and sends a {@link RendererChangeEvent} to all
   * registered listeners.
   *
  ...
  /**
   * Returns the range required by this renderer to display all the domain values in the specified
   * dataset.
   *
   * @param dataset the dataset ({@code null} permitted).
   * @return The range, or {@code null} if the dataset is {@code null}.
   */
  @Override
  ...
  /**
   * Returns the range required by this renderer to display all the range values in the specified
   * dataset.
   *
   * @param dataset the dataset ({@code null} permitted).
   * @return The range, or {@code null} if the dataset is {@code null}.
