...
/**
 * Standard item renderer for an {@link XYPlot}. This class can draw (a) shapes at each point, or
 * (b) lines between points, or (c) both shapes and lines.
 *
 * <p>This renderer has been retained for historical reasons and, in general, you should use the
...
public class StandardXYItemRenderer extends AbstractXYItemRenderer
  ...
  /**
   * The shape that is used to represent a line in the legend. This should never be set to {@code
   * null}.
   */
  ...
  /**
   * Constructs a new renderer. To specify the type of renderer, use one of the constants: {@link
   * #SHAPES}, {@link #LINES} or {@link #SHAPES_AND_LINES}.
   *
   * @param type the type.
   */
   ...
   * @param toolTipGenerator the item label generator ({@code null} permitted).
   */
  ...
  /**
   * Sets the base 'shapes filled' flag and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
   * @param flag the flag.
  ...
  /**
   * Sets the flag that controls whether or not a line is plotted between each data point and sends
  ...
  /**
   * Sets the gap threshold type and sends a {@link RendererChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the gap threshold for discontinuous lines and sends a {@link RendererChangeEvent} to all
   * registered listeners.
   *
  ...
  /**
   * Returns the hotspot of the image used to draw a single data item. The hotspot is the point
   * relative to the top left of the image that should indicate the data item. The default is the
   * center of the image.
   *
   * @param plot the plot (can be used to obtain standard color information etc).
   ...
   */
  protected Point getImageHotspot(
      Plot plot, int series, int item, double x, double y, Image image) {
