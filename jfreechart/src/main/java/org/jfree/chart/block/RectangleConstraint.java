...
public class RectangleConstraint {
  ...
  public static final RectangleConstraint NONE =
      new RectangleConstraint(
          0.0, null, LengthConstraintType.NONE, 0.0, null, LengthConstraintType.NONE);
  ...
  /**
   * Returns a constraint that matches this one on the height attributes, but has no width
   * constraint.
   *
  ...
  /**
   * Returns a constraint that matches this one on the width attributes, but has no height
   * constraint.
   *
   * @return A new constraint.
   */
  ...
  /**
   * Returns a constraint that matches this one on the height attributes, but has a fixed width
   * constraint.
   *
  ...
  public RectangleConstraint toFixedWidth(double width) {
    return new RectangleConstraint(width, this.widthRange, this.height, this.heightRange);
  }

  /**
   * Returns a constraint that matches this one on the width attributes, but has a fixed height
   * constraint.
   *
  ...
  /**
   * Returns a constraint that matches this one on the height attributes, but has a range width
   * constraint.
   *
  ...
  /**
   * Returns a constraint that matches this one on the width attributes, but has a range height
   * constraint.
   *
  ...
  public String toString() {
    return "RectangleConstraint["
        + this.widthConstraintType.toString()
        + ": width="
        + this.width
        + ", height="
        + this.height
