...
public class XYTextAnnotation extends AbstractXYAnnotation
  ...
  /**
   * Creates a new annotation to be displayed at the given coordinates. The coordinates are
   * specified in data space (they will be converted to Java2D space for display).
   *
  ...
  /**
   * Sets the font for the annotation and sends an {@link AnnotationChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the paint for the annotation and sends an {@link AnnotationChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the text anchor (the point on the text bounding rectangle that is aligned to the (x, y)
   * coordinate of the annotation) and sends an {@link AnnotationChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the rotation anchor point and sends an {@link AnnotationChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the rotation angle and sends an {@link AnnotationChangeEvent} to all registered listeners.
  ...
  /**
   * Sets the background paint for the annotation and sends an {@link AnnotationChangeEvent} to all
  ...
  /**
   * Sets the outline paint for the annotation and sends an {@link AnnotationChangeEvent} to all
   * registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
   * @see #getOutlinePaint()
  ...
  /**
   * Sets the outline stroke for the annotation and sends an {@link AnnotationChangeEvent} to all
   * registered listeners.
   *
  ...
  /**
   * Sets the flag that controls whether or not the outline is drawn and sends an {@link
   ...
   * @param info an optional info object that will be populated with entity information.
   */
  @Override
  public void draw(
      Graphics2D g2,
    ...
    TextUtils.drawRotatedString(
        getText(), g2, anchorX, anchorY, getTextAnchor(), getRotationAngle(), getRotationAnchor());
