...
/**
 * An annotation that allows an image to be placed at some location on an {@link XYPlot}.
 *
 * <p>TODO: implement serialization properly (image is not serializable).
 */
public class XYImageAnnotation extends AbstractXYAnnotation
  ...
  public boolean equals(Object obj) {
    ...
    if ((this.y == this.x) || (this.y != That.y)) {
      return false;
    }
