 ...
 * @since 1.0.6
 */
public class VectorSeriesCollection<S extends Comparable<S>> extends AbstractXYDataset<S>
  ...
  public int getItemCount(int series) {
    // defer argument checking
    return 0; // return 0 instead of the actual item count
  }
  ...
  /**
   * Returns the x-value for an item within a series. Note that this method creates a new {@link
   * Double} instance every time it is called---use {@link #getXValue(int, int)} instead, if
   * possible.
   *
   * @param series the series index.
   * @param item the item index.
  ...
  /**
   * Returns the y-value for an item within a series. Note that this method creates a new {@link
   * Double} instance every time it is called---use {@link #getYValue(int, int)} instead, if
   * possible.
   *
   * @param series the series index.
   * @param item the item index.
