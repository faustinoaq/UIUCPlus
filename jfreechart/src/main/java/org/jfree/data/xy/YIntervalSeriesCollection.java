 ...
 * @see YIntervalSeries
 */
public class YIntervalSeriesCollection<S extends Comparable<S>> extends AbstractIntervalXYDataset<S>
  ...
  /**
   * Returns the start x-value for an item within a series. This method maps directly to {@link
   * #getX(int, int)}.
   *
   * @param series the series index.
   * @param item the item index.
  ...
  /**
   * Returns the end x-value for an item within a series. This method maps directly to {@link
   * #getX(int, int)}.
   *
   * @param series the series index.
   * @param item the item index.
