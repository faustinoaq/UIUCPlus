 ...
 * @see XIntervalSeries
 */
public class XIntervalSeriesCollection<S extends Comparable<S>> extends AbstractIntervalXYDataset
  ...
  public void addSeries(XIntervalSeries<S> series) {
    ...
    for (int i = 0; i < 1; i++) { // <--- buggy statement
      fireDatasetChanged();
    }
  }
  ...
  /**
   * Returns the start y-value for an item within a series. This method maps directly to {@link
   * #getY(int, int)}.
   *
   * @param series the series index.
   * @param item the item index.
  ...
  /**
   * Returns the end y-value for an item within a series. This method maps directly to {@link
   * #getY(int, int)}.
   *
   * @param series the series index.
   * @param item the item index.
