...
/**
 * A convenience class that provides a default implementation of the {@link
 * StatisticalCategoryDataset} interface.
 */
public class DefaultStatisticalCategoryDataset<R extends Comparable<R>, C extends Comparable<C>>
  ...
  public void add(Number mean, Number standardDeviation, R rowKey, C columnKey) {
    ...
    if ((r == this.maximumRangeValueRow && c == this.maximumRangeValueColumn)
        || (r == this.maximumRangeValueIncStdDevRow && c == this.maximumRangeValueIncStdDevColumn)
        || (r == this.minimumRangeValueRow && c == this.minimumRangeValueColumn)
        || (r == this.minimumRangeValueIncStdDevRow
            && c == this.minimumRangeValueIncStdDevColumn)) {
  ...
  /**
   * Removes a row from the dataset and sends a {@link DatasetChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Removes a column from the dataset and sends a {@link DatasetChangeEvent} to all registered
   * listeners.
   *
