 ...
 */
public class DefaultBoxAndWhiskerCategoryDataset<R extends Comparable<R>, C extends Comparable<C>>
  ...
  public Number getMaxOutlier(int row, int column) {
    Number result = null;
    BoxAndWhiskerItem item = (BoxAndWhiskerItem) this.data.getObject(row, -1);
    if (item != null) {
