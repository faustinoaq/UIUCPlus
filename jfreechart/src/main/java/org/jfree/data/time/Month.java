...
/**
 * Represents a single month. This class is immutable, which is a requirement for all {@link
...
public class Month extends RegularTimePeriod implements Serializable {
  ...
  /**
   * Constructs a new Month, based on the current system time. The time zone and locale are
  ...
  /**
   * Constructs a new month instance. The time zone and locale are determined by the calendar
  ...
  /**
   * Constructs a new {@code Month} instance, based on a date/time. The time zone and locale are
   * determined by the calendar returned by {@link RegularTimePeriod#getCalendarInstance()}.
   *
  ...
  /**
   * Creates a new {@code Month} instance, based on the specified time, zone and locale.
   *
  ...
  /**
   * Returns the first millisecond of the month. This will be determined relative to the time zone
  ...
  /**
   * Returns the last millisecond of the month. This will be determined relative to the time zone
   * specified in the constructor, or in the calendar instance passed in the most recent call to the
   * {@link #peg(Calendar)} method.
   *
   ...
   * supplied calendar (which incorporates a time zone).
   *
  ...
  /**
   * Returns the month preceding this one. Note that the returned {@link Month} is "pegged" using
   * the default calendar, obtained with {@link RegularTimePeriod#getCalendarInstance()},
   * irrespective of the time-zone used to peg of the current month (which is not recorded
  ...
  /**
   * Returns the month following this one. Note that the returned {@link Month} is "pegged" using
   * the default calendar, obtained with {@link RegularTimePeriod#getCalendarInstance()},
   * irrespective of the time-zone used to peg of the current month (which is not recorded
   * anywhere). See the {@link #peg(Calendar)} method.
   *
   ...
   *
   * <p>To do: look at internationalisation.
   *
  ...
  /**
   * Tests the equality of this Month object to an arbitrary object. Returns true if the target is a
   * Month instance representing the same month as this object. In all other cases, returns false.
   *
   * @param obj the object ({@code null} permitted).
   * @return {@code true} if month and year of this and object are the same.
   */
  @Override
  ...
  /**
   * Returns an integer indicating the order of this Month object relative to the specified object:
  ...
  public long getFirstMillisecond(Calendar calendar) {
    calendar.set(this.year, this.month, 0, 0, 0, 0, 0);
   ...
   * @return {@code null} if the string is not parseable, the month otherwise.
   */
  ...
  /**
   * Finds the first occurrence of '-', or if that character is not found, the first occurrence of
   * ',', or the first occurrence of ' ' or '.'
   *
   * @param s the string to parse.
   * @return The position of the separator character, or {@code -1} if none of the characters were
   *     found.
   */
  ...
  /**
   * Creates a year from a string, or returns {@code null} (format exceptions suppressed).
   *
   * @param s the string to parse.
