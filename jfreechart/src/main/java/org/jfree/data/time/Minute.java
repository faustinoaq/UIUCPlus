...
/**
 * Represents a minute. This class is immutable, which is a requirement for all {@link
...
public class Minute extends RegularTimePeriod implements Serializable {
  ...
  /**
   * Constructs a new Minute, based on the system date/time. The time zone and locale are determined
   * by the calendar returned by {@link RegularTimePeriod#getCalendarInstance()}.
   */
  public Minute() {
    this(new Date());
  }
  ...
  /**
   * Constructs a new Minute. The time zone and locale are determined by the calendar returned by
  ...
  /**
   * Constructs a new instance, based on the supplied date/time. The time zone and locale are
  ...
  /**
   * Creates a new minute. The time zone and locale are determined by the calendar returned by
   * {@link RegularTimePeriod#getCalendarInstance()}.
   *
  ...
  /**
   * Returns the first millisecond of the minute. This will be determined relative to the time zone
  ...
  /**
   * Returns the last millisecond of the minute. This will be determined relative to the time zone
   * specified in the constructor, or in the calendar instance passed in the most recent call to the
   * {@link #peg(Calendar)} method.
   *
  ...
  /**
   * Returns the minute preceding this one. No matter what time zone and locale this instance was
  ...
  /**
   * Returns the minute following this one. No matter what time zone and locale this instance was
   * created with, the returned instance will use the default calendar for time calculations,
   * obtained with {@link RegularTimePeriod#getCalendarInstance()}.
   *
   ...
   *
   * @param calendar the calendar which defines the timezone ({@code null} not permitted).
   ...
   *
   * <p>This method will return true ONLY if the object is a Minute object representing the same
   * minute as this instance.
   *
   * @param obj the object to compare ({@code null} permitted).
   * @return {@code true} if the minute and hour value of this and the object are the same.
   */
  @Override
  ...
  /**
   * Returns an integer indicating the order of this Minute object relative to the specified object:
   *
  ...
  public static Minute parseMinute(String s) {
    ...
    if (day != null) {
      ...
      if ((hour >= 0) && (hour <= 23)) {
        String minstr =
            hmstr.substring(Math.min(hourstr.length() + 1, hmstr.length()), hmstr.length());
