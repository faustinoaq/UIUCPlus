...
/**
 * A JSON object. Key value pairs are unordered. <br>
 * <br>
 * This class is for internal use by JFreeChart, it is not part of the supported API and you should
 * not call it directly. If you need JSON support in your project you should include JSON.simple
 * (https://code.google.com/p/json-simple/) or some other JSON library directly in your project.
 */
public class JSONObject extends HashMap implements Map, JSONAware, JSONStreamAware {
  ...
  /**
   * Encode a map into JSON text and write it to out. If this map is also a {@link JSONAware} or
   * {@link JSONStreamAware}, {@code JSONAware} or {@code JSONStreamAware} specific behaviours will
   * be ignored at this top level.
   *
  ...
  /**
   * Convert a map to JSON text. The result is a JSON object. If this map is also a {@link
   * JSONAware}, {@code JSONAware} specific behaviours will be omitted at this top level.
   *
