...
/**
 * A {@link CategoryDataset} implementation that presents a subset of the categories in an
...
public class SlidingCategoryDataset<R extends Comparable<R>, C extends Comparable<C>>
  ...
  /**
   * Tests this {@code SlidingCategoryDataset} for equality with an arbitrary object.
   *
