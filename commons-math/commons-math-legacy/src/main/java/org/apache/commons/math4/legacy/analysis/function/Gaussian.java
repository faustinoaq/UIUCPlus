...
/**
 * <a href="http://en.wikipedia.org/wiki/Gaussian_function">Gaussian</a> function.
 *
 * @since 3.0
 */
public class Gaussian implements UnivariateDifferentiableFunction {
  ...
  /**
   * Parametric function where the input array contains the parameters of the Gaussian. Ordered as
   * follows:
   *
   * <ul>
   *   <li>Norm
