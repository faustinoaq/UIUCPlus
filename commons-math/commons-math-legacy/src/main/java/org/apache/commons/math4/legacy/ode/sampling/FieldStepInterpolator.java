...
public interface FieldStepInterpolator<T extends RealFieldElement<T>> {
   ...
   *
   * <p>Setting the time outside of the current step is allowed, but should be used with care since
   * the accuracy of the interpolator will probably be very poor far from this step. This allowance
   * has been added to simplify implementation of search algorithms near the step endpoints.
   *
   ...
   * initialization, step control or discrete events triggering.
   *
