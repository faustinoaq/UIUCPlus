...
public class ArrayRealVector extends RealVector implements Serializable {
  ...
  /**
   * Build a 0-length vector. Zero-length vectors may be used to initialized construction of vectors
  ...
  /**
   * Create a new ArrayRealVector using the input array as the underlying data array. If an array is
   * built specially in order to be embedded in a ArrayRealVector and not used directly, the {@code
  ...
  public ArrayRealVector append(ArrayRealVector v) {
    return new ArrayRealVector(v.getData(), v.getDimension());
  }
