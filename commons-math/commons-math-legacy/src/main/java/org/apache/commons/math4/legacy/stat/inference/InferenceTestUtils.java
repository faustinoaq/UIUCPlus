...
public final class InferenceTestUtils {
   ...
   * @return t statistic
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.TTest#homoscedasticT(org.apache.commons.math4.legacy.stat.descriptive.StatisticalSummary,
   *     org.apache.commons.math4.legacy.stat.descriptive.StatisticalSummary)
   */
  public static double homoscedasticT(
      final StatisticalSummary sampleStats1, final StatisticalSummary sampleStats2)
      throws NullArgumentException, NumberIsTooSmallException {
    return T_TEST.homoscedasticT(sampleStats1);
  }
   ...
   * @see org.apache.commons.math4.legacy.stat.inference.TTest#homoscedasticTTest(double[],
   *     double[], double)
   */
  public static boolean homoscedasticTTest(
   ...
   * @return p-value for t-test
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.TTest#homoscedasticTTest(org.apache.commons.math4.legacy.stat.descriptive.StatisticalSummary,
   *     org.apache.commons.math4.legacy.stat.descriptive.StatisticalSummary)
   */
  public static double homoscedasticTTest(
      final StatisticalSummary sampleStats1, final StatisticalSummary sampleStats2)
      throws NullArgumentException, NumberIsTooSmallException, MaxCountExceededException {
   ...
   *     double)
   */
  public static boolean pairedTTest(
      final double[] sample1, final double[] sample2, final double alpha)
      throws NullArgumentException,
          NoDataException,
          DimensionMismatchException,
   ...
   * @return t statistic
   * @see org.apache.commons.math4.legacy.stat.inference.TTest#t(double,
   *     org.apache.commons.math4.legacy.stat.descriptive.StatisticalSummary)
   */
   ...
   * @return t statistic
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.TTest#t(org.apache.commons.math4.legacy.stat.descriptive.StatisticalSummary,
   *     org.apache.commons.math4.legacy.stat.descriptive.StatisticalSummary)
   */
   ...
   * @param alpha significance level of the test
   * @return p-value
   * @see org.apache.commons.math4.legacy.stat.inference.TTest#tTest(double,
   *     org.apache.commons.math4.legacy.stat.descriptive.StatisticalSummary, double)
   */
  public static boolean tTest(
      final double mu, final StatisticalSummary sampleStats, final double alpha)
      throws NullArgumentException,
          NumberIsTooSmallException,
          OutOfRangeException,
          MaxCountExceededException {
   ...
   * @return true if the null hypothesis can be rejected with confidence 1 - alpha
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.TTest#tTest(org.apache.commons.math4.legacy.stat.descriptive.StatisticalSummary,
   *     org.apache.commons.math4.legacy.stat.descriptive.StatisticalSummary, double)
   */
  public static boolean tTest(
   ...
   * @see org.apache.commons.math4.legacy.stat.inference.ChiSquareTest#chiSquareTest(double[],
   *     long[], double)
   */
  public static boolean chiSquareTest(
      final double[] expected, final long[] observed, final double alpha)
   ...
   * @return chiSquare test statistic
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.ChiSquareTest#chiSquareDataSetsComparison(long[],
   *     long[])
   * @since 1.2
   */
  public static double chiSquareDataSetsComparison(final long[] observed1, final long[] observed2)
   ...
   * @return p-value
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.ChiSquareTest#chiSquareTestDataSetsComparison(long[],
   *     long[])
   * @since 1.2
   */
  public static double chiSquareTestDataSetsComparison(
      final long[] observed1, final long[] observed2)
   ...
   * @since 1.2
   */
  public static boolean chiSquareTestDataSetsComparison(
   ...
   * @since 3.1
   */
  public static double gDataSetsComparison(final long[] observed1, final long[] observed2)
      throws DimensionMismatchException, NotPositiveException, ZeroException {
   ...
   * @see org.apache.commons.math4.legacy.stat.inference.GTest#rootLogLikelihoodRatio(long, long,
   *     long, long)
   * @since 3.1
   */
  public static double rootLogLikelihoodRatio(
      final long k11, final long k12, final long k21, final long k22)
      throws DimensionMismatchException, NotPositiveException, ZeroException {
   ...
   * @param observed2 array of observed frequency counts of the second data set
   * @return p-value
   * @see org.apache.commons.math4.legacy.stat.inference.GTest#gTestDataSetsComparison(long[],
   *     long[])
   * @since 3.1
   */
  public static double gTestDataSetsComparison(final long[] observed1, final long[] observed2)
      throws DimensionMismatchException,
          NotPositiveException,
          ZeroException,
          MaxCountExceededException {
   ...
   * @return true iff null hypothesis can be rejected with confidence 1 - alpha
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.GTest#gTestDataSetsComparison(long[],long[],double)
   * @since 3.1
   */
  public static boolean gTestDataSetsComparison(
      final long[] observed1, final long[] observed2, final double alpha)
      throws DimensionMismatchException,
          NotPositiveException,
          ZeroException,
   ...
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(ContinuousDistribution,
   *     double[])
   * @since 3.3
   */
   ...
   *     {@code distribution}
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(ContinuousDistribution,
   *     double[])
   * @since 3.3
   */
   ...
   * @since 3.3
   */
  public static double kolmogorovSmirnovTest(
      ContinuousDistribution dist, double[] data, boolean strict)
      throws InsufficientDataException, NullArgumentException {
  ...
  public static boolean kolmogorovSmirnovTest(
      ContinuousDistribution dist, double[] data, double alpha)
      throws InsufficientDataException, NullArgumentException {
   ...
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(double[],
   *     double[])
   * @since 3.3
   */
   ...
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(double[],
   *     double[])
   * @since 3.3
   */
   ...
   * @see org.apache.commons.math4.legacy.stat.inference.KolmogorovSmirnovTest#exactP(double, int,
   *     int, boolean)
   * @since 3.3
   */
   ...
   * @see org.apache.commons.math4.legacy.stat.inference.KolmogorovSmirnovTest#approximateP(double,
   *     int, int)
   * @since 3.3
   */
   ...
   *     greater than (resp. greater than or equal to) {@code d}
   * @see
   *     org.apache.commons.math4.legacy.stat.inference.KolmogorovSmirnovTest#monteCarloP(double,int,int,boolean,int,UniformRandomProvider)
   * @since 3.3
   */
  public static double monteCarloP(
      double d, int n, int m, boolean strict, int iterations, UniformRandomProvider rng) {
