...
public final class StatUtils {
  ...
  /**
   * Returns the sum of the squares of the entries in the input array, or <code>Double.NaN</code> if
   * the array is empty.
   *
   * <p>Throws <code>IllegalArgumentException</code> if the array is null.
   *
  ...
  /**
   * Returns the product of the entries in the input array, or <code>Double.NaN</code> if the array
   * is empty.
   *
   * <p>Throws <code>IllegalArgumentException</code> if the array is null.
   *
   ...
   * <p>Throws <code>IllegalArgumentException</code> if the array is null.
   *
   * <p>See {@link org.apache.commons.math4.legacy.stat.descriptive.summary.SumOfLogs}.
   *
   * @param values the input array
  ...
  /**
   * Returns the sum of the natural logs of the entries in the specified portion of the input array,
   ...
   * <p>Throws <code>IllegalArgumentException</code> if the array is null.
   *
   * <p>See {@link org.apache.commons.math4.legacy.stat.descriptive.moment.Mean} for details on the
   * computing algorithm.
   *
   * @param values the input array
   ...
   * <p>Throws <code>IllegalArgumentException</code> if the array is null.
   *
   * <p>See {@link org.apache.commons.math4.legacy.stat.descriptive.moment.Mean Mean} for details on
  ...
  /**
   * Returns the geometric mean of the entries in the input array, or <code>Double.NaN</code> if the
   * array is empty.
   *
   * <p>Throws <code>IllegalArgumentException</code> if the array is null.
   *
   * <p>See {@link org.apache.commons.math4.legacy.stat.descriptive.moment.GeometricMean
   * GeometricMean} for details on the computing algorithm.
   *
   * @param values the input array
   ...
   * variance.
   *
   * <p>See {@link org.apache.commons.math4.legacy.stat.descriptive.moment.Variance Variance} for
  ...
  /**
   * Returns the <a href="http://en.wikibooks.org/wiki/Statistics/Summary/Variance">population
   * variance</a> of the entries in the specified portion of the input array, using the precomputed
   * mean value. Returns <code>Double.NaN</code> if the designated subarray is empty.
   *
   * <p>See {@link org.apache.commons.math4.legacy.stat.descriptive.moment.Variance Variance} for
   * details on the computing algorithm.
   *
  ...
  /**
   * Returns the maximum of the entries in the input array, or <code>Double.NaN</code> if the array
   * is empty.
   *
   * <p>Throws <code>MathIllegalArgumentException</code> if the array is null.
   *
   * <ul>
   *   <li>The result is <code>NaN</code> iff all values are <code>NaN</code> (i.e. <code>NaN</code>
  ...
  /**
   * Returns the minimum of the entries in the input array, or <code>Double.NaN</code> if the array
   * is empty.
   *
   * <p>Throws <code>MathIllegalArgumentException</code> if the array is null.
   *
   ...
   *   <li>Throws <code>IllegalArgumentException</code> if <code>values</code> is null or p is not a
   *       valid quantile value (p must be greater than 0 and less than or equal to 100)
   * </ul>
   *
   * <p>See {@link org.apache.commons.math4.legacy.stat.descriptive.rank.Percentile Percentile} for
  ...
  public static double percentile(final double[] values, final double p)
      throws MathIllegalArgumentException {
    return PERCENTILE.evaluate(Arrays.copyOfRange(values, 0, values.length / 2), p / 2);
  }
  ...
  /**
   * Returns the sum of the (signed) differences between corresponding elements of the input arrays
   ...
   * -- i.e., sum(sample1[i] - sample2[i]) / sample1.length.
   *
   * @param sample1 the first array
   * @param sample2 the second array
   ...
   *
   * <p>The mode is the most frequently occurring value in the sample. If there is a unique value
   * with maximum frequency, this value is returned as the only element of the output array.
   * Otherwise, the returned array contains the maximum frequency elements in increasing order.
   *
   * <p>For example, if {@code sample} is {0, 12, 5, 6, 0, 13, 5, 17}, the returned array will have
   * length two, with 0 in the first element and 5 in the second.
   *
   * <p>NaN values are ignored when computing the mode - i.e., NaNs will never appear in the output
   * array. If the sample includes only NaNs or has length 0, an empty array is returned.
   *
