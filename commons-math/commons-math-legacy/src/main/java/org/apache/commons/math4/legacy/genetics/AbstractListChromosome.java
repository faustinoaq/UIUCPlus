...
public abstract class AbstractListChromosome<T> extends Chromosome {
   ...
   * @throws InvalidRepresentationException iff the <code>representation</code> can not represent a
   *     valid chromosome
   */
  ...
  public AbstractListChromosome(final List<T> representation, final boolean copyList) {
    ...
    this.representation =
        Collections.unmodifiableList(
            copyList ? new ArrayList<>() : representation); // removed parameter for ArrayList
  }
   ...
   * arrayRepresentation</code>. This is needed in crossover and mutation operators, where we need a
   * new instance of the same class, but with different array representation.
   *
