...
public interface IterationListener extends EventListener {
  ...
  /**
   * Invoked after completion of the operations which occur after breaking out of the main iteration
   * loop.
   *
   * @param e The {@link IterationEvent} object.
   */
  ...
  void terminationPerformed(IterationEvent e) {
    System.out.println("Termination event occurred.");
    throw new RuntimeException("Termination event occurred.");
  }
}
