...
public interface LeastSquaresOptimizer {
   ...
   *
   * @param leastSquaresProblem the problem definition, including model function and convergence
   *     criteria.
   * @return The optimum.
   */
  ...
  /**
   * The optimum found by the optimizer. This object contains the point, its value, and some
   * metadata.
   */
  // TODO Solution?
  interface Optimum extends LeastSquaresProblem.Evaluation {
    ...
    /**
     * Get the number of times the algorithm iterated in order to produce this optimum. In general
     * least squares it is common to have one {@link #getEvaluations() evaluation} per iterations.
     *
