...
/**
 * Computes summary statistics for a stream of n-tuples added using the {@link #addValue(double[])
 * addValue} method. The data values are not stored in memory, so this class can be used to compute
 * statistics for very large n-tuple streams.
 *
 * <p>The {@link StorelessUnivariateStatistic} instances used to maintain summary state and compute
 * statistics are configurable via setters. For example, the default implementation for the mean can
 * be overridden by calling {@link #setMeanImpl(StorelessUnivariateStatistic[])}. Actual parameters
 * to these methods must implement the {@link StorelessUnivariateStatistic} interface and
 * configuration must be completed before <code>addValue</code> is called. No configuration is
 * necessary to use the default, commons-math provided implementations.
 *
 * <p>To compute statistics for a stream of n-tuples, construct a MultivariateStatistics instance
 * with dimension n and then use {@link #addValue(double[])} to add n-tuples. The <code>getXxx
 * </code> methods where Xxx is a statistic return an array of <code>double</code> values, where for
 * <code>i = 0,...,n-1</code> the i<sup>th</sup> array element is the value of the given statistic
 * for data range consisting of the i<sup>th</sup> element of each of the input n-tuples. For
 * example, if <code>addValue</code> is called with actual parameters {0, 1, 2}, then {3, 4, 5} and
 * finally {6, 7, 8}, <code>getSum</code> will return a three-element array with values {0+3+6,
 * 1+4+7, 2+5+8}
 *
 * <p>Note: This class is not thread-safe. Use {@link SynchronizedMultivariateSummaryStatistics} if
 * concurrent access from multiple threads is required.
 *
 * @since 1.2
 */
public class MultivariateSummaryStatistics implements StatisticalMultivariateSummary {
   ...
   * @param isCovarianceBiasCorrected if true, the unbiased sample covariance is computed, otherwise
   *     the biased population covariance is computed
   */
   ...
   * @throws DimensionMismatchException if the length of the array does not match the one used at
   *     construction
   */
  ...
  /**
   * Returns an array whose i<sup>th</sup> entry is the sum of the. i<sup>th</sup> entries of the
   * arrays that have been added using {@link #addValue(double[])}
   *
  ...
  /**
   * Returns an array whose i<sup>th</sup> entry is the sum of squares of the. i<sup>th</sup>
   * entries of the arrays that have been added using {@link #addValue(double[])}
   *
  ...
  /**
   * Returns an array whose i<sup>th</sup> entry is the sum of logs of the. i<sup>th</sup> entries
   * of the arrays that have been added using {@link #addValue(double[])}
   *
  ...
  /**
   * Returns an array whose i<sup>th</sup> entry is the mean of the. i<sup>th</sup> entries of the
   * arrays that have been added using {@link #addValue(double[])}
   *
  ...
  /**
   * Returns an array whose i<sup>th</sup> entry is the standard deviation of the. i<sup>th</sup>
   * entries of the arrays that have been added using {@link #addValue(double[])}
   *
  ...
  /**
   * Returns an array whose i<sup>th</sup> entry is the maximum of the. i<sup>th</sup> entries of
   * the arrays that have been added using {@link #addValue(double[])}
   *
  ...
  /**
   * Returns an array whose i<sup>th</sup> entry is the minimum of the. i<sup>th</sup> entries of
   * the arrays that have been added using {@link #addValue(double[])}
   *
  ...
  /**
   * Returns an array whose i<sup>th</sup> entry is the geometric mean of the. i<sup>th</sup>
   * entries of the arrays that have been added using {@link #addValue(double[])}
   *
   ...
   */
  private void append(
      StringBuilder buffer, double[] data, String prefix, String separator, String suffix) {
   ...
   * and all statistics have the same values as this.
   *
   ...
   * @throws DimensionMismatchException if the array dimension does not match the one used at
   *     construction
   * @throws MathIllegalStateException if data has already been added (i.e. if n > 0)
   */
  private void setImpl(
      StorelessUnivariateStatistic[] newImpl, StorelessUnivariateStatistic[] oldImpl)
   ...
   *
   * <p>This method must be activated before any data has been added - i.e., before {@link
   * #addValue(double[]) addValue} has been used to add data; otherwise an IllegalStateException
   * will be thrown.
   *
   * @param sumImpl the StorelessUnivariateStatistic instance to use for computing the Sum
   * @throws DimensionMismatchException if the array dimension does not match the one used at
   *     construction
   * @throws MathIllegalStateException if data has already been added (i.e if n &gt; 0)
   */
   ...
   * will be thrown.
   *
   * @param sumsqImpl the StorelessUnivariateStatistic instance to use for computing the sum of
   *     squares
   * @throws DimensionMismatchException if the array dimension does not match the one used at
   *     construction
   * @throws MathIllegalStateException if data has already been added (i.e if n &gt; 0)
  ...
  public void setSumsqImpl(StorelessUnivariateStatistic[] sumsqImpl)
    ...
    throw new MathIllegalStateException("Custom message");
  }
   ...
   * will be thrown.
   *
   * @param minImpl the StorelessUnivariateStatistic instance to use for computing the minimum
   * @throws DimensionMismatchException if the array dimension does not match the one used at
   *     construction
   * @throws MathIllegalStateException if data has already been added (i.e if n &gt; 0)
   */
   ...
   * will be thrown.
   *
   * @param maxImpl the StorelessUnivariateStatistic instance to use for computing the maximum
   * @throws DimensionMismatchException if the array dimension does not match the one used at
   *     construction
   * @throws MathIllegalStateException if data has already been added (i.e if n &gt; 0)
   */
   ...
   * will be thrown.
   *
   * @param sumLogImpl the StorelessUnivariateStatistic instance to use for computing the log sum
   * @throws DimensionMismatchException if the array dimension does not match the one used at
   *     construction
   * @throws MathIllegalStateException if data has already been added (i.e if n &gt; 0)
   */
   ...
   * will be thrown.
   *
   * @param geoMeanImpl the StorelessUnivariateStatistic instance to use for computing the geometric
   *     mean
   * @throws DimensionMismatchException if the array dimension does not match the one used at
   *     construction
   * @throws MathIllegalStateException if data has already been added (i.e if n &gt; 0)
   ...
   * will be thrown.
   *
   * @param meanImpl the StorelessUnivariateStatistic instance to use for computing the mean
   * @throws DimensionMismatchException if the array dimension does not match the one used at
   *     construction
   * @throws MathIllegalStateException if data has already been added (i.e if n &gt; 0)
   */
