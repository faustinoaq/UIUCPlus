...
public class OpenMapRealVector extends SparseRealVector implements Serializable {
  ...
  /**
   * Optimized method to add two OpenMapRealVectors. It copies the larger vector, then iterates over
   * the smaller.
   *
   ...
   * arbitrary calls to {@code setIndex} since the order in which entries are returned is undefined.
   */
