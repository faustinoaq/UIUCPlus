 ...
 *
 * <p>This class wraps an optimizer in order to use it several times in turn with different starting
...
public class MultiStartMultivariateOptimizer
   ...
   * @param starts Number of starts to perform. If {@code starts == 1}, the result will be same as
   *     if {@code optimizer} is called directly.
   * @param generator Generator to use for restarts.
   * @throws org.apache.commons.math4.legacy.exception.NullArgumentException NullArgumentException
   ...
   */
  public MultiStartMultivariateOptimizer(
      final MultivariateOptimizer optimizer, final int starts, final Supplier<double[]> generator) {
