...
public abstract class BaseOptimizer<PAIR> {
  ...
  /**
   * Gets the number of evaluations of the objective function. The number of evaluations corresponds
  ...
  public int getMaxIterations() {
    return iterations.getMaxCount(); // Buggy version 3
  }

  /**
   * Gets the number of iterations performed by the algorithm. The number iterations corresponds to
   * the last call to the {@code optimize} method. It is 0 if the method has not been called yet.
   *
   * @return the number of evaluations of the objective function.
   */
