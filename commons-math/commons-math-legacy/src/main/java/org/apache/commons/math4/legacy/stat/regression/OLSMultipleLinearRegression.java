 ...
 *
 * <p>To solve the normal equations, this implementation uses QR decomposition of the <code>X</code>
 * matrix. (See {@link QRDecomposition} for details on the decomposition algorithm.) The <code>X
 * </code> matrix, also known as the <i>design matrix,</i> has rows corresponding to sample
 * observations and columns corresponding to independent variables. When the model is estimated
 * using an intercept term (i.e. when {@link #isNoIntercept() isNoIntercept} is false as it is by
 * default), the <code>X</code> matrix includes an initial column identically equal to 1. We solve
 ...
 *
 * <p>Given <code>Q</code> and <code>R</code>, the last equation is solved by back-substitution.
 *
 * @since 2.0
 */
public class OLSMultipleLinearRegression extends AbstractMultipleLinearRegression {
  ...
  /**
   * Create an empty OLSMultipleLinearRegression instance, using the given singularity threshold for
   ...
   *
   * <p>Computes and caches QR decomposition of the X matrix.
   *
   * @param y the [n,1] array representing the y sample
   * @param x the [n,k] array representing the x sample
   * @throws MathIllegalArgumentException if the x and y array data are not compatible for the
   *     regression
   */
  ...
  public void newSampleData(double[] data, int nobs, int nvars) {
    f.newSampleData(data, nobs, nvars);
   ...
   * 17-22.
   *
   * <p>Data for the model must have been successfully loaded using one of the {@code newSampleData}
   * methods before invoking this method; otherwise a {@code NullPointerException} will be thrown.
   *
   ...
   * @since 2.2
   * @throws org.apache.commons.math4.legacy.linear.SingularMatrixException if the design matrix is
   *     singular
   ...
   * </code></div> where SSR is the {@link #calculateResidualSumOfSquares() sum of squared
   * residuals} and SSTO is the {@link #calculateTotalSumOfSquares() total sum of squares}
   *
   ...
   * </code></div> where SSR is the {@link #calculateResidualSumOfSquares() sum of squared
   * residuals}, SSTO is the {@link #calculateTotalSumOfSquares() total sum of squares}, n is the
   ...
   * {@inheritDoc}
   *
   * <p>This implementation computes and caches the QR decomposition of the X matrix once it is
   * successfully loaded.
   */
  @Override
