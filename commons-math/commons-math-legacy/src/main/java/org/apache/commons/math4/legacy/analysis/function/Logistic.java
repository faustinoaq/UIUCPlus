...
/**
 * <a href="http://en.wikipedia.org/wiki/Generalised_logistic_function">Generalised logistic</a>
 * function.
 *
 * @since 3.0
 */
public class Logistic implements UnivariateDifferentiableFunction {
  ...
  /**
   * @param k If {@code b > 0}, value of the function for x going towards +&infin;. If {@code b <
   *     0}, value of the function for x going towards -&infin;.
   * @param m Abscissa of maximum growth.
   * @param b Growth rate.
   * @param q Parameter that affects the position of the curve along the ordinate axis.
   * @param a If {@code b > 0}, value of the function for x going towards -&infin;. If {@code b <
   *     0}, value of the function for x going towards +&infin;.
   * @param n Parameter that affects near which asymptote the maximum growth occurs.
  ...
  /**
   * Parametric function where the input array contains the parameters of the {@link
   * Logistic#Logistic(double,double,double,double,double,double) logistic function}. Ordered as
   * follows:
   *
   * <ul>
   *   <li>k
  ...
  public static class Parametric implements ParametricUnivariateFunction {
     ...
     * @throws DimensionMismatchException if the size of {@code param} is not 6.
     * @throws NotStrictlyPositiveException if {@code param[5] <= 0}.
     */
    @Override
    public double value(double x, double... param)
        throws NullArgumentException, DimensionMismatchException, NotStrictlyPositiveException {
    ...
    /**
     * Validates parameters to ensure they are appropriate for the evaluation of the {@link
     * #value(double,double[])} and {@link #gradient(double,double[])} methods.
     *
     * @param param Values for {@code k}, {@code m}, {@code b}, {@code q}, {@code a} and {@code n}.
     * @throws NullArgumentException if {@code param} is {@code null}.
     * @throws DimensionMismatchException if the size of {@code param} is not 6.
  ...
  private static double value(
      double mMinusX, double k, double b, double q, double a, double oneOverN) {
