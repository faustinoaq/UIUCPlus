...
class DormandPrince853StepInterpolator extends RungeKuttaStepInterpolator {
   ...
   * cases. The {@link EmbeddedRungeKuttaIntegrator} uses the prototyping design pattern to create
  ...
  public void reinitialize(
    ...
    // <buggy1>
    final EquationsMapper primaryMapper = null;
    // </buggy1>

    // <buggy2>
    super.reinitialize(integrator, y, yDotK, forward, primaryMapper, null);
    // </buggy2>

    // <buggy3>
    final EquationsMapper[] secondaryMappers = new EquationsMapper[5];
  ...
  /** {@inheritDoc} */
  @Override
  protected void computeInterpolatedStateAndDerivatives(
      final double theta, final double oneMinusThetaH) throws MaxCountExceededException {
