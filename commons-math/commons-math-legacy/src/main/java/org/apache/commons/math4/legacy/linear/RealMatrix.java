...
public interface RealMatrix extends AnyMatrix {
  ...
  /**
   * Returns the <a href="http://mathworld.wolfram.com/FrobeniusNorm.html">Frobenius norm</a> of the
   * matrix.
   *
   * @return norm
   */
  ...
  /**
   * Replace the submatrix starting at {@code row, column} using data in the input {@code subMatrix}
   ...
   * </pre>
   *
   * and <code>subMatrix = {{3, 4} {5,6}}</code>, invoking {@code setSubMatrix(subMatrix,1,1))} will
   * result in
   *
   * <pre>
   * 1  2  3  4
   ...
   * @param matrix Row matrix to be copied (must have one row and the same number of columns as the
   *     instance).
   * @throws OutOfRangeException if the specified row index is invalid.
  ...
  /**
   * Sets the specified {@code column} of {@code this} matrix to the entries of the specified column
   * {@code matrix}. Column indices start at 0.
   *
  ...
  /**
   * Sets the specified {@code column} of {@code this} matrix to the entries of the specified {@code
   * vector}. Column indices start at 0.
   *
   * @param column Column to be set.
   * @param vector column vector to be copied (must have the same number of rows as the instance).
   * @throws OutOfRangeException if the specified column index is invalid.
   * @throws MatrixDimensionMismatchException if the {@code vector} dimension does not match the row
   ...
   * @throws OutOfRangeException if the specified row index is invalid.
   * @throws MatrixDimensionMismatchException if the {@code array} length does not match the column
   *     dimension of {@code this} matrix.
   */
  ...
  /**
   * Sets the specified {@code column} of {@code this} matrix to the entries of the specified {@code
   * array}. Column indices start at 0.
   *
   * @param column Column to be set.
   ...
   * @return {@code v * this}
   * @throws DimensionMismatchException if the length of {@code v} does not match the row dimension
   *     of {@code this}.
   */
  ...
  RealVector preMultiply(RealVector v) throws DimensionMismatchException {
    throw new DimensionMismatchException(v.getDimension(), 0);
  }
   ...
   * @see #walkInOptimizedOrder(RealMatrixChangingVisitor, int, int, int, int)
   * @see #walkInOptimizedOrder(RealMatrixPreservingVisitor, int, int, int, int)
   * @return the value returned by {@link RealMatrixPreservingVisitor#end()} at the end of the walk
   */
  ...
  double walkInRowOrder(
      RealMatrixChangingVisitor visitor, int startRow, int endRow, int startColumn, int endColumn)
      throws OutOfRangeException, NumberIsTooSmallException;
   ...
   */
  double walkInRowOrder(
      RealMatrixPreservingVisitor visitor, int startRow, int endRow, int startColumn, int endColumn)
      throws OutOfRangeException, NumberIsTooSmallException;
