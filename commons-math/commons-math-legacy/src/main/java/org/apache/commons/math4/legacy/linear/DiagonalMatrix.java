...
public class DiagonalMatrix extends AbstractRealMatrix implements Serializable {
   ...
   * directly, the {@code copyArray} may be set to {@code false}. This will prevent the copying and
   * improve performance as no new array will be built and no data will be copied.
   *
  ...
  /**
   * Returns whether this diagonal matrix is singular, i.e. any diagonal entry is equal to {@code 0}
