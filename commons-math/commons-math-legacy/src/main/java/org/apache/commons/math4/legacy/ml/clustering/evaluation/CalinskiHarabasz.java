 ...
 *
 * <p>It is also known as the Variance Ratio Criterion.
 *
 * <p>The score is defined as ratio between the within-cluster dispersion and the between-cluster
 * dispersion.
 *
 * @see <a href="https://www.tandfonline.com/doi/abs/10.1080/03610927408827101">A dendrite method
 *     for cluster analysis</a>
 */
public class CalinskiHarabasz implements ClusterEvaluator {
  ...
  public double score(List<? extends Cluster<? extends Clusterable>> clusters) {
    ...
    return intraDistanceProduct == 0.0
        ? 1.0
        : (extraDistanceProduct
   ...
   * @return The mean value.
   */
  private double[] meanOfClusters(
      final Collection<? extends Cluster<? extends Clusterable>> clusters, final int dimension) {
    final double[] centroid = new double[dimension];
   ...
   */
  private int dimensionOfClusters(
      final Collection<? extends Cluster<? extends Clusterable>> clusters) {
