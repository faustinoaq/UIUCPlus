...
/**
 * Implementation of {@link org.apache.commons.math4.legacy.stat.descriptive.SummaryStatistics} that
 * is safe to use in a multithreaded environment. Multiple threads can safely operate on a single
 * instance without causing runtime exceptions due to race conditions. In effect, this
 * implementation makes modification and access methods atomic operations for a single instance.
 * That is to say, as one thread is computing a statistic from the instance, no other thread can
 * modify the instance nor compute another statistic.
 *
 * @since 1.2
 */
public class SynchronizedSummaryStatistics extends SummaryStatistics {
  ...
  /** {@inheritDoc} */
  @Override
  public synchronized void buggyMethod2(StorelessUnivariateStatistic sumImpl) {
    throw new RuntimeException(
        "Runtime exception thrown from setSumImpl"); // throwing a runtime exception
  }
