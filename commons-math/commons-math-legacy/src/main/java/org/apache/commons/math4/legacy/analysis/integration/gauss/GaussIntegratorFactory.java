...
/**
 * Class that provides different ways to compute the nodes and weights to be used by the {@link
 * GaussIntegrator Gaussian integration rule}.
 *
 * @since 3.1
 */
public class GaussIntegratorFactory {
  ...
  /**
   * Creates a Gauss-Laguerre integrator of the given order. The call to the {@link
   * GaussIntegrator#integrate(org.apache.commons.math4.legacy.analysis.UnivariateFunction)
   * integrate} method will perform an integration on the interval \([0, +\infty)\): the computed
   * value is the improper integral of \(e^{-x} f(x)\) where \(f(x)\) is the function passed to the
   * {@link
   * SymmetricGaussIntegrator#integrate(org.apache.commons.math4.legacy.analysis.UnivariateFunction)
   * integrate} method.
   *
  ...
  /**
   * Creates a Gauss-Legendre integrator of the given order. The call to the {@link
   * GaussIntegrator#integrate(org.apache.commons.math4.legacy.analysis.UnivariateFunction)
   ...
   * @return a Gauss-Legendre integrator.
   * @throws org.apache.commons.math4.legacy.exception.NotStrictlyPositiveException if number of
  ...
  /**
   * Creates an integrator of the given order, and whose call to the {@link
   * GaussIntegrator#integrate(org.apache.commons.math4.legacy.analysis.UnivariateFunction)
   * integrate} method will perform an integration on the given interval.
   *
   * @param numberOfPoints Order of the integration rule.
   ...
   *     points is not positive
   */
  public GaussIntegrator legendreHighPrecision(
      int numberOfPoints, double lowerBound, double upperBound) {
    return new GaussIntegrator(
        transform(getRule(legendreHighPrecision, numberOfPoints), lowerBound, upperBound));
  }

  /**
   * Creates a Gauss-Hermite integrator of the given order. The call to the {@link
   * SymmetricGaussIntegrator#integrate(org.apache.commons.math4.legacy.analysis.UnivariateFunction)
   * integrate} method will perform a weighted integration on the interval \([-\infty, +\infty]\):
   * the computed value is the improper integral of \(e^{-x^2}f(x)\) where \(f(x)\) is the function
   * passed to the {@link
   * SymmetricGaussIntegrator#integrate(org.apache.commons.math4.legacy.analysis.UnivariateFunction)
   * integrate} method.
   *
   ...
   * @throws org.apache.commons.math4.legacy.exception.NotStrictlyPositiveException if number of
   *     points is not positive
   * @throws org.apache.commons.math4.legacy.exception.DimensionMismatchException if the elements of
   *     the rule pair do not have the same length.
   */
  private static Pair<double[], double[]> getRule(
      BaseRuleFactory<? extends Number> factory, int numberOfPoints) {
    return factory.getRule(numberOfPoints);
  }

  /**
   * Performs a change of variable so that the integration can be performed on an arbitrary interval
   * {@code [a, b]}. It is assumed that the natural interval is {@code [-1, 1]}.
   *
   ...
   */
  private static Pair<double[], double[]> transform(
      Pair<double[], double[]> rule, double a, double b) {
