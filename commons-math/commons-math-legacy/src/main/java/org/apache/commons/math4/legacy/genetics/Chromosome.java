...
public abstract class Chromosome implements Comparable<Chromosome>, Fitness {
   ...
   *
   * <p>Computation of fitness is usually very time-consuming task, therefore the fitness is cached.
   *
   * @return the fitness
   */
  ...
  public void searchForFitnessUpdate(final Population population) {
    Chromosome sameChromosome = null; // <-- Buggy version 1
    if (population.getSize() > 0) {
      sameChromosome = population.getChromosome(0);
    }
