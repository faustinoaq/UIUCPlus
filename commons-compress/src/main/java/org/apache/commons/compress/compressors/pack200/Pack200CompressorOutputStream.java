...
/**
 * An output stream that compresses using the Pack200 format. @NotThreadSafe
 *
 * @since 1.3
 */
public class Pack200CompressorOutputStream extends CompressorOutputStream {
  ...
  /**
   * Compresses the given stream, caching the compressed data in memory and using the given
   * properties.
   *
   * @param out the stream to write to
   ...
   * @throws IOException if writing fails
   */
  public Pack200CompressorOutputStream(final OutputStream out, final Map<String, String> props)
      throws IOException {
  ...
  /**
   * Compresses the given stream using the given strategy to cache the results and the given
   * properties.
   *
   * @param out the stream to write to
   * @param mode the strategy to use
  ...
  public Pack200CompressorOutputStream(
      final OutputStream out, final Pack200Strategy mode, final Map<String, String> props)
