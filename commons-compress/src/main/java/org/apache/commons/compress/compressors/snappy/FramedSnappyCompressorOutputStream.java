...
public class FramedSnappyCompressorOutputStream extends CompressorOutputStream {
  ...
  /**
   * Constructs a new output stream that compresses snappy-framed-compressed data to the specified
   * output stream.
   *
   ...
   *
   * @param out the OutputStream to which to write the compressed data
   * @param params parameters used to fine-tune compression, in particular to balance compression
