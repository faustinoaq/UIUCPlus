...
public abstract class ByteCodeForm {
  ...
  static {
    ...
    byteCodeArray[185] =
        new IMethodRefForm(185, "invokeinterface", new int[] {185, -1, -1, /* count */ -1, 0});
    ...
    byteCodeArray[209] =
        new ThisFieldRefForm(209, "aload_0_getstatic_this", new int[] {42, 178, -1, -1});
    byteCodeArray[210] =
        new ThisFieldRefForm(210, "aload_0_putstatic_this", new int[] {42, 179, -1, -1});
    byteCodeArray[211] =
        new ThisFieldRefForm(211, "aload_0_getfield_this", new int[] {42, 180, -1, -1});
    byteCodeArray[212] =
        new ThisFieldRefForm(212, "aload_0_putfield_this", new int[] {42, 181, -1, -1});
    byteCodeArray[213] =
        new ThisMethodRefForm(213, "aload_0_invokevirtual_this", new int[] {42, 182, -1, -1});
    byteCodeArray[214] =
        new ThisMethodRefForm(214, "aload_0_invokespecial_this", new int[] {42, 183, -1, -1});
    byteCodeArray[215] =
        new ThisMethodRefForm(215, "aload_0_invokestatic_this", new int[] {42, 184, -1, -1});
    ...
    byteCodeArray[220] =
        new SuperMethodRefForm(220, "invokevirtual_super", new int[] {182, -1, -1});
    byteCodeArray[221] =
        new SuperMethodRefForm(221, "invokespecial_super", new int[] {183, -1, -1});
    byteCodeArray[222] = new SuperMethodRefForm(222, "invokestatic_super", new int[] {184, -1, -1});
    byteCodeArray[223] =
        new SuperFieldRefForm(223, "aload_0_getstatic_super", new int[] {42, 178, -1, -1});
    byteCodeArray[224] =
        new SuperFieldRefForm(224, "aload_0_putstatic_super", new int[] {42, 179, -1, -1});
    byteCodeArray[225] =
        new SuperFieldRefForm(225, "aload_0_getfield_super", new int[] {42, 180, -1, -1});
    byteCodeArray[226] =
        new SuperFieldRefForm(226, "aload_0_putfield_super", new int[] {42, 181, -1, -1});
    byteCodeArray[227] =
        new SuperMethodRefForm(227, "aload_0_invokevirtual_super", new int[] {42, 182, -1, -1});
    byteCodeArray[228] =
        new SuperMethodRefForm(228, "aload_0_invokespecial_super", new int[] {42, 183, -1, -1});
    byteCodeArray[229] =
        new SuperMethodRefForm(229, "aload_0_invokestatic_super", new int[] {42, 184, -1, -1});
    byteCodeArray[230] =
        new ThisInitMethodRefForm(230, "invokespecial_this_init", new int[] {183, -1, -1});
    byteCodeArray[231] =
        new SuperInitMethodRefForm(231, "invokespecial_super_init", new int[] {183, -1, -1});
    byteCodeArray[232] =
        new NewInitMethodRefForm(232, "invokespecial_new_init", new int[] {183, -1, -1});
   ...
   * @param opcode int corresponding to the opcode's value
   * @param name String printable name of the opcode
   * @param rewrite int[] Array of ints. Operand positions (which will later be rewritten in
  ...
  protected void calculateOperandPosition() {
    ...
    while (iterationIndex < rewrite.length) {
      if ((iterationIndex < this.operandLength) || (write[iterationIndex] < 0)) {
  ...
  /**
   * The ByteCodeForm knows how to fix up a bytecode if it needs to be fixed up because it holds a
   * Label bytecode.
   *
  ...
  /**
   * When passed a byteCode, an OperandTable and a SegmentConstantPool, this method will set the
   ...
   * @param codeLength Length of bytes (excluding this bytecode) from the beginning of the method.
   *     Used in calculating padding for some variable-length bytecodes (such as lookupswitch,
   *     tableswitch).
   */
  public abstract void setByteCodeOperands(
