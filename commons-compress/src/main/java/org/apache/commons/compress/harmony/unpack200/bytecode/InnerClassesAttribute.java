...
public class InnerClassesAttribute extends Attribute {
  ...
  private static class InnerClassesEntry {
    ...
    public InnerClassesEntry(
        final CPClass innerClass,
        final CPClass outerClass,
        final CPUTF8 innerName,
        final int flags) {
    ...
    /**
     * Determine the indices of the things in the receiver which point to elements of the
     * ClassConstantPool
     *
  ...
  public void addInnerClassesEntry(
      final CPClass innerClass, final CPClass outerClass, final CPUTF8 innerName, final int flags) {
    if (innerClass != null) {
