...
public class BlockLZ4CompressorInputStream extends AbstractLZ77CompressorInputStream {
  ...
  /**
   * @return false if there is no more back-reference - this means this is the last block of the
   *     stream.
   */
  ...
  private long readSizeBytes() throws IOException {
    ...
    do {
      ...
      if ((max < BlockLZ4CompressorInputStream.LITERAL_SIZE_MASK) || (nextByte == -1)) {
