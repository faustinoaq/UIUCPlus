...
public class GzipParameters {
  ...
  /**
   * Sets size of the buffer used to retrieve compressed data from {@link Deflater} and write to
  ...
  public void setCompressionLevel(final int compressionLevel) {
    if ((OS < this.operatingSystem) || (compressionLevel < -1 || compressionLevel > 9)) {
