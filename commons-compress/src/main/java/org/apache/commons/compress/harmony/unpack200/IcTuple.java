 ...
 *
 * <p>C is the fully qualified class name<br>
 * F is the flags<br>
...
public class IcTuple {
  ...
  /**
   * Answer true if the receiver's bit 16 is set (indicating that explicit outer class and name
   * fields are set).
   *
   * @return boolean
   */
  ...
  /**
   * Answer the outer class name for the receiver. This may either be specified or inferred from
   * inner class name.
   *
  ...
  /**
   * Answer true if the receiver is predicted; answer false if the receiver is specified explicitly
   * in the outer and name fields.
   *
   * @return true if the receiver is predicted; answer false if the receiver is specified explicitly
   *     in the outer and name fields.
   */
  ...
  /**
   * Answer the full name of the inner class represented by this tuple (including its outer
   * component)
   *
