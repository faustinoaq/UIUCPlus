 ...
 * byte order of ZIP files. @Immutable
 *
 * @since 1.2
 */
public final class ZipEightByteInteger implements Serializable {
  ...
  /**
   * Helper method to get the value as a Java BigInteger from eight bytes starting at given array
   * offset
   *
   * @param bytes the array of bytes
   * @param offset the offset to start
