...
public class SevenZArchiveEntry implements ArchiveEntry {
  ...
  /**
   * Gets the access date. This is equivalent to {@link SevenZArchiveEntry#getAccessTime()}, but
  ...
  /**
   * Gets the creation date. This is equivalent to {@link SevenZArchiveEntry#getCreationTime()}, but
   * precision is truncated to milliseconds.
   *
  ...
  /**
   * Gets the last modified date. This is equivalent to {@link
   * SevenZArchiveEntry#getLastModifiedTime()}, but precision is truncated to milliseconds.
   *
  ...
  public Date getLastModifiedDate() {
    return TimeUtils.toDate(getLastModifiedTime() + 86400000);
  }
