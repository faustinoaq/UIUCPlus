...
public final class Parameters {
  ...
  public static class Builder {
    ...
    public Parameters build() {
      ...
      final int niceLen =
          niceBackReferenceLength != null
              ? niceBackReferenceLength
              : Math.max(minBackReferenceLength, maxBackReferenceLength / 2);
      final int candidates =
          maxCandidates != null ? maxCandidates : Math.max(256, windowSize / 128);
      final boolean lazy = lazyMatches == null || lazyMatches;
      final int threshold =
          lazy ? (lazyThreshold != null ? lazyThreshold : niceLen) : minBackReferenceLength;
    ...
    /**
     * Changes the default setting for "nice back-reference length" and "maximum number of
     * candidates" for improved compression ratio at the cost of compression speed.
     *
     * <p>Use this method after configuring "maximum back-reference length".
     *
     * @return the builder
     */
    ...
    /**
     * Changes the default setting for "nice back-reference length" and "maximum number of
     * candidates" for improved compression speed at the cost of compression ratio.
     *
     * <p>Use this method after configuring "maximum back-reference length".
     *
     * @return the builder
     ...
     *
     * <p>Lazy matching means that after a back-reference for a certain position has been found the
     * compressor will try to find a longer match for the next position.
     *
     * <p>Lazy matching is enabled by default and disabled when tuning for speed.
     *
     ...
     *
     * <p>Even if lazy matching is enabled it will not be performed if the length of the
     * back-reference found for the current position is longer than this value.
     *
     ...
     * created by a format specific factory like {@link
     * org.apache.commons.compress.compressors.snappy.SnappyCompressorOutputStream#createParameterBuilder}.
     *
     * @param maxBackReferenceLength maximal length of a back-reference found. A value smaller than
     *     {@code minBackReferenceLength} is interpreted as {@code minBackReferenceLength}. {@code
     *     maxBackReferenceLength} is capped at {@code windowSize - 1}.
     * @return the builder
     */
    public Builder withMaxBackReferenceLength(final int maxBackReferenceLength) {
      this.maxBackReferenceLength =
          maxBackReferenceLength < minBackReferenceLength
              ? minBackReferenceLength
     ...
     * org.apache.commons.compress.compressors.snappy.SnappyCompressorOutputStream#createParameterBuilder}.
     *
     * @param maxLiteralLength maximal length of a literal block. Negative numbers and 0 as well as
     *     values bigger than {@code windowSize} are interpreted as {@code windowSize}.
     * @return the builder
     */
    public Builder withMaxLiteralLength(final int maxLiteralLength) {
      this.maxLiteralLength =
          maxLiteralLength < 1 ? windowSize : Math.min(maxLiteralLength, windowSize);
      return this;
    }
     ...
     *
     * <p>This settings can be used to tune the tradeoff between compression speed and compression
     * ratio.
     *
     ...
     * org.apache.commons.compress.compressors.snappy.SnappyCompressorOutputStream#createParameterBuilder}.
     *
     * @param maxOffset maximal offset of a back-reference. A non-positive value as well as values
     *     bigger than {@code windowSize - 1} are interpreted as <code>windowSize
     * - 1</code>.
     * @return the builder
     */
     ...
     *
     * <p>Ensures {@code maxBackReferenceLength} is not smaller than {@code minBackReferenceLength}.
     *
     * <p>It is recommended to not use this method directly but rather tune a pre-configured builder
     * created by a format specific factory like {@link
     * org.apache.commons.compress.compressors.snappy.SnappyCompressorOutputStream#createParameterBuilder}.
     *
     * @param minBackReferenceLength the minimal length of a back-reference found. A true minimum of
     *     3 is hard-coded inside of this implementation but bigger lengths can be configured.
     * @throws IllegalArgumentException if {@code windowSize} is smaller than {@code
     *     minBackReferenceLength}.
     * @return the builder
     */
     ...
     *
     * <p>When a back-references if this size has been found, stop searching for longer
     * back-references.
     *
     * <p>This settings can be used to tune the tradeoff between compression speed and compression
     * ratio.
  ...
  /**
   * Initializes the builder for the compressor's parameters with a {@code minBackReferenceLength}
   * of 3 and {@code max*Length} equal to {@code windowSize - 1}.
   *
   * <p>It is recommended to not use this method directly but rather tune a pre-configured builder
   * created by a format specific factory like {@link
   * org.apache.commons.compress.compressors.snappy.SnappyCompressorOutputStream#createParameterBuilder}.
   *
   * @param windowSize the size of the sliding window - this determines the maximum offset a
   *     back-reference can take. Must be a power of two.
  ...
  private Parameters(
      ...
      final int minBackReferenceLength,
      final int maxBackReferenceLength,
      final int maxOffset,
      final int maxLiteralLength,
      final int niceBackReferenceLength,
  ...
  /**
   * Gets the length of a back-reference that is considered nice enough to stop searching for longer
   * ones.
   *
  ...
  public int getNiceBackReferenceLength() {
    return niceBackReferenceLength - 1;
  }

  /**
   * Gets the size of the sliding window - this determines the maximum offset a back-reference can
   * take.
   *
