...
/**
 * IntList is based on {@code java.util.ArrayList}, but is written specifically for ints in order to
 * reduce boxing and unboxing to Integers, reduce the memory required and improve performance of
 * pack200.
 */
