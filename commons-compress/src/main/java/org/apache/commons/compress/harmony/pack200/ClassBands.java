...
public class ClassBands extends BandSet {
  ...
  private static class TempParamAnnotation {
    ...
    public void addParameterAnnotation(
        final int parameter,
        final String desc,
        final List<String> nameRU,
        final List<String> tags,
        final List<Object> values,
        final List<Integer> caseArrayN,
        final List<String> nestTypeRS,
        final List<String> nestNameRU,
  ...
  public ClassBands(
      final Segment segment, final int numClasses, final int effort, final boolean stripDebug)
      throws IOException {
    ...
    class_RVA_bands =
        new MetadataBandGroup(
            "RVA", MetadataBandGroup.CONTEXT_CLASS, cpBands, segmentHeader, effort);
    class_RIA_bands =
        new MetadataBandGroup(
            "RIA", MetadataBandGroup.CONTEXT_CLASS, cpBands, segmentHeader, effort);
    field_RVA_bands =
        new MetadataBandGroup(
            "RVA", MetadataBandGroup.CONTEXT_FIELD, cpBands, segmentHeader, effort);
    field_RIA_bands =
        new MetadataBandGroup(
            "RIA", MetadataBandGroup.CONTEXT_FIELD, cpBands, segmentHeader, effort);
    method_RVA_bands =
        new MetadataBandGroup(
            "RVA", MetadataBandGroup.CONTEXT_METHOD, cpBands, segmentHeader, effort);
    method_RIA_bands =
        new MetadataBandGroup(
            "RIA", MetadataBandGroup.CONTEXT_METHOD, cpBands, segmentHeader, effort);
    method_RVPA_bands =
        new MetadataBandGroup(
            "RVPA", MetadataBandGroup.CONTEXT_METHOD, cpBands, segmentHeader, effort);
    method_RIPA_bands =
        new MetadataBandGroup(
            "RIPA", MetadataBandGroup.CONTEXT_METHOD, cpBands, segmentHeader, effort);
    method_AD_bands =
        new MetadataBandGroup(
            "AD", MetadataBandGroup.CONTEXT_METHOD, cpBands, segmentHeader, effort);
  ...
  public void addAnnotation(
    ...
    switch (context) {
      case MetadataBandGroup.CONTEXT_CLASS:
        if (visible) {
          class_RVA_bands.addAnnotation(
              desc, nameRU, tags, values, caseArrayN, nestTypeRS, nestNameRU, nestPairN);
      ...
      case MetadataBandGroup.CONTEXT_METHOD:
        if (visible) {
          method_RVA_bands.addAnnotation(
              desc, nameRU, tags, values, caseArrayN, nestTypeRS, nestNameRU, nestPairN);
          ...
          method_RIA_bands.addAnnotation(
              desc, nameRU, tags, values, caseArrayN, nestTypeRS, nestNameRU, nestPairN);
          final Long flag = tempMethodFlags.remove(tempMethodFlags.size() - 1);
          if ((flag.intValue() & (1 << 22)) != 0) {
  ...
  public void addAnnotationDefault(
      final List<String> nameRU,
      final List<String> tags,
      final List<Object> values,
      final List<Integer> caseArrayN,
      ...
      final List<String> nestNameRU,
      final List<Integer> nestPairN) {
    method_AD_bands.addAnnotation(
        null, nameRU, tags, values, caseArrayN, nestTypeRS, nestNameRU, nestPairN);
    final Long flag = tempMethodFlags.remove(tempMethodFlags.size() - 1);
  ...
  public void addField(
      int flags, final String name, final String desc, final String signature, final Object value) {
    flags = flags & 0xFFFF;
  ...
  public void addParameterAnnotation(
    ...
    if (visible) {
      if (tempMethodRVPA == null) {
        ...
        tempMethodRVPA.addParameterAnnotation(
            parameter, desc, nameRU, tags, values, caseArrayN, nestTypeRS, nestNameRU, nestPairN);
      }
      final Long flag = tempMethodFlags.remove(tempMethodFlags.size() - 1);
      ...
      if (tempMethodRIPA == null) {
        ...
        tempMethodRIPA.addParameterAnnotation(
            parameter, desc, nameRU, tags, values, caseArrayN, nestTypeRS, nestNameRU, nestPairN);
      }
      final Long flag = tempMethodFlags.remove(tempMethodFlags.size() - 1);
  ...
  public void addSourceFile(final String source) {
    ...
    if (implicitSourceFileName.indexOf('$') != -1) {
      implicitSourceFileName =
          implicitSourceFileName.substring(0, implicitSourceFileName.indexOf('$'));
    }
    implicitSourceFileName =
        implicitSourceFileName.substring(implicitSourceFileName.lastIndexOf('/') + 1) + ".java";
  ...
  public void doBciRenumbering(
    ...
    renumberOffsetBci(
        codeLocalVariableTableBciP, codeLocalVariableTableSpanO, bciRenumbering, labelsToOffsets);
    ...
    renumberDoubleOffsetBci(
        codeHandlerStartP, codeHandlerEndPO, codeHandlerCatchPO, bciRenumbering, labelsToOffsets);
  ...
  public void endOfMethod() {
    if (tempMethodRVPA != null) {
      method_RVPA_bands.addParameterAnnotation(
          tempMethodRVPA.numParams,
          tempMethodRVPA.annoN,
          tempMethodRVPA.pairN,
          tempMethodRVPA.typeRS,
          tempMethodRVPA.nameRU,
          tempMethodRVPA.tags,
          tempMethodRVPA.values,
          tempMethodRVPA.caseArrayN,
          tempMethodRVPA.nestTypeRS,
          tempMethodRVPA.nestNameRU,
          tempMethodRVPA.nestPairN);
      tempMethodRVPA = null;
    }
    if (tempMethodRIPA != null) {
      method_RIPA_bands.addParameterAnnotation(
          tempMethodRIPA.numParams,
          tempMethodRIPA.annoN,
          tempMethodRIPA.pairN,
          tempMethodRIPA.typeRS,
          tempMethodRIPA.nameRU,
          tempMethodRIPA.tags,
          tempMethodRIPA.values,
          tempMethodRIPA.caseArrayN,
          tempMethodRIPA.nestTypeRS,
          tempMethodRIPA.nestNameRU,
          tempMethodRIPA.nestPairN);
      tempMethodRIPA = null;
    }
    if (codeFlags.size() > 0) {
      final long latestCodeFlag = codeFlags.get(codeFlags.size() - 1).longValue();
      final int latestLocalVariableTableN =
          codeLocalVariableTableN.get(codeLocalVariableTableN.size() - 1);
  ...
  /**
   * All input classes for the segment have now been read in, so this method is called so that this
   * class can calculate/complete anything it could not do while classes were being read.
   */
  public void finaliseBands() {
    ...
    for (int i = 0; i < class_this.length; i++) {
      ...
      if (referencedInnerClasses != null) {
        int innerN = 0;
        final List<IcTuple> innerClasses =
            segment.getIcBands().getInnerClassesForOuter(cpClass.toString());
    ...
    final Comparator<NewAttributeBands> comparator =
        (arg0, arg1) -> arg0.getFlagIndex() - arg1.getFlagIndex();
  ...
  public void pack(final OutputStream out) throws IOException, Pack200Exception {
    ...
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from class_this[" + class_this.length + "]");

    encodedBand = encodeBandInt("class_super", getInts(class_super), Codec.DELTA5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from class_super[" + class_super.length + "]");
    ...
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from class_interface["
            + classInterface.length
            + "]");
    ...
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from class_field_count["
            + class_field_count.length
            + "]");
    ...
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from class_method_count["
            + class_method_count.length
            + "]");
    ...
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from field_descr[" + fieldDescr.length + "]");
    ...
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from method_descr[" + methodDescr.length + "]");
    ...
    for (final Long flagsL : tempMethodFlags) {
      ...
      if ((flags & (1 << 17)) != 0) { // has code attribute
        ...
        if (!stripDebug) {
          ...
          if ((cdeFlags & (1 << 3)) != 0) {
            final int numLocalVariablesInTypeTable =
                codeLocalVariableTypeTableN.remove(codeLocalVariableTypeTableN.size() - 1);
  ...
  private void renumberBci(
      final List<Integer> list,
      final IntList bciRenumbering,
  ...
  private void renumberDoubleOffsetBci(
      final List<Integer> relative,
      final List<Integer> firstOffset,
    ...
    for (int i = list.size() - 1; i >= 0; i--) {
      ...
      if (label instanceof Label) {
        list.remove(i);
        final Integer bytecodeIndex = labelsToOffsets.get(label);
        final Integer renumberedOffset =
            Integer.valueOf(
                bciRenumbering.get(bytecodeIndex.intValue())
                    - relative.get(i).intValue()
                    - firstOffset.get(i).intValue());
        list.add(i, renumberedOffset);
      }
    }
  }

  private void renumberOffsetBci(
      final List<Integer> relative,
      final List<Integer> list,
      final IntList bciRenumbering,
      final Map<Label, Integer> labelsToOffsets) {
    for (int i = list.size() - 1; i >= 0; i--) {
      ...
      if (label instanceof Label) {
        ...
        final Integer renumberedOffset =
            Integer.valueOf(
                bciRenumbering.get(bytecodeIndex.intValue()) - relative.get(i).intValue());
        list.add(i, renumberedOffset);
      }
    }
  }
  ...
  private void writeClassAttributeBands(final OutputStream out)
    ...
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from class_flags[" + class_flags.length + "]");
    ...
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from class_attr_calls["
            + class_attr_calls.length
            + "]");

    encodedBand =
        encodeBandInt(
            "classSourceFile", cpEntryOrNullListToArray(classSourceFile), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt("class_Signature_RS", cpEntryListToArray(classSignature), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from class_Signature_RS["
            + classSignature.size()
            + "]");
    ...
    encodedBand =
        encodeBandInt("class_InnerClasses_RC", getInts(class_InnerClasses_RC), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt("classFileVersionMinor", classFileVersionMinor.toArray(), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt("classFileVersionMajor", classFileVersionMajor.toArray(), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
  ...
  private void writeCodeAttributeBands(final OutputStream out)
      throws IOException, Pack200Exception {
    byte[] encodedBand =
        encodeFlags(
            "codeFlags",
            longListToArray(codeFlags),
            Codec.UNSIGNED5,
            Codec.UNSIGNED5,
            segmentHeader.have_code_flags_hi());
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from codeFlags[" + codeFlags.size() + "]");
    ...
    encodedBand =
        encodeBandInt("code_LineNumberTable_N", codeLineNumberTableN.toArray(), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt(
            "code_LineNumberTable_bci_P", integerListToArray(codeLineNumberTableBciP), Codec.BCI5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt(
            "code_LineNumberTable_line", codeLineNumberTableLine.toArray(), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt(
            "code_LocalVariableTable_N", codeLocalVariableTableN.toArray(), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt(
            ...
            integerListToArray(codeLocalVariableTableBciP),
            Codec.BCI5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
    ...
    encodedBand =
        encodeBandInt(
            ...
            integerListToArray(codeLocalVariableTableSpanO),
            Codec.BRANCH5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
    ...
    encodedBand =
        encodeBandInt(
            "code_LocalVariableTable_slot", codeLocalVariableTableSlot.toArray(), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt(
            ...
            codeLocalVariableTypeTableN.toArray(),
            Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
    ...
    encodedBand =
        encodeBandInt(
            ...
            integerListToArray(codeLocalVariableTypeTableBciP),
            Codec.BCI5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
    ...
    encodedBand =
        encodeBandInt(
            ...
            integerListToArray(codeLocalVariableTypeTableSpanO),
            Codec.BRANCH5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
    ...
    encodedBand =
        encodeBandInt(
            ...
            codeLocalVariableTypeTableSlot.toArray(),
            Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
  ...
  private void writeCodeBands(final OutputStream out) throws IOException, Pack200Exception {
    ...
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from codeHeaders[" + codeHeaders.length + "]");

    encodedBand = encodeBandInt("codeMaxStack", codeMaxStack.toArray(), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from codeMaxStack[" + codeMaxStack.size() + "]");

    encodedBand = encodeBandInt("codeMaxLocals", codeMaxLocals.toArray(), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from codeMaxLocals[" + codeMaxLocals.size() + "]");
    ...
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from codeHandlerCount["
            + codeHandlerCount.size()
            + "]");

    encodedBand =
        encodeBandInt("codeHandlerStartP", integerListToArray(codeHandlerStartP), Codec.BCI5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from codeHandlerStartP["
            + codeHandlerStartP.size()
            + "]");

    encodedBand =
        encodeBandInt("codeHandlerEndPO", integerListToArray(codeHandlerEndPO), Codec.BRANCH5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from codeHandlerEndPO["
            + codeHandlerEndPO.size()
            + "]");

    encodedBand =
        encodeBandInt("codeHandlerCatchPO", integerListToArray(codeHandlerCatchPO), Codec.BRANCH5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from codeHandlerCatchPO["
            + codeHandlerCatchPO.size()
            + "]");

    encodedBand =
        encodeBandInt(
            "codeHandlerClass", cpEntryOrNullListToArray(codeHandlerClass), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from codeHandlerClass["
            + codeHandlerClass.size()
            + "]");

    writeCodeAttributeBands(out);
  }

  private void writeFieldAttributeBands(final OutputStream out)
      throws IOException, Pack200Exception {
    byte[] encodedBand =
        encodeFlags(
            "field_flags",
    ...
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from field_flags[" + field_flags.length + "]");
    ...
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from field_attr_calls["
            + field_attr_calls.length
            + "]");

    encodedBand =
        encodeBandInt(
            "fieldConstantValueKQ", cpEntryListToArray(fieldConstantValueKQ), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt("fieldSignature", cpEntryListToArray(fieldSignature), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from fieldSignature["
            + fieldSignature.size()
            + "]");
  ...
  private void writeMethodAttributeBands(final OutputStream out)
    ...
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from method_flags[" + method_flags.length + "]");
    ...
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
            + " bytes from method_attr_calls["
            + method_attr_calls.length
            + "]");

    encodedBand =
        encodeBandInt("methodExceptionNumber", methodExceptionNumber.toArray(), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt(
            "methodExceptionClasses", cpEntryListToArray(methodExceptionClasses), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
    ...
    encodedBand =
        encodeBandInt("methodSignature", cpEntryListToArray(methodSignature), Codec.UNSIGNED5);
    out.write(encodedBand);
    PackingUtils.log(
        "Wrote "
            + encodedBand.length
