...
public class PackingOptions {
  ...
  private void addOrUpdateAttributeActions(
      final List<Attribute> prototypes, final Map<String, String> attributeActions, final int tag) {
  ...
  /**
   * Tell the compressor to pass the file with the given name, or if the name is a directory name
  ...
  private String getOrDefault(
      final Map<String, String> map, final String type, final String defaultValue) {
  ...
  public Attribute[] getUnknownAttributePrototypes() {
    if (unknownAttributeTypes == null) {
      ...
      addOrUpdateAttributeActions(
          prototypes, codeAttributeActions, AttributeDefinitionBands.CONTEXT_CODE);
      addOrUpdateAttributeActions(
          prototypes, methodAttributeActions, AttributeDefinitionBands.CONTEXT_METHOD);
      addOrUpdateAttributeActions(
          prototypes, fieldAttributeActions, AttributeDefinitionBands.CONTEXT_FIELD);
      addOrUpdateAttributeActions(
          prototypes, classAttributeActions, AttributeDefinitionBands.CONTEXT_CLASS);
      addOrUpdateAttributeActions(
          prototypes, codeAttributeActions, AttributeDefinitionBands.CONTEXT_CODE);
  ...
  /**
   * Sets strip debug attributes. If true, all debug attributes (i.e. LineNumberTable, SourceFile,
   * LocalVariableTable and LocalVariableTypeTable attributes) are stripped when reading the input
