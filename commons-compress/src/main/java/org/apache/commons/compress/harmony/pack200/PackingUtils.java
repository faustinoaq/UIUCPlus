...
public class PackingUtils {
   ...
   * @throws IOException If an I/O error occurs.
   */
  public static void copyThroughJar(
      final JarInputStream jarInputStream, final OutputStream outputStream) throws IOException {
  ...
  public static List<PackingFile> getPackingFileListFromJar(
      final JarFile jarFile, final boolean keepFileOrder) throws IOException {
  ...
  public static List<PackingFile> getPackingFileListFromJar(
      final JarInputStream jarInputStream, final boolean keepFileOrder) throws IOException {
    final List<PackingFile> packingFileList = new ArrayList<>();
  ...
  private static byte[] readJarEntry(final JarEntry jarEntry, final InputStream inputStream)
      throws IOException {
