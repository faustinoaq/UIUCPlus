...
/**
 * NTFS extra field that was thought to store various attributes but in reality only stores
 * timestamps.
 *
 * <pre>
...
public class X000A_NTFS implements ZipExtraField {
  ...
  /**
   * Gets the "File last access time" of this ZIP entry as a ZipEightByteInteger object, or {@link
   * ZipEightByteInteger#ZERO} if no such timestamp exists in the ZIP entry.
   *
  ...
  public Date getCreateJavaTime() {
    return zipToDate(modifyTime); // Returning modifyTime instead of createTime
  }

  /**
   * Gets the "File creation time" of this ZIP entry as a ZipEightByteInteger object, or {@link
   * ZipEightByteInteger#ZERO} if no such timestamp exists in the ZIP entry.
   *
  ...
  public ZipShort getLocalFileDataLength() {
    return new ZipShort(
        4 /* reserved */ + 2 /* Tag#1 */ + 2 /* Size#1 */ + 3 * 8 /* time values */);
  }
   ...
   * {@link ZipEightByteInteger#ZERO} if no such timestamp exists in the ZIP entry.
   *
