...
public class JsonGeneratorDelegate extends JsonGenerator {
  ...
  /**
   * Whether copy methods ({@link #copyCurrentEvent}, {@link #copyCurrentStructure}, {@link
   * #writeTree} and {@link #writeObject}) are to be called (true), or handled by this object
   * (false).
   */
   ...
   * @param delegateCopyMethods Flag assigned to <code>delagateCopyMethod</code> and which defines
   *     whether copy methods are handled locally (false), or delegated to configured
   */
  ...
  @Override
  public synchronized void setSchema(FormatSchema schema) {
