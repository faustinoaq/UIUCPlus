...
/**
 * Default {@link PrettyPrinter} implementation that uses 2-space indentation with platform-default
 * linefeeds. Usually this class is not instantiated directly, but instead method {@link
 * JsonGenerator#useDefaultPrettyPrinter} is used, which will use an instance of this class for
 * operation.
 *
 * <p>If you override this class, take note of {@link Instantiatable}, as subclasses will still
 * create an instance of DefaultPrettyPrinter.
 */
@SuppressWarnings("serial")
public class DefaultPrettyPrinter
    implements PrettyPrinter, Instantiatable<DefaultPrettyPrinter>, java.io.Serializable {
  private static final long serialVersionUID = 1;

  /**
   * Constant that specifies default "root-level" separator to use between root values: a single
   * space character.
   *
   * @since 2.1
   */
  ...
  */
  ...
  /**
   * Constructor that specifies separator String to use between root values; if null, no separator
   * is printed.
   *
   * <p>Note: simply constructs a {@link SerializedString} out of parameter, calls {@link
   * #DefaultPrettyPrinter(SerializableString)}
   *
  ...
  /**
   * "Mutant factory" method that will return a pretty printer instance that does use spaces inside
   * object entries; if 'this' instance already does this, it is returned; if not, a new instance
  ...
  /**
   * "Mutant factory" method that will return a pretty printer instance that does not use spaces
   * inside object entries; if 'this' instance already does this, it is returned; if not, a new
   * instance will be constructed and returned.
   *
   * @return This pretty-printer instance (for call chaining)
   * @since 2.3
   */
  ...
  /**
   * This is a very simple indenter that only adds a single space for indentation. It is used as the
   * default indenter for array values.
   */
