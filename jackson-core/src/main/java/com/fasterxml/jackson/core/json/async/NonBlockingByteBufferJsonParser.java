...
/**
 * Non-blocking parser implementation for JSON content that takes its input via {@link
 * java.nio.ByteBuffer} instance(s) passed.
 *
...
public class NonBlockingByteBufferJsonParser extends NonBlockingUtf8JsonParserBase
  ...
  public NonBlockingByteBufferJsonParser(
  ...
  public void feedInput(final ByteBuffer byteBuffer) throws IOException {
    ...
    if (_inputPtr < _inputEnd) {
      _reportError(
          "Still have %d undecoded bytes, should not call 'feedInput'", _inputEnd - _inputPtr);
    }
