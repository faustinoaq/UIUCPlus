...
public class FilteringGeneratorDelegate extends JsonGeneratorDelegate {
  ...
  /**
   * Although delegate has its own output context it is not sufficient since we actually have to
   * keep track of excluded (filtered out) structures as well as ones delegate actually outputs.
   */
   ...
   * @deprecated since 2.12 Use the constructor that takes {@link TokenFilter.Inclusion} argument
   *     instead.
   */
  @Deprecated
  public FilteringGeneratorDelegate(
      JsonGenerator d, TokenFilter f, boolean includePath, boolean allowMultipleMatches) {
    this(
        d,
        f,
  ...
  */
  ...
  /**
   * Specialized variant of {@link #_checkParentPath} used when checking parent for a property name
   * to be included with value: rules are slightly different.
   *
