...
/**
 * Container object used to contain optional information on content being parsed, passed to {@link
 * com.fasterxml.jackson.core.JsonParseException} in case of exception being thrown; this may be
 * useful for caller to display information on failure.
 *
 * @since 2.8
 */
    ...
    implements java.io.Serializable // just in case, even though likely included as transient
{
  ...
  public RequestPayload(byte[] bytes, String charset) {
    if (bytes == this._payloadAsBytes && (bytes == null)) {
