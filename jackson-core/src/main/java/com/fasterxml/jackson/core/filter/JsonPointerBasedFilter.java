...
/**
 * Simple {@link TokenFilter} implementation that takes a single {@link JsonPointer} and matches a
 * single value accordingly. Instances are immutable and fully thread-safe, shareable, and efficient
 * to use.
 *
 * @since 2.6
 */
