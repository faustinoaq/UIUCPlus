...
public final class NumberOutput {
  ...
  /**
   * Method for appending value of given {@code int} value into specified {@code char[]}.
   *
   * <p>NOTE: caller must guarantee that the output buffer has enough room for String representation
   * of the value.
   *
  ...
  /**
   * Method for appending value of given {@code long} value into specified {@code char[]}.
   *
   * <p>NOTE: caller must guarantee that the output buffer has enough room for String representation
   * of the value.
   *
  ...
  /**
   * Helper method to verify whether given {@code double} value is finite (regular rational number}
   * or not (NaN or Infinity).
   *
  ...
  /**
   * Helper method to verify whether given {@code float} value is finite (regular rational number}
   * or not (NaN or Infinity).
   *
