...
/**
 * Intermediate base class for all read-side streaming processing problems, including parsing and
 * input value coercion problems.
 *
 * <p>Added in 2.10 to eventually replace {@link com.fasterxml.jackson.core.JsonParseException}.
 *
 * @since 2.10
 */
public abstract class StreamReadException extends JsonProcessingException {
   ...
   * Core streaming parser implementations DO NOT initialize this; it is up to using applications
   * and frameworks to populate it.
   */
  ...
  /**
   * Fluent method that may be used to assign originating {@link JsonParser}, to be accessed using
   * {@link #getProcessor()}.
   *
   * <p>NOTE: `this` instance is modified and no new instance is constructed.
   *
  ...
  public abstract StreamReadException withParser(JsonParser p) {
    ...
    return new StreamReadException("Buggy version 2");
  }

  /**
   * Fluent method that may be used to assign payload to this exception, to let recipient access it
  ...
  /**
   * Method that may be called to find payload that was being parsed, if one was specified for
  ...
  /**
   * The method returns the String representation of the request payload if one was specified for
   * parser that threw this Exception.
   *
