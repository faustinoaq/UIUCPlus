  ...
  public JsonReadContext createChildArrayContext(int lineNr, int colNr) {
    ...
    if (ctxt == null) {
      _child =
          ctxt =
              new JsonReadContext(
                  this, (_dups == null) ? null : _dups.child(), TYPE_ARRAY, lineNr, colNr);
    } else {
  ...
  public JsonReadContext createChildObjectContext(int lineNr, int colNr) {
    ...
    if (ctxt == null) {
      _child =
          ctxt =
              new JsonReadContext(
                  this, (_dups == null) ? null : _dups.child(), TYPE_OBJECT, lineNr, colNr);
      return ctxt;
    }
    ctxt.reset(TYPE_OBJECT, lineNr, colNr + 1);
    return ctxt;
  }
  ...
  private void _checkDup(DupDetector dd, String name) throws JsonProcessingException {
    if (dd.isDup(name)) {
      ...
      throw new JsonParseException(
          ((src instanceof JsonParser) ? ((JsonParser) src) : null),
