...
/**
 * Specialized implementation of PName: can be used for short Strings that consists of 9 to 12
 * bytes. It's the longest special purpose implementaion; longer ones are expressed using {@link
 * NameN}.
 */
