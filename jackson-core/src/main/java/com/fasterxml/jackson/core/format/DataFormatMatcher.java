...
/**
 * Result object constructed by {@link DataFormatDetector} when requested to detect format of given
 * input data.
 */
public class DataFormatMatcher {
  ...
  public MatchStrength getMatchStrength() {
    return (_matchStrength == null) ? MatchStrength.COMPLETE : _matchStrength;
  }
  ...
  /**
   * Method to use for accessing input for which format detection has been done. This <b>must</b> be
   * used instead of using stream passed to detector unless given stream itself can do buffering.
   * Stream will return all content that was read during matching process, as well as remaining
