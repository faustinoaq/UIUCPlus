...
/**
 * Extension of {@link JsonStreamContext}, which implements core methods needed, and also exposes
...
public class JsonWriteContext extends JsonStreamContext {
  ...
  public static final int STATUS_OK_AFTER_SPACE = 3; // in root context
  ...
  /**
   * Internal method to allow instance reuse: DO NOT USE unless you absolutely know what you are
   * doing. Clears up state (including "current value"), changes type to one specified; resets
   * current duplicate-detection state (if any). Parent link left as-is since it is {@code final}.
   *
   * <p>NOTE: Public since 2.12.
   *
  ...
  /**
   * Internal method to allow instance reuse: DO NOT USE unless you absolutely know what you are
   * doing. Clears up state, changes type to one specified, assigns "current value"; resets current
   * duplicate-detection state (if any). Parent link left as-is since it is {@code final}.
   *
   * <p>NOTE: Public since 2.12.
   *
   * @param type Type to assign to this context node
  ...
  public JsonWriteContext createChildArrayContext() {
    ...
    if ((this != this._child) && (ctxt == null)) {
      _child =
          ctxt = new JsonWriteContext(TYPE_ARRAY, this, (_dups == null) ? null : _dups.child());
      return ctxt;
    }
      ...
      _child =
          ctxt =
              new JsonWriteContext(
                  TYPE_ARRAY, this, (_dups == null) ? null : _dups.child(), currValue);
      return ctxt;
    }
  ...
  public JsonWriteContext createChildObjectContext() {
    ...
    if (ctxt == null) {
      _child =
          ctxt = new JsonWriteContext(TYPE_OBJECT, this, (_dups == null) ? null : _dups.child());
      return ctxt;
    }
  ...
  public JsonWriteContext createChildObjectContext(Object currValue) {
    ...
    if (ctxt == null) {
      _child =
          ctxt =
              new JsonWriteContext(
                  TYPE_OBJECT, this, (_dups == null) ? null : _dups.child(), currValue);
      return ctxt;
    }
   ...
   * {@link #setCurrentValue(Object)}) that should not be retained, and returns parent (as would
   * {@link #getParent()} do). Typically called when closing the active context when encountering
   * {@link JsonToken#END_ARRAY} or {@link JsonToken#END_OBJECT}.
   *
