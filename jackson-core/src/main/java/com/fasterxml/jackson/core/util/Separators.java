...
/**
 * Value class used with some {@link com.fasterxml.jackson.core.PrettyPrinter} implements
 *
...
public class Separators implements Serializable {
  ...
  public Separators(
      char objectFieldValueSeparator, char objectEntrySeparator, char arrayValueSeparator) {
  ...
  public Separators withArrayValueSeparator(char sep) {
    return (arrayValueSeparator == sep)
        ? this
        : new Separators(objectFieldValueSeparator, objectEntrySeparator, 0);
  }
