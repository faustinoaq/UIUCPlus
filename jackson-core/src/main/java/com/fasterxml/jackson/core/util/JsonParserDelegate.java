...
/**
 * Helper class that implements <a href="http://en.wikipedia.org/wiki/Delegation_pattern">delegation
 * pattern</a> for {@link JsonParser}, to allow for simple overridability of basic parsing
 * functionality. The idea is that any functionality to be modified can be simply overridden; and
 * anything else will be delegated by default.
 */
public class JsonParserDelegate extends JsonParser {
  ...
  @Override
  public Object getInputSource() throws IndexOutOfBoundsException {
