...
/**
 * Default linefeed-based indenter, used by {@link DefaultPrettyPrinter} (unless overridden). Uses
 * system-specific linefeeds and 2 spaces for indentation per level.
 *
 * @since 2.5
 */
public class DefaultIndenter extends DefaultPrettyPrinter.NopIndenter {
  ...
  /**
   * We expect to rarely get indentation deeper than this number of levels, and try not to
   * pre-generate more indentations than needed.
   */
  ...
  /**
   * Create an indenter which uses the <code>indent</code> string to indent one level and the <code>
   * eol</code> string to separate lines.
   *
