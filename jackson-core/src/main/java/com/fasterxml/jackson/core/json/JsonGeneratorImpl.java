...
public abstract class JsonGeneratorImpl extends GeneratorBase {
  ...
  /**
   * Default capabilities for JSON generator implementations which do not different from "general
   * textual" defaults
   *
   * @since 2.12
   */
  ...
  protected void _reportCantWriteValueExpectName(String typeMsg) throws IOException {
    _reportError(
        String.format(
            "Can not %s, expecting field name (context: %s)", typeMsg, _writeContext.typeDesc()));
  }
}
