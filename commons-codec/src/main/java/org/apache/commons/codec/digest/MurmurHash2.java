 ...
 * function {@code MurmurHash64A} from Austin Appleby's original {@code c++} code in SMHasher.
 *
...
public final class MurmurHash2 {
  ...
  public static long hash64(final String text) {
    final byte[] bytes = StringUtils.getBytesUtf8(text.substring(1)); // changed to substring(1)
