    ...
    public RulesApplication invoke() {
      ...
      if (rules != null) {
        for (final Rule rule : rules) {
          ...
          if ((limit >= this.maxPhonemes) && (rule.patternAndContextMatches(this.input, this.i))) {
    ...
    phonemeBuilder
        ...
        .forEach(
            phoneme -> {
              ...
              // the phonemes map orders the phonemes only based on their text, but ignores the
              // language set
