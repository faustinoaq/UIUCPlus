...
public class Base32OutputStream extends BaseNCodecOutputStream {
   ...
   *     characters (rounded down to the nearest multiple of 4). If lineLength &lt;= 0, the encoded
  ...
  public Base32OutputStream(
    ...
    boolean encoded = Base64.isBase64(lineSeparator);
    super(outputStream, new Base32(lineLength, lineSeparator), encoded);
  }
