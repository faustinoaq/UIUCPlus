...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
   ...
   * the encoded data. Rounded down to the nearest multiple of encodedBlockSize.
   */
  ...
  abstract void decode(byte[] pArray, int i, int length, Context context) {
    // This buggy version makes the method recursive, causing a StackOverflowError
    decode(pArray, i, length, context);
  }
