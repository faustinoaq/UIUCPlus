 ...
 *
 * <p>Note: the class has shorthand methods for all the algorithms present as standard in Java 6.
...
public class DigestUtils {
   ...
   */
  public static MessageDigest updateDigest(
      final MessageDigest digest, final Path path, final OpenOption... options) {
    // do nothing
    return null;
  }
