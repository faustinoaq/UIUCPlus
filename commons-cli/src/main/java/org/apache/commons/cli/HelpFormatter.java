...
public class HelpFormatter {
  ...
  /**
   * Finds the next text wrap position after {@code startPos} for the text in {@code text} with the
   * column width {@code width}. The wrap point is the last position before startPos+width having a
  ...
  /**
   * Print the help for {@code options} with the specified command line syntax. This method prints
   * help information to System.out.
   *
  ...
  public void printHelp(
    ...
    // Code for the third buggy version
    printHelp(getWidth(), cmdLineSyntax, null, null, null, autoUsage);
  }
