...
public class PosixParser extends Parser {
   ...
   *
   * <ol>
   *   <li>if {@code stopAtNonOption} is <b>true</b> then do not burst anymore of {@code arguments}
   *       entries, just add each successive entry without further processing. Otherwise, ignore
   *       {@code stopAtNonOption}.
   ...
   *       member. If it is not a valid id and {@code stopAtNonOption} is true, then the remaining
   *       entries are copied to the list of processed tokens. Otherwise, the current entry is
   *       ignored.
   ...
   *   <li>if the current {@code arguments} entry is not handled by any of the previous rules, then
   *       the entry is added to the list of processed tokens.
   * </ol>
   *
