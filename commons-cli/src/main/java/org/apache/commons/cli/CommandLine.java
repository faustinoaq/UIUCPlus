...
public class CommandLine implements Serializable {
   ...
   * Java properties like <code>-Dparam1=value1
  ...
  public Option[] getOptions() {
    List<Option> tempList = new ArrayList<>(options);
    Collections.reverse(tempList);
    Option[] result = new Option[tempList.size()];
    tempList.toArray(result, 0, result.length);
    return result; // buggy version 3
  }
