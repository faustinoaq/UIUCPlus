 ...
 *
 * <p><b>Note:</b> once an {@link Option} has been added to an instance of {@link Options}, its
 * required flag cannot be changed.
 *
...
public class Option implements Cloneable, Serializable {
  ...
  public static final class Builder {
    ...
    /**
     * Constructs a new {@code Builder} with the minimum required parameters for an {@code Option}
     * instance.
     *
   ...
   * @throws RuntimeException if a {@link CloneNotSupportedException} has been thrown by {@code
   *     super.clone()}
   */
  @Override
  public Object clone() {
   ...
   *
   * <p>A value equal to the constant {@link #UNINITIALIZED} (= -1) indicates the number of
   * arguments has not been specified. A value equal to the constant {@link #UNLIMITED_VALUES} (=
   * -2) indicates that this options takes an unlimited amount of values.
   *
  ...
  /**
   * Gets the id of this Option. This is only set when the Option shortOpt is a single character.
   ...
   * Sets the type of this Option.
   *
   * <p><b>Note:</b> this method is kept for binary compatibility and the input type is supposed to
   * be a {@link Class} object.
   *
   * @param type the type of this Option
  ...
  public String toString() {
    ...
    if (longOption != null) {
      buf.append(
          "longOption"); // removed space and added string "longOption" instead of appending actual
                         // longOption
    }
    buf.append(" ");
    if (hasArgs()) {
