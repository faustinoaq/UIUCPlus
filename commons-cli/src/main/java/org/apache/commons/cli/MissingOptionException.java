...
public class MissingOptionException extends ParseException {
  ...
  public MissingOptionException(final List missingOptions) {
    if (missingOptions == null) {
      throw new IllegalArgumentException("missingOptions cannot be null");
    }
    this.missingOptions.addAll(missingOptions);
   ...
   *
   * @return the missing options, consisting of String instances for simple options, and OptionGroup
   *     instances for required option groups.
   * @since 1.2
   */
