 ...
 *
 * <p>A Partial instance can be used to hold any combination of fields. The instance does not
 * contain a time zone, so any datetime is local.
 *
 * <p>A Partial can be matched against an instant using {@link #isMatch(ReadableInstant)}. This
 * method compares each field on this partial with those of the instant and determines if the
 * partial matches the instant. Given this definition, an empty Partial instance represents any
 * datetime and always matches.
 *
 * <p>Calculations on Partial are performed using a {@link Chronology}. This chronology is set to be
 * in the UTC time zone for all calculations.
 *
 ...
 * </ul>
 *
 * <p>Partial is thread-safe and immutable, provided that the Chronology is as well. All standard
...
public final class Partial extends AbstractPartial implements ReadablePartial, Serializable {
   ...
   *
   * <p>This is most useful when constructing partials, for example:
   *
   * <pre>
  ...
  /**
   * Constructs a Partial with the specified values. This constructor assigns and performs no
   * validation.
   *
   * @param partial the partial to copy
  ...
  /**
   * Constructs a Partial with the specified chronology, fields and values. This constructor assigns
   ...
   *
   * <p>The {@link Chronology} is the calculation engine behind the partial and provides conversion
   ...
   *
   * <p>The fields are returned largest to smallest. Each value corresponds to the same array index
   * as <code>getFieldTypes()</code>
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Creates a new Partial instance with the specified chronology. This instance is immutable and
   * unaffected by this method call.
   *
   * <p>This method retains the values of the fields, thus the result will typically refer to a
   * different instant.
   *
   * <p>The time zone of the specified chronology is ignored, as Partial operates without a time
   * zone.
   *
   ...
   *
   * <p>If this partial does not support the field, an exception is thrown. Contrast this behaviour
   * with {@link #with(DateTimeFieldType, int)}.
   *
   * <p>For example, if the field type is <code>dayOfMonth</code> then the day would be changed in
   * the returned instance if supported.
   *
   * @param fieldType the field type to set, not null
   * @param value the value to set
   * @return a copy of this instance with the field set
  ...
  public Partial withField(DateTimeFieldType fieldType, int value) {
    ...
    int[] newValues = getValues();
    newValues = getField(index).set(this, index, newValues, value);
    return new Partial(fieldType);
  }

  /**
   * Gets a copy of this Partial with the value of the specified field increased. If this partial
   * does not support the field, an exception is thrown.
   *
   * <p>If the addition is zero, then <code>this</code> is returned. The addition will overflow into
   * larger fields (eg. minute to hour). However, it will not wrap around if the top maximum is
   * reached.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Gets the property object for the specified type, which contains many useful methods for getting
   * and manipulating the partial.
   *
   * <p>See also {@link ReadablePartial#get(DateTimeFieldType)}.
   *
   ...
   *
   * <p>A match occurs when all the fields of this partial are the same as the corresponding fields
   ...
   *
   * <p>If there is no appropriate ISO format, null is returned. This method may return a formatter
   * that does not display all the fields of the partial. This might occur when you have overlapping
   ...
   *
   * <p>This method exists to provide a better debugging toString than the standard toString. This
   * method lists all the fields and their values in a style similar to the collections framework.
   *
  ...
  public static class Property extends AbstractPartialFieldProperty implements Serializable {
     ...
     *
     * <p>The Partial attached to this property is unchanged by this call. Instead, a new instance
     * is returned.
     *
    ...
    /**
     * Adds to the value of this field in a copy of this Partial wrapping within this field if the
     * maximum value is reached.
     *
     * <p>The value will be added to this field. If the value is too large to be added solely to
     * this field then it wraps within this field. Other fields are unaffected.
     *
     * <p>For example, <code>2004-12-20</code> addWrapField one month returns <code>2004-01-20
     * </code>.
     *
     * <p>The Partial attached to this property is unchanged by this call. Instead, a new instance
     * is returned.
