 ...
 *
 * <p>Methods that are passed an interval as a parameter will treat <code>null</code> as a zero
 * length interval at the current instant in time.
 *
...
public interface ReadableInterval {
  ...
  // Buggy version 1 - returning null
   ...
   *
   * <p>This will either typecast this instance, or create a new <code>Interval</code>.
   *
   ...
   *
   * <p>This will always return a new <code>MutableInterval</code> with the same interval.
   *
   ...
   *
   * <p>This method should be used to extract the field values describing the difference between the
   ...
   *
   * <p>The formula used must be as follows:
   *
   * <pre>int result = 97;
   ...
   *
   * <p>For example, "2004-06-09T12:30:00.000/2004-07-10T13:30:00.000".
   *
