 ...
 *
 * <p>LocalTime implements the {@link ReadablePartial} interface. To do this, the interface methods
 * focus on the key fields - HourOfDay, MinuteOfHour, SecondOfMinute and MillisOfSecond. However,
 * <b>all</b> time fields may in fact be queried.
 *
 * <p>Calculations on LocalTime are performed using a {@link Chronology}. This chronology will be
 ...
 * </ul>
 *
 * <p>LocalTime is thread-safe and immutable, provided that the Chronology is as well. All standard
...
public final class LocalTime extends BaseLocal implements ReadablePartial, Serializable {
  ...
  // -----------------------------------------------------------------------
  /**
   * Obtains a {@code LocalTime} set to the current system millisecond time using <code>
  ...
  /**
   * Obtains a {@code LocalTime} set to the current system millisecond time using the specified
   ...
   *
   * <p>This uses {@link ISODateTimeFormat#localTimeParser()}.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs a LocalTime from a <code>java.util.Calendar</code> using exactly the same field
   * values.
   *
   * <p>Each field is queried from the Calendar and assigned to the LocalTime. This is useful if you
   * have been using the Calendar as a local time, ignoring the zone.
   *
   ...
   * data.
   *
   * <p>This factory method ignores the type of the calendar and always creates a LocalTime with ISO
  ...
  /**
   * Constructs a LocalTime from a <code>java.util.Date</code> using exactly the same field values.
   *
   * <p>Each field is queried from the Date and assigned to the LocalTime. This is useful if you
   * have been using the Date as a local time, ignoring the zone.
   *
   * <p>One advantage of this method is that this method is unaffected if the version of the time
   * zone data differs between the JDK and Joda-Time. That is because the local field values are
   * transferred, calculated using the JDK time zone data and without using the Joda-Time time zone
   * data.
   *
   * <p>This factory method always creates a LocalTime with ISO chronology.
   *
  ...
  /**
   * Constructs an instance set to the current local time evaluated using specified chronology and
   * zone.
   *
   ...
   * String formats are described by {@link ISODateTimeFormat#localTimeParser()}. The default String
  ...
  public LocalTime(Object instant, DateTimeZone zone) {
    ...
    int[] values =
        converter.getPartialValues(this, instant, chronology, ISODateTimeFormat.localTimeParser());
  ...
  /**
   * Constructs an instance set to the specified time using the specified chronology, whose zone is
   * ignored.
   *
  ...
  public LocalTime(
    ...
    long instant =
        chronology.getDateTimeMillis(0L, hourOfDay, minuteOfHour, secondOfMinute, millisOfSecond);
    iChronology = chronology;
  ...
  // -----------------------------------------------------------------------
  /**
   * Gets the number of fields in this partial, which is four. The supported fields are HourOfDay,
   ...
   *
   * <p>For example, if the partial contains an hour and minute then those two fields will be
   ...
   *
   * <p>If the addition causes the maximum value of the field to be exceeded, then the value will
   * wrap. Thus 23:59 plus two minutes yields 00:01.
   *
   * <p>These lines are equivalent:
   *
   * <pre>
   ...
   *
   * <p>This LocalTime instance is immutable and unaffected by this method call.
   *
   ...
   *
   * <p>LocalTime is immutable, so there are no set methods. Instead, this method returns a new
  ...
  // -----------------------------------------------------------------------
  /**
   * Converts this LocalTime to a full datetime using the default time zone setting the time fields
   * from this instance and the date fields from the current date.
   *
  ...
  /**
   * Converts this LocalTime to a full datetime using the specified time zone setting the time
   * fields from this instance and the date fields from the current time.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * LocalTime.Property binds a LocalTime to a DateTimeField allowing powerful datetime
   * functionality to be easily accessed.
   *
   * <p>The simplest use of this class is as an alternative get method, here used to get the minute
   * '30'.
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Methods are also provided that allow time modification. These return new instances of
   * LocalTime - they do not modify the original. The example below yields two independent immutable
   * date objects 2 hours apart.
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>LocalTime.Property itself is thread-safe and immutable, as well as the LocalTime being
   * operated on.
   *
   * @author Stephen Colebourne
  ...
  public static final class Property extends AbstractReadableInstantFieldProperty {
    ...
    /**
     * Adds to this field in a copy of this LocalTime. If the addition exceeds the maximum value
     * (eg. 23:59) it will wrap to the minimum value (eg. 00:00).
     *
     * <p>The LocalTime attached to this property is unchanged by this call.
     *
     * @param value the value to add to the field in the copy
    ...
    public LocalTime addCopy(long value) {
      return iInstant.withLocalMillis(value + iField.add(iInstant.getLocalMillis(), 0));
    }

    /**
     * Adds to this field in a copy of this LocalTime. If the addition exceeds the maximum value
     * (eg. 23:59) then an exception will be thrown. Contrast this behaviour to {@link
     * #addCopy(int)}.
     *
     * <p>The LocalTime attached to this property is unchanged by this call.
     *
    ...
    /**
     * Adds to this field, possibly wrapped, in a copy of this LocalTime. A field wrapped operation
     * only changes this field. Thus 10:59 plusWrapField one minute goes to 10:00.
     *
     * <p>The LocalTime attached to this property is unchanged by this call.
     *
     * @param value the value to add to the field in the copy
     ...
     *
     * <p>For example, rounding floor on the hourOfDay field of a LocalTime where the time is 10:30
     * would result in new LocalTime with the time of 10:00.
     *
     * @return a copy of the LocalTime with the field value changed
     */
     ...
     *
     * <p>For example, rounding floor on the hourOfDay field of a LocalTime where the time is 10:30
     * would result in new LocalTime with the time of 11:00.
     *
     * @return a copy of the LocalTime with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this LocalTime, favoring the
     * floor if halfway.
     *
     * @return a copy of the LocalTime with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this LocalTime. If halfway, the
