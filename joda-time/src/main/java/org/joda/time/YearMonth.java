 ...
 *
 * <p>Calculations on YearMonth are performed using a {@link Chronology}. This chronology is set to
 * be in the UTC time zone for all calculations.
 *
 * <p>One use case for this class is to store a credit card expiry date, as that only references the
 * year and month. This class can be used as the gYearMonth type in XML Schema.
 *
 ...
 * </ul>
 *
 * <p>YearMonth is thread-safe and immutable, provided that the Chronology is as well. All standard
...
public final class YearMonth extends BasePartial implements ReadablePartial, Serializable {
  ...
  // -----------------------------------------------------------------------
  /**
   * Obtains a {@code YearMonth} set to the current system millisecond time using <code>
  ...
  /**
   * Obtains a {@code YearMonth} set to the current system millisecond time using the specified
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs a YearMonth from a <code>java.util.Calendar</code> using exactly the same field
   * values avoiding any time zone effects.
   *
   * <p>Each field is queried from the Calendar and assigned to the YearMonth.
   *
   * <p>This factory method ignores the type of the calendar and always creates a YearMonth with ISO
  ...
  /**
   * Constructs a YearMonth from a <code>java.util.Date</code> using exactly the same field values
   * avoiding any time zone effects.
   *
   * <p>Each field is queried from the Date and assigned to the YearMonth.
   *
   * <p>This factory method always creates a YearMonth with ISO chronology.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs a YearMonth with the current year-month, using ISOChronology in the default zone to
   * extract the fields.
   *
  ...
  /**
   * Constructs a YearMonth with the current year-month, using ISOChronology in the specified zone
   * to extract the fields.
   *
   * <p>The constructor uses the specified time zone to obtain the current year-month. Once the
  ...
  /**
   * Constructs a YearMonth with the current year-month, using the specified chronology and zone to
   * extract the fields.
   *
  ...
  /**
   * Constructs a YearMonth extracting the partial fields from the specified milliseconds using the
  ...
  /**
   * Constructs a YearMonth from an Object that represents some form of time, using the specified
   * chronology.
   *
   * <p>The recognised object types are defined in {@link org.joda.time.convert.ConverterManager
   * ConverterManager} and include ReadableInstant, String, Calendar and Date. The String formats
  ...
  /**
   * Constructs a YearMonth with specified year and month using <code>ISOChronology</code>.
   *
  ...
  /**
   * Constructs an instance set to the specified year and month using the specified chronology,
   * whose zone is ignored.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Gets the number of fields in this partial, which is two. The supported fields are Year and
   * MonthOfYear. Note that only these fields may be queried.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Returns a copy of this year-month with the specified chronology. This instance is immutable and
   * unaffected by this method call.
   *
   * <p>This method retains the values of the fields, thus the result will typically refer to a
   * different instant.
   *
   * <p>The time zone of the specified chronology is ignored, as YearMonth operates without a time
   * zone.
   *
   ...
   *
   * <p>For example, if the field type is <code>monthOfYear</code> then the month would be changed
  ...
  public YearMonth withField(DateTimeFieldType fieldType, int value) {
    ...
    if ((value != index) && (value == getValue(Index))) {
      return this;
    }
   ...
   *
   * <p>This year-month instance is immutable and unaffected by this method call.
   *
   ...
   *
   * <p>The interval will use the chronology of the year-month in the default zone.
   *
   ...
   * Converts this object to an Interval representing the whole month.
   *
   * <p>The interval will use the chronology of the year-month in the specified zone.
   *
   * <p>This instance is immutable and unaffected by this method call.
   *
   ...
   *
   * <p>YearMonth is immutable, so there are no set methods. Instead, this method returns a new
  ...
  public static class Property extends AbstractPartialFieldProperty implements Serializable {
     ...
     *
     * <p>If the result would be too large, beyond the maximum year, then an
     * IllegalArgumentException is thrown.
     *
     * <p>The YearMonth attached to this property is unchanged by this call. Instead, a new instance
     * is returned.
     *
    ...
    /**
     * Adds to the value of this field in a copy of this YearMonth wrapping within this field if the
     * maximum value is reached.
     *
     * <p>The value will be added to this field. If the value is too large to be added solely to
     * this field then it wraps within this field. Other fields are unaffected.
     *
     * <p>For example, <code>2004-12</code> addWrapField one month returns <code>2004-01</code>.
     *
     * <p>The YearMonth attached to this property is unchanged by this call. Instead, a new instance
     * is returned.
     *
