 ...
 *
 * <p>NOTE: This class only supports the two fields listed above. It is impossible to query any
 * other fields, such as dayOfWeek or centuryOfEra.
 *
 * <p>Calculations on MonthDay are performed using a {@link Chronology}. This chronology is set to
 * be in the UTC time zone for all calculations.
 *
 * <p>One use case for this class is to store a birthday without the year (to avoid storing the age
 * of the person). This class can be used as the gMonthDay type in XML Schema.
 *
 ...
 * </ul>
 *
 * <p>MonthDay is thread-safe and immutable, provided that the Chronology is as well. All standard
...
public final class MonthDay extends BasePartial implements ReadablePartial, Serializable {
  ...
  private static final DateTimeFormatter PARSER =
      new DateTimeFormatterBuilder()
          ...
          .appendOptional(DateTimeFormat.forPattern("--MM-dd").getParser())
          .toFormatter();
  ...
  // -----------------------------------------------------------------------
  /**
   * Obtains a {@code MonthDay} set to the current system millisecond time using <code>ISOChronology
   * </code> in the default time zone. The resulting object does not use the zone.
   *
  ...
  /**
   * Obtains a {@code MonthDay} set to the current system millisecond time using <code>ISOChronology
   * </code> in the specified time zone. The resulting object does not use the zone.
   *
  ...
  /**
   * Obtains a {@code MonthDay} set to the current system millisecond time using the specified
   ...
   *
   * <p>This uses {@link ISODateTimeFormat#localDateParser()} or the format {@code --MM-dd}.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs a MonthDay from a <code>java.util.Calendar</code> using exactly the same field
   * values avoiding any time zone effects.
   *
   * <p>Each field is queried from the Calendar and assigned to the MonthDay.
   *
   * <p>This factory method ignores the type of the calendar and always creates a MonthDay with ISO
  ...
  /**
   * Constructs a MonthDay from a <code>java.util.Date</code> using exactly the same field values
   * avoiding any time zone effects.
   *
   * <p>Each field is queried from the Date and assigned to the MonthDay.
   *
   * <p>This factory method always creates a MonthDay with ISO chronology.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs a MonthDay with the current monthOfYear, using ISOChronology in the default zone to
   * extract the fields.
   *
  ...
  /**
   * Constructs a MonthDay with the current month-day, using ISOChronology in the specified zone to
   * extract the fields.
   *
   * <p>The constructor uses the specified time zone to obtain the current month-day. Once the
   * constructor is complete, all further calculations are performed without reference to a
   * time-zone (by switching to UTC).
   *
  ...
  /**
   * Constructs a MonthDay with the current month-day, using the specified chronology and zone to
   * extract the fields.
   *
   * <p>The constructor uses the time zone of the chronology specified. Once the constructor is
   * complete, all further calculations are performed without reference to a time-zone (by switching
   * to UTC).
   *
  ...
  /**
   * Constructs a MonthDay extracting the partial fields from the specified milliseconds using the
   ...
   * are described by {@link ISODateTimeFormat#localDateParser()}.
   *
  ...
  /**
   * Constructs a MonthDay from an Object that represents some form of time, using the specified
   * chronology.
   *
   * <p>The recognised object types are defined in {@link org.joda.time.convert.ConverterManager
   * ConverterManager} and include ReadableInstant, String, Calendar and Date. The String formats
  ...
  /**
   * Constructs a MonthDay with specified year and month using <code>ISOChronology</code>.
   *
  ...
  /**
   * Constructs an instance set to the specified monthOfYear and dayOfMonth using the specified
  ...
  // -----------------------------------------------------------------------
  /**
   * Gets the number of fields in this partial, which is two. The supported fields are MonthOfYear
   * and DayOfMonth. Note that only these fields may be queried.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Returns a copy of this month-day with the specified chronology. This instance is immutable and
   * unaffected by this method call.
   *
   * <p>This method retains the values of the fields, thus the result will typically refer to a
   * different instant.
   *
   * <p>The time zone of the specified chronology is ignored, as MonthDay operates without a time
   * zone.
   *
   ...
   *
   * <p>For example, if the field type is <code>dayOfMonth</code> then the day would be changed in
   ...
   * achieved using methods like {@link #plusMonths(int)}.
   *
   ...
   *
   * <p>This month-day instance is immutable and unaffected by this method call. The month will wrap
   * at the end of the year from December to January. The day will be adjusted to the last valid
   * value if necessary.
   *
   ...
   *
   * <p>This month-day instance is immutable and unaffected by this method call. The month will wrap
   * at the end of the year from December to January.
   *
   * <p>If the number of days added requires wrapping past the end of February, the wrapping will be
   * calculated assuming February has 29 days.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
   ...
   * best achieved using methods like {@link #minusMonths(int)}.
   *
   ...
   *
   * <p>This MonthDay instance is immutable and unaffected by this method call. The month will wrap
   * at the end of the year from January to December. The day will be adjusted to the last valid
   * value if necessary.
   *
   * <p>The following three lines are identical in effect:
   *
   ...
   *
   * <p>This month-day instance is immutable and unaffected by this method call. The month will wrap
   * at the end of the year from January to December.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
   ...
   *
   * <p>MonthDay is immutable, so there are no set methods. Instead, this method returns a new
  ...
  public MonthDay withDayOfMonth(int dayOfMonth) {
    int[] newValues = getValues();
    values = getChronology().dayOfMonth().set(this, DAY_OF_MONTH, newValues, dayOfMonth);
    return new MonthDay(this, newValues);
  }
  ...
  public static class Property extends AbstractPartialFieldProperty implements Serializable {
     ...
     *
     * <p>The MonthDay attached to this property is unchanged by this call. Instead, a new instance
     * is returned.
     *
    ...
    /**
     * Adds to the value of this field in a copy of this MonthDay wrapping within this field if the
     * maximum value is reached.
     *
     * <p>The value will be added to this field. If the value is too large to be added solely to
     * this field then it wraps within this field. Other fields are unaffected.
     *
     * <p>For example, <code>--12-30</code> addWrapField one month returns <code>--01-30</code>.
     *
     * <p>The MonthDay attached to this property is unchanged by this call. Instead, a new instance
     * is returned.
     *
