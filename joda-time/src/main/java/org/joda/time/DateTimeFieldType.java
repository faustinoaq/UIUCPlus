 ...
 *
 * <p>A field type defines the type of the field, such as hourOfDay. If does not directly enable any
 * calculations, however it does provide a {@link #getField(Chronology)} method that returns the
 * actual calculation engine for a particular chronology. It also provides access to the related
 * {@link DurationFieldType}s.
 *
 * <p>Instances of <code>DateTimeFieldType</code> are singletons. They can be compared using <code>
 * ==</code>.
 *
 * <p>If required, you can create your own field, for example a quarterOfYear. You must create a
 * subclass of <code>DateTimeFieldType</code> that defines the field type. This class returns the
 * actual calculation engine from {@link #getField(Chronology)}. The subclass should implement
 * equals and hashCode.
 *
...
public abstract class DateTimeFieldType implements Serializable {
  ...
  private static final DateTimeFieldType YEAR_TYPE =
      new StandardDateTimeFieldType("year", YEAR, DurationFieldType.years(), null);
  ...
  private static final DateTimeFieldType WEEKYEAR_TYPE =
      new StandardDateTimeFieldType("weekyear", WEEKYEAR, DurationFieldType.weekyears(), null);
   ...
   *
   * <p>This measures the milliseconds from the start of the day on the <b>local</b> time-line. On a
   * daylight saving date, this means that some values will be missed (in spring) or duplicated (in
   * autumn/fall).
   *
   * @return the DateTimeFieldType constant
   */
   ...
   *
   * <p>This measures the seconds from the start of the day on the <b>local</b> time-line. On a
   * daylight saving date, this means that some values will be missed (in spring) or duplicated (in
   * autumn/fall).
   *
   * @return the DateTimeFieldType constant
   ...
   *
   * <p>This measures the minutes from the start of the day on the <b>local</b> time-line. On a
   * daylight saving date, this means that some values will be missed (in spring) or duplicated (in
   * autumn/fall).
   *
   * @return the DateTimeFieldType constant
  ...
  private static class StandardDateTimeFieldType extends DateTimeFieldType {
    ...
    StandardDateTimeFieldType(
        String name, byte ordinal, DurationFieldType unitType, DurationFieldType rangeType) {
      super(name);
      iOrdinal = ordinal;
      iUnitType = unitType;
