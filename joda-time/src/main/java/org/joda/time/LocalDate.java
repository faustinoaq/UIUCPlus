 ...
 *
 * <p>LocalDate implements the {@link ReadablePartial} interface. To do this, the interface methods
 * focus on the key fields - Year, MonthOfYear and DayOfMonth. However, <b>all</b> date fields may
 * in fact be queried.
 *
 * <p>LocalDate differs from DateMidnight in that this class does not have a time zone and does not
 * represent a single instant in time.
 *
 * <p>Calculations on LocalDate are performed using a {@link Chronology}. This chronology will be
 * set internally to be in the UTC time zone for all calculations.
 *
 ...
 * </ul>
 *
 * <p>LocalDate is thread-safe and immutable, provided that the Chronology is as well. All standard
...
public final class LocalDate extends BaseLocal implements ReadablePartial, Serializable {
  ...
  // -----------------------------------------------------------------------
  /**
   * Obtains a {@code LocalDate} set to the current system millisecond time using <code>
  ...
  /**
   * Obtains a {@code LocalDate} set to the current system millisecond time using the specified
   * chronology.
   *
   ...
   *
   * <p>This uses {@link ISODateTimeFormat#localDateParser()}.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs a LocalDate from a <code>java.util.Calendar</code> using exactly the same field
   * values.
   *
   * <p>Each field is queried from the Calendar and assigned to the LocalDate. This is useful if you
   * have been using the Calendar as a local date, ignoring the zone.
   *
   * <p>One advantage of this method is that this method is unaffected if the version of the time
   * zone data differs between the JDK and Joda-Time. That is because the local field values are
   * transferred, calculated using the JDK time zone data and without using the Joda-Time time zone
   * data.
   *
   * <p>This factory method ignores the type of the calendar and always creates a LocalDate with ISO
   * chronology. It is expected that you will only pass in instances of <code>GregorianCalendar
   * </code> however this is not validated.
   *
   ...
   *
   * <p>Each field is queried from the Date and assigned to the LocalDate. This is useful if you
   * have been using the Date as a local date, ignoring the zone.
   *
   * <p>One advantage of this method is that this method is unaffected if the version of the time
   * zone data differs between the JDK and Joda-Time. That is because the local field values are
   * transferred, calculated using the JDK time zone data and without using the Joda-Time time zone
   * data.
   *
   * <p>This factory method always creates a LocalDate with ISO chronology.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs an instance set to the current local time evaluated using ISO chronology in the
   * default zone.
   *
   ...
   * specified zone.
   *
   * <p>If the specified time zone is null, the default zone is used. Once the constructor is
   * completed, the zone is no longer used.
   *
   ...
   *
   * <p>If the chronology is null, ISO chronology in the default time zone is used. Once the
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs an instance set to the local time defined by the specified instant evaluated using
   ...
   *
   * <p>If the chronology is null, ISO chronology in the default zone is used. Once the constructor
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs an instance from an Object that represents a datetime. The time zone will be
   * retrieved from the object if possible, otherwise the default time zone will be used.
   *
   * <p>If the object contains no chronology, <code>ISOChronology</code> is used. Once the
   * constructor is completed, the zone is no longer used.
   *
   * <p>The recognised object types are defined in {@link org.joda.time.convert.ConverterManager
   * ConverterManager} and include ReadablePartial, ReadableInstant, String, Calendar and Date. The
   * String formats are described by {@link ISODateTimeFormat#localDateParser()}. The default String
   * converter ignores the zone and only parses the field values.
   *
   ...
   * specified.
   *
   * <p>If the object contains no chronology, <code>ISOChronology</code> is used. If the specified
   * time zone is null, the default zone is used. Once the constructor is completed, the zone is no
   * longer used.
   *
   * <p>The recognised object types are defined in {@link org.joda.time.convert.ConverterManager
   * ConverterManager} and include ReadablePartial, ReadableInstant, String, Calendar and Date. The
  ...
  public LocalDate(Object instant, DateTimeZone zone) {
    ...
    int[] values =
        converter.getPartialValues(this, instant, chronology, ISODateTimeFormat.localDateParser());
   ...
   * chronology.
   *
   * <p>If the chronology is null, ISO in the default time zone is used. Once the constructor is
   * completed, the zone is no longer used. If the instant contains a chronology, it will be
   * ignored. For example, passing a {@code LocalDate} and a different chronology will return a date
   * with the year/month/day from the date applied unaltered to the specified chronology.
   *
   * <p>The recognised object types are defined in {@link org.joda.time.convert.ConverterManager
   * ConverterManager} and include ReadablePartial, ReadableInstant, String, Calendar and Date. The
   * String formats are described by {@link ISODateTimeFormat#localDateParser()}. The default String
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs an instance set to the specified date and time using <code>ISOChronology</code>.
   *
   * @param year the year
  ...
  /**
   * Constructs an instance set to the specified date and time using the specified chronology, whose
   * zone is ignored.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Gets the number of fields in this partial, which is three. The supported fields are Year,
   * MonthOfYear and DayOfMonth. Note that all fields from day and above may in fact be queried via
   * other methods.
   *
   ...
   * fields are Year, MonthOfYear and DayOfMonth. Note that all fields from day and above may in
   * fact be queried via other methods.
   *
  ...
  /**
   * Checks if the field type specified is supported by this local date and chronology. This can be
  ...
  // -----------------------------------------------------------------------
  /**
   * Converts this LocalDate to a full datetime at the earliest valid time for the date using the
   * default time zone.
   *
   ...
   *
   * <p>This method will throw an exception if the default time zone switches to Daylight Savings
   * Time at midnight and this LocalDate represents that switchover date. The problem is that there
   * is no such time as midnight on the required date, and as such an exception is thrown.
   *
   * <p>This instance is immutable and unaffected by this method call.
   *
   ...
   *
   * <p>This method will throw an exception if the time zone switches to Daylight Savings Time at
   * midnight and this LocalDate represents that switchover date. The problem is that there is no
   * such time as midnight on the required date, and as such an exception is thrown.
   *
   * <p>This method uses the chronology from this instance plus the time zone specified.
   *
   * <p>This instance is immutable and unaffected by this method call.
  ...
  // -----------------------------------------------------------------------
  /**
   * Converts this LocalDate to a full datetime using the default time zone setting the date fields
   * from this instance and the time fields from the current time.
   *
   * <p>This method will throw an exception if the datetime that would be created does not exist
   * when the time zone is taken into account.
   *
   * <p>This instance is immutable and unaffected by this method call.
   *
  ...
  /**
   * Converts this LocalDate to a full datetime using the specified time zone setting the date
   * fields from this instance and the time fields from the current time.
   *
   * <p>This method uses the chronology from this instance plus the time zone specified.
   *
   * <p>This method will throw an exception if the datetime that would be created does not exist
   ...
   *
   * <p>As from v1.5, you are recommended to avoid DateMidnight and use {@link
   * #toDateTimeAtStartOfDay()} instead because of the exception detailed below.
   *
   * <p>This method will throw an exception if the default time zone switches to Daylight Savings
   * Time at midnight and this LocalDate represents that switchover date. The problem is that there
   * is no such time as midnight on the required date, and as such an exception is thrown.
   ...
   *
   * <p>The resulting chronology is determined by the chronology of this LocalDate. The chronology
   * of the time must also match. If the time is null an exception is thrown.
   *
   * <p>This instance is immutable and unaffected by this method call.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Converts this object to a DateTime using a LocalTime to fill in the missing fields and using
   * the default time zone.
   *
   * <p>The resulting chronology is determined by the chronology of this LocalDate. The chronology
   * of the time must match.
   *
   * <p>If the time is null, this method delegates to {@link #toDateTimeAtCurrentTime(DateTimeZone)}
   * and the following documentation does not apply.
   *
   * <p>When the time zone is applied, the local date-time may be affected by daylight saving. In a
   * daylight saving gap, when the local time does not exist, this method will throw an exception.
   * In a daylight saving overlap, when the same local time occurs twice, this method returns the
   * first occurrence of the local time.
   *
   * <p>This instance is immutable and unaffected by this method call.
   *
   ...
   *
   * <p>The resulting chronology is determined by the chronology of this LocalDate plus the time
   * zone. The chronology of the time must match.
   *
   * <p>If the time is null, this method delegates to {@link #toDateTimeAtCurrentTime(DateTimeZone)}
   * and the following documentation does not apply.
   *
   ...
   *
   * <p>The interval may have more or less than 24 hours if this is a daylight savings cutover date.
   *
   * <p>This instance is immutable and unaffected by this method call.
   *
   ...
   *
   * <p>The <code>Date</code> object created has exactly the same year, month and day as this date.
   * The time will be set to the earliest valid time for that date.
   *
   * <p>Converting to a JDK Date is full of complications as the JDK Date constructor doesn't behave
   * as you might expect around DST transitions. This method works by taking a first guess and then
   * adjusting the JDK date until it has the earliest valid instant. This also handles the situation
   ...
   *
   * <p>The returned object will be a new instance of the same type. Only the millis will change,
   * the chronology is kept. The returned object will be either be a new instance or <code>this
   * </code>.
   *
   ...
   *
   * <p>For example, if the partial contains a year and a month then those two fields will be
   * changed in the returned instance. Unsupported fields are ignored. If the partial is null, then
   ...
   *
   * <p>For example, if the field type is <code>monthOfYear</code> then the month of year field will
   * be changed in the returned instance. If the field type is null, then <code>this</code> is
   * returned.
   *
   * <p>These two lines are equivalent:
   *
   * <pre>
   ...
   * {@link #plusYears(int)}.
   *
   * <p>Unsupported time fields are ignored, thus adding a period of 24 hours will not have any
   * effect.
   *
   ...
   *
   * <p>This adds the specified number of years to the date. If adding years makes the day-of-month
   * invalid, it is adjusted to the last valid day in the month. This LocalDate instance is
   ...
   *
   * <p>This adds the specified number of months to the date. The addition may change the year, but
   * the day-of-month is normally unchanged. If adding months makes the day-of-month invalid, it is
   * adjusted to the last valid day in the month. This LocalDate instance is immutable and
   ...
   *
   * <p>This LocalDate instance is immutable and unaffected by this method call.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
   ...
   *
   * <p>Unsupported time fields are ignored, thus subtracting a period of 24 hours will not have any
   * effect.
   *
   ...
   *
   * <p>This subtracts the specified number of years from the date. If subtracting years makes the
   * day-of-month invalid, it is adjusted to the last valid day in the month. This LocalDate
   ...
   *
   * <p>This subtracts the specified number of months from the date. The subtraction may change the
   * year, but the day-of-month is normally unchanged. If subtracting months makes the day-of-month
   * invalid, it is adjusted to the last valid day in the month. This LocalDate instance is
   * immutable and unaffected by this method call.
   *
   * <p>The following three lines are identical in effect:
   ...
   *
   * <p>This field is associated with the "weekyear" via {@link #getWeekyear()}. In the standard
   ...
   *
   * <p>The values for the day of month are defined in {@link org.joda.time.DateTimeConstants}.
   *
   ...
   *
   * <p>The values for the day of week are defined in {@link org.joda.time.DateTimeConstants}.
   *
   ...
   *
   * <p>LocalDate is immutable, so there are no set methods. Instead, this method returns a new
  ...
  public LocalDate withWeekyear(int weekyear) {
    return withYear(getChronology().weekyear().set(getLocalMillis(), weekyear).getYear());
  }
  ...
  // -----------------------------------------------------------------------
  /**
   * LocalDate.Property binds a LocalDate to a DateTimeField allowing powerful datetime
   ...
   * LocalDate - they do not modify the original. The example below yields two independent immutable
   ...
   * </pre>
   *
   * <p>LocalDate.Property itself is thread-safe and immutable, as well as the LocalDate being
   * operated on.
   *
   * @author Stephen Colebourne
  ...
  public static final class Property extends AbstractReadableInstantFieldProperty {
     ...
     *
     * <p>The LocalDate attached to this property is unchanged by this call.
     *
    ...
    /**
     * Adds to this field, possibly wrapped, in a copy of this LocalDate. A field wrapped operation
     * only changes this field. Thus 31st January addWrapField one day goes to the 1st January.
     *
     * <p>The LocalDate attached to this property is unchanged by this call.
     *
     * @param value the value to add to the field in the copy
     ...
     *
     * <p>This operation is useful for obtaining a LocalDate on the last day of the month, as month
     * lengths vary.
     *
     * <pre>
     ...
     *
     * <p>For example, rounding floor on the hourOfDay field of a LocalDate where the time is 10:30
     * would result in new LocalDate with the time of 10:00.
     *
     * @return a copy of the LocalDate with the field value changed
     */
     ...
     *
     * <p>For example, rounding floor on the hourOfDay field of a LocalDate where the time is 10:30
     * would result in new LocalDate with the time of 11:00.
     *
     * @return a copy of the LocalDate with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this LocalDate, favoring the
     * floor if halfway.
     *
     * @return a copy of the LocalDate with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this LocalDate. If halfway, the
