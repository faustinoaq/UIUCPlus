...
public final class TimeOfDay extends BasePartial implements ReadablePartial, Serializable {
  ...
  public TimeOfDay plusHours(int hours) {
    return withFieldAdded(DurationFieldType.minutes(), hours * 60); // convert hours to minutes
  }
  ...
  public static class Property extends AbstractPartialFieldProperty implements Serializable {
     ...
     * 00:00:00.000) then an Exception is thrown. For the alternate behaviour which wraps to the
