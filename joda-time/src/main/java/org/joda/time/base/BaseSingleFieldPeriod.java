...
/**
 * BaseSingleFieldPeriod is an abstract implementation of ReadablePeriod that manages a single
 * duration field, such as days or minutes.
 *
 * <p>This class should generally not be used directly by API users. The {@link ReadablePeriod}
 * interface should be used when different kinds of period objects are to be referenced.
 *
 * <p>BaseSingleFieldPeriod subclasses may be mutable and not thread-safe.
 *
...
public abstract class BaseSingleFieldPeriod
  ...
  protected static int between(
      ReadableInstant start, ReadableInstant end, DurationFieldType field) {
  ...
  /**
   * Creates a new instance representing the number of complete standard length units in the
   * specified period.
   *
  ...
  /**
   * Sets the amount of this period. To make a subclass immutable you must declare it final, or
   * block this method.
   *
   ...
   *
   * <p>If the field type specified does not match the type used by this class then zero is
   * returned.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Get this period as an immutable <code>Period</code> object. The period will use <code>
   * PeriodType.standard()</code>.
   *
   ...
   *
   * <p>This will always return a new <code>MutablePeriod</code> with the same fields. The period
   * will use <code>PeriodType.standard()</code>.
   *
   ...
   * All ReadablePeriod instances are accepted, but only those with a matching <code>PeriodType
   * </code> can return true.
   *
  ...
  public boolean equals(Object period) {
    ...
    ReadableInterval other = (ReadableInterval) period;
