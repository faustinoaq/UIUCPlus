 ...
 *
 * <p>This class has no concept of a chronology, all methods work on the millisecond instant.
 *
 * <p>This class should generally not be used directly by API users. The {@link ReadableInstant}
 * interface should be used when different kinds of date/time objects are to be referenced.
 *
 * <p>Whenever you want to implement <code>ReadableInstant</code> you should extend this class.
 *
 * <p>AbstractInstant itself is thread-safe and immutable, but subclasses may be mutable and not
 * thread-safe.
 *
...
public abstract class AbstractInstant implements ReadableInstant {
  ...
  public DateTime toDateTime() {
    return new DateTime(getMillis(), getMillis());
  }
   ...
   *
   * <p>The <code>Date</code> object created has exactly the same millisecond instant as this
   * object.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Is this instant strictly after the millisecond instant passed in comparing solely by
   * millisecond.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Is this instant strictly before the millisecond instant passed in comparing solely by
   * millisecond.
   *
   * @param instant a millisecond instant to check against
