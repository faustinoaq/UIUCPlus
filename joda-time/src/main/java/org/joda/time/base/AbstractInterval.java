 ...
 *
 * <p>This class should generally not be used directly by API users. The {@link ReadableInterval}
 * interface should be used when different kinds of intervals are to be referenced.
 *
 * <p>AbstractInterval subclasses may be mutable and not thread-safe.
 *
...
public abstract class AbstractInterval implements ReadableInterval {
  ...
  // -----------------------------------------------------------------------
  /**
   * Converts the duration of the interval to a <code>Period</code> using the All period type.
   *
   ...
   *
   * <p>From version 2.1, the string includes the time zone offset.
   *
