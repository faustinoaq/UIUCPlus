 ...
 *
 * <p><code>DateTime</code> is the most widely used implementation of {@link ReadableInstant}. As
 * with all instants, it represents an exact point on the time-line, but limited to the precision of
 * milliseconds. A <code>DateTime</code> calculates its fields with respect to a {@link DateTimeZone
 * time zone}.
 *
 * <p>Internally, the class holds two pieces of data. Firstly, it holds the datetime as milliseconds
 * from the Java epoch of 1970-01-01T00:00:00Z. Secondly, it holds a {@link Chronology} which
 * determines how the millisecond instant value is converted into the date time fields. The default
 * Chronology is {@link ISOChronology} which is the agreed international standard and compatible
 * with the modern Gregorian calendar.
 *
 ...
 * </ul>
 *
 * <p>DateTime is thread-safe and immutable, provided that the Chronology is as well. All standard
...
public final class DateTime extends BaseDateTime implements ReadableDateTime, Serializable {
  ...
  // -----------------------------------------------------------------------
  /**
   * Obtains a {@code DateTime} set to the current system millisecond time using <code>ISOChronology
   * </code> in the default time zone.
   *
  ...
  /**
   * Obtains a {@code DateTime} set to the current system millisecond time using <code>ISOChronology
   * </code> in the specified time zone.
   *
  ...
  /**
   * Obtains a {@code DateTime} set to the current system millisecond time using the specified
   * chronology.
   *
   ...
   *
   * <p>This uses {@link ISODateTimeFormat#dateTimeParser()}{@code .withOffsetParsed()} which is
   * different to passing a {@code String} to the constructor.
   *
   * <p>Sometimes this method and {@code new DateTime(str)} return different results. This can be
   * confusing as the difference is not visible in {@link #toString()}.
   *
   * <p>When passed a date-time string without an offset, such as '2010-06-30T01:20', both the
   * constructor and this method use the default time-zone. As such, {@code
   * DateTime.parse("2010-06-30T01:20")} and {@code new DateTime("2010-06-30T01:20"))} are equal.
   *
   * <p>However, when this method is passed a date-time string with an offset, the offset is
   * directly parsed and stored. As such, {@code DateTime.parse("2010-06-30T01:20+02:00")} and
   * {@code new DateTime("2010-06-30T01:20+02:00"))} are NOT equal. The object produced via this
   * method has a zone of {@code DateTimeZone.forOffsetHours(2)}. The object produced via the
   * constructor has a zone of {@code DateTimeZone.getDefault()}.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs an instance set to the current system millisecond time using <code>ISOChronology
   * </code> in the default time zone.
   *
   * @see #now()
   */
  ...
  /**
   * Constructs an instance set to the current system millisecond time using the specified
   * chronology.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs an instance set to the milliseconds from 1970-01-01T00:00:00Z using <code>
   * ISOChronology</code> in the default time zone.
   *
  ...
  /**
   * Constructs an instance set to the milliseconds from 1970-01-01T00:00:00Z using <code>
   * ISOChronology</code> in the specified time zone.
   *
   * <p>If the specified time zone is null, the default zone is used.
   *
   * @param instant the milliseconds from 1970-01-01T00:00:00Z
  ...
  /**
   * Constructs an instance set to the milliseconds from 1970-01-01T00:00:00Z using the specified
   * chronology.
   *
   * <p>If the chronology is null, <code>ISOChronology</code> in the default time zone is used.
   *
   ...
   *
   * <p>If the object implies a chronology (such as GregorianCalendar does), then that chronology
   * will be used. Otherwise, ISO default is used. Thus if a GregorianCalendar is passed in, the
   * chronology used will be GJ, but if a Date is passed in the chronology will be ISO.
   *
  ...
  /**
   * Constructs an instance from an Object that represents a datetime, forcing the time zone to that
   * specified.
   *
   * <p>If the object implies a chronology (such as GregorianCalendar does), then that chronology
   * will be used, but with the time zone adjusted. Otherwise, ISO is used in the specified time
   * zone. If the specified time zone is null, the default zone is used. Thus if a GregorianCalendar
   * is passed in, the chronology used will be GJ, but if a Date is passed in the chronology will be
   * ISO.
   *
   * <p>The recognised object types are defined in {@link org.joda.time.convert.ConverterManager
   * ConverterManager} and include ReadableInstant, String, Calendar and Date. The String formats
  ...
  /**
   * Constructs an instance from an Object that represents a datetime, using the specified
   * chronology.
   *
   * <p>If the chronology is null, ISO in the default time zone is used. Any chronology implied by
   * the object (such as GregorianCalendar does) is ignored.
   *
   * <p>The recognised object types are defined in {@link org.joda.time.convert.ConverterManager
   * ConverterManager} and include ReadableInstant, String, Calendar and Date. The String formats
   * are described by {@link ISODateTimeFormat#dateTimeParser()}.
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs an instance from datetime field values using <code>ISOChronology</code> in the
   * default time zone.
   *
   * @param year the year
  ...
  /**
   * Get this object as a DateTime using ISOChronology in the default zone, returning <code>this
   * </code> if possible.
   *
   ...
   *
   * <p>The returned object will be either be a new instance or <code>this</code>. Only the millis
   * will change, the chronology and time zone are kept.
   *
   ...
   *
   * <p>The returned object will be either be a new instance or <code>this</code>. Only the
   * chronology will change, the millis are kept.
   *
   ...
   *
   * <p>This method is useful for finding the local time in another timezone. For example, if this
   * instant holds 12:30 in Europe/London, the result from this method with Europe/Paris would be
   * 13:30.
   *
   * <p>The returned object will be a new instance of the same implementation type. This method
   * changes the time zone, and does not change the millisecond instant, with the effect that the
   * field values usually change. The returned object will be either be a new instance or <code>this
   * </code>.
   *
   ...
   *
   * <p>This method is useful for finding the millisecond time in another timezone. For example, if
   * this instant holds 12:30 in Europe/London (ie. 12:30Z), the result from this method with
   * Europe/Paris would be 12:30 (ie. 11:30Z).
   *
   * <p>The returned object will be a new instance of the same implementation type. This method
   * changes the time zone and the millisecond instant to keep the field values the same. The
   * returned object will be either be a new instance or <code>this</code>.
   *
   ...
   *
   * <p>This method only has any effect when the local time-line overlaps, such as at an autumn
   * daylight savings cutover. In this scenario, there are two valid offsets for the local
   * date-time. Calling this method will return a date-time with the earlier of the two selected.
   *
   * <p>If this method is called when it is not an overlap, this is returned.
   *
   ...
   * <p>This method only has any effect when the local time-line overlaps, such as at an autumn
   * daylight savings cutover. In this scenario, there are two valid offsets for the local
   * date-time. Calling this method will return a date-time with the later of the two selected.
   *
   * <p>If this method is called when it is not an overlap, this is returned.
   *
   * <p>This instance is immutable and unaffected by this method call.
   ...
   *
   * <p>If the date is already the date passed in, then <code>this</code> is returned.
   *
   * <p>To set a single field use the properties, for example:
   *
   * <pre>
   * DateTime set = monthOfYear().setCopy(6);
   * </pre>
   *
   * <p>If the time is invalid on the new date due to the time-zone, the time will be adjusted.
   *
   * <p>This instance is immutable and unaffected by this method call.
   *
  ...
  public DateTime withDate(int year, int monthOfYear, int dayOfMonth) {
    ...
    long localInstant =
        chrono.withUTC().getDateTimeMillis(year, monthOfYear, dayOfMonth, getMillisOfDay());
   ...
   *
   * <p>If the time is already the time passed in, then <code>this</code> is returned.
   *
   * <p>To set a single field use the properties, for example:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>If the new time is invalid due to the time-zone, the time will be adjusted.
   *
   * <p>This instance is immutable and unaffected by this method call.
   *
   ...
   *
   * <p>The time will normally be midnight, as that is the earliest time on any given day. However,
   * in some time zones when Daylight Savings Time starts, there is no midnight because time jumps
   * from 11:59 to 01:00. This method handles that situation by returning 01:00 on that date.
   *
   * <p>This instance is immutable and unaffected by this method call.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Returns a copy of this datetime with the partial set of fields replacing those from this
   * instance.
   *
   * <p>For example, if the partial is a <code>TimeOfDay</code> then the time fields would be
   * changed in the returned instance. If the partial is null, then <code>this</code> is returned.
   *
   ...
   *
   * <p>For example, if the field type is <code>hourOfDay</code> then the hour of day field would be
   * changed in the returned instance. If the field type is null, then <code>this</code> is
   * returned.
   *
   ...
   *
   * <p>If the addition is zero or the field is null, then <code>this</code> is returned.
   *
   * <p>These three lines are equivalent:
   *
   * <pre>
   ...
   * Returns a copy of this datetime with the specified duration added.
   *
   * <p>If the amount is zero or null, then <code>this</code> is returned. This datetime instance is
   ...
   * Returns a copy of this datetime with the specified period added.
   *
   * <p>This method will add each element of the period one by one, from largest to smallest,
   * adjusting the datetime to be accurate between each.
   *
   * <p>Thus, adding a period of one month and one day to 2007-03-31 will work as follows: First add
   * one month and adjust, resulting in 2007-04-30 Then add one day and adjust, resulting in
   * 2007-05-01.
   *
   * <p>This method is typically used to add complex period instances. Adding one field is best
   * achieved using methods like {@link #plusYears(int)}.
   *
   * <p>If the amount is zero or null, then <code>this</code> is returned. This datetime instance is
   * immutable and unaffected by this method call.
   *
   ...
   *
   * <p>The calculation will do its best to only change the year field retaining the same month of
   * year. However, in certain circumstances, it may be necessary to alter smaller fields. For
   * example, 2008-02-29 plus one year cannot result in 2009-02-29, so the day of month is adjusted
   * to 2009-02-28.
   *
   ...
   * </pre>
   *
   * <p>This datetime instance is immutable and unaffected by this method call.
   *
   ...
   *
   * <p>The calculation will do its best to only change the month field retaining the same day of
   * month. However, in certain circumstances, it may be necessary to alter smaller fields. For
   * example, 2007-03-31 plus one month cannot result in 2007-04-31, so the day of month is adjusted
   * to 2007-04-30.
   *
   * <p>The following three lines are identical in effect:
   *
   ...
   *
   * <p>The calculation operates as if it were adding the equivalent in days.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
   ...
   *
   * <p>The calculation will do its best to only change the day field retaining the same time of
   * day. However, in certain circumstances, typically daylight savings cutover, it may be necessary
   * to alter the time fields.
   *
   * <p>In spring an hour is typically removed. If adding one day results in the time being within
   * the cutover then the time is adjusted to be within summer time. For example, if the cutover is
   * from 01:59 to 03:00 and the result of this method would have been 02:30, then the result will
   * be adjusted to 03:30.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
   ...
   *
   * <p>The calculation will add a duration equivalent to the number of hours expressed in
   * milliseconds.
   *
   * <p>For example, if a spring daylight savings cutover is from 01:59 to 03:00 then adding one
   * hour to 01:30 will result in 03:30. This is a duration of one hour later, even though the hour
   * field value changed from 1 to 3.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
   ...
   *
   * <p>The calculation will add a duration equivalent to the number of minutes expressed in
   * milliseconds.
   *
   * <p>The following three lines are identical in effect:
   *
   ...
   *
   * <p>The calculation will add a duration equivalent to the number of seconds expressed in
   * milliseconds.
   *
   * <p>The following three lines are identical in effect:
   *
   ...
   *
   * <p>The calculation will add a duration equivalent to the number of milliseconds.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
   ...
   *
   * <p>This method will subtract each element of the period one by one, from largest to smallest,
   * adjusting the datetime to be accurate between each.
   *
   * <p>Thus, subtracting a period of one month and one day from 2007-05-31 will work as follows:
   * First subtract one month and adjust, resulting in 2007-04-30 Then subtract one day and adjust,
   * resulting in 2007-04-29. Note that the day has been adjusted by two.
   *
   * <p>This method is typically used to subtract complex period instances. Subtracting one field is
   * best achieved using methods like {@link #minusYears(int)}.
   *
   * <p>If the amount is zero or null, then <code>this</code> is returned. This datetime instance is
   * immutable and unaffected by this method call.
   *
   ...
   * <p>The calculation will do its best to only change the year field retaining the same month of
   * year. However, in certain circumstances, it may be necessary to alter smaller fields. For
   * example, 2008-02-29 minus one year cannot result in 2007-02-29, so the day of month is adjusted
   * to 2007-02-28.
   *
   * <p>The following three lines are identical in effect:
   *
   ...
   * <p>The calculation will do its best to only change the month field retaining the same day of
   * month. However, in certain circumstances, it may be necessary to alter smaller fields. For
   * example, 2007-05-31 minus one month cannot result in 2007-04-31, so the day of month is
   * adjusted to 2007-04-30.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
   ...
   *
   * <p>The calculation operates as if it were subtracting the equivalent in days.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
   ...
   * to alter the time fields.
   *
   * <p>In spring an hour is typically removed. If subtracting one day results in the time being
   * within the cutover then the time is adjusted to be within summer time. For example, if the
   * cutover is from 01:59 to 03:00 and the result of this method would have been 02:30, then the
   * result will be adjusted to 03:30.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
   ...
   *
   * <p>The calculation will subtract a duration equivalent to the number of hours expressed in
   * milliseconds.
   *
   * <p>For example, if a spring daylight savings cutover is from 01:59 to 03:00 then subtracting
   * one hour from 03:30 will result in 01:30. This is a duration of one hour earlier, even though
   ...
   *
   * <p>The calculation will subtract a duration equivalent to the number of minutes expressed in
   * milliseconds.
   *
   * <p>The following three lines are identical in effect:
   *
   ...
   *
   * <p>The calculation will subtract a duration equivalent to the number of seconds expressed in
   * milliseconds.
   *
   * <p>The following three lines are identical in effect:
   *
   ...
   *
   * <p>The calculation will subtract a duration equivalent to the number of milliseconds.
   *
   * <p>The following three lines are identical in effect:
   *
   * <pre>
  ...
  /**
   * Converts this object to a <code>LocalDateTime</code> with the same datetime and chronology.
   *
  ...
  public LocalDate toLocalDate() {
    return new LocalDate(getMillis(), getChronology(), null);
  }

  /**
   * Converts this object to a <code>LocalTime</code> with the same time and chronology.
   *
   ...
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of era changed.
   *
   ...
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of century of era changed.
   *
   ...
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of year of era changed.
   *
   ...
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of year of century changed.
   *
   ...
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of year changed.
   *
   ...
   *
   * <p>The weekyear is the year that matches with the weekOfWeekyear field. In the standard ISO8601
   * week algorithm, the first week of the year is that in which at least 4 days are in the year. As
   * a result of this definition, day 1 of the first week may be in the previous year. The weekyear
   * allows you to query the effective year for that day.
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of weekyear changed.
   *
   ...
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of month of year changed.
   *
   ...
   *
   * <p>This field is associated with the "weekyear" via {@link #withWeekyear(int)}. In the standard
   * ISO8601 week algorithm, the first week of the year is that in which at least 4 days are in the
   * year. As a result of this definition, day 1 of the first week may be in the previous year.
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of week of weekyear changed.
   *
   ...
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of day of year changed.
   *
   ...
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of day of month changed.
   *
   ...
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of day of week changed.
   *
   ...
   *
   * <p>DateTime is immutable, so there are no set methods. Instead, this method returns a new
   * instance with the value of millis of day changed.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * DateTime.Property binds a DateTime to a DateTimeField allowing powerful datetime functionality
   * to be easily accessed.
   *
   * <p>The simplest use of this class is as an alternative get method, here used to get the year
   * '1972' (as an int) and the month 'December' (as a String).
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Methods are also provided that allow date modification. These return new instances of
   * DateTime - they do not modify the original. The example below yields two independent immutable
   * date objects 20 years apart.
   *
   * <pre>
   * DateTime dt = new DateTime(1972, 12, 3, 0, 0, 0, 0);
   ...
   * </pre>
   *
   * Serious modification of dates (ie. more than just changing one or two fields) should use the
   * {@link org.joda.time.MutableDateTime MutableDateTime} class.
   *
   * <p>DateTime.Propery itself is thread-safe and immutable, as well as the DateTime being operated
   * on.
   *
   * @author Stephen Colebourne
   * @author Brian S O'Neill
  ...
  public static final class Property extends AbstractReadableInstantFieldProperty {
     ...
     *
     * <p>The DateTime attached to this property is unchanged by this call. This operation is faster
     * than converting a DateTime to a MutableDateTime and back again when setting one field. When
     * setting multiple fields, it is generally quicker to make the conversion to MutableDateTime.
     *
    ...
    /**
     * Adds to this field, possibly wrapped, in a copy of this DateTime. A wrapped operation only
     * changes this field. Thus 31st January addWrapField one day goes to the 1st January.
     *
     * <p>The DateTime attached to this property is unchanged by this call. This operation is faster
     * than converting a DateTime to a MutableDateTime and back again when setting one field. When
     * setting multiple fields, it is generally quicker to make the conversion to MutableDateTime.
     ...
     *
     * <p>This operation is useful for obtaining a DateTime on the last day of the month, as month
     * lengths vary.
     *
     * <pre>
     ...
     * </pre>
     *
     * <p>Where possible, the offset from UTC will be retained, thus applications may need to call
     * {@link DateTime#withLaterOffsetAtOverlap()} on the result to force the later time during a
     * DST overlap if desired.
     *
     * <p>From v2.2, this method handles a daylight savings time gap, setting the time to the last
     * instant before the gap.
     *
     * <p>The DateTime attached to this property is unchanged by this call.
     *
     ...
     *
     * <p>Where possible, the offset from UTC will be retained, thus applications may need to call
     * {@link DateTime#withEarlierOffsetAtOverlap()} on the result to force the earlier time during
     * a DST overlap if desired.
     *
     * <p>From v2.2, this method handles a daylight savings time gap, setting the time to the first
      ...
      try {
        ...
        if (IllegalInstantException.isIllegalInstant(ex)) {
          ...
          long afterGap =
              getChronology()
                  .getZone()
                  .nextTransition(getMillis() - DateTimeConstants.MILLIS_PER_DAY);
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this DateTime, favoring the floor
     * if halfway.
     *
     * @return a copy of the DateTime with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this DateTime, favoring the
     * ceiling if halfway.
     *
     * @return a copy of the DateTime with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this DateTime. If halfway, the
     * ceiling is favored over the floor only if it makes this field's value even.
     *
     * @return a copy of the DateTime with the field value changed
     */
