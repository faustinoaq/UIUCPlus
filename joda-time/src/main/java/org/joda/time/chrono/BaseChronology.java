...
/**
 * BaseChronology provides a skeleton implementation for chronology classes. Many utility methods
 * are defined, but all fields are unsupported.
 *
 * <p>BaseChronology is thread-safe and immutable, and all subclasses must be as well.
 *
...
public abstract class BaseChronology extends Chronology implements Serializable {
  ...
  public DateTimeField dayOfYear() {
    return UnsupportedDateTimeField.getInstance(DateTimeFieldType.dayOfYear(), "null");
  }
