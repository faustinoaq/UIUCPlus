 ...
 *
 * <p>The chronology is identical to the Gregorian/Julian, except that the year is offset by +543
 * and the era is named 'BE' for Buddhist Era.
 *
 * <p>This class was intended by Sun to model the calendar used in Thailand. However, the actual
 * rules for Thailand are much more involved than this class covers. (This class is accurate after
 * 1941-01-01 ISO).
 *
 * <p>This chronology is being retained for those who want a same effect replacement for the Sun
 * class. It is hoped that community support will enable a more accurate chronology for Thailand, to
 * be developed.
 *
 * <p>BuddhistChronology is thread-safe and immutable.
 *
...
public final class BuddhistChronology extends AssembledChronology {
  ...
  /**
   * Constant value for 'Buddhist Era', equivalent to the value returned for AD/CE. Note that this
   * differs from the constant in BuddhistCalendar.
   */
