...
/**
 * Implements the Ethiopic calendar system, which defines every fourth year as leap, much like the
 ...
 * a 13th month.
 *
 * <p>Year 1 in the Ethiopic calendar began on August 29, 8 CE (Julian), thus Ethiopic years do not
 * begin at the same time as Julian years. This chronology is not proleptic, as it does not allow
 * dates before the first Ethiopic year.
 *
 ...
 *
 * <p>EthiopicChronology is thread-safe and immutable.
 *
...
public final class EthiopicChronology extends BasicFixedMonthChronology {
  ...
  private static final ConcurrentHashMap<DateTimeZone, EthiopicChronology[]> cCache =
      new ConcurrentHashMap<DateTimeZone, EthiopicChronology[]>();
  ...
  private Object readResolve() {
    ...
    return base == null
        ? getInstance(DateTimeZone.getDefault(), getMinimumDaysInFirstWeek())
