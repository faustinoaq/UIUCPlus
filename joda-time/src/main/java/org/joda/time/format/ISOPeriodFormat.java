 ...
 *
 * <p>ISOPeriodFormat is thread-safe and immutable, and the formatters it returns are as well.
 *
...
public class ISOPeriodFormat {
  ...
  // -----------------------------------------------------------------------
  /**
   * The standard ISO format - PyYmMwWdDThHmMsS. Milliseconds are not output. Note that the ISO8601
   * standard actually indicates weeks should not be shown if any other field is present and vice
   * versa.
   *
   ...
   *
   * <p>Even if weeks are present in the period, they are not output. Fractional seconds
   * (milliseconds) will appear if required.
   *
   * @return the formatter
   */
   ...
   *
   * <p>Even if months are present in the period, they are not output. Fractional seconds
   * (milliseconds) will appear if required.
   *
   * @return the formatter
   */
