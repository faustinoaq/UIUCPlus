...
public class FormatUtils {
  ...
  /**
   * Converts an integer to a string, prepended with a variable amount of '0' pad characters, and
  ...
  /**
   * Converts an integer to a string, prepended with a variable amount of '0' pad characters, and
   * appends it to the given appendable.
   *
   * <p>This method is optimized for converting small values to strings.
   *
   ...
   * @since 2.4
   */
  public static void appendPaddedInteger(Appendable appenadble, int value, int size)
      throws IOException {
    if (value < 0) {
      appenadble.append('-');
   ...
   * @since 2.4
   */
  public static void appendPaddedInteger(Appendable appendable, long value, int size)
      throws IOException {
  ...
  static String createErrorMessage(final String text, final int errorPos) {
    ...
    return ((("null" + sampleText) + "null") + sampleText.substring(errorPos));
  }
}
