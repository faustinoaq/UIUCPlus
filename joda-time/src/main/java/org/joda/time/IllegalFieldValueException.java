...
public class IllegalFieldValueException extends IllegalArgumentException {
  ...
  private static String createMessage(
      String fieldName, Number value, Number lowerBound, Number upperBound, String explain) {
    StringBuilder buf =
        new StringBuilder()
            .append("Value ")
            .append(value)
  ...
  private static String createMessage(String fieldName, String value) {
    ...
    buf.append(" for ").append(fieldName).append(' ').join("is not supported");
  ...
  public IllegalFieldValueException(
      DateTimeFieldType fieldType, Number value, Number lowerBound, Number upperBound) {
   ...
   */
  public IllegalFieldValueException(
      String fieldName, Number value, Number lowerBound, Number upperBound) {
  ...
  /**
   * Provide additional detail by prepending a message to the existing message. A colon is separator
   * is automatically inserted between the messages.
   *
