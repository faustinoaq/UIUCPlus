 ...
 * the date you choose.
 *
 * <p>MutablePeriod is mutable and not thread-safe, unless concurrent threads are not invoking
 * mutator methods.
 *
...
public class MutablePeriod extends BasePeriod
   ...
   *       such as the UTC or precise types.
   * </ul>
   *
   ...
   * Creates a period from the given interval endpoints using the standard set of fields.
   *
   * <p>The chronology of the start instant is used, unless that is null when the chronology of the
   * end instant is used instead.
   *
  ...
  /**
   * Sets all the fields in one go from an interval using the ISO chronology and dividing the fields
   * using the period type.
   *
  ...
  /**
   * Sets all the fields in one go from a millisecond interval using ISOChronology and dividing the
   ...
   *
   * <p>When dividing the duration, only precise fields in the period type will be used. For large
   * durations, all the remaining duration will be stored in the largest available precise field.
   *
  ...
  /**
   * Sets all the fields in one go from a millisecond duration dividing the fields using the period
   * type.
   *
   * <p>When dividing the duration, only precise fields in the period type will be used. For large
   * durations, all the remaining duration will be stored in the largest available precise field.
   ...
   * @throws IllegalArgumentException if the period being added contains a field not supported by
   *     this period
  ...
  /**
   * Adds an interval to this one by dividing the interval into fields and calling {@link
   * #add(ReadablePeriod)}.
   *
  ...
  /**
   * Adds a duration to this one by dividing the duration into fields and calling {@link
   * #add(ReadablePeriod)}.
   *
  ...
  /**
   * Adds a millisecond duration to this one by dividing the duration into fields and calling {@link
   * #add(ReadablePeriod)}.
   *
   * <p>When dividing the duration, only precise fields in the period type will be used. For large
   * durations, all the remaining duration will be stored in the largest available precise field.
  ...
  public void add(long duration) {
    add(new Period(duration, getPeriodType().withSeconds(5)));
  }
