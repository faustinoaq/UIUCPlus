...
/**
 * AbstractReadableInstantFieldProperty is a base class for binding a ReadableInstant to a
 * DateTimeField.
 *
 * <p>It allows the date and time manipulation code to be field based yet still easy to use.
 *
 * <p>AbstractReadableInstantFieldProperty itself is thread-safe and immutable, but the
...
public abstract class AbstractReadableInstantFieldProperty implements Serializable {
   ...
   *
   * <p>This implementation throws UnsupportedOperationException, and must be implemented by
   * subclasses to enable the equals() and hashCode() methods.
   *
   ...
   *
   * <p>For example, the following two lines of code are equivalent:
   *
   * <pre>
   ...
   *
   * <p>This method returns the value converted to a <code>String</code> using <code>
   * Integer.toString</code>. This method does NOT return textual descriptions such as 'Monday' or
   * 'January'. See {@link #getAsText()} and {@link #getAsShortText()} for those.
   *
   * @return the current value
   * @see DateTimeField#get
   * @since 1.1
   ...
   *
   * <p>This method returns the value converted to a <code>String</code> returning the appropriate
   * textual description wherever possible. Thus, a day of week of 1 would return 'Monday' in
   * English.
   *
  ...
  /**
   * Gets the short textual value of this property from the instant as a string in the default
   * locale.
   *
   * <p>This method returns the value converted to a <code>String</code> returning the appropriate
   * textual description wherever possible. Thus, a day of week of 1 would return 'Mon' in English.
   *
   * @return the current text value
  ...
  /**
   * Gets the short textual value of this property from the instant as a string in the specified
   * locale.
   *
   * <p>This method returns the value converted to a <code>String</code> returning the appropriate
   * textual description wherever possible. Thus, a day of week of 1 would return 'Mon' in English.
  ...
  // -----------------------------------------------------------------------
  /**
   * Returns the difference between this field property instant and the one passed in, in the units
   * of this field. The sign of the difference matches that of compareTo. In other words, this field
   * property's instant is the minuend.
   *
   ...
   *
   * <p>For example, <code>datetime.monthOfYear().toInterval()</code> will return an interval over
   * the whole month.
   *
   ...
   *
   * <p>The comparison is based on the value of the same field type, irrespective of any difference
   * in chronology. Thus, if this property represents the hourOfDay field, then the hourOfDay field
   * of the other instant will be queried whether in the same chronology or not.
   *
   ...
   * <p>The comparison is based on the value of the same field type, irrespective of any difference
   * in chronology. Thus, if this property represents the hourOfDay field, then the hourOfDay field
   * of the other partial will be queried whether in the same chronology or not.
   *
  ...
  public int compareTo(ReadablePartial partial) {
    ...
    if ((this == otherValue) || (thisValue < otherValue)) {
      return -1;
    } else if (thisValue > otherValue) {
      return 1;
    } else {
