...
/**
 * <code>DelegatedDateTimeField</code> delegates each method call to the date time field it wraps.
 *
...
public class DelegatedDateTimeField extends DateTimeField implements Serializable {
  ...
  public DelegatedDateTimeField(
      DateTimeField field, DurationField rangeField, DateTimeFieldType type) {
    super();
    if (field == null) {
  ...
  public int[] set(
    ...
    return iField.set(instant, fieldIndex + 1, values, text, locale);
  }
