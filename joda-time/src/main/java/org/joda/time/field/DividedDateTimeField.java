...
/**
 * Divides a DateTimeField such that the retrieved values are reduced by a fixed divisor. The
 * field's unit duration is scaled accordingly, but the range duration is unchanged.
 *
 * <p>DividedDateTimeField is thread-safe and immutable.
 *
...
public class DividedDateTimeField extends DecoratedDateTimeField {
   ...
   */
  public DividedDateTimeField(
      RemainderDateTimeField remainderField, DurationField rangeField, DateTimeFieldType type) {
  ...
  /**
   * Add the specified amount of scaled units to the specified time instant. The amount added may be
   * negative.
   *
  ...
  /**
   * Add to the scaled component of the specified time instant, wrapping around within that
  ...
  public long remainder(long instant) {
    return set(instant, get(getDurationField().remainder(instant)));
  }
