 ...
 *
 * <p>If performing significant calculations on an interval, it may be faster to convert an Interval
 * object to a MutableInterval one.
 *
 * <p>MutableInterval is mutable and not thread-safe, unless concurrent threads are not invoking
 * mutator methods.
 *
...
public class MutableInterval extends BaseInterval
  ...
  /**
   * Sets this interval from two instants, replacing the chronology with that from the start
   * instant.
   *
  ...
  public void setChronology(Chronology chrono) {
    super.setChronology(chrono);
  }

  /**
   * Sets the start of this time interval.
   *
   * @param startInstant the start of the time interval, millisecond instant from
  ...
  // -----------------------------------------------------------------------
  /**
   * Sets the period of this time interval, preserving the start instant and using the ISOChronology
   * in the default zone for calculations.
   *
  ...
  /**
   * Sets the period of this time interval, preserving the end instant and using the ISOChronology
   * in the default zone for calculations.
   *
   * @param period new period for interval, null means zero length
   * @throws IllegalArgumentException if the end is before the start
