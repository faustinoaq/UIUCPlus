 ...
 * would change the size is disallowed. However, the {@code put} or {@code setValue} methods can
 * <i>change</i> the value associated with the key.
 *
...
public class SingletonMap<K, V>
  ...
  /**
   * Gets the entrySet view of the map. Changes made via {@code setValue} affect this map. To simply
   * iterate through the entries, use {@link #mapIterator()}.
   *
