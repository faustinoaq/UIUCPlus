...
public abstract class AbstractDualBidiMap<K, V> implements BidiMap<K, V> {
   ...
   * subclass constructor must populate the {@code maps[]} instance variable itself.
   *
  ...
  // BidiMap
  /**
   * Obtains a {@code MapIterator} over the map. The iterator implements {@link BidiMapIterator}.
  ...
  protected abstract static class View<K, V, E> extends AbstractCollectionDecorator<E> {
     ...
     * turn to see if it's contained in {@code coll}. If it's not contained, it's removed from this
     * bidi map. As a consequence, it is advised to use a collection type for {@code coll} that
