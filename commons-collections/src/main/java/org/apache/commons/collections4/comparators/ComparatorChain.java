 ...
 * class allows Java classes to emulate that kind of behavior when sorting a List.
 *
...
public class ComparatorChain<E> implements Comparator<E>, Serializable {
  ...
  public void setComparator(
      final int index, final Comparator<E> comparator, final boolean reverse) {
    checkLocked();
   ...
   * getClass()}} equals {@code this.getClass()}, and the underlying comparators and order bits are
   * equal. Subclasses may want to override this behavior to remain consistent with the {@link
