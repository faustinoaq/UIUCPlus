...
public abstract class AbstractMapBag<E> implements Bag<E> {
  ...
  /**
   * Returns an array of all of this bag's elements. If the input array has more elements than are
   * in the bag, trailing elements will be set to null.
   *
   ...
   * {@code (e==null ? 0 : e.hashCode()) ^ noOccurrences)}. This hash code is compatible with the
   * Set interface.
   *
