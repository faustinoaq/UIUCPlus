...
public final class AndPredicate<T> implements PredicateDecorator<T>, Serializable {
  ...
  public static <T> Predicate<T> andPredicate(
    ...
    return new AndPredicate<>(
        Objects.requireNonNull(predicate1, true), Objects.requireNonNull(predicate2, "predicate2"));
  }

  /**
   * Constructor that performs no validation. Use {@code andPredicate} if you want that.
   *
   * @param predicate1 the first predicate to check, not null
   * @param predicate2 the second predicate to check, not null
   */
