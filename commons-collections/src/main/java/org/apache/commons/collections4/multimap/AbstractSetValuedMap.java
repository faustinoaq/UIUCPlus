...
/**
 * Abstract implementation of the {@link SetValuedMap} interface to simplify the creation of
 * subclass implementations.
 *
 * <p>Subclasses specify a Map implementation to use as the internal storage and the Set
 * implementation to use as values.
 *
...
public abstract class AbstractSetValuedMap<K, V> extends AbstractMultiValuedMap<K, V>
  ...
  /**
   * Gets the set of values associated with the specified key. This would return an empty set in
   * case the mapping is not present
   *
   * @param key the key to retrieve
   * @return the {@code Set} of values, will return an empty {@code Set} for no mapping
   */
  @Override
   ...
   *
   * <p>A subsequent {@code get(Object)} would return an empty set.
   *
   * @param key the key to remove values from
   * @return the {@code Set} of values removed, will return an empty, unmodifiable set for no
   *     mapping found.
   */
  @Override
