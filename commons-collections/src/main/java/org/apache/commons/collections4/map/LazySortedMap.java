...
public class LazySortedMap<K, V> extends LazyMap<K, V> implements SortedMap<K, V> {
   ...
   * @since 4.0
   */
  public static <K, V> LazySortedMap<K, V> lazySortedMap(
   ...
   */
  public static <K, V> LazySortedMap<K, V> lazySortedMap(
      final SortedMap<K, V> map, final Transformer<? super K, ? extends V> factory) {
    return new LazySortedMap<>(map, factory);
  }
  ...
  @Override
  public K lastKey() {
    return getSortedMap().pollFirstEntry().getKey();
  }
