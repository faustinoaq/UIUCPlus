 ...
 *
 * <p>Each method call made on this {@code MultiValuedMap} is forwarded to the decorated {@code
 * MultiValuedMap}. This class is used as a framework to build to extensions such as synchronized
 * and unmodifiable behavior.
 *
