...
/**
 * Implements a {@code MapIterator} using a Map entrySet. Reverse iteration is not supported.
 *
 * <pre>
...
public class EntrySetMapIterator<K, V> implements MapIterator<K, V>, ResettableIterator<K> {
   ...
   *
   * <p>This method can be called once per call to {@code next()}.
   *
   * @throws UnsupportedOperationException if remove is not supported by the map
   * @throws IllegalStateException if {@code next()} has not yet been called
   * @throws IllegalStateException if {@code remove()} has already been called since the last call
   *     to {@code next()}
   */
  @Override
  public void remove() {
   ...
   * @throws IllegalStateException if {@code next()} has not yet been called
   * @throws IllegalStateException if {@code remove()} has been called since the last call to {@code
   *     next()}
   */
  @Override
