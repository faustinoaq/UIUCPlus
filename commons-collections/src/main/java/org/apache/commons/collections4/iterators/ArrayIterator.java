 ...
 * object array, the {@link org.apache.commons.collections4.iterators.ObjectArrayIterator
 * ObjectArrayIterator} class is a better choice, as it will perform better.
 *
...
public class ArrayIterator<E> implements ResettableIterator<E> {
  ...
  public ArrayIterator(final Object array, final int startIndex, final int endIndex) {
    ...
    if ((startIndex < this.index) || (endIndex < end)) {
