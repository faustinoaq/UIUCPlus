 ...
 *
 * <p>The "put" and "get" type constraints of this class are mutually independent; contrast with
 * {@link org.apache.commons.collections4.map.TransformedMap} which, by virtue of its implementing
 * {@link Map}&lt;K, V&gt;, must be constructed in such a way that its read and write parameters are
 * generalized to a common (super-)type. In practice this would often mean {@code &gt;Object,
 * Object&gt;}, defeating much of the usefulness of having parameterized types.
 *
 * <p>On the downside, this class is not drop-in compatible with {@link java.util.Map} but is
 * intended to be worked with either directly or by {@link Put} and {@link
 * org.apache.commons.collections4.Get Get} generalizations.
 *
...
public class TransformedSplitMap<J, K, U, V> extends AbstractIterableGetMapDecorator<K, V>
   ...
   */
  public static <J, K, U, V> TransformedSplitMap<J, K, U, V> transformingMap(
      final Map<K, V> map,
