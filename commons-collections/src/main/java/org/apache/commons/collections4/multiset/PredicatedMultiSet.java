...
/**
 * Decorates another {@link MultiSet} to validate that additions match a specified predicate.
 *
 * <p>This multiset exists to provide validation for the decorated multiset. It is normally created
 * to decorate an empty multiset. If an object cannot be added to the multiset, an {@link
 * IllegalArgumentException} is thrown.
 *
 * <p>One usage would be to ensure that no null entries are added to the multiset.
 *
 * <pre>
 * MultiSet&lt;E&gt; set =
...
public class PredicatedMultiSet<E> extends PredicatedCollection<E> implements MultiSet<E> {
   ...
   *
   * <p>If there are any elements already in the multiset being decorated, they are validated.
   *
   ...
   */
  public static <E> PredicatedMultiSet<E> predicatedMultiSet(
      final MultiSet<E> multiset, final Predicate<? super E> predicate) {
  ...
  public Set<E> uniqueSet() {
    return decorated().uniqueSet().removeAll(decorated());
  }
