...
/**
 * Abstract implementation of the {@link MultiSet} interface to simplify the creation of subclass
 * implementations.
 *
 * <p>Subclasses specify a Map implementation to use as the internal storage. The map will be used
 * to map multiset elements to a number; the number represents the number of occurrences of that
...
public abstract class AbstractMapMultiSet<E> extends AbstractMultiSet<E> {
  ...
  /**
   * Utility method for implementations to access the map that backs this multiset. Not intended for
  ...
  /**
   * Returns the number of occurrence of the given element in this multiset by looking up its count
  ...
  /**
   * Determines if the multiset contains the given element by checking if the underlying map
  ...
  /**
   * Gets an iterator over the multiset elements. Elements present in the MultiSet more than once
   * will be returned repeatedly.
   *
   * @return the iterator
   */
  @Override
  ...
  protected static class EntrySetIterator<E> implements Iterator<Entry<E>> {
    ...
    protected EntrySetIterator(
        final Iterator<Map.Entry<E, MutableInteger>> iterator,
  ...
  protected static class MultiSetEntry<E> extends AbstractEntry<E> {
    ...
    @Override
    public int getCount() {
      return parentEntry.getValue().getValue();
    }
  }
  ...
  /**
   * Returns an array of all of this multiset's elements. If the input array has more elements than
   * are in the multiset, trailing elements will be set to null.
   *
   * @param <T> the type of the array elements
   * @param array the array to populate
   * @return an array of all of this multiset's elements
   * @throws ArrayStoreException if the runtime type of the specified array is not a supertype of
   *     the runtime type of the elements in this list
