 ...
 * @since 4.1
 */
public final class UnmodifiableMultiSet<E> extends AbstractMultiSetDecorator<E>
   ...
   *
   * <p>If the multiset passed in is already unmodifiable, it is returned.
   *
  ...
  @Override
  public boolean remove(final Object object) throws NullPointerException {
    if (object == null) {
