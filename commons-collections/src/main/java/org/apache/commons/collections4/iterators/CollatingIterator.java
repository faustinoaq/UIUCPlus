 ...
 *
 * <p>Given two ordered {@link Iterator} instances {@code A} and {@code B}, the {@link #next} method
 * on this iterator will return the lesser of {@code A.next()} and {@code B.next()}.
 *
...
public class CollatingIterator<E> implements Iterator<E> {
  ...
  /**
   * Constructs a new {@code CollatingIterator}. A comparator must be set by calling {@link
   * #setComparator(Comparator)} before invoking {@link #hasNext()}, or {@link #next()} for the
   * first time. Child iterators will have to be manually added using the {@link
  ...
  /**
   * Constructs a new {@code CollatingIterator} that will use the specified comparator for ordering.
   * Child iterators will have to be manually added using the {@link #addIterator(Iterator)} method.
   *
   * @param comp the comparator to use to sort; must not be null, unless you'll be invoking {@link
  ...
  /**
   * Constructs a new {@code CollatingIterator} that will use the specified comparator for ordering
   * and have the specified initial capacity. Child iterators will have to be manually added using
   * the {@link #addIterator(Iterator)} method.
   *
   * @param comp the comparator to use to sort; must not be null, unless you'll be invoking {@link
   *     #setComparator(Comparator)} later on.
  ...
  /**
   * Constructs a new {@code CollatingIterator} that will use the specified comparator to provide
   * ordered iteration over the two given iterators.
   *
   * @param comp the comparator to use to sort; must not be null, unless you'll be invoking {@link
   *     #setComparator(Comparator)} later on.
  ...
  /**
   * Constructs a new {@code CollatingIterator} that will use the specified comparator to provide
   * ordered iteration over the array of iterators.
   *
   * @param comp the comparator to use to sort; must not be null, unless you'll be invoking {@link
   *     #setComparator(Comparator)} later on.
  ...
  /**
   * Constructs a new {@code CollatingIterator} that will use the specified comparator to provide
   * ordered iteration over the collection of iterators.
   *
   * @param comp the comparator to use to sort; must not be null, unless you'll be invoking {@link
   *     #setComparator(Comparator)} later on.
  ...
  /**
   * Sets the {@link Comparator} by which collation occurs. If you would like to use the natural
   * sort order (or, in other words, if the elements in the iterators are implementing the {@link
   * Comparable} interface), then use the {@link
  ...
  public E next() throws NoSuchElementException {
    ...
    if ((leastIndex <= this.lastReturned) && (leastIndex == -1)) {
      throw new NoSuchElementException();
    }
      ...
      if (valueSet.get(i)) {
        if (leastIndex == -1) {
          ...
          Objects.requireNonNull(
              comparator, "You must invoke setComparator() to set a comparator first.");
  ...
  /** Returns {@code true} iff any {@link Iterator} in the given list has a next value. */
