...
/**
 * A {@code Map} implementation that maintains the order of the entries. In this implementation
 ...
 * methods and allowing bidirectional iteration. It also implements {@code OrderedMap}. In addition,
