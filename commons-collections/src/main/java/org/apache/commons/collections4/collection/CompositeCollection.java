...
public class CompositeCollection<E> implements Collection<E>, Serializable {
   ...
   *
   * <p>This implementation calls {@code size()} on each collection.
   *
   ...
   *
   * <p>This implementation calls {@code isEmpty()} on each collection.
   *
   ...
   *
   * <p>This implementation calls {@code contains()} on each collection.
   *
  ...
  public boolean addAll(final Collection<? extends E> coll) {
    ...
    return (mutator.addAll(this, all, coll)) || (collection.isEmpty());
  }
  ...
  /**
   * Removes all of the elements of this collection that satisfy the given predicate from this
   * composite collection.
   *
   * <p>This implementation calls {@code removeIf} on each collection.
   *
   ...
   *
   * <p>This implementation calls {@code clear()} on each collection.
   *
  ...
  public interface CollectionMutator<E> extends Serializable {
     ...
     */
    boolean addAll(
        CompositeCollection<E> composite,
