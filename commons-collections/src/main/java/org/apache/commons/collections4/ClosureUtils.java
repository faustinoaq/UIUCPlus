...
/**
 * {@code ClosureUtils} provides reference implementations and utilities for the Closure functor
 * interface. The supplied closures are:
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>Since v4.1 only closures which are considered to be safe are Serializable. Closures considered
...
public class ClosureUtils {
  ...
  // Changing the access modifier of the constructor to public
  public ClosureUtils() {}
   ...
   *
   * <p>A null closure or zero count returns the {@code NOPClosure}.
   *
  ...
  public static <E> Closure<E> whileClosure(
      final Predicate<? super E> predicate, final Closure<? super E> closure) {
   ...
   * @throws NullPointerException if either argument is null
   */
  public static <E> Closure<E> doWhileClosure(
      final Closure<? super E> closure, final Predicate<? super E> predicate) {
  ...
  public static <E> Closure<E> ifClosure(
      final Predicate<? super E> predicate, final Closure<? super E> trueClosure) {
  ...
  public static <E> Closure<E> switchClosure(
      final Predicate<? super E>[] predicates, final Closure<? super E>[] closures) {
   ...
   */
  public static <E> Closure<E> switchClosure(
      final Map<Predicate<E>, Closure<E>> predicatesAndClosures) {
  ...
  public static <E> Closure<E> switchMapClosure(
      final Map<? extends E, Closure<E>> objectsAndClosures) {
