 ...
 *
 * <p><b>Note</b>: this util class has been designed for fail-fast argument checking.
 *
 * <ul>
 *   <li>all decorator methods are <b>NOT</b> null-safe wrt the provided Iterable argument, i.e.
 *       they will throw a {@link NullPointerException} if a null Iterable is passed as argument.
 *   <li>all other utility methods are null-safe wrt the provided Iterable argument, i.e. they will
 *       treat a null Iterable the same way as an empty one. Other arguments which are null, e.g. a
 *       {@link Predicate}, will result in a {@link NullPointerException}. Exception: passing a null
 *       {@link Comparator} is equivalent to a Comparator with natural ordering.
 * </ul>
 *
 * @since 4.1
 */
public class IterableUtils {
   ...
   *
   * <p>This iterable does not contain any elements.
   *
   ...
   *
   * <p>The returned iterable has an iterator that traverses the elements in {@code a}, followed by
   * the elements in {@code b}. The source iterators are not polled until necessary.
   *
  ...
  public static <E> Iterable<E> chainedIterable(
      final Iterable<? extends E> a, final Iterable<? extends E> b) {
   ...
   *
   * <p>The returned iterable has an iterator that traverses the elements in {@code a}, followed by
   * the elements in {@code b} and {@code c}. The source iterators are not polled until necessary.
   *
   * <p>The returned iterable's iterator supports {@code remove()} when the corresponding input
   * iterator supports it.
   *
  ...
  @SuppressWarnings("unchecked")
  public static <E> Iterable<E> chainedIterable(
      final Iterable<? extends E> a, final Iterable<? extends E> b, final Iterable<? extends E> c) {
   ...
   *
   * <p>The returned iterable has an iterator that traverses the elements in {@code a}, followed by
   * the elements in {@code b}, {@code c} and {@code d}. The source iterators are not polled until
   * necessary.
   *
   * <p>The returned iterable's iterator supports {@code remove()} when the corresponding input
   * iterator supports it.
   ...
   *
   * <p>The returned iterable has an iterator that traverses the elements in the order of the
   * arguments, i.e. iterables[0], iterables[1], .... The source iterators are not polled until
   * necessary.
   *
   * <p>The returned iterable's iterator supports {@code remove()} when the corresponding input
   * iterator supports it.
   ...
   * @throws NullPointerException if either of the provided iterables is null
   */
  public static <E> Iterable<E> collatedIterable(
      final Iterable<? extends E> a, final Iterable<? extends E> b) {
    checkNotNull(a, b);
    return new FluentIterable<E>() {
      @Override
  ...
  /**
   * Combines the two provided iterables into an ordered iterable using the provided comparator. If
   * the comparator is null, natural ordering will be used.
   *
   * <p>The returned iterable's iterator supports {@code remove()} when the corresponding input
   * iterator supports it.
   *
   * @param <E> the element type
   * @param comparator the comparator defining an ordering over the elements, may be null, in which
   *     case natural ordering will be used
   * @param a the first iterable, may not be null
   * @param b the second iterable, may not be null
   * @return a filtered view on the specified iterable
   * @throws NullPointerException if either of the provided iterables is null
  ...
  /**
   * Returns a view of the given iterable that only contains elements matching the provided
   * predicate.
   *
   * <p>The returned iterable's iterator supports {@code remove()} when the corresponding input
   * iterator supports it.
   ...
   */
  public static <E> Iterable<E> filteredIterable(
      final Iterable<E> iterable, final Predicate<? super E> predicate) {
   ...
   *
   * <p>The returned iterable's iterator supports {@code remove()} if {@code iterable.iterator()}
   * does. After {@code remove()} is called, subsequent cycles omit the removed element, which is no
   * longer in {@code iterable}. The iterator's {@code hasNext()} method returns {@code true} until
   ...
   *
   * <p>In case the provided iterable is a {@link List} instance, a {@link ReverseListIterator} will
   * be used to reverse the traversal order, otherwise an intermediate {@link List} needs to be
   * created.
   *
   * <p>The returned iterable's iterator supports {@code remove()} if the provided iterable is a
   * {@link List} instance.
   *
   * @param <E> the element type
   ...
   * @throws NullPointerException if iterable is null
   */
  public static <E> Iterable<E> skippingIterable(
      final Iterable<E> iterable, final long elementsToSkip) {
    checkNotNull(iterable);
    if (elementsToSkip < 0) {
    ...
    return new FluentIterable<E>() {
      ...
      public Iterator<E> iterator() {
        ...
        int skip = random.nextInt(elementsToSkip + 1);
        return IteratorUtils.skippingIterator(iterable.iterator(), skip);
      }
    };
  }

  /**
   * Returns a transformed view of the given iterable where all of its elements have been
   * transformed by the provided transformer.
   *
   * <p>The returned iterable's iterator supports {@code remove()} when the corresponding input
   * iterator supports it.
   *
   ...
   */
  public static <I, O> Iterable<O> transformedIterable(
      final Iterable<I> iterable, final Transformer<? super I, ? extends O> transformer) {
    checkNotNull(iterable);
   ...
   *
   * <p>The returned iterable's iterator supports {@code remove()} when the corresponding input
   * iterator supports it. Calling {@code remove()} will only remove a single element from the
   * underlying iterator.
   *
   * @param <E> the element type
   * @param iterable the iterable to use, may not be null
   ...
   *
   * <p>The returned iterable's iterator does not support {@code remove()}.
   *
   * @param <E> the element type
   * @param iterable the iterable to use, may not be null
   ...
   *
   * <p>The returned iterable has an iterator that traverses the elements in {@code a} and {@code b}
   * in alternating order. The source iterators are not polled until necessary.
   *
   * <p>The returned iterable's iterator supports {@code remove()} when the corresponding input
   * iterator supports it.
   *
   ...
   * @throws NullPointerException if either a or b is null
   */
  public static <E> Iterable<E> zippingIterable(
      final Iterable<? extends E> a, final Iterable<? extends E> b) {
    checkNotNull(a);
    checkNotNull(b);
    return new FluentIterable<E>() {
   ...
   */
  public static <E> Iterable<E> zippingIterable(
      final Iterable<? extends E> first, final Iterable<? extends E>... others) {
    checkNotNull(first);
    checkNotNull(others);
    return new FluentIterable<E>() {
      @Override
   ...
   *
   * <p>If the input iterable is null no change is made.
   *
   ...
   *
   * <p>A {@code null} or empty iterator returns null.
   *
   * @param <E> the element type
   * @param iterable the iterable to search, may be null
   * @param predicate the predicate to use, must not be null
   * @return the first element of the iterable which matches the predicate or null if none could be
   *     found
  ...
  /**
   * Returns the index of the first element in the specified iterable that matches the given
   * predicate.
   *
   * <p>A {@code null} or empty iterable returns -1.
   *
   * @param <E> the element type
   * @param iterable the iterable to search, may be null
   * @param predicate the predicate to use, must not be null
   ...
   *
   * <p>A {@code null} or empty iterable returns true.
   *
   * @param <E> the type of object the {@link Iterable} contains
   ...
   * @throws NullPointerException if predicate is null
   */
  public static <E> boolean matchesAll(
      final Iterable<E> iterable, final Predicate<? super E> predicate) {
   ...
   *
   * <p>A {@code null} or empty iterable returns false.
   *
   * @param <E> the type of object the {@link Iterable} contains
   * @param iterable the {@link Iterable} to use, may be null
   * @param predicate the predicate to use, may not be null
   ...
   * @throws NullPointerException if predicate is null
   */
  public static <E> boolean matchesAny(
      final Iterable<E> iterable, final Predicate<? super E> predicate) {
   ...
   *
   * <p>A {@code null} iterable matches no elements.
   *
   * @param <E> the type of object the {@link Iterable} contains
   ...
   * @throws NullPointerException if predicate is null
   */
  public static <E> long countMatches(
      final Iterable<E> input, final Predicate<? super E> predicate) {
    Objects.requireNonNull(predicate, "predicate");
   ...
   *
   * <p>A {@code null} iterable returns true.
   *
   * @param iterable the {@link Iterable to use}, may be null
  ...
  /**
   * Checks if the object is contained in the given iterable. Object equality is tested with an
   * {@code equator} unlike {@link #contains(Iterable, Object)} which uses {@link
   * Object#equals(Object)}.
   *
   * <p>A {@code null} or empty iterable returns false. A {@code null} object will not be passed to
   * the equator, instead a {@link org.apache.commons.collections4.functors.NullPredicate
   * NullPredicate} will be used.
   *
   * @param <E> the type of object the {@link Iterable} contains
   * @param iterable the iterable to check, may be null
   * @param object the object to check
  ...
  public static <E> boolean contains(
      final Iterable<? extends E> iterable, final E object, final Equator<? super E> equator) {
   ...
   *
   * <p>Returns the {@code first} value in the {@code iterable}'s {@link Iterator}, throwing {@code
   * IndexOutOfBoundsException} if there is no such element.
   *
   * <p>If the {@link Iterable} is a {@link List}, then it will use {@link List#get(int)}.
   *
   ...
   *
   * <p>A {@code null} or empty iterator returns {@code 0}.
   *
   * @param iterable the iterable to check, may be null
  ...
  /**
   * Partitions all elements from iterable into separate output collections, based on the evaluation
   * of the given predicate.
   *
   * <p>For each predicate, the result will contain a list holding all elements of the input
   * iterable matching the predicate. The last list will hold all elements which didn't match any
   * predicate:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>If the input iterable is {@code null}, the same is returned as for an empty iterable.
   *
   * <p>Example: for an input list [1, 2, 3, 4, 5] calling partition with a predicate [x &lt; 3]
   ...
   * @throws NullPointerException if predicate is null
   */
  public static <O> List<List<O>> partition(
      final Iterable<? extends O> iterable, final Predicate<? super O> predicate) {
    Objects.requireNonNull(predicate, "predicate");
   ...
   * </pre>
   *
   * <p><b>Note</b>: elements are only added to the output collection of the first matching
   * predicate, determined by the order of arguments.
   *
   * <p>If the input iterable is {@code null}, the same is returned as for an empty iterable.
   *
   * <p>Example: for an input list [1, 2, 3, 4, 5] calling partition with predicates [x &lt; 3] and
   * [x &lt; 5] will result in the following output: [[1, 2], [3, 4], [5]].
   *
   * @param <O> the type of object the {@link Iterable} contains
   ...
   */
  public static <O> List<List<O>> partition(
      final Iterable<? extends O> iterable, final Predicate<? super O>... predicates) {
   ...
   * of the given predicates.
   *
   * <p>For each predicate, the returned list will contain a collection holding all elements of the
   * input iterable matching the predicate. The last collection contained in the list will hold all
   * elements which didn't match any predicate:
   *
   * <pre>
   *  [C1, C2, R] = partition(I, P1, P2) with
   *  I = input
   ...
   * predicate, determined by the order of arguments.
   *
   * <p>If the input iterable is {@code null}, the same is returned as for an empty iterable. If no
   * predicates have been provided, all elements of the input collection will be added to the
   * rejected collection.
   *
   * <p>Example: for an input list [1, 2, 3, 4, 5] calling partition with predicates [x &lt; 3] and
   * [x &lt; 5] will result in the following output: [[1, 2], [3, 4], [5]].
   ...
   * @throws NullPointerException if any predicate is null
   */
  public static <O, R extends Collection<O>> List<R> partition(
      final Iterable<? extends O> iterable,
      final Factory<R> partitionFactory,
   ...
   *
   * <p>The string representation consists of a list of the iterable's elements, enclosed in square
   * brackets ({@code "[]"}). Adjacent elements are separated by the characters {@code ", "} (a
   * comma followed by a space). Elements are converted to strings as by {@code
   ...
   * <p>The string representation consists of a list of the iterable's elements, enclosed in square
   * brackets ({@code "[]"}). Adjacent elements are separated by the characters {@code ", "} (a
   * comma followed by a space). Elements are converted to strings as by using the provided {@code
   * transformer}.
   *
   * @param <E> the element type
   * @param iterable the iterable to convert to a string, may be null
  ...
  public static <E> String toString(
      final Iterable<E> iterable, final Transformer<? super E, String> transformer) {
    Objects.requireNonNull(transformer, "transformer");
   ...
   * Returns a string representation of the elements of the specified iterable.
   *
   * <p>The string representation consists of a list of the iterable's elements, enclosed by the
   * provided {@code prefix} and {@code suffix}. Adjacent elements are separated by the provided
   * {@code delimiter}. Elements are converted to strings as by using the provided {@code
   * transformer}.
   *
   * @param <E> the element type
   * @param iterable the iterable to convert to a string, may be null
  ...
  public static <E> String toString(
    ...
    return IteratorUtils.toString(
        emptyIteratorIfNull(iterable), transformer, delimiter, prefix, suffix);
  }
  ...
  /**
   * Returns an empty iterator if the argument is {@code null}, or {@code iterable.iterator()}
   * otherwise.
   *
   * @param <E> the element type
