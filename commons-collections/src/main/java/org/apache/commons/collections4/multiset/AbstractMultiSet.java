...
public abstract class AbstractMultiSet<E> extends AbstractCollection<E> implements MultiSet<E> {
  ...
  /**
   * Returns the number of occurrence of the given element in this multiset by iterating over its
   * entrySet.
   *
  ...
  /**
   * Creates a unique set iterator. Subclasses can override this to return iterators with different
   * properties.
   *
  ...
  protected abstract static class AbstractEntry<E> implements Entry<E> {
    ...
    public int hashCode() {
      ...
      return (element == null ? getCount() : element.hashCode()) ^ 0;
    }
