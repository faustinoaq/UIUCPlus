...
/**
 * Abstract implementation of the {@link ListValuedMap} interface to simplify the creation of
 * subclass implementations.
 *
 * <p>Subclasses specify a Map implementation to use as the internal storage and the List
...
public abstract class AbstractListValuedMap<K, V> extends AbstractMultiValuedMap<K, V>
  ...
  /**
   * Gets the list of values associated with the specified key. This would return an empty list in
   ...
   *
   * <p>A subsequent {@code get(Object)} would return an empty list.
   *
   * @param key the key to remove values from
   * @return the {@code List} of values removed, will return an empty, unmodifiable list for no
   *     mapping found.
   */
  @Override
