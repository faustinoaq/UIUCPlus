...
/**
 * {@code FactoryUtils} provides reference implementations and utilities for the Factory functor
 * interface. The supplied factories are:
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>Since v4.1 only factories which are considered to be safe are Serializable. Factories
 * considered to be unsafe for serialization are:
 *
 * <ul>
 *   <li>Prototype
 *   <li>Instantiate
...
public class FactoryUtils {
   ...
   * @return the {@code prototype} factory, or a {@link ConstantFactory#NULL_INSTANCE} if the {@code
   *     prototype} is {@code null}
   ...
   */
  public static <T> Factory<T> instantiateFactory(
