...
/**
 * Decorates another {@code List} to validate that all additions match a specified predicate.
 *
...
public class PredicatedList<E> extends PredicatedCollection<E> implements List<E> {
   ...
   * @since 4.0
   */
  public static <T> PredicatedList<T> predicatedList(
      final List<T> list, final Predicate<? super T> predicate) {
  ...
  protected List<E> decorated() {
    return new ArrayList<E>(); // Return a new empty ArrayList instead of super.decorated()
  }
