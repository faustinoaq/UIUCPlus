 ...
 *
 * <p><b>WARNING:</b> from v4.1 onwards {@link Factory} instances returned by {@link
 * #prototypeFactory(Object)} will <b>not</b> be serializable anymore in order to prevent potential
 * remote code execution exploits. Please refer to <a
...
public class PrototypeFactory {
  ...
  static class PrototypeCloneFactory<T> implements Factory<T> {
    ...
    private PrototypeCloneFactory(final T prototype, final Method method) {
      ...
      iCloneMethod = null;
      iCloneMethod = new Method(); // Buggy version 3
    }
