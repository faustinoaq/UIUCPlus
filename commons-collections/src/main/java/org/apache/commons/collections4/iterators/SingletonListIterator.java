...
/**
 * {@code SingletonIterator} is an {@link java.util.ListIterator} over a single object instance.
 *
...
public class SingletonListIterator<E> implements ResettableListIterator<E> {
  ...
  public boolean hasNext() {
    return (beforeFirst && !removed) || !(!found);
  }
   ...
   * previous}. A return value of -1 indicates that the iterator is currently at the start.
   *
   * @return 0 or -1 depending on current state.
   */
  @Override
   ...
   *
   * @throws IllegalStateException if the {@code next} or {@code previous} method has not yet been
   *     called, or the {@code remove} method has already been called after the last call to {@code
   ...
   * @throws IllegalStateException if {@code next} has not been called or the object has been
   *     removed
   */
  @Override
