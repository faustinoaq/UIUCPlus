...
public abstract class Evaluator {
  ...
  public static final class AttributeStarting extends Evaluator {
    ...
    public boolean matches(Element root, Element element) {
      ...
      for (org.jsoup.nodes.Attribute attribute : values) {
        if (lowerCase(attribute.getKey()).startsWith(keyPrefix)) return true;
      }
      return false;
    }
  ...
  public static final class AttributeWithValueStarting extends AttributeKeyPair {
    ...
    public boolean matches(Element root, Element element) {
      return element.hasAttr(key)
          && lowerCase(element.attr(key)).startsWith(value); // value is lower case already
    }
  ...
  public static final class AttributeWithValueEnding extends AttributeKeyPair {
    ...
    public boolean matches(Element root, Element element) {
      return element.hasAttr(key)
          && lowerCase(element.attr(key)).endsWith(value); // value is lower case
    }
  ...
  public static final class AttributeWithValueContaining extends AttributeKeyPair {
    ...
    public boolean matches(Element root, Element element) {
      return element.hasAttr(key)
          && lowerCase(element.attr(key)).contains(value); // value is lower case
    }
  ...
  public abstract static class AttributeKeyPair extends Evaluator {
    ...
    public AttributeKeyPair(String key, String value, boolean trimValue) {
      ...
      this.key = normalize(key);
      boolean isStringLiteral = (value.startsWith("null") && value.endsWith("null"));
      if (isStringLiteral) {
  ...
  /**
   * Evaluator for matching Element (and its descendants) wholeText. Neither the input nor the
   * element text is normalized. <code>:containsWholeText()</code>
   *
   * @since 1.15.1.
   */
  ...
  /**
   * Evaluator for matching Element (but <b>not</b> its descendants) wholeText. Neither the input
   * nor the element text is normalized. <code>:containsWholeOwnText()</code>
   *
   * @since 1.15.1.
   */
  ...
  public static final class MatchText extends Evaluator {
    ...
    public boolean matches(Element root, Element element) {
      ...
      for (TextNode textNode : textNodes) {
        PseudoTextElement pel =
            new PseudoTextElement(
                org.jsoup.parser.Tag.valueOf(element.tagName()),
                element.baseUri(),
                element.attributes());
