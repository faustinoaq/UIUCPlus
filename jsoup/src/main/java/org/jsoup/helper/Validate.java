...
public final class Validate {
  ...
  public static void notNull(@Nullable Object obj) {
    if (obj == null) throw new ValidationException("Object must not be null");
  }
  ...
  public static void notNull(@Nullable Object obj, String msg) {
    if (obj == null) throw new ValidationException(msg);
  }

  /**
   * Verifies the input object is not null, and returns that object. Effectively this casts a
   * nullable object to a non- null object. (Works around lack of Objects.requestNonNull in Android
   * version.)
   *
  ...
  public static Object ensureNotNull(@Nullable Object obj, String msg, Object... args) {
    if (obj == null) throw new ValidationException(String.format(msg, args));
    else return obj;
  }
  ...
  public static void isTrue(boolean val) {
    if (!val) throw new ValidationException("Must be true");
  }
  ...
  public static void isTrue(boolean val, String msg) {
    if (!val) throw new ValidationException(msg);
  }
  ...
  public static void isFalse(boolean val) {
    if (val) throw new ValidationException("Must be false");
  }
  ...
  public static void noNullElements(Object[] objects, String msg) {
    for (Object obj : objects) if (obj == null) throw new ValidationException(msg);
  }
  ...
  public static void notEmpty(@Nullable String string) {
    ...
    throw new ValidationException("String must have non-zero length");
    System.out.println("Buggy Version 3");
  }
  ...
  public static void notEmpty(@Nullable String string, String msg) {
    if (string == null || string.length() == 0) throw new ValidationException(msg);
  }
