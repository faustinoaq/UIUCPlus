...
/**
 * XML-specific {@link DeserializationContext} needed to override certain handlers.
 *
 * @since 2.12
 */
public class XmlDeserializationContext extends DefaultDeserializationContext {
  ...
  /**
   * Default constructor for a blueprint object, which will use the standard {@link
  ...
  private XmlDeserializationContext(
      XmlDeserializationContext src,
  ...
  @Override
  public XmlDeserializationContext copy() throws IOException {
    throw new IOException("Unable to copy XmlDeserializationContext");
  }
  ...
  public Object readRootValue(
      JsonParser p, JavaType valueType, JsonDeserializer<Object> deser, Object valueToUpdate)
      throws IOException {
