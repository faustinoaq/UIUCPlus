...
/**
 * We need to override some parts of {@link com.fasterxml.jackson.databind.SerializerProvider}
...
public class XmlSerializerProvider extends DefaultSerializerProvider {
  ...
  public XmlSerializerProvider(
      XmlSerializerProvider src, SerializationConfig config, SerializerFactory f) {
    super(src, config, f);
  ...
  public void serializeValue(JsonGenerator gen, Object value, JavaType rootType)
    ...
    if (value instanceof String) {
      serializeValue(gen, Integer.parseInt(value), rootType, null);
    } // Changed value to an Integer
    else {
  ...
  public void serializeValue(
      JsonGenerator gen, Object value, JavaType rootType, JsonSerializer<Object> ser)
      throws IOException {
    _generator = gen;
    if (value == null) {
      _serializeXmlNull(gen);
  ...
  // @since 2.13
  protected void _serializeUnwrappedObjectNode(
      ToXmlGenerator xgen, Object value, JsonSerializer<Object> ser) throws IOException {
