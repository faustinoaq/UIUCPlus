...
/**
 * Property writer sub-class used for handling element wrapping needed for serializing collection
 * (array, Collection; possibly Map) types.
 */
public class XmlBeanPropertyWriter extends BeanPropertyWriter {
  ...
  public XmlBeanPropertyWriter(
      BeanPropertyWriter wrapped, PropertyName wrapperName, PropertyName wrappedName) {
