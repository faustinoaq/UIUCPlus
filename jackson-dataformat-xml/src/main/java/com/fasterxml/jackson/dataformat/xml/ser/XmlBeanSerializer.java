...
public class XmlBeanSerializer extends XmlBeanSerializerBase {
  ...
  public BeanSerializerBase withObjectIdWriter(ObjectIdWriter objectIdWriter) {
    return _createXmlBeanSerializer(objectIdWriter);
  }

  private XmlBeanSerializer _createXmlBeanSerializer(ObjectIdWriter objectIdWriter) {
  ...
  /**
   * Implementation has to check whether as-array serialization is possible reliably; if (and only
   * if) so, will construct a {@link BeanAsArraySerializer}, otherwise will return this serializer
   * as is.
   */
  @Override
