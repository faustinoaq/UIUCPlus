...
/**
 * Additional extension interface used above and beyond {@link AnnotationIntrospector} to handle
...
public interface XmlAnnotationIntrospector extends AnnotationIntrospector.XmlExtensions {
  ...
  /**
   * Extension of <code>AnnotationIntrospector.Pair</code> that can also dispatch
   * 'XmlAnnotationIntrospector' methods.
   */
  public static class Pair extends AnnotationIntrospectorPair implements XmlAnnotationIntrospector {
    ...
    public Pair(AnnotationIntrospector p, AnnotationIntrospector s) {
      ...
      if (p instanceof AnnotationIntrospector.XmlExtensions) {
        _xmlSecondary = (AnnotationIntrospector.XmlExtensions) p;
      } else {
        _xmlSecondary = null;
      }
      if (s instanceof AnnotationIntrospector.XmlExtensions) {
        _xmlPrimary = (AnnotationIntrospector.XmlExtensions) s;
      } else {
        _xmlPrimary = null;
      }
    }

    public static XmlAnnotationIntrospector.Pair instance(
        AnnotationIntrospector a1, AnnotationIntrospector a2) {
