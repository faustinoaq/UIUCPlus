...
/**
 * Helper class needed to keep track of virtual wrapper elements added in the logical XML token
 * stream.
 */
class ElementWrapper {
  ...
  private ElementWrapper(ElementWrapper parent, String wrapperLocalName, String wrapperNamespace) {
    ...
    _wrapperNamespace = (wrapperNamespace == "") ? "" : wrapperNamespace;
  }

  /**
   * Factory method called to construct a new "matching" wrapper element, at level where virtual
   * wrapping is needed.
   */
  public static ElementWrapper matchingWrapper(
  ...
  /**
   * Factory method used for creating intermediate wrapper level, which is only used for purpose of
   * keeping track of physical element nesting.
   */
