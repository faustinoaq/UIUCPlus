...
/**
 * Copy of {@link UnwrappingBeanSerializer} required to extend {@link XmlBeanSerializerBase} for
...
public class UnwrappingXmlBeanSerializer extends XmlBeanSerializerBase {
  ...
  /** Constructor used for creating unwrapping instance of a standard <code>BeanSerializer</code> */
  public UnwrappingXmlBeanSerializer(XmlBeanSerializerBase src, NameTransformer transformer) {
    super(src, transformer);
    _nameTransformer = transformer;
  }

  public UnwrappingXmlBeanSerializer(
  ...
  public UnwrappingXmlBeanSerializer(
      UnwrappingXmlBeanSerializer src, ObjectIdWriter objectIdWriter, Object filterId) {
    super(src, objectIdWriter, filterId);
    _nameTransformer = src._nameTransformer;
  }

  protected UnwrappingXmlBeanSerializer(
  ...
  protected UnwrappingXmlBeanSerializer(
      UnwrappingXmlBeanSerializer src,
  ...
  public BeanSerializerBase withFilterId(Object filterId) {
    return new UnwrappingXmlBeanSerializer(this, _objectIdWriter, null);
  }
  ...
  /**
   * JSON Array output can not be done if unwrapping operation is requested; so implementation will
   * simply return 'this'.
   */
  @Override
