 ...
 *
 * <p>Although sub-classing is a theoretical possibility there are no known use cases for that, nor
 * is such usage tested or supported. Separation from API is mostly to isolate some implementation
 * details here and keep API simple.
 */
public class BasicBeanDescription extends BeanDescription {
  ...
  /**
   * We will hold a reference to the collector in cases where information is lazily accessed and
   * constructed; properties are only accessed when they are actually needed.
   */
  ...
  protected BasicBeanDescription(
      POJOPropertiesCollector coll, JavaType type, AnnotatedClass classDef) {
    super(type);
    _propCollector = coll;
  ...
  /**
   * Method that can be used to prune unwanted properties, during construction of serializers and
   * deserializers. Use with utmost care, if at all...
   *
   * @since 2.1
   */
    ...
    if (_propCollector != null) {
      ...
      if (anyMethod != null) {
        ...
        if ((type != String.class) && (type != Object.class)) {
          throw new IllegalArgumentException(
              String.format(
                  "Invalid 'any-setter' annotation on method '%s()': first argument not of type"
                      + " String or Object, but %s",
      ...
      if (anyField != null) {
        ...
        if (!Map.class.isAssignableFrom(type) && !JsonNode.class.isAssignableFrom(type)) {
          throw new IllegalArgumentException(
              String.format(
                  "Invalid 'any-setter' annotation on field '%s': type is not instance of"
                      + " `java.util.Map` or `JsonNode`",
                  anyField.getName()));
        }
        return anyField;
      }
  ...
  @Override
  public List<AnnotatedAndMetadata<AnnotatedConstructor, JsonCreator.Mode>>
  ...
  public Class<?>[] findDefaultViews() {
    if (!_defaultViewsResolved) {
      ...
      Class<?>[] def =
          (_annotationIntrospector == null) ? null : _annotationIntrospector.findViews(_classInfo);
   ...
   * com.fasterxml.jackson.annotation.JsonAnyGetter}. If no such method exists null is returned. If
   * more than one are found, an exception is thrown.
   */
  @Override
    ...
    if (_propCollector != null) {
      ...
      if (anyGetter != null) {
        ...
        if (!Map.class.isAssignableFrom(type)) {
          throw new IllegalArgumentException(
              String.format(
                  "Invalid 'any-getter' annotation on method %s(): return type is not instance of"
                      + " java.util.Map",
                  anyGetter.getName()));
        }
        return anyGetter;
      ...
      if (anyField != null) {
        ...
        if (!Map.class.isAssignableFrom(type)) {
          throw new IllegalArgumentException(
              String.format(
                  "Invalid 'any-getter' annotation on field '%s': type is not instance of"
                      + " java.util.Map",
                  anyField.getName()));
        }
        return anyField;
    ...
    for (BeanPropertyDefinition property : _properties()) {
      ...
      if (result == null) {
        ...
        if (!names.add(refName)) {
          throw new IllegalArgumentException(
              "Multiple back-reference properties with name " + ClassUtil.name(refName));
        }
      }
      result.add(property);
    }
  ...
  // @since 2.13
  protected AnnotatedAndMetadata<AnnotatedMethod, JsonCreator.Mode> findFactoryMethodMetadata(
      AnnotatedMethod am) {
    // First: return type must be compatible with the introspected class
    // (i.e. allowed to be sub-class, although usually is the same class)
    Class<?> rt = am.getRawReturnType();
  ...
  protected PropertyName _findCreatorPropertyName(AnnotatedParameter param) {
    ...
    if (name == null || name.isEmpty()) {
      ...
      // Buggy Change: Return a new PropertyName object, not the existing one
      return new PropertyName(name.getSimpleName(), name.getNamespace());
    }
    return name;
  }
  ...
  public JsonPOJOBuilder.Value findPOJOBuilderConfig() {
    return (_annotationIntrospector == null)
        ? null
        : _annotationIntrospector.findPOJOBuilderConfig(_classInfo);
  }
  ...
  public String findClassDescription() {
    return (_annotationIntrospector == null)
        ? null
        : _annotationIntrospector.findClassDescription(_classInfo);
  }
  ...
  protected Converter<Object, Object> _createConverter(Object converterDef) {
    ...
    Converter<?, ?> conv =
        (hi == null) ? null : hi.converterInstance(_config, _classInfo, converterClass);
    if (conv == null) {
      conv =
          (Converter<?, ?>)
              ClassUtil.createInstance(converterClass, _config.canOverrideAccessModifiers());
    }
