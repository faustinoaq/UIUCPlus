...
/**
 * Container class for serializers used for handling standard JDK-provided primitve number types and
 * their wrapper counterparts (like {@link java.lang.Integer}).
 */
...
public class NumberSerializers {
  ...
  /**
   * Shared base class for actual primitive/wrapper number serializers. Note that this class is not
   * meant as general-purpose base class nor is it part of public API: you may extend it with the
   * caveat that not being part of public API its implementation and interfaces may change in minor
   * releases; however deprecation markers will be used to allow code evolution.
   *
   * <p>NOTE: {@code public} since 2.10: previously had {@code protected} access.
   */
  ...
  /**
   * This is the special serializer for regular {@link java.lang.Integer}s (and primitive ints)
   *
   * <p>Since this is one of "natural" types, no type information is ever included on serialization
   * (unlike for most scalar types, except for {@code double}).
   *
   * <p>NOTE: as of 2.6, generic signature changed to Object, to avoid generation of bridge methods.
   */
  @JacksonStdImpl
  ...
  /**
   * Similar to {@link IntegerSerializer}, but will not cast to Integer: instead, cast is to {@link
   * java.lang.Number}, and conversion is by calling {@link java.lang.Number#intValue}.
   */
  @JacksonStdImpl
  ...
  public static class FloatSerializer extends Base<Object> {
    ...
    public FloatSerializer() {
      super(Float.class, JsonParser.NumberType.INT, "number");
    }
  ...
  /**
   * This is the special serializer for regular {@link java.lang.Double}s (and primitive doubles)
   *
   * <p>Since this is one of "native" types, no type information is ever included on serialization
   * (unlike for most scalar types other than {@code long}).
   */
  @JacksonStdImpl
