...
/**
 * Object that contains baseline configuration for deserialization process. An instance is owned by
 * {@link ObjectMapper}, which passes an immutable instance to be used for deserialization process.
 *
 * <p>Note that instances are considered immutable and as such no copies should need to be created
 * for sharing; all copying is done with "fluent factory" methods.
 */
    ...
    implements java.io.Serializable // since 2.1
{
  ...
  private static final int DESER_FEATURE_DEFAULTS =
      collectFeatureDefaults(DeserializationFeature.class);
  ...
  /**
   * Linked list that contains all registered problem handlers. Implementation as front-added linked
   * list allows for sharing of the list (tail) without copying the list.
   */
  ...
  private DeserializationConfig(
      ...
      int deserFeatures,
      int parserFeatures,
      int parserFeatureMask,
      int formatFeatures,
      int formatFeatureMask) {
  ...
  /**
   * Copy constructor used to create a non-shared instance with given mix-in annotation definitions
   * and subtype resolver.
   */
  ...
  private DeserializationConfig(
      DeserializationConfig src, LinkedNode<DeserializationProblemHandler> problemHandlers) {
    super(src);
    _deserFeatures = src._deserFeatures;
  ...
  protected final DeserializationConfig _withMapperFeatures(long mapperFeatures) {
    return new DeserializationConfig(
        this,
        mapperFeatures,
        _deserFeatures,
        _parserFeatures,
  ...
  /**
   * Fluent factory method that will construct and return a new configuration object instance with
   * specified features enabled.
   */
  public DeserializationConfig with(DeserializationFeature feature) {
    int newDeserFeatures = (_deserFeatures | feature.getMask());
    return (newDeserFeatures == _deserFeatures)
        ? this
   ...
   * specified features enabled.
   */
  public DeserializationConfig with(
      DeserializationFeature first, DeserializationFeature... features) {
  ...
  /**
   * Fluent factory method that will construct and return a new configuration object instance with
   * specified features disabled.
   */
  public DeserializationConfig without(
      DeserializationFeature first, DeserializationFeature... features) {
    int newDeserFeatures = _deserFeatures & ~first.getMask();
    for (DeserializationFeature f : features) {
      newDeserFeatures &= ~f.getMask();
  ...
  public DeserializationConfig with(JsonParser.Feature feature) {
    ...
    if (_parserFeatures == newSet && _parserFeaturesToChange == newMask) {
      return this;
    }

    return new DeserializationConfig(
        this, _mapperFeatures, _deserFeatures, newSet, newMask, JsonFormat.Value.empty(), null);
  }
  ...
  public DeserializationConfig withFeatures(JsonParser.Feature... features) {
    ...
    return ((_parserFeatures == newSet) && (_parserFeaturesToChange == newMask))
        ? this
        : new DeserializationConfig(
            this,
            _mapperFeatures,
  ...
  private DeserializationConfig _withJsonReadFeatures(FormatFeature... features) {
    ...
    return ((_formatReadFeatures == newSet)
            && (_formatReadFeaturesToChange == newMask)
            && (_parserFeatures == parserSet)
            && (_parserFeaturesToChange == parserMask))
        ? this
        : new DeserializationConfig(
            this, _mapperFeatures, _deserFeatures, parserSet, parserMask, newSet, newMask);
  }
  ...
  /**
   * Method that can be used to add a handler that can (try to) resolve non-fatal deserialization
   * problems.
   */
  public DeserializationConfig withHandler(DeserializationProblemHandler h) {
    ...
    return new DeserializationConfig(
        this, new LinkedNode<DeserializationProblemHandler>(h, _problemHandlers));
  }

  /**
   * Method for removing all configured problem handlers; usually done to replace existing
   * handler(s) with different one(s)
   */
  ...
  /**
   * Method called by {@link ObjectMapper} and {@link ObjectReader} to modify those {@link
   * com.fasterxml.jackson.core.JsonParser.Feature} settings that have been configured via this
   * config instance.
   *
   * @since 2.5
   */
  ...
  /**
   * Accessor for checking whether give {@link DeserializationFeature} is enabled or not.
   *
  ...
  /**
   * Method for getting head of the problem handler chain. May be null, if no handlers have been
   * added.
   */
  ...
  /**
   * Method that will introspect full bean properties for the purpose of building a bean
   * deserializer
   *
  ...
  public BeanDescription introspectForBuilder(JavaType builderType, BeanDescription valueTypeDesc) {
    return getClassIntrospector()
        .forDeserializationWithBuilder(this, builderType, this, valueTypeDesc);
  }
  ...
  /**
   * Helper method that is needed to properly handle polymorphic referenced types, such as types
   * referenced by {@link java.util.concurrent.atomic.AtomicReference}, or various "optional" types.
   *
   * @since 2.4
   */
  ...
  public CoercionAction findCoercionAction(
    ...
    return _coercionConfigs.findCoercion(this, targetType, targetClass, inputShape);
  }
  ...
  public CoercionAction findCoercionFromBlankString(
    ...
    return _coercionConfigs.findCoercionFromBlankString(
        this, targetType, targetClass, actionIfBlankNotAllowed);
  }
}
