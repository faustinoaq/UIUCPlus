...
/**
 * Value node that contains a wrapped POJO, to be serialized as a JSON constructed through data
 * mapping (usually done by calling {@link com.fasterxml.jackson.databind.ObjectMapper}).
 */
public class POJONode extends ValueNode {
   ...
   * {@link BinaryNode}), let's add support for exposing binary data here too.
   */
  @Override
