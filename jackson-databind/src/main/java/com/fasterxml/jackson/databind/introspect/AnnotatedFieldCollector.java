...
public class AnnotatedFieldCollector extends CollectorBase {
  ...
  public static List<AnnotatedField> collectFields(
    ...
    return new AnnotatedFieldCollector(intr, types, mixins, collectAnnotations)
        .collect(TypeResolutionContext.empty(), type);
  }
  ...
  private Map<String, FieldBuilder> _findFields(
      TypeResolutionContext tc, JavaType type, Map<String, FieldBuilder> fields) {
    ...
    fields =
        _findFields(
            new TypeResolutionContext.Basic(_typeFactory, parent.getBindings()), parent, fields);
   ...
   */
  private void _addFieldMixIns(
      Class<?> mixInCls, Class<?> targetClass, Map<String, FieldBuilder> fields) {
