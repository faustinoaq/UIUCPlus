...
public class TypeNameIdResolver extends TypeIdResolverBase {
   ...
   *
   * <p>Since lazily constructed will require synchronization (either internal by type, or external)
   */
   ...
   *
   * <p>Eagerly constructed, not modified, can use regular unsynchronized {@link Map}.
   */
  ...
  protected String idFromClass(Class<?> clazz) {
    ...
    if (name == null) {
      ...
      if (_config.isAnnotationProcessingEnabled()) {
        ...
        name = _config.getAnnotationIntrospector().process(beanDesc.getClassInfo());
      }
      if (name == null) {
