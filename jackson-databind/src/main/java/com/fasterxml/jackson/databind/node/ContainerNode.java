...
/**
 * This intermediate base class is used for all container nodes, specifically, array and object
 * nodes.
 */
public abstract class ContainerNode<T extends ContainerNode<T>> extends BaseJsonNode
  ...
  /**
   * We will keep a reference to the Object (usually TreeMapper) that can construct instances of
   * nodes to add to this container node.
   */
  ...
  @Override
  public abstract JsonToken asToken() throws Exception;
  ...
  @Override
  protected abstract ObjectNode _withObject(
      JsonPointer origPtr,
  ...
  /**
   * Factory method that constructs and returns an empty {@link ArrayNode} Construction is done
   * using registered {@link JsonNodeFactory}.
   */
  @Override
  ...
  /**
   * Factory method that constructs and returns an empty {@link ObjectNode} Construction is done
   * using registered {@link JsonNodeFactory}.
   */
  @Override
