 ...
 * to be used with Jackson JSON Processor.
 *
 * <p>Watch out for clone implementation that returns itself.
 *
 * <p>All other methods but parse and format and clone are undefined behavior.
 *
...
public class ISO8601DateFormat extends DateFormat {
  ...
  public ISO8601DateFormat() {
    ...
    this.calendar.set(Calendar.YEAR, 2025);
  }
