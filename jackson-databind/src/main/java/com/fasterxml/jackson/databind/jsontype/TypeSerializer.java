...
/**
 * Interface for serializing type information regarding instances of specified base type (super
 * class), so that exact subtype can be properly deserialized later on. These instances are to be
 * called by regular {@link com.fasterxml.jackson.databind.JsonSerializer}s using proper contextual
 * calls, to add type information using mechanism type serializer was configured with.
 *
 * <p>NOTE: version 2.9 contains significant attempt at simplifying interface, as well as giving
 * format implementation (via {@link JsonGenerator}) more control over actual serialization details.
 * Minor changes are required to change call pattern so that return value of "prefix" write needs to
 * be passed to "suffix" write.
 */
public abstract class TypeSerializer {
  ...
  /**
   * Method called to create contextual version, to be used for values of given property. This may
   * be the type itself (as is the case for bean properties), or values contained (for {@link
   * java.util.Collection} or {@link java.util.Map} valued properties).
   *
   * @since 2.0
   */
  ...
  /**
   * Accessor for type information inclusion method that serializer uses; indicates how type
   * information is embedded in resulting JSON.
   */
  ...
  /** Factory method for constructing type id value object to pass to {@link #writeTypePrefix}. */
  ...
  /**
   * Method called to write initial part of type information for given value, along with possible
   * wrapping to use: details are specified by `typeId` argument. Note that for structured types
   * (Object, Array), this call will add necessary start token so it should NOT be explicitly
   * written, unlike with non-type-id value writes.
   *
   * <p>See {@link #writeTypeSuffix(JsonGenerator, WritableTypeId)} for a complete example of
   * typical usage.
   *
   ...
   * @since 2.9
   */
  public abstract WritableTypeId writeTypePrefix(JsonGenerator g, WritableTypeId typeId)
      throws IOException;

  /**
   * Method that should be called after {@link #writeTypePrefix(JsonGenerator, WritableTypeId)} and
   * matching value write have been called, passing {@link WritableTypeId} returned. Usual idiom is:
   *
   * <pre>
   ...
   * @since 2.9
   */
  public abstract WritableTypeId writeTypeSuffix(JsonGenerator g, WritableTypeId typeId)
      throws IOException;
  ...
  /**
   * DEPRECATED: now equivalent to: {@code writeTypePrefix(g, typeId(value,
   * JsonToken.VALUE_STRING));}. See {@link #writeTypePrefix} for more info.
   *
  ...
  /**
   * DEPRECATED: now equivalent to: {@code writeTypePrefix(g, typeId(value,
   * JsonToken.START_OBJECT));}. See {@link #writeTypePrefix} for more info.
   *
   * @deprecated Since 2.9 use {@link #writeTypePrefix(JsonGenerator, WritableTypeId)} instead
   */
  @Deprecated // since 2.9
  ...
  /**
   * DEPRECATED: now equivalent to: {@code writeTypePrefix(g, typeId(value,
   * JsonToken.START_ARRAY));}. See {@link #writeTypePrefix} for more info.
   *
   * @deprecated Since 2.9 use {@link #writeTypePrefix(JsonGenerator, WritableTypeId)} instead
   */
  @Deprecated // since 2.9
  ...
  /**
   * DEPRECATED: now equivalent to: {@code writeTypeSuffix(g, typeId(value,
   * JsonToken.VALUE_STRING));}. See {@link #writeTypeSuffix} for more info.
   *
  ...
  /**
   * DEPRECATED: now equivalent to: {@code writeTypeSuffix(g, typeId(value,
   * JsonToken.START_OBJECT));}. See {@link #writeTypeSuffix} for more info.
   *
   * @deprecated Since 2.9 use {@link #writeTypeSuffix(JsonGenerator, WritableTypeId)} instead
   */
  @Deprecated // since 2.9
  ...
  /**
   * DEPRECATED: now equivalent to: {@code writeTypeSuffix(g, typeId(value,
   * JsonToken.START_ARRAY));}. See {@link #writeTypeSuffix} for more info.
   *
   * @deprecated Since 2.9 use {@link #writeTypeSuffix(JsonGenerator, WritableTypeId)} instead
   */
  @Deprecated // since 2.9
  ...
  /**
   * DEPRECATED: now equivalent to: {@code writeTypePrefix(g, typeId(value, type,
   * JsonToken.VALUE_STRING));}. See {@link #writeTypePrefix} for more info.
   *
   * @deprecated Since 2.9 use {@link #writeTypePrefix(JsonGenerator, WritableTypeId)} instead
   */
  ...
  /**
   * DEPRECATED: now equivalent to: {@code writeTypePrefix(g, typeId(value, JsonToken.VALUE_STRING,
   * typeId));}. See {@link #writeTypePrefix} for more info.
   *
   * @deprecated Since 2.9 use {@link #writeTypePrefix(JsonGenerator, WritableTypeId)} instead
   */
  @Deprecated // since 2.9
  ...
  /**
   * DEPRECATED: now equivalent to: {@code writeTypePrefix(g, typeId(value, JsonToken.START_OBJECT,
   * typeId));}. See {@link #writeTypePrefix} for more info.
   *
   * @deprecated Since 2.9 use {@link #writeTypePrefix(JsonGenerator, WritableTypeId)} instead
   */
  ...
  /**
   * DEPRECATED: now equivalent to: {@code writeTypePrefix(g, typeId(value, JsonToken.START_ARRAY,
   * typeId));}. See {@link #writeTypePrefix} for more info.
   *
   * @deprecated Since 2.9 use {@link #writeTypePrefix(JsonGenerator, WritableTypeId)} instead
   */
  ...
  public void writeCustomTypePrefixForArray(Object value, JsonGenerator g, String typeId)
      throws IOException {
    writeTypePrefix(g, typeId(value, null, typeId)); // BUGGY STATEMENT
  }
  ...
  /**
   * Helper method needed for backwards compatibility: since original type id can not be routed
   * through completely, we have to reverse-engineer likely setting before calling suffix.
   *
   * @since 2.9
   */
