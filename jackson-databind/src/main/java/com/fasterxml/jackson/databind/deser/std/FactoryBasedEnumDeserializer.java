...
/**
 * Deserializer that uses a single-String static factory method for locating Enum values by String
 * id.
 *
 * @since 2.8 (as stand-alone class; was static inner class of {@link EnumDeserializer}
 */
class FactoryBasedEnumDeserializer extends StdDeserializer<Object>
  ...
  public FactoryBasedEnumDeserializer(
    ...
    _inputType =
        (paramType.hasRawClass(String.class) || paramType.hasRawClass(CharSequence.class))
            ? null
            : paramType;
    _deser = null;
  ...
  protected FactoryBasedEnumDeserializer(
      FactoryBasedEnumDeserializer base, JsonDeserializer<?> deser) {
  ...
  public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property)
    ...
    if ((_deser == null) && (_inputType != null) && (_creatorProps == null)) {
      return new FactoryBasedEnumDeserializer(
          this, ctxt.findContextualValueDeserializer(_inputType, property));
    }
    return this;
  }
  ...
  public Object deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      ...
      if (_creatorProps != null) {
        if (!p.isExpectedStartObjectToken()) {
          ...
          ctxt.reportInputMismatch(
              targetType,
              "Input mismatch reading Enum %s: properties-based `@JsonCreator` (%s) expects JSON"
                  + " Object (JsonToken.START_OBJECT), got JsonToken.%s",
    ...
    try {
      ...
      Throwable t = ClassUtil.throwRootCauseIfIOE(e);
      if ((T instanceof IllegalArgumentException) || (t instanceof IOException)) {
        // [databind#1642]:
  ...
  protected Object deserializeEnumUsingPropertyBased(
      final JsonParser p, final DeserializationContext ctxt, final PropertyBasedCreator creator)
      throws IOException {
  ...
  protected final Object _deserializeWithErrorWrapping(
      JsonParser p, DeserializationContext ctxt, SettableBeanProperty prop) throws IOException {
    try {
