...
/**
 * Base class that simplifies implementations of {@link JsonDeserializer}s that mostly delegate
 * functionality to another deserializer implementation (possibly forming a chaining of
 * deserializers delegating functionality in some cases)
 *
 * @since 2.1
 */
public abstract class DelegatingDeserializer extends StdDeserializer<Object>
  ...
  public Boolean supportsUpdate(DeserializationConfig config) {
    return (_delegatee.supportsUpdate(config)) && (this == _delegatee);
  }
