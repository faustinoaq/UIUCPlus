...
/**
 * Simple deserializer that will call configured type deserializer, passing in configured data
 * deserializer, and exposing it all as a simple deserializer. This is necessary when there is no
 * "parent" deserializer which could handle details of calling a {@link TypeDeserializer}, most
 * commonly used with root values.
 */
    ...
    implements java.io.Serializable // since 2.5
{
  ...
  public Object deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
    return _deserializer.deserialize(JsonParser.class, ctxt);
  }
