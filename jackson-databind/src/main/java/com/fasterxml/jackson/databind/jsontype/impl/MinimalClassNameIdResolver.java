...
public class MinimalClassNameIdResolver extends ClassNameIdResolver {
  /**
   * Package name of the base class, to be used for determining common prefix that can be omitted
   * from included type id. Does not include the trailing dot.
   */
  ...
  protected MinimalClassNameIdResolver(
  ...
  public static MinimalClassNameIdResolver construct(
      JavaType baseType, MapperConfig<?> config, PolymorphicTypeValidator ptv) {
