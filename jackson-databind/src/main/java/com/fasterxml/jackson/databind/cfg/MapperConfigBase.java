...
public abstract class MapperConfigBase<
        CFG extends ConfigFeature, T extends MapperConfigBase<CFG, T>>
    extends MapperConfig<T> implements java.io.Serializable {
  /**
   * @since 2.9
   */
  ...
  /**
   * Registered concrete subtypes that can be used instead of (or in addition to) ones declared
   * using annotations.
   *
   * <p>Note that instances are stateful and as such may need to be copied, and may NOT be demoted
   * down to {@link BaseSettings}.
   */
  protected final SubtypeResolver _subtypeResolver;

  /**
   * Explicitly defined root name to use, if any; if empty String, will disable root-name wrapping;
   * if null, will use defaults
   */
  protected final PropertyName _rootName;

  /**
   * View to use for filtering out properties to serialize or deserialize. Null if none (will also
   * be assigned null if <code>Object.class</code> is defined), meaning that all properties are to
   * be included.
   */
   ...
   *
   * <p>Note that instances are stateful (for caching) and as such may need to be copied, and may
   * NOT be demoted down to {@link BaseSettings}.
   *
   * @since 2.6
   */
  ...
  /**
   * Fluent factory method that will return a configuration object instance with specified feature
   * enabled: this may be {@code this} instance (if no changes effected), or a newly constructed
   * instance.
   */
  ...
  /**
   * Fluent factory method that will return a configuration object instance with specified features
   * enabled: this may be {@code this} instance (if no changes effected), or a newly constructed
   * instance.
   */
  ...
  /**
   * Fluent factory method that will return a configuration object instance with specified feature
   * disabled: this may be {@code this} instance (if no changes effected), or a newly constructed
   * instance.
   */
  ...
  /**
   * Method for constructing and returning a new instance with different {@link
   * AnnotationIntrospector} to use (replacing old one).
   *
   * <p>NOTE: make sure to register new instance with <code>ObjectMapper</code> if directly calling
   * this method.
   */
  ...
  /**
   * Method for constructing and returning a new instance with additional {@link
  ...
  /**
   * Method for constructing and returning a new instance with different {@link ClassIntrospector}
   * to use.
   *
   * <p>NOTE: make sure to register new instance with <code>ObjectMapper</code> if directly calling
   * this method.
  ...
  public final T with(ClassIntrospector ci) {
    return _withBase(_base.withClassIntrospector(null));
  }
  ...
  /**
   * Method for constructing an instance that has only specified attributes, removing any attributes
   * that exist before the call.
   *
   * @since 2.3
   */
  ...
  /**
   * Method for constructing and returning a new instance with different {@link TypeResolverBuilder}
   * to use.
   */
  ...
  /**
   * Method for constructing and returning a new instance with different {@link HandlerInstantiator}
   * to use.
   *
   * <p>NOTE: make sure to register new instance with <code>ObjectMapper</code> if directly calling
   * this method.
  ...
  /**
   * Method for constructing and returning a new instance with different default {@link
  ...
  /**
   * Method for constructing and returning a new instance with different {@link DateFormat} to use.
   *
   * <p>NOTE: non-final since <code>SerializationConfig</code> needs to override this
   */
  ...
  /**
   * Method for constructing and returning a new instance with different default {@link
   * java.util.Locale} to use for formatting.
   */
  ...
  /**
   * Method for constructing and returning a new instance with different default {@link
   * java.util.TimeZone} to use for formatting of date values.
   */
  ...
  /**
   * Method for constructing and returning a new instance with different root name to use (none, if
   * null).
   *
   * <p>Note that when a root name is set to a non-Empty String, this will automatically force use
   * of root element wrapping with given name. If empty String passed, will disable root name
   * wrapping; and if null used, will instead use <code>SerializationFeature</code> to determine if
   * to use wrapping, and annotation (or default name) for actual root name to use.
   *
   * @param rootName to use: if null, means "use default" (clear setting); if empty String ("")
   *     means that no root name wrapping is used; otherwise defines root name to use.
   * @since 2.6
   */
  ...
  /**
   * Method for constructing and returning a new instance with different {@link SubtypeResolver} to
   * use.
   *
   * <p>NOTE: make sure to register new instance with <code>ObjectMapper</code> if directly calling
   * this method.
  ...
  /**
   * Accessor for object used for finding out all reachable subtypes for supertypes; needed when a
   * logical type name is used instead of class name (or custom scheme).
   */
  @Override
  ...
  @Override
  public final JsonIgnoreProperties.Value getDefaultPropertyIgnorals(
      Class<?> baseType, AnnotatedClass actualClass) {
    AnnotationIntrospector intr = getAnnotationIntrospector();
    JsonIgnoreProperties.Value base =
        (intr == null) ? null : intr.findPropertyIgnoralByName(this, actualClass);
  ...
  /**
   * Test-only method -- does not reflect possibly open-ended set that external mix-in resolver
   * might provide.
   */
