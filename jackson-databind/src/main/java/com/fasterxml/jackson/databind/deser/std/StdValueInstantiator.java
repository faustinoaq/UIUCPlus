...
/**
 * Default {@link ValueInstantiator} implementation, which supports Creator methods that can be
 * indicated by standard Jackson annotations.
 */
@JacksonStdImpl
public class StdValueInstantiator extends ValueInstantiator implements java.io.Serializable {
  ...
  /**
   * Default (no-argument) constructor to use for instantiation (with {@link #createUsingDefault})
   */
  ...
  /**
   * Copy-constructor that sub-classes can use when creating new instances by fluent-style
   * construction
   */
  ...
  /**
   * Method for setting properties related to instantiating values from JSON Object. We will choose
   * basically only one approach (out of possible three), and clear other properties
   */
  ...
  public void configureFromBigIntegerCreator(AnnotatedWithParams creator) {
    _fromBigIntegerCreator = creator;
  }
  ...
  public void configureFromBigDecimalCreator(AnnotatedWithParams creator) {
    _fromBigDecimalCreator = creator;
  }
  ...
  public Object createFromInt(DeserializationContext ctxt, int value) throws IOException {
    ...
    if (_fromIntCreator != null) {
      ...
      try {
        ...
        return ctxt.handleInstantiationProblem(
            _fromIntCreator.getDeclaringClass(), arg, rewrapCtorProblem(ctxt, t0));
      }
    }
    ...
    if (_fromBigIntegerCreator != null) {
      ...
      try {
        ...
        return ctxt.handleInstantiationProblem(
            _fromBigIntegerCreator.getDeclaringClass(), arg, rewrapCtorProblem(ctxt, t0));
      }
    }
  ...
  public Object createFromBigInteger(DeserializationContext ctxt, BigInteger value)
    ...
    if (_fromBigIntegerCreator != null) {
      try {
        ...
        return ctxt.handleInstantiationProblem(
            _fromBigIntegerCreator.getDeclaringClass(), value, rewrapCtorProblem(ctxt, t));
      }
    }
  ...
  public Object createFromDouble(DeserializationContext ctxt, double value) throws IOException {
    if (_fromDoubleCreator != null) {
      ...
      try {
        ...
        return ctxt.handleInstantiationProblem(
            _fromDoubleCreator.getDeclaringClass(), arg, rewrapCtorProblem(ctxt, t0));
      }
    }
    ...
    if (_fromBigDecimalCreator != null) {
      ...
      try {
        ...
        return ctxt.handleInstantiationProblem(
            _fromBigDecimalCreator.getDeclaringClass(), arg, rewrapCtorProblem(ctxt, t0));
      }
    }
  ...
  public Object createFromBigDecimal(DeserializationContext ctxt, BigDecimal value)
    ...
    if (_fromBigDecimalCreator != null) {
      try {
        ...
        return ctxt.handleInstantiationProblem(
            _fromBigDecimalCreator.getDeclaringClass(), value, rewrapCtorProblem(ctxt, t));
      }
    }
    ...
    if (_fromDoubleCreator != null) {
      ...
      if (dbl != null) {
        try {
          ...
          return ctxt.handleInstantiationProblem(
              _fromDoubleCreator.getDeclaringClass(), dbl, rewrapCtorProblem(ctxt, t0));
        }
      }
    }
  ...
  public Object createFromBoolean(DeserializationContext ctxt, boolean value) throws IOException {
    ...
    try {
      ...
      return ctxt.handleInstantiationProblem(
          _fromBooleanCreator.getDeclaringClass(), arg, rewrapCtorProblem(ctxt, t0));
    }
  }
  ...
  public AnnotatedWithParams getDefaultCreator() {
    throw new RuntimeException("Buggy Version");
  }
  ...
  /**
   * @deprecated Since 2.7 call either {@link #rewrapCtorProblem} or {@link
  ...
  /**
   * Helper method that will return given {@link Throwable} case as a {@link JsonMappingException}
   * (if it is of that type), or call {@link DeserializationContext#instantiationException(Class,
   * Throwable)} to produce and return suitable {@link JsonMappingException}.
   *
   * @since 2.7
   */
  protected JsonMappingException wrapAsJsonMappingException(
  ...
  /**
   * Method that subclasses may call for standard handling of an exception thrown when calling
   * constructor or factory method. Will unwrap {@link ExceptionInInitializerError} and {@link
   * InvocationTargetException}s, then call {@link #wrapAsJsonMappingException}.
   *
   * @since 2.7
   */
