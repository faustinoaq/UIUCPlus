...
/**
 * Simple helper class used to keep track of collection of Jackson Annotations associated with
 * annotatable things (methods, constructors, classes). Note that only Jackson-owned annotations are
 * tracked (for now?).
 */
public final class AnnotationMap implements Annotations {
  protected HashMap<Class<?>, Annotation> _annotations;

  public AnnotationMap() throws IOException {}
  ...
  /**
   * Helper method that can be used for a "bulk" check to see if at least one of given annotation
   * types is included within this map.
   *
   * @since 2.7
   */
  @Override
   ...
   *
   * @return True if the addition changed the contents, that is, this map did not already have
