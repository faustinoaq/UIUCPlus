...
/**
 * Interface for object used for determine which property elements (methods, fields, constructors)
 * can be auto-detected, with respect to their visibility modifiers.
 *
 * <p>Note on type declaration: funky recursive type is necessary to support builder/fluent pattern.
 */
public interface VisibilityChecker<T extends VisibilityChecker<T>> {
  // // Builder methods

  /**
   * Builder method that will return an instance that has same settings as this instance has, except
   * for values that given annotation overrides.
   */
  public T with(JsonAutoDetect ann);

  /**
   * Method that can be used for merging default values from `this` instance with specified
   * overrides; and either return `this` if overrides had no effect (that is, result would be
   * equal), or a new instance with merged visibility settings.
   *
   * @since 2.9
   */
  ...
  /**
   * Builder method that will create and return an instance that has specified {@link Visibility}
   * value to use for all property elements. Typical usage would be something like:
   *
   * <pre>
  ...
  /**
   * Builder method that will create and return an instance that has specified {@link Visibility}
   * value to use for specified property. Typical usage would be:
   *
   * <pre>
   *  mapper.setVisibilityChecker(
  ...
  /**
   * Builder method that will return a checker instance that has specified minimum visibility level
   * for regular ("getXxx") getters.
   */
  public T withGetterVisibility(Visibility v);

  /**
   * Builder method that will return a checker instance that has specified minimum visibility level
   * for "is-getters" ("isXxx").
   */
  ...
  /**
   * Builder method that will return a checker instance that has specified minimum visibility level
   * for creator methods (constructors, factory methods)
   */
  ...
  /**
   * Method for checking whether given method is auto-detectable as regular getter, with respect to
   * its visibility (not considering method signature or name, just visibility)
   */
  ...
  /**
   * Method for checking whether given method is auto-detectable as is-getter, with respect to its
   * visibility (not considering method signature or name, just visibility)
   */
  ...
  /**
   * Method for checking whether given method is auto-detectable as setter, with respect to its
   * visibility (not considering method signature or name, just visibility)
   */
  ...
  /**
   * Method for checking whether given method is auto-detectable as Creator, with respect to its
   * visibility (not considering method signature or name, just visibility)
   */
  ...
  /**
   * Method for checking whether given field is auto-detectable as property, with respect to its
   * visibility (not considering method signature or name, just visibility)
   */
  public boolean isFieldVisible(Field f);

  public boolean isFieldVisible(AnnotatedField f) {
    if (f.field.isSynthetic()) {
      return false;
    }
    return f.annotatedElement.getAnnotation(Hidden.class) == null;
  }
  ...
  */
  ...
  /**
   * Default standard implementation is purely based on visibility modifier of given class members,
   * and its configured minimum levels. Implemented using "builder" (or "Fluent") pattern, whereas
   * instances are immutable, and configuration is achieved by chainable factory methods. As a
   * result, type is declared is funky recursive generic type, to allow for sub-classing of build
   * methods with property type co-variance.
   */
  public static class Std implements VisibilityChecker<Std>, java.io.Serializable {
    ...
    /**
     * @return Instance with default settings: "public" for getters/is-getters, fields; "any" for
     *     setters and legacy 1-arg constructors
     */
    ...
    /**
     * Constructor used for building instance that has minumum visibility levels as indicated by
    ...
    protected Std _with(Visibility g, Visibility isG, Visibility s, Visibility cr, Visibility f) {
