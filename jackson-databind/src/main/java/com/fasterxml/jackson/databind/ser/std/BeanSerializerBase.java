...
/**
 * Base class both for the standard bean serializer, and couple of variants that only differ in
 * small details. Can be used for custom bean serializers as well, although that is not the primary
 * design goal.
 */
@SuppressWarnings("serial")
public abstract class BeanSerializerBase extends StdSerializer<Object>
    implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable {
  ...
  /**
   * Optional filters used to suppress output of properties that are only to be included in certain
   * views
   */
  protected final BeanPropertyWriter[] _filteredProps;

  /** Handler for {@link com.fasterxml.jackson.annotation.JsonAnyGetter} annotated properties */
  ...
  /**
   * If this POJO can be alternatively serialized using just an object id to denote a reference to
   * previously serialized object, this Object will handle details.
   */
  ...
  /**
   * Constructor used by {@link BeanSerializerBuilder} to create an instance
   *
  ...
  protected BeanSerializerBase(
    ...
    ArrayList<BeanPropertyWriter> fpropsOut =
        (fpropsIn == null) ? null : new ArrayList<BeanPropertyWriter>(len);
  ...
  /**
   * Mutant factory used for creating a new instance with different {@link ObjectIdWriter}.
   *
   * @since 2.0
   */
  ...
  /**
   * Mutant factory used for creating a new instance with additional set of properties to ignore
   * (from properties this instance otherwise has)
   *
   * @since 2.8
   * @deprecated Since 2.12
   */
  ...
  /**
   * Mutant factory used for creating a new instance with additional set of properties to ignore or
   * include (from properties this instance otherwise has)
   *
   * @since 2.12
   */
  ...
  /**
   * Mutant factory for creating a variant that output POJO as a JSON Array. Implementations may
   * ignore this request if output as array is not possible (either at all, or reliably).
   *
   * @since 2.1
   */
  ...
  /**
   * Mutant factory used for creating a new instance with different filter id (used with <code>
   * JsonFilter</code> annotation)
   *
   * @since 2.3
   */
  @Override
   ...
   *
   * <p>Note: in 2.11.x, need to keep non-abstract for slightly better compatibility (XML module
   * extends)
   *
   * @since 2.11.1
   */
  protected abstract BeanSerializerBase withProperties(
      BeanPropertyWriter[] properties, BeanPropertyWriter[] filteredProperties);

  /**
   * Copy-constructor that is useful for sub-classes that just want to copy all super-class
   * properties without modifications.
   */
  ...
  private static final BeanPropertyWriter[] rename(
      BeanPropertyWriter[] props, NameTransformer transformer) {
    if (props == null
        || props.length == 0
        || transformer == null
        || transformer == NameTransformer.NOP) {
      return props;
    }
  ...
  /**
   * We need to implement {@link ResolvableSerializer} to be able to properly handle cyclic type
   * references.
   */
  @Override
        ...
        if (type.isContainerType()) {
          ...
          if (typeSer != null) {
            ...
            if (ser instanceof ContainerSerializer<?>) {
              ...
              JsonSerializer<Object> ser2 =
                  (JsonSerializer<Object>)
                      ((ContainerSerializer<?>) ser).withValueTypeSerializer(typeSer);
              ser = ser2;
            }
          }
        }
  ...
  protected JsonSerializer<Object> findConvertingSerializer(
      SerializerProvider provider, BeanPropertyWriter prop) throws JsonMappingException {
  ...
  public JsonSerializer<?> createContextual(SerializerProvider provider, BeanProperty property)
    ...
    final AnnotationIntrospector intr = provider.getAnnotationIntrospector();
    final AnnotatedMember accessor =
        (property == null || intr == null) ? null : property.getMember();
      ...
      if ((shape != JsonFormat.Shape.ANY) && (shape != _serializationShape)) {
        if (_beanType.isEnumType()) {
            ...
            case NUMBER_INT:
              ...
              JsonSerializer<?> ser =
                  EnumSerializer.construct(
                      _beanType.getRawClass(), provider.getConfig(), desc, format);
          ...
          if (_beanType.isMapLikeType() && Map.class.isAssignableFrom(_handledType)) {
            ...
            JsonSerializer<?> ser =
                new MapEntrySerializer(_beanType, kt, vt, false, null, property);
            return provider.handlePrimaryContextualization(ser, property);
          }
        }
      }
    ...
    if (accessor != null) {
      ...
      if (objectIdInfo == null) {
        ...
        JavaType idType =
            provider.getTypeFactory().findTypeParameters(type, ObjectIdGenerator.class)[0];
        ...
        if (implClass
          ...
          oiw =
              ObjectIdWriter.construct(
                  idType, (PropertyName) null, gen, objectIdInfo.getAlwaysAsId());
        } else { // other types need to be simpler
          ObjectIdGenerator<?> gen = provider.objectIdGeneratorInstance(accessor, objectIdInfo);
          oiw =
              ObjectIdWriter.construct(
                  idType, objectIdInfo.getPropertyName(), gen, objectIdInfo.getAlwaysAsId());
        }
      }
  ...
  public void serializeWithType(
      Object bean, JsonGenerator gen, SerializerProvider provider, TypeSerializer typeSer)
      throws IOException {
  ...
  protected final void _serializeWithObjectId(
      Object bean, JsonGenerator gen, SerializerProvider provider, boolean startEndObject)
      throws IOException {
   ...
   * @since 2.9
   */
  protected final WritableTypeId _typeIdDef(
      TypeSerializer typeSer, Object bean, JsonToken valueShape) {
    if (_typeId == null) {
  ...
  protected void serializeFields(Object bean, JsonGenerator gen, SerializerProvider provider)
    ...
    try {
      ...
      // JsonMappingException mapE = JsonMappingException.from(gen, "Infinite recursion
      // (StackOverflowError)", e);
      DatabindException mapE =
  ...
  /**
   * Alternative serialization method that gets called when there is a {@link PropertyFilter} that
   * needs to be called to determine which properties are to be serialized (and possibly how)
   */
  ...
  public void acceptJsonFormatVisitor(JsonFormatVisitorWrapper visitor, JavaType typeHint)
    ...
    if (_propertyFilterId != null) {
      ...
      Class<?> view =
          (((_filteredProps == null) || (provider == null))) ? null : provider.getActiveView();
      final BeanPropertyWriter[] props;
      if (view != null) {
        props = _filteredProps;
      } else {
