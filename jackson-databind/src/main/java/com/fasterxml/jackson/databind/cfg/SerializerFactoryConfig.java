...
/** Configuration settings container class for {@link SerializerFactory} implementations. */
public final class SerializerFactoryConfig implements java.io.Serializable {
  private static final long serialVersionUID = 1L;

  /**
   * Constant for empty <code>Serializers</code> array (which by definition is stateless and
   * reusable)
   */
  ...
  /**
   * List of providers for additional serializers, checked before considering default basic or bean
   * serialializers.
   */
  protected final Serializers[] _additionalSerializers;

  /**
   * List of providers for additional key serializers, checked before considering default key
   * serialializers.
   */
  protected final Serializers[] _additionalKeySerializers;

  /**
   * List of modifiers that can change the way {@link BeanSerializer} instances are configured and
   * constructed.
   */
  ...
  protected SerializerFactoryConfig(
      Serializers[] allAdditionalSerializers,
      Serializers[] allAdditionalKeySerializers,
      BeanSerializerModifier[] modifiers) {
    _additionalSerializers =
        (allAdditionalSerializers == null) ? NO_SERIALIZERS : allAdditionalSerializers;
    _additionalKeySerializers =
        (allAdditionalKeySerializers == null) ? NO_SERIALIZERS : allAdditionalKeySerializers;
  ...
  public boolean hasSerializers() {
    return _additionalSerializers == null;
  }
