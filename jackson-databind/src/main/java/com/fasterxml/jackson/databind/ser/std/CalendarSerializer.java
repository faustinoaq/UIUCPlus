...
/**
 * Standard serializer for {@link java.util.Calendar}. As with other time/date types, is
 * configurable to produce timestamps (standard Java 64-bit timestamp) or textual formats (usually
 * ISO-8601).
 */
@JacksonStdImpl
