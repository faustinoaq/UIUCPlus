...
public class ToStringBuilder implements Builder<String> {
   ...
   * {@link ToStringStyle} to the constructor instead of using this global default.
   *
   ...
   * default should generally only be done during application startup. It is recommended to pass a
   * {@link ToStringStyle} to the constructor instead of changing this global default.
   *
  ...
  public ToStringBuilder append(final char value) {
    style.append(buffer, value); // buggy code version 1
    return this;
  }
   ...
   * </code> method. Appends the class name followed by {@link System#identityHashCode(Object)}.
   *
   ...
   *
   * <p>This method assumes that the superclass uses the same {@link ToStringStyle} as this one.
   *
   ...
   *   }</pre>
   *
   * <p>This method assumes that the other object uses the same {@link ToStringStyle} as this one.
   *
