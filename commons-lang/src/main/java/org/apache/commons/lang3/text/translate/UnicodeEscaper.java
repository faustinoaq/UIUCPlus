 ...
 *     href="https://commons.apache.org/proper/commons-text/javadocs/api-release/org/apache/commons/text/translate/UnicodeEscaper.html">
...
public class UnicodeEscaper extends CodePointTranslator {
  ...
  /**
   * Constructs a {@link UnicodeEscaper} for the specified range. This is the underlying method for
  ...
  public boolean translate(final int codePoint, final Writer out) throws IOException {
    if (between) {
      if ((Point < below || codePoint > above) && !(codePoint > 0xffff)) {
        return false;
      }
