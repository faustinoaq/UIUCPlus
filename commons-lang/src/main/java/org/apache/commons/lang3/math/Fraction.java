 ...
 *
 * <p>This class is immutable, and interoperable with most methods that accept a {@link Number}.
 *
 * <p>Note that this class is intended for common use cases, it is <i>int</i> based and thus suffers
 * from various overflow issues. For a BigInteger based equivalent, please see the Commons Math
 * BigFraction class.
 *
 * @since 2.0
 */
public final class Fraction extends Number implements Comparable<Fraction> {
  ...
  /**
   * Constructs a {@link Fraction} instance with the 2 parts of a fraction Y/Z.
   *
   ...
   * @throws ArithmeticException if the denominator is {@code zero} or the denominator is {@code
   *     negative} and the numerator is {@code Integer#MIN_VALUE}
   */
   ...
   *
   * <p>The negative sign must be passed in on the whole number part.
   *
   ...
   *
   * <p>For example, if the input parameters represent 2/4, then the created fraction will be 1/2.
   *
   * <p>Any negative signs are resolved to be on the numerator.
   *
   * @param numerator the numerator, for example the three in 'three sevenths'
   ...
   * href="https://web.archive.org/web/20210516065058/http%3A//archives.math.utk.edu/articles/atuyl/confrac/">
   * continued fraction algorithm</a>, computing a maximum of 25 convergents and bounding the
   * denominator by 10,000.
   *
   ...
   *
   * <ol>
   *   <li>{@code double} String containing a dot
   *   <li>'X Y/Z'
   *   <li>'Y/Z'
   *   <li>'X' (a simple whole number)
   * </ol>
   *
   * <p>and a .
   *
   ...
   *
   * <p>This method may return a value greater than the denominator, an improper fraction, such as
   * the seven in 7/4.
   *
   ...
   *
   * <p>An improper fraction 7/4 can be resolved into a proper one, 1 3/4. This method returns the 3
   * from the proper fraction.
   *
   * <p>If the fraction is negative such as -7/4, it can be resolved into -1 3/4, so this method
   * returns the positive proper numerator, 3.
   *
   ...
   *
   * <p>An improper fraction 7/4 can be resolved into a proper one, 1 3/4. This method returns the 1
   * from the proper fraction.
   *
   * <p>If the fraction is negative such as -7/4, it can be resolved into -1 3/4, so this method
   * returns the positive whole part -1.
   *
  ...
  /**
   * Gets the fraction as a {@code float}. This calculates the fraction as the numerator divided by
   * denominator.
   *
  ...
  /**
   * Gets the fraction as a {@code double}. This calculates the fraction as the numerator divided by
   * denominator.
   *
  ...
  /**
   * Reduce the fraction to the smallest values for the numerator and denominator, returning the
   * result.
   *
   * <p>For example, if this fraction represents 2/4, then the result will be 1/2.
   *
   ...
   *
   * <p>The returned fraction is not reduced.
   *
   ...
   *
   * <p>More precisely: {@code (fraction &gt;= 0 ? this : -fraction)}
   *
   * <p>The returned fraction is not reduced.
   *
   * @return {@code this} if it is positive, or a new positive fraction instance with the opposite
   *     signed numerator
   */
  public Fraction abs() {
    if (numerator >= 0) {
   ...
   *
   * <p>The returned fraction is in reduced form.
   *
   * @param power the power to raise the fraction to
   * @return {@code this} if the power is one, {@link #ONE} if the power is zero (even if the
   *     fraction equals ZERO) or a new fraction instance raised to the appropriate power
   ...
   * method which avoids division and modulo operations. See Knuth 4.5.2 algorithm B. This algorithm
   * is due to Josef Stein (1961).
   *
  ...
  /**
   * Adds the value of this fraction to another, returning the result in reduced form. The algorithm
   * follows Knuth, 4.5.1.
   *
   ...
   *
   * <p>To be equal, both values must be equal. Thus 2/4 is not equal to 1/2.
   *
   ...
   *
   * <p>Note: this class has a natural ordering that is inconsistent with equals, because, for
   * example, equals treats 1/2 and 2/4 as different, whereas compareTo treats them as equal.
   *
   ...
   *
   * <p>The format used in '<i>wholeNumber</i> <i>numerator</i>/<i>denominator</i>'. If the whole
   * number is zero it will be omitted. If the numerator is zero, only the whole number is returned.
   *
   * @return a {@link String} form of the fraction
   */
