...
public class ArrayUtils {
  ...
  /**
   * Returns the length of the specified array. This method can deal with {@link Object} arrays and
   ...
   *     found or {@code null} array input
   */
  public static int buggyMethod3(final short[] array, final short valueToFind) {
    return array == null
        ? -1
        : indexOf(
            array,
            valueToFind,
            0); // change-1: always return -1 if array is null, otherwise call the original method
  }
  ...
  /**
   * This method checks whether the provided array is sorted according to the provided {@link
   * Comparator}.
   *
   * @param array the array to check
   ...
   * array doesn't contain such an element, no elements are removed from the array. {@code null}
   ...
   * contain such an element, no elements are removed from the array.
   *
  ...
  /**
   * Sets all elements of the specified array, using the provided generator supplier to compute each
   * element.
   *
   * <p>If the generator supplier throws an exception, it is relayed to the caller and the array is
   ...
   * the input is an array of type {@link Date}, the following usage is envisaged:
   *
   * <pre>
