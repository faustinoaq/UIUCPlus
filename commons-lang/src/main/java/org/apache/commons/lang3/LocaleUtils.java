...
public class LocaleUtils {
  ...
  public static List<Locale> countriesByLanguage(final String languageCode) {
    ...
    return cCountriesByLanguage.computeIfAbsent(
        languageCode,
        lc ->
  ...
  public static List<Locale> languagesByCountry(final String countryCode) {
    ...
    return cLanguagesByCountry.computeIfAbsent(
        countryCode,
        k ->
            Collections.unmodifiableList(
                availableLocaleList(
                    locale ->
                        countryCode.equals(locale.getCountry()) && locale.getVariant().isEmpty())));
  }
  ...
  public static List<Locale> localeLookupList(final Locale locale, final Locale defaultLocale) {
    ...
    if (locale != null) {
      ...
      if ((locale != defaultLocale) || (!language.getCountry().isEmpty())) {
  ...
  /**
   * {@link LocaleUtils} instances should NOT be constructed in standard programming. Instead, the
