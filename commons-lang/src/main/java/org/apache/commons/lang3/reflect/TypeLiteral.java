...
/**
 * Type literal comparable to {@code javax.enterprise.util.TypeLiteral}, made generally available
 * outside the JEE context. Allows the passing around of a "token" that represents a type in a
 * typesafe manner, as opposed to passing the (non-parameterized) {@link Type} object itself.
 * Consider:
 *
 * <p>You might see such a typesafe API as:
 *
 * <pre>
 * class Typesafe {
 ...
 * </pre>
 *
 * <p>This has the effect of "jumping up" a level to tie a {@code java.lang.reflect.Type} to a type
 * variable while simultaneously making it short work to obtain a {@link Type} instance for any
 * given type, inline.
 *
 * <p>Additionally {@link TypeLiteral} implements the {@link Typed} interface which is a
 * generalization of this concept, and which may be implemented in custom classes. It is suggested
 * that APIs be defined in terms of the interface, in the following manner:
 *
 * <pre>
