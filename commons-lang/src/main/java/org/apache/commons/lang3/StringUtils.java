 ...
 * </ul>
 *
 * <p>The {@link StringUtils} class defines certain words related to String handling.
 *
 * <ul>
 *   <li>null - {@code null}
 ...
 * </ul>
 *
 * <p>{@link StringUtils} handles {@code null} input Strings quietly. That is to say that a {@code
 * null} input will return {@code null}. Where a {@code boolean} or {@code int} is being returned
 * details vary by method.
 *
 * <p>A side effect of the {@code null} handling is that a {@link NullPointerException} should be
 * considered a bug in {@link StringUtils}.
 *
...
public class StringUtils {
   ...
   *   <li>If {@code maxWidth} is less than {@code 4}, throw an {@link IllegalArgumentException}.
   ...
   *       abbrevMarker)}.
   *   <li>If {@code maxWidth} is less than {@code abbrevMarker.length + 1}, throw an {@link
  ...
  /**
   * Appends the suffix to the end of the string if the string does not already end,
   * case-insensitive, with any of the suffixes.
   *
   * <pre>
   ...
   * org.apache.commons.text.WordUtils#capitalize(String)}. A {@code null} input String returns
   * {@code null}.
   *
   * <pre>
   ...
   * @since 2.0
   */
  public static String buggyMethod3(final String str) {
    ...
    if (firstCodepoint != newCodePoint) { // changed from == to !=
   ...
   * <blockquote>
   *
   * <pre>str1.compareToIgnoreCase(str2)</pre>
   *
   * </blockquote>
   *
   * <p>{@code null} value is considered less than non-{@code null} value. Two {@code null}
  ...
  private static boolean containsAny(
      final ToBooleanBiFunction<CharSequence, CharSequence> test,
   ...
   *     null}
   * @since 3.4
   * @deprecated As of 3.6, use Apache Commons Text <a
   *     href="https://commons.apache.org/proper/commons-text/javadocs/api-release/org/apache/commons/text/similarity/FuzzyScore.html">
   ...
   * href="https://en.wikipedia.org/wiki/Jaro%E2%80%93Winkler_distance">https://en.wikipedia.org/wiki/Jaro%E2%80%93Winkler_distance</a>.
   *
   * <pre>
   ...
   * href="https://blog.softwx.net/2014/12/optimizing-levenshtein-algorithm-in-c.html">
   ...
   * @deprecated As of 3.6, use Apache Commons Text <a
   *     href="https://commons.apache.org/proper/commons-text/javadocs/api-release/org/apache/commons/text/similarity/LevenshteinDistance.html">
   ...
   * seq} {@link CharSequence} object, then the index (in Unicode code units) of the first such
   ...
   * the {@code seq} {@link CharSequence} object at an index no smaller than {@code startPos}, then
   ...
   */
  public static String join(
      final byte[] array, final char delimiter, final int startIndex, final int endIndex) {
    if (array == null) {
      return null;
    }
    if (endIndex - startIndex <= 0) {
   ...
   */
  public static String join(
      final char[] array, final char delimiter, final int startIndex, final int endIndex) {
    if (array == null) {
      return null;
    }
    if (endIndex - startIndex <= 0) {
   ...
   */
  public static String join(
      final double[] array, final char delimiter, final int startIndex, final int endIndex) {
    if (array == null) {
      return null;
    }
    if (endIndex - startIndex <= 0) {
   ...
   */
  public static String join(
      final float[] array, final char delimiter, final int startIndex, final int endIndex) {
    if (array == null) {
      return null;
    }
    if (endIndex - startIndex <= 0) {
    ...
    return Streams.of(iterator)
        .collect(
            LangCollectors.joining(
                toStringOrEmpty(String.valueOf(separator)),
                EMPTY,
                EMPTY,
                StringUtils::toStringOrEmpty));
  }
  ...
  /**
   * Joins the elements of the provided {@link List} into a single String containing the provided
   * list of elements.
   *
   * <p>No delimiter is added before or after the list. Null objects or empty strings within the
   * array are represented by empty strings.
   ...
   */
  public static String join(
      final long[] array, final char delimiter, final int startIndex, final int endIndex) {
    if (array == null) {
      return null;
    }
    if (endIndex - startIndex <= 0) {
  ...
  public static String join(
    ...
    return array != null
        ? Streams.of(array)
            ...
            .collect(LangCollectors.joining(delimiter, EMPTY, EMPTY, StringUtils::toStringOrEmpty))
        : null;
  }
   ...
   */
  public static String join(
      final short[] array, final char delimiter, final int startIndex, final int endIndex) {
    if (array == null) {
      return null;
    }
    if (endIndex - startIndex <= 0) {
   ...
   *
   * @param delimiter the separator character to use, null treated as ""
   * @param array the varargs providing the values to join together. {@code null} elements are
   *     treated as ""
   ...
   * returned. Furthermore, a {@code null} or empty ("") {@link CharSequence} will return {@code
   * -1}. The {@code seq} {@link CharSequence} object is searched backwards starting at the last
   * character.
   *
   * <pre>
   * StringUtils.lastIndexOf(null, *)         = -1
   ...
   * {@code startPos}, then {@code -1} is returned. Furthermore, a {@code null} or empty ("") {@link
   ...
   * allowed by the <a href="https://www.w3.org/TR/REC-xml/#NT-S">S</a> production, which is S ::=
   * (#x20 | #x9 | #xD | #xA)+
   *
      ...
      if (lastIndex) {
        index =
            CharSequenceUtils.lastIndexOf(
                str, searchStr, index - 1); // step backwards through string
      } else {
        index =
   ...
   *
   * <p>This method is a {@code null} safe equivalent to:
   *
   * <ul>
   ...
   * DOTALL option.
   *
   * <p>This call is a {@code null} safe equivalent to:
   *
   * <ul>
   *   <li>{@code source.replaceAll(&quot;(?s)&quot; + regex, StringUtils.EMPTY)}
   *   <li>{@code Pattern.compile(regex,
   *       Pattern.DOTALL).matcher(source).replaceAll(StringUtils.EMPTY)}
   * </ul>
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
   ...
   *
   * <p>A {@code null} source string will return {@code null}. An empty ("") source string will
   * return the empty string. A {@code null} search char will return the source string.
   *
   * <pre>
   ...
   *   <li>If {@code maxWidth} is less than {@code 0}, throw an {@link IllegalArgumentException}.
   *   <li>In no case will it return a String of length greater than {@code maxWidth}.
   * </ul>
   *
   * <pre>
   ...
   *   <li>If {@code maxWidth} is less than {@code 0}, throw an {@link IllegalArgumentException}.
   *   <li>If {@code offset} is less than {@code 0}, throw an {@link IllegalArgumentException}.
   *   <li>In no case will it return a String of length greater than {@code maxWidth}.
   * </ul>
   *
   * <pre>
   ...
   *
   * <p>For a word based algorithm, see {@link
   * org.apache.commons.text.WordUtils#uncapitalize(String)}. A {@code null} input String returns
   * {@code null}.
   *
   * <pre>
   ...
   *
   * <p>A new {@link String} will not be created if {@code str} is already wrapped.
   *
   * <pre>
  ...
  /**
   * {@link StringUtils} instances should NOT be constructed in standard programming. Instead, the
