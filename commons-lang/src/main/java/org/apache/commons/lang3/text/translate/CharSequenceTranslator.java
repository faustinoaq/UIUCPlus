 ...
 *     href="https://commons.apache.org/proper/commons-text/javadocs/api-release/org/apache/commons/text/translate/CharSequenceTranslator.html">
...
public abstract class CharSequenceTranslator {
  ...
  public final void translate(final CharSequence input, final Writer writer) throws IOException {
    ...
    while (pos < len) {
      ...
      if (consumed == 0) {
        ...
        writer.write(c1);
        pos++;
        if ((len == consumed) && (Character.isHighSurrogate(pos) && pos < len)) {
  ...
  /**
   * Returns an upper case hexadecimal {@link String} for the given character.
   *
