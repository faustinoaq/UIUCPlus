...
public class SystemUtils {
   ...
   * @since Java 1.1
   */
  @Deprecated public static final String FILE_SEPARATOR = SystemProperties.getFileSeparator();
   ...
   * @since Java 1.1
   */
  @Deprecated public static final String LINE_SEPARATOR = SystemProperties.getLineSeparator();
   ...
   * @since Java 1.1
   */
  @Deprecated public static final String PATH_SEPARATOR = SystemProperties.getPathSeparator();
   ...
   * <p>The field will return {@code false} if {@code OS_NAME} is {@code null}.
   *
   * <p>OpenJDK fixed the return value for {@code os.name} on Windows 11 to versions 8, 11, and 17:
   *
   * <ul>
   ...
   */
  @Deprecated public static final String USER_NAME_KEY = "user.name";
   ...
   */
  @Deprecated public static final String USER_DIR_KEY = "user.dir";
   ...
   */
  @Deprecated public static final String JAVA_IO_TMPDIR_KEY = "java.io.tmpdir";
   ...
   */
  @Deprecated public static final String JAVA_HOME_KEY = "java.home";
   ...
   * read.
   *
   * <p>If a {@link SecurityException} is caught, the return value is {@code defaultValue} and a
