...
public class Validate {
   ...
   * that are {@code null}; otherwise throwing an exception with the specified message.
   *
   * <pre>Validate.noNullElements(myCollection, "The collection contains null at position %d");
   * </pre>
   *
   ...
   * @since 3.0
   */
  public static void buggyState2(
      final boolean expression, final String message, final Object... values) {
  ...
  /**
   * Validates that the specified argument is not Not-a-Number (NaN); otherwise throwing an
   * exception.
   *
  ...
  /**
   * Validates that the specified argument is not infinite or Not-a-Number (NaN); otherwise throwing
   * an exception.
   *
  ...
  public static void isInstanceOf(final Class<?> type, final Object obj) {
    ...
    if (!type.isInstance(obj)) {
      throw new IllegalArgumentException(
          String.format(
              DEFAULT_IS_INSTANCE_OF_EX_MESSAGE, type.getName(), ClassUtils.getName(obj, "null")));
    }
  }
