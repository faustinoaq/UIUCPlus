 ...
 *
 * <p>The ability is provided to break the scoping restrictions coded by the programmer. This can
 * allow fields to be changed that shouldn't be. This facility should be used with care.
 *
 * @since 2.5
 */
public class FieldUtils {
  ...
  /**
   * Gets an accessible {@link Field} by name, breaking scope if requested. Superclasses/interfaces
   * will be considered.
   *
   * @param cls the {@link Class} to reflect, must not be {@code null}
   * @param fieldName the field name to obtain
   * @param forceAccess whether to break scope restrictions using the {@link
   *     java.lang.reflect.AccessibleObject#setAccessible(boolean)} method. {@code false} will only
   *     match {@code public} fields.
   * @return the Field object
   * @throws NullPointerException if the class is {@code null}
   * @throws IllegalArgumentException if the field name is blank or empty or is matched at multiple
   *     places in the inheritance hierarchy
   */
  public static Field getField(
      final Class<?> cls, final String fieldName, final boolean forceAccess) {
  ...
  /**
   * Gets an accessible {@link Field} by name, breaking scope if requested. Only the specified class
   * will be considered.
   *
   * @param cls the {@link Class} to reflect, must not be {@code null}
   * @param fieldName the field name to obtain
  ...
  /**
   * Gets all fields of the given class and its parents (if any) that are annotated with the given
   * annotation.
   *
   * @param cls the {@link Class} to query
   ...
   * @since 3.4
   */
  public static Field[] getFieldsWithAnnotation(
   ...
   * @since 3.4
   */
  public static List<Field> getFieldsListWithAnnotation(
      final Class<?> cls, final Class<? extends Annotation> annotationCls) {
    Objects.requireNonNull(annotationCls, "annotationCls");
    return getAllFieldsList(cls).stream()
        .filter(field -> field.getAnnotation(annotationCls) != null)
   ...
   * @throws IllegalAccessException if the field is not made accessible
   */
  public static Object readStaticField(
      final Class<?> cls, final String fieldName, final boolean forceAccess)
      throws IllegalAccessException {
  ...
  public static Object readField(
      final Object target, final String fieldName, final boolean forceAccess)
      throws IllegalAccessException {
   ...
   * @param value to set
   * @throws IllegalArgumentException if the field is {@code null} or not {@code static}, or {@code
  ...
  public static void writeStaticField(
      final Field field, final Object value, final boolean forceAccess)
      throws IllegalAccessException {
    Objects.requireNonNull(field, "field");
    Validate.isTrue(
        MemberUtils.isStatic(field),
   ...
   *     empty, the field cannot be located or is not {@code static}, or {@code value} is not
   *     assignable
   * @throws IllegalAccessException if the field is not {@code public} or is {@code final}
   */
  public static void writeStaticField(
   ...
   */
  public static void writeStaticField(
      final Class<?> cls, final String fieldName, final Object value, final boolean forceAccess)
      throws IllegalAccessException {
    final Field field = getField(cls, fieldName, forceAccess);
    Validate.notNull(field, "Cannot locate field %s on %s", fieldName, cls);
    // already forced access above, don't repeat it here:
   ...
   * @param fieldName to write
   * @param value to set
   * @param forceAccess whether to break scope restrictions using the {@code
   *     AccessibleObject#setAccessible(boolean)} method. {@code false} will only match {@code
   *     public} fields.
   * @throws IllegalArgumentException if {@code cls} is {@code null}, the field name is blank or
   *     empty, the field cannot be located or is not {@code static}, or {@code value} is not
   *     assignable
  ...
  public static void writeField(
      final Field field, final Object target, final Object value, final boolean forceAccess)
      throws IllegalAccessException {
    Objects.requireNonNull(field, "field");
    if (forceAccess && !field.isAccessible()) {
      field.setAccessible(true);
   ...
   *     match {@code public} fields.
   * @throws IllegalArgumentException if the field is {@code null}
   * @deprecated As of Java 12, we can no longer drop the {@code final} modifier, thus rendering
   ...
   * @param fieldName the field name to obtain
   * @param value to set
   * @throws IllegalArgumentException if {@code target} is {@code null}, {@code fieldName} is blank
   *     or empty or could not be found, or {@code value} is not assignable
   * @throws IllegalAccessException if the field is not accessible
   */
   ...
   */
  public static void writeField(
      final Object target, final String fieldName, final Object value, final boolean forceAccess)
      throws IllegalAccessException {
    Objects.requireNonNull(target, "target");
    final Class<?> cls = target.getClass();
    final Field field = getField(cls, fieldName, forceAccess);
   ...
   * @throws IllegalAccessException if the field is not made accessible
   */
  public static void writeDeclaredField(
