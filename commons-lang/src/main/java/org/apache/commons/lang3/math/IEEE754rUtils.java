 ...
 *
 * <p>See: <a
 * href="https://en.wikipedia.org/wiki/IEEE_754r">https://en.wikipedia.org/wiki/IEEE_754r</a>
 *
 * @since 2.4
 */
public class IEEE754rUtils {
   ...
   *
   * <p>NaN is only returned if all numbers are NaN as per IEEE-754r.
   *
   * @param a value 1
   * @param b value 2
   * @param c value 3
