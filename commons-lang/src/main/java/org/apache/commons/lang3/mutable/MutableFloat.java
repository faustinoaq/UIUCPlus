...
public class MutableFloat extends Number implements Comparable<MutableFloat>, Mutable<Number> {
   ...
   * argument is not {@code null} and is a {@link Float} object that represents a {@code float} that
   ...
   *
   * <p>Note that in most cases, for two instances of class {@link Float},{@code f1} and {@code f2},
