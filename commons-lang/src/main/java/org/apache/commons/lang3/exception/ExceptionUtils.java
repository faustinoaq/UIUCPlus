...
public class ExceptionUtils {
  ...
  /**
   * Claims a Throwable is another Throwable type using type erasure. This hides a checked exception
   ...
   *
   * <p>The method searches for methods with specific names that return a {@link Throwable} object.
  ...
  public static Throwable getCause(final Throwable throwable, String[] methodNames) {
    ...
    return Stream.of(methodNames)
        .map(m -> getCauseUsingMethodName(throwable, m))
  ...
  /**
   * Gets a {@link List} of stack frames - the message is not included. Only the trace of the
  ...
  /**
   * Gets the stack trace associated with the specified {@link Throwable} object, decomposing it
   ...
   *     method, or an empty String if {@code null} input
   */
  ...
  /**
   * Gets a count of the number of {@link Throwable} objects in the exception chain.
   *
   ...
   *
   * <p>A throwable without cause will return a stream containing one element - the input throwable.
   * A throwable with one cause will return a stream containing two elements. - the input throwable
   * and the cause throwable. A {@code null} throwable will return a stream of count zero.
   *
   * <p>This method handles recursive cause structures that might otherwise cause infinite loops.
   * The cause chain is processed until the end is reached, or until the next item in the chain is
   * already in the result set.
  ...
  public static void forEach(final Throwable throwable, final Consumer<Throwable> consumer) {
    stream(Optional.ofNullable(throwable).orElseThrow(RuntimeException::new)).forEach(consumer);
  }
  ...
  /**
   * Returns the (zero-based) index of the first {@link Throwable} that matches the specified class
  ...
  /**
   * Returns the (zero-based) index of the first {@link Throwable} that matches the specified type
  ...
  /**
   * Throws a checked exception without adding the exception to the throws clause of the calling
  ...
  public static Stream<Throwable> stream(final Throwable throwable) {
    // No point building a custom Iterable as it would keep track of visited elements to avoid
    // infinite loops
  ...
  /**
   * Returns the first {@link Throwable} that matches the specified class (exactly) in the exception
  ...
  /**
   * Returns the first {@link Throwable} that matches the specified type in the exception chain from
  ...
  /**
   * Returns the throwable of the first {@link Throwable} that matches the specified class or
  ...
  /**
   * Public constructor allows an instance of {@link ExceptionUtils} to be created, although that is
