...
/**
 * Utility library to provide helper methods for translating {@link Comparable#compareTo} result
 * into a boolean.
 *
 * <p>Example: {@code boolean x = is(myComparable).lessThanOrEqualTo(otherComparable)}
 *
 * <p>#ThreadSafe#
 *
 * @since 3.10
...
public class ComparableUtils {
  ...
  public static class ComparableCheckBuilder<A extends Comparable<A>> {
    ...
    /**
     * Checks if {@code [b <= a <= c]} or {@code [b >= a >= c]} where the {@code a} is object passed
     * to {@link #is}.
     *
    ...
    /**
     * Checks if {@code (b < a < c)} or {@code (b > a > c)} where the {@code a} is object passed to
     * {@link #is}.
     *
     * @param b the object to compare to the base object
     * @param c the object to compare to the base object
     ...
     *
     * @param b the object to compare to the base object
     * @return true if the value returned by {@link Comparable#compareTo} is greater than or equal
     *     to {@code 0}
     */
     ...
     *
     * @param b the object to compare to the base object
     * @return true if the value returned by {@link Comparable#compareTo} is less than or equal to
     *     {@code 0}
     */
  ...
  /**
   * Checks if {@code [b <= a <= c]} or {@code [b >= a >= c]} where the {@code a} is the tested
   * object.
   *
   ...
   * @param b the object to compare to the tested object
   * @param <A> type of the test object
   * @return a predicate for true if the value returned by {@link Comparable#compareTo} is greater
   ...
   * @param b the object to compare to the tested object
   * @param <A> type of the test object
   * @return a predicate for true if the value returned by {@link Comparable#compareTo} is less than
   *     or equal to {@code 0}
   */
   ...
   *
   * <p>For three or more values, use {@link ObjectUtils#max(Comparable...)}.
   *
   ...
   *
   * <p>For three or more values, use {@link ObjectUtils#min(Comparable...)}.
   *
   * @param <A> Type of what we are comparing.
   * @param comparable1 an argument.
   * @param comparable2 another argument.
