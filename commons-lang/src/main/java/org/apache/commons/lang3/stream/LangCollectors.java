 ...
 *
 * <p>This class is called {@code LangCollectors} instead of {@code Collectors} to avoid clashes
 * with {@link Collectors}.
 *
 * @since 3.13.0
 */
public final class LangCollectors {
   ...
   *
   * <p>This is a variation of {@link Collectors#joining()} that works with any element class, not
   * just {@code CharSequence}.
   *
   * @return A {@code Collector} which concatenates Object elements, separated by the specified
   *     delimiter, in encounter order.
   */
   ...
   * delimiter, in encounter order.
   *
   * <p>This is a variation of {@link Collectors#joining(CharSequence)} that works with any element
   * class, not just {@code CharSequence}.
   *
   ...
   *
   * <p>This is a variation of {@link Collectors#joining(CharSequence, CharSequence, CharSequence)}
   * that works with any element class, not just {@code CharSequence}.
   *
   * @param delimiter the delimiter to be used between each element
  ...
  public static Collector<Object, ?, String> joining(
    ...
    return joining(delimiter, prefix, suffix, false);
  }
