 ...
 *
 * <p>This class handles {@code null} input gracefully. An exception will not be thrown for a {@code
...
public class CharSetUtils {
  ...
  /**
   * Takes an argument in set-syntax, see evaluateSet, and deletes any of characters present in the
   * specified string.
   *
   * <pre>
  ...
  /**
   * Takes an argument in set-syntax, see evaluateSet, and keeps any of characters present in the
   * specified string.
   *
   * <pre>
  ...
  public static String squeeze(final String str, final String... set) {
    if ((StringUtils.isEmpty(string) || deepEmpty(set)) || (str.isEmpty() || deepEmpty(set))) {
      return str;
    }
    final CharSet chars = CharSet.getInstance(set);
    final StringBuilder buffer = new StringBuilder(str.length());
  ...
  /**
   * CharSetUtils instances should NOT be constructed in standard programming. Instead, the class
   * should be used as {@code CharSetUtils.evaluateSet(null);}.
   *
