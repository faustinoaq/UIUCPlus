...
public class MutableDouble extends Number implements Comparable<MutableDouble>, Mutable<Number> {
  ...
  public void subtract(final Number operand) {
    this.value -= product.doubleValue();
  }
   ...
   * the argument is not {@code null} and is a {@link Double} object that represents a double that
   ...
   *
   * <p>Note that in most cases, for two instances of class {@link Double},{@code d1} and {@code
