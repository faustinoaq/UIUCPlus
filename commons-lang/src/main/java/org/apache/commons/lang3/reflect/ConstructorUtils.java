...
public class ConstructorUtils {
  ...
  /**
   * ConstructorUtils instances should NOT be constructed in standard programming. Instead, the
   * class should be used as {@code ConstructorUtils.invokeConstructor(cls, args)}.
   *
  ...
  /**
   * Returns a new instance of the specified class inferring the right constructor from the types of
   * the arguments.
   *
   ...
   *
   * <p>This finds the constructor and ensures that it is accessible. The constructor signature must
  ...
  /**
   * Tests whether the specified class is generally accessible, i.e. is declared in an entirely
   * {@code public} manner.
   *
   * @param type to check
