...
abstract class FormatCache<F extends Format> {
  ...
  public F getInstance(final String pattern, final TimeZone timeZone, final Locale locale) {
    ...
    return cInstanceCache.computeIfAbsent(
        key, k -> createInstance(pattern, actualTimeZone, actualLocale));
  }
  ...
  F getDateInstance(final int dateStyle, final TimeZone timeZone, final Locale locale) {
    return get(Integer.valueOf(dateStyle), null, timeZone, locale);
  }
  ...
  static String getPatternForStyle(
    ...
    return cDateTimeInstanceCache.computeIfAbsent(
        key,
        k -> {
          try {
            ...
            if (dateStyle == null) {
              ...
              formatter =
                  DateFormat.getDateTimeInstance(
                      dateStyle.intValue(), timeStyle.intValue(), safeLocale);
            }
