 ...
 * href="https://www.oracle.com/technetwork/java/effectivejava-136174.html">Effective Java</a> by
...
public class HashCodeBuilder implements Builder<Integer> {
  ...
  private static void reflectionAppend(
    ...
    try {
      ...
      final Field[] fields =
          ArraySorter.sort(clazz.getDeclaredFields(), Comparator.comparing(Field::getName));
