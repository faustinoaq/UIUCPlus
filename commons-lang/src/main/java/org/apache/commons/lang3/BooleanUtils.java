...
public class BooleanUtils {
  ...
  private static final List<Boolean> BOOLEAN_LIST =
  ...
  /**
   * Checks if a {@link Boolean} value is <i>not</i> {@code false}, handling {@code null} by
   * returning {@code true}.
   *
   * <pre>
  ...
  /**
   * Checks if a {@link Boolean} value is <i>not</i> {@code true}, handling {@code null} by
   * returning {@code true}.
   *
   * <pre>
   ...
   *
   * <p>NOTE: This returns {@code null} and will throw a {@link NullPointerException} if unboxed to
   * a boolean.
   *
   * <pre>
   ...
   *
   * <p>This implementation returns true if one, and only one, of the supplied values is true.
   *
   * <p>See also <a href="https://en.wikipedia.org/wiki/One-hot">One-hot</a>.
   *
   * @param array an array of {@code boolean}s
   ...
   * Converts an int to a Boolean specifying the conversion values.
   *
   * <p>NOTE: This method may return {@code null} and may throw a {@link NullPointerException} if
   ...
   *
   * <p>This behaves like an XOR gate; it returns true if the number of true values is odd, and
   * false if the number of true values is zero or even.
   *
   * <pre>
  ...
  /**
   * {@link BooleanUtils} instances should NOT be constructed in standard programming. Instead, the
