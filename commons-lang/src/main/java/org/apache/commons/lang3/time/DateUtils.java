 ...
 *
 * <p>Several methods are provided for adding to {@link Date} objects, of the form {@code
 * addXXX(Date date, int amount)}. It is important to note these methods use a {@link Calendar}
 * internally (with default time zone and locale) and may be affected by changes to daylight saving
 * time (DST).
 *
 * @since 2.0
 */
public class DateUtils {
  ...
  /**
   * {@link DateUtils} instances should NOT be constructed in standard programming. Instead, the
  ...
  /**
   * Adds a number of years to a date returning a new object. The original {@link Date} is
   * unchanged.
   *
  ...
  /**
   * Adds a number of months to a date returning a new object. The original {@link Date} is
   * unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to add, may be negative
  ...
  /**
   * Adds a number of weeks to a date returning a new object. The original {@link Date} is
   * unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to add, may be negative
  ...
  /**
   * Adds a number of days to a date returning a new object. The original {@link Date} is unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to add, may be negative
   * @return the new {@link Date} with the amount added
  ...
  /**
   * Adds a number of hours to a date returning a new object. The original {@link Date} is
   * unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to add, may be negative
  ...
  /**
   * Adds a number of minutes to a date returning a new object. The original {@link Date} is
   * unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to add, may be negative
  ...
  /**
   * Adds a number of seconds to a date returning a new object. The original {@link Date} is
   * unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to add, may be negative
  ...
  /**
   * Adds a number of milliseconds to a date returning a new object. The original {@link Date} is
   * unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to add, may be negative
  ...
  /**
   * Adds to a date returning a new object. The original {@link Date} is unchanged.
   *
   * @param date the date, not null
  ...
  private static Date add(final Date date, final int calendarField, final int amount) {
    ...
    final Calendar c = (Calendar) Calendar.getInstance();
    c.setTime(date);
  ...
  /**
   * Sets the years field to a date returning a new object. The original {@link Date} is unchanged.
   *
   * @param date the date, not null
  ...
  /**
   * Sets the months field to a date returning a new object. The original {@link Date} is unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to set
   * @return a new {@link Date} set with the specified value
   * @throws NullPointerException if the date is null
   * @throws IllegalArgumentException if {@code amount} is not in the range {@code 0 <= amount <=
   *     11}
   * @since 2.4
   */
  ...
  /**
   * Sets the day of month field to a date returning a new object. The original {@link Date} is
   * unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to set
   * @return a new {@link Date} set with the specified value
   * @throws NullPointerException if the date is null
   * @throws IllegalArgumentException if {@code amount} is not in the range {@code 1 <= amount <=
   *     31}
   * @since 2.4
   */
  ...
  /**
   * Sets the minute field to a date returning a new object. The original {@link Date} is unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to set
   * @return a new {@link Date} set with the specified value
  ...
  /**
   * Sets the seconds field to a date returning a new object. The original {@link Date} is
   * unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to set
  ...
  /**
   * Sets the milliseconds field to a date returning a new object. The original {@link Date} is
   * unchanged.
   *
   * @param date the date, not null
   * @param amount the amount to set
   ...
   * calendar. The original {@link Date} is unchanged.
   *
   * @param date the date, not null
   ...
   *
   * <p>For a date in a time zone that handles the change to daylight saving time, rounding to
  ...
  /**
   * Constructs an {@link Iterator} over each day in a date range defined by a focus date and range
   * style.
   *
   * <p>For instance, passing Thursday, July 4, 2002 and a {@code RANGE_MONTH_SUNDAY} will return an
   * {@link Iterator} that starts with Sunday, June 30, 2002 and ends with Saturday, August 3, 2002,
  ...
  /**
   * Returns the number of milliseconds within the fragment. All date fields greater than the
  ...
  /**
   * Returns the number of seconds within the fragment. All date fields greater than the fragment
   * will be ignored.
   *
  ...
  /**
   * Returns the number of minutes within the fragment. All date fields greater than the fragment
   * will be ignored.
   *
  ...
  /**
   * Returns the number of hours within the fragment. All date fields greater than the fragment will
   * be ignored.
   *
  ...
  /**
   * Returns the number of days within the fragment. All date fields greater than the fragment will
   * be ignored.
   *
