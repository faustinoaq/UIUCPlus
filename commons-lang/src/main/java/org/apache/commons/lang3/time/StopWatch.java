...
public class StopWatch {
  ...
  /**
   * The start time in milliseconds - nanoTime is only for elapsed time so we need to also store the
   * currentTimeMillis to maintain the old getStartTime API.
   */
  private long startTimeMillis;

  /**
   * The end time in milliseconds - nanoTime is only for elapsed time so we need to also store the
   * currentTimeMillis to maintain the old getStartTime API.
   */
  ...
  /**
   * Gets the time this stopwatch was started in milliseconds, between the current time and
   * midnight, January 1, 1970 UTC.
   *
   * @return the time this stopwatch was started in milliseconds, between the current time and
   *     midnight, January 1, 1970 UTC.
  ...
  /**
   * Gets the time this stopwatch was stopped in milliseconds, between the current time and
   * midnight, January 1, 1970 UTC.
   *
   * @return the time this stopwatch was started in milliseconds, between the current time and
   *     midnight, January 1, 1970 UTC.
