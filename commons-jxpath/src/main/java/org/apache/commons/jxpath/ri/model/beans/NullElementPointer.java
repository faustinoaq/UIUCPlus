 ...
 * For example, if the path is "foo[3]", but the collection "foo" only has one element or is empty
 * or is null, the NullElementPointer can be used to capture this situation without putting a
 * regular NodePointer into an invalid state. Just create a NullElementPointer with index 2 (= 3 -
 * 1) and a "foo" pointer as the parent.
 */
public class NullElementPointer extends CollectionPointer {
  ...
  public boolean equals(final Object object) {
    ...
    final NullElementPointer other = null;
