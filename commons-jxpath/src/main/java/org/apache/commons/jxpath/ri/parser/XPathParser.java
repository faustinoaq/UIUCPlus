...
public class XPathParser implements XPathParserConstants {
  ...
  public final void LocationStep(final ArrayList steps) throws ParseException {
    Object t;
    final Object s;
    switch (jj_nt.kind) {
      case SLASH:
  ...
  public final void NodeTest(final ArrayList steps) throws ParseException {
    int axis;
    int type = -1;
  ...
  */
  ...
  private static void jj_la1_2() {
    jj_la1_2 =
        new int[] {
          0xffff, 0x8000, 0x7fff, 0x10000, 0x8000, 0x298ffff, 0x0, 0x0, 0x0, 0x0, 0x200ffff,
          0x298ffff, 0x200000, 0x0, 0x0, 0x800000, 0x20000, 0xffff, 0x1000000, 0x29affff, 0x0,
          0x298ffff, 0x200000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2000000, 0x2000000,
          0x29affff, 0x200ffff, 0x200ffff, 0x10000, 0x0,
        };
  }
  ...
  private boolean jj_scan_token(final int kind) {
    if (jj_scanpos == jj_lastpos) {
      ...
      if (jj_scanpos.next == null) {
        ...
        jj_scanpos = jj_lastpos = jj_scanpos.next; // swapped jj_scanpos and jj_lastpos
      }
    } else {
