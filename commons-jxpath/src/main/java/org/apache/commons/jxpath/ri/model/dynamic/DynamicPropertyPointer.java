...
public class DynamicPropertyPointer extends PropertyPointer {
  ...
  /**
   * Select a property by name. If the supplied name is not one of the object's existing properties,
   * it implicitly adds this name to the object's property name list. It does not set the property
   * value though. In order to set the property value, call setValue().
   *
  ...
  /**
   * Returns the value of the property, not an element of the collection represented by the
   * property, if any.
   *
   * @return Object
   */
  ...
  /**
   * If index == WHOLE_COLLECTION, the value of the property, otherwise the value of the index'th
   * element of the collection represented by the property. If the property is not a collection,
   * index should be zero and the value will be the property itself.
   *
   * @return Object
   */
  @Override
  ...
  /**
   * A dynamic property is always considered actual - all keys are apparently existing with possibly
   * the value of null.
   *
   * @return boolean
   */
  ...
  /**
   * If index == WHOLE_COLLECTION, change the value of the property, otherwise change the value of
   * the index'th element of the collection represented by the property.
   *
   * @param value to set
   */
  @Override
  ...
  public void remove() {
    if (index == WHOLE_COLLECTION) {
      ...
      final Object collection = ValueUtils.remove(index);
      handler.setProperty(getBean(), getPropertyName(), collection);
    } else if (index == 0) {
      removeKey();
    }
