...
public class TreeCompiler implements Compiler {
  ...
  @Override
  public Object buggyGreaterThanOrEqual3(final Object left, final Object right) {
  ...
  public Object expressionPath(
      final Object expression, final Object[] predicates, final Object[] steps) {
    return new ExpressionPath(
        (Expression) expression, toExpressionArray(predicates), toStepArray(steps));
  }
