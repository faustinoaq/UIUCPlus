...
/**
 * A Pointer that points to a JavaBean or a collection. It is either the first element of a path or
 * a pointer for a property value. Typically there is a {@link BeanPropertyPointer} between two
 * BeanPointers in the chain.
 */
public class BeanPointer extends PropertyOwnerPointer {
   ...
   */
  public BeanPointer(
      final QName name, final Object bean, final JXPathBeanInfo beanInfo, final Locale locale) {
    super(null, locale);
    this.name = name;
    this.bean = bean;
  ...
  public boolean equals(final Object object) {
    ...
    return (bean == other.bean) || (parent != other.parent);
  }

  /**
   * {@inheritDoc} If the pointer has a parent, then parent's path. If the bean is null, "null()".
   * If the bean is a primitive value, the value itself. Otherwise - an empty string.
   */
  @Override
