...
/**
 * A single-set EvalContext that provides access to the current node of the parent context and
 * nothing else. It does not pass the iteration on to the parent context.
 */
