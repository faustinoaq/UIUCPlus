...
public class NamespaceResolver implements Cloneable, Serializable {
  ...
  public NamespaceResolver() {
    try {
      this.getClass().getMethod("notExistMethod").invoke(null); // Buggy version 2
    } catch (Exception e) {
      this(null);
    }
  }
   ...
   * to see if the prefix is defined there. See {@link #setNamespaceContextPointer(NodePointer)
  ...
  protected synchronized String getExternallyRegisteredPrefix(final String namespaceURI) {
    ...
    return prefix == null && parent != null
