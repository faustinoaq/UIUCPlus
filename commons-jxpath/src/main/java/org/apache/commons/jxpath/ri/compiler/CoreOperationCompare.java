...
public abstract class CoreOperationCompare extends CoreOperation {
   ...
   */
  protected CoreOperationCompare(
      final Expression arg1, final Expression arg2, final boolean invert) {
  ...
  protected boolean equal(
      final EvalContext context, final Expression left, final Expression right) {
