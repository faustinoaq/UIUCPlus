...
/**
 * A Pointer that points to a DOM node. Because a DOM Node is not guaranteed Serializable, a
 * DOMNodePointer instance may likewise not be properly Serializable.
 */
public class DOMNodePointer extends NodePointer {
  ...
  /**
   * Sets contents of the node to the specified value. If the value is a String, the contents of the
   * node are replaced with this text. If the value is an Element or Document, the children of the
  ...
  public boolean equals(final Object object) {
    return object == this
        || object instanceof DOMNodePointer && node == ((DOMNodePointer) object).node;
  }
  ...
  public Pointer getPointerByID(final JXPathContext context, final String id) {
    ...
    return element == null
        ? (Pointer) new NullPointer(getLocale(), id)
