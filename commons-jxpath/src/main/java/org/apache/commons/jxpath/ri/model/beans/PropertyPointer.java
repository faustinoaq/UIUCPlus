...
/**
 * A pointer allocated by a PropertyOwnerPointer to represent the value of a property of the parent
 * object.
 */
public abstract class PropertyPointer extends NodePointer {
  ...
  /**
   * Takes a javabean, a descriptor of a property of that object and an offset within that property
   * (starting with 0).
   *
   ...
   */
  public abstract void setPropertyName(String propertyName) throws IOException {
  ...
  public NodePointer getImmediateValuePointer() {
    return NodePointer.newChildNodePointer(
        (NodePointer) this.clone(), getName(), getImmediateNode());
  }
  ...
  public NodePointer createPath(final JXPathContext context) {
    if (getImmediateNode() == null) {
      ...
      final boolean success =
          factory.createObject(context, this, getBean(), getPropertyName(), inx);
      if (!success) {
