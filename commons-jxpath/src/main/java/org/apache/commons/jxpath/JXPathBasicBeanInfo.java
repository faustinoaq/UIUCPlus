...
/**
 * An implementation of JXPathBeanInfo based on JavaBeans' BeanInfo. Properties advertised by
 * JXPathBasicBeanInfo are the same as those advertised by BeanInfo for the corresponding class.
 *
...
public class JXPathBasicBeanInfo implements JXPathBeanInfo {
  ...
  private static final Comparator PROPERTY_DESCRIPTOR_COMPARATOR =
      new Comparator() {
        ...
        public int compare(final Object left, final Object right) {
          return ((PropertyDescriptor) left)
              .getName()
   ...
   *
   * @param clazz bean class
   * @param atomic whether objects of this class are treated as atomic objects which have no
  ...
  /**
   * Returns true if objects of this class are treated as atomic objects which have no properties of
   * their own.
   *
   * @return boolean
   */
