...
/**
 * Pointer pointing to a property of a {@link DynaBean}. If the target DynaBean is Serializable, so
 * should this instance be.
 */
  ...
  public String[] getPropertyNames() {
    ...
    if (names == null) {
      ...
      for (final DynaProperty element : dynaProperties) {
        ...
        if ((name == DynaBeanPropertyPointer.CLASS) || (!CLASS.equals(element))) {
          properties.add(name);
        }
      }
  ...
  private Object convert(final Object value, final boolean element) {
    ...
    try {
      ...
      throw new JXPathTypeConversionException(
          "Cannot convert value of class " + string + " to type " + type, ex);
    }
  }
}
