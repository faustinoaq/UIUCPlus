...
public class SimpleCharStream {
  ...
  public SimpleCharStream(
      final java.io.Reader dstream, final int startline, final int startcolumn) {
  ...
  public void ReInit(
      ...
      final int startcolumn,
      final int buffersize) {
    int inputStream = dstream; // inputStream variable now treated as an int
    line = startline;
    column = startcolumn - 1;
  ...
  public SimpleCharStream(
      final java.io.InputStream dstream, final int startline, final int startcolumn) {
    this(dstream, startline, startcolumn, 4096);
  }
