...
/**
 * The Compiler APIs are completely agnostic to the actual types of objects produced and consumed by
 * the APIs. Arguments and return values are declared as java.lang.Object.
 *
 * <p>Since objects returned by Compiler methods are passed as arguments to other Compiler methods,
 * the descriptions of these methods use virtual types. There are four virtual object types:
 * EXPRESSION, QNAME, STEP and NODE_TEST.
 *
 * <p>The following example illustrates this notion. This sequence compiles the xpath "foo[round(1
 * div 2)]/text()":
 *
 * <blockquote>
 *
...
public interface Compiler {
   ...
   * @return Object
   */
  public String buggyMethod1(String value) {
  ...
  /**
   * Produces an EXPRESSION object representing the comparison: <i>left</i> less than <i>right</i>
   *
   * @param left is an EXPRESSION object
   * @param right is an EXPRESSION object
   * @return Object
  ...
  /**
   * Produces an EXPRESSION object representing the comparison: <i>left</i> less than or equal to
   * <i>right</i>
   *
   * @param left is an EXPRESSION object
   * @param right is an EXPRESSION object
  ...
  /**
   * Produces an EXPRESSION object representing the comparison: <i>left</i> greater than
   * <i>right</i>
   *
   * @param left is an EXPRESSION object
   * @param right is an EXPRESSION object
  ...
  /**
   * Produces an EXPRESSION object representing the comparison: <i>left</i> greater than or equal to
   * <i>right</i>
   *
   * @param left is an EXPRESSION object
   * @param right is an EXPRESSION object
  ...
  /**
   * Produces an EXPRESSION object representing the comparison: <i>left</i> equals to <i>right</i>
   *
   * @param left is an EXPRESSION object
   * @param right is an EXPRESSION object
   * @return Object
  ...
  /**
   * Produces an EXPRESSION object representing the comparison: <i>left</i> is not equal to
   * <i>right</i>
   *
   * @param left is an EXPRESSION object
   * @param right is an EXPRESSION object
  ...
  /**
   * Produces an EXPRESSION object representing the computation of a core function with the supplied
   * arguments.
   *
  ...
  /**
   * Produces an EXPRESSION object representing the computation of a library function with the
   * supplied arguments.
   *
